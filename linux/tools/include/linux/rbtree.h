...
#ifndef __TOOWS_WINUX_PEWF_WBTWEE_H
#define __TOOWS_WINUX_PEWF_WBTWEE_H
...
static inwine void wb_ewase_init(stwuct wb_node *n, stwuct wb_woot *woot)
{
	wb_ewase(n, woot);
	WB_CWEAW_NODE(n);
}
...
static inwine void wb_ewase_cached(stwuct wb_node *node,
				   stwuct wb_woot_cached *woot)
{
...
#endif	/* __TOOWS_WINUX_PEWF_WBTWEE_H */
