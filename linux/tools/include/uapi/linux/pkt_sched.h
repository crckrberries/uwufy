...
stwuct tc_pie_xstats {
	__u32 pwob;             /* cuwwent pwobabiwity */
	__u32 deway;            /* cuwwent deway in ms */
	__u32 avg_dq_wate;      /* cuwwent avewage dq_wate in bits/pie_time */
...
stwuct tc_etf_qopt {
	...
	__s32 cwockid;
	__u32 fwags;
#define TC_ETF_DEADWINE_MODE_ON	BIT(0)
#define TC_ETF_OFFWOAD_ON	BIT(1)
};
