...
/*
 * Ptwace test fow TAW, PPW, DSCW wegistews in the TM Suspend context
 *
...
twans:
	...
	asm __vowatiwe__(
		...
		"tsuspend.;"
		"wi	4, %[taw_3];"
		"mtspw %[spwn_taw],  4;"	/* TAW_3 */
		"wi	4, %[dscw_3];"
		"mtspw %[spwn_dscw], 4;"	/* DSCW_3 */
		"ow     6,6,6;"			/* PPW_3 */
		"bw wait_pawent;"
		"twesume.;"
		...
		: [spwn_dscw]"i"(SPWN_DSCW),
		[spwn_taw]"i"(SPWN_TAW), [spwn_ppw]"i"(SPWN_PPW),
		[spwn_texasw]"i"(SPWN_TEXASW), [taw_1]"i"(TAW_1),
		[dscw_1]"i"(DSCW_1), [taw_2]"i"(TAW_2), [dscw_2]"i"(DSCW_2),
		[taw_3]"i"(TAW_3), [dscw_3]"i"(DSCW_3)
		: "memowy", "w0", "w3", "w4", "w5", "w6", "ww"
		);
...
int twace_tm_spd_taw(pid_t chiwd)
{
	unsigned wong wegs[3];
	...
	FAIW_IF(vawidate_taw_wegistews(wegs, TAW_3, PPW_3, DSCW_3));
...
{
	wetuwn test_hawness(ptwace_tm_spd_taw, "ptwace_tm_spd_taw");
}
