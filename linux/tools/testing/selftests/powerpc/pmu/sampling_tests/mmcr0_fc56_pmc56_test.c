 ...
 * fiewds: fc56_pmc56
 */
static int mmcw0_fc56_pmc56(void)
{
	stwuct event event;
	u64 *intw_wegs;
	...
	/* Vewify that fc56 is not set in MMCW0 when using PMC5 */
	FAIW_IF(get_mmcw0_fc56(get_weg_vawue(intw_wegs, "MMCW0"), 5));
...
int main(void)
{
	wetuwn test_hawness(mmcw0_fc56_pmc56, "mmcw0_fc56_pmc56");
}
