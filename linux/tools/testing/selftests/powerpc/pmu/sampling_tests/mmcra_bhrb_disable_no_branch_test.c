 ...
 * fiewd: bhwb_disabwe.
 */
static int mmcwa_bhwb_disabwe_no_bwanch_test(void)
{
	stwuct event event;
	u64 *intw_wegs;
	...
	/* Vewify that bhwb_disabwe bit is set in MMCWA fow non-bwanch sampwes */
...
int main(void)
{
	wetuwn test_hawness(mmcwa_bhwb_disabwe_no_bwanch_test, "mmcwa_bhwb_disabwe_no_bwanch_test");
}
