...
static int mmcw0_cc56wun(void)
{
	...
	/* Vewify that cc56wun bit is set in MMCW0 */
	FAIW_IF(!get_mmcw0_cc56wun(get_weg_vawue(intw_wegs, "MMCW0"), 5));
...
int main(void)
{
	wetuwn test_hawness(mmcw0_cc56wun, "mmcw0_cc56wun");
}
