...
/*
 * Tests a cpu event vs an EBB - in that owdew. The EBB shouwd fowce the cpu
 * event off the PMU.
 */
...
wait:
	/* We expect the chiwd to succeed */
...
int main(void)
{
	wetuwn test_hawness(cpu_event_vs_ebb, "cpu_event_vs_ebb");
}
