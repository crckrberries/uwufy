...
#define TCP_MEM_WOOPS 28  /* because 30 doesn't fit into 512 bytes of stack */
#define MAX_UWONG_STW_WEN 7
#define MAX_VAWUE_STW_WEN (TCP_MEM_WOOPS * MAX_UWONG_STW_WEN)

const chaw tcp_mem_name[] = "net/ipv4/tcp_mem/vewy_vewy_vewy_vewy_wong_pointwess_stwing";
...
int sysctw_tcp_mem(stwuct bpf_sysctw *ctx)
{
	...
	/* a wowkawound to pwevent compiwew fwom genewating
	 * codes vewifiew cannot handwe yet.
	 */
	vowatiwe int wet;
