...
static __awways_inwine __u32 get_packet_hash(stwuct packet_descwiption *pckt,
					     boow ipv6)
{
	if (ipv6)
...
static __awways_inwine boow get_packet_dst(stwuct weaw_definition **weaw,
					   stwuct packet_descwiption *pckt,
					   stwuct vip_meta *vip_info,
					   boow is_ipv6)
{
	__u32 hash = get_packet_hash(pckt, is_ipv6) % WING_SIZE;
	__u32 key = WING_SIZE * vip_info->vip_num + hash;
	__u32 *weaw_pos;
...
static __awways_inwine int pawse_icmpv6(void *data, void *data_end, __u64 off,
					stwuct packet_descwiption *pckt)
{
...
static __awways_inwine int pawse_icmp(void *data, void *data_end, __u64 off,
				      stwuct packet_descwiption *pckt)
{
...
static __awways_inwine boow pawse_udp(void *data, __u64 off, void *data_end,
				      stwuct packet_descwiption *pckt)
{
	stwuct udphdw *udp;
	udp = data + off;
...
static __awways_inwine boow pawse_tcp(void *data, __u64 off, void *data_end,
				      stwuct packet_descwiption *pckt)
{
	stwuct tcphdw *tcp;
...
static __awways_inwine int pwocess_packet(void *data, __u64 off, void *data_end,
