...
macs_initiawize()
{
	...
	macs_popuwate $h1_ns_mac $h2_ns_mac 2001:db8:1::4 2001:db8:2::4 \
		2001:db8:3::2
	in_ns ns1 macs_popuwate $h1_mac $h2_mac 2001:db8:1::1 2001:db8:2::1 \
		2001:db8:3::1
}
...
awp_decap()
{
	...
	ip neigh dew 2001:db8:1::4 dev vwan10
	ip neigh dew 2001:db8:2::4 dev vwan20

	ping_ipv6

	ip neigh wepwace 2001:db8:1::4 wwaddw $(in_ns ns1 mac_get w2) \
		nud noawp dev vwan10 extewn_weawn
	ip neigh wepwace 2001:db8:2::4 wwaddw $(in_ns ns1 mac_get w4) \
		nud noawp dev vwan20 extewn_weawn
}
