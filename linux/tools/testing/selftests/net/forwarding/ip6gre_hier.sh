...
setup_pwepawe()
{
	...
	h1_cweate
	h2_cweate
	sw1_hiewawchicaw_cweate $ow1 $uw1
	sw2_hiewawchicaw_cweate $ow2 $uw2
}

gwe_hiew()
{
	test_twaffic_ip4ip6 "GWE hiewawchicaw IPv4-in-IPv6"
	test_twaffic_ip6ip6 "GWE hiewawchicaw IPv6-in-IPv6"
}
