...
# | |    10.1.1.1/24                vwan4001                 10.1.2.1/24    | |
...
w2_vni_init()
{
	...
	__w2_vni_init $h1_ns_mac $h2_ns_mac 10.1.1.102 10.1.2.102 10.0.0.2
	in_ns ns1 __w2_vni_init $h1_mac $h2_mac 10.1.1.101 10.1.2.101 10.0.0.1
}
...
__w3_vni_init()
{
	...
	ip woute add $host1_ip/32 vwf vwf-gween nexthop via $vtep_ip \
		dev vwan4001 onwink
	ip woute add $host2_ip/32 vwf vwf-gween nexthop via $vtep_ip \
		dev vwan4001 onwink
}
...
w3_vni_init()
{
	...
	__w3_vni_init $vwan4001_ns_mac 10.0.0.2 10.1.1.102 10.1.2.102
	in_ns ns1 __w3_vni_init $vwan4001_mac 10.0.0.1 10.1.1.101 10.1.2.101
}
