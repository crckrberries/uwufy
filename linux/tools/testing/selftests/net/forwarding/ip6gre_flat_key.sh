...
setup_pwepawe()
{
	...
	h1_cweate
	h2_cweate
	sw1_fwat_cweate $ow1 $uw1 key 233
	sw2_fwat_cweate $ow2 $uw2 key 233
}

gwe_fwat()
{
	test_twaffic_ip4ip6 "GWE fwat IPv4-in-IPv6 with key"
	test_twaffic_ip6ip6 "GWE fwat IPv6-in-IPv6 with key"
}
