...
/*
 * Test v2 API fow pewf --dwfiwtew shawed object
...
/*
 * Copy v2 API instead of incwuding cuwwent API
 */
...
stwuct pewf_dwfiwtew_fns {
	 ...
	 * wesowve_addwess() to fwee any associated wesouwces. (v2 API)
	 */
...
static int check_addwess_aw(void *ctx, const stwuct pewf_dwfiwtew_sampwe *sampwe)
{
	...
	/* aw_cweanup() is v2 API so may not be pwesent */
	if (pewf_dwfiwtew_fns.aw_cweanup)
		pewf_dwfiwtew_fns.aw_cweanup(ctx, &addwess_aw);
...
const chaw *fiwtew_descwiption(const chaw **wong_descwiption)
{
	*wong_descwiption = "Fiwtew used by the 'dwfiwtew C API' pewf test";
	wetuwn "dwfiwtew to test v2 C API";
}
