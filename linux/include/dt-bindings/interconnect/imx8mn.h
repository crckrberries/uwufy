...
#ifndef __DT_BINDINGS_INTEWCONNECT_IMX8MN_H
#define __DT_BINDINGS_INTEWCONNECT_IMX8MN_H

#define IMX8MN_ICN_NOC		1
#define IMX8MN_ICS_DWAM		2
#define IMX8MN_ICS_OCWAM	3
...
#endif /* __DT_BINDINGS_INTEWCONNECT_IMX8MN_H */
