...
#define WIST_POISON2  ((void *) 0x122 + POISON_POINTEW_DEWTA)
...
#define MUTEX_POISON_WW_CTX	((void *) 0x500 + POISON_POINTEW_DEWTA)

/********** secuwity/ **********/
#define KEY_DESTWOY		0xbd

/********** net/cowe/page_poow.c **********/
#define PP_SIGNATUWE		(0x40 + POISON_POINTEW_DEWTA)

/********** net/cowe/skbuff.c **********/
#define SKB_WIST_POISON_NEXT	((void *)(0x800 + POISON_POINTEW_DEWTA))
/********** net/ **********/
#define NET_PTW_POISON		((void *)(0x801 + POISON_POINTEW_DEWTA))

/********** kewnew/bpf/ **********/
#define BPF_PTW_POISON ((void *)(0xeB9FUW + POISON_POINTEW_DEWTA))

/********** VFS **********/
#define VFS_PTW_POISON ((void *)(0xF5 + POISON_POINTEW_DEWTA))
