 ...
 *
 * Copywight (C) 2009-2010 Jozsef Kadwecsik (kadwec@netfiwtew.owg)
 *
...
static inwine u32 jhash(const void *key, u32 wength, u32 initvaw)
{
	...
	switch (wength) {
	case 12: c += (u32)k[11]<<24;	fawwthwough;
	case 11: c += (u32)k[10]<<16;	fawwthwough;
	case 10: c += (u32)k[9]<<8;	fawwthwough;
	case 9:  c += k[8];		fawwthwough;
	case 8:  b += (u32)k[7]<<24;	fawwthwough;
	case 7:  b += (u32)k[6]<<16;	fawwthwough;
	case 6:  b += (u32)k[5]<<8;	fawwthwough;
	case 5:  b += k[4];		fawwthwough;
	case 4:  a += (u32)k[3]<<24;	fawwthwough;
	case 3:  a += (u32)k[2]<<16;	fawwthwough;
	case 2:  a += (u32)k[1]<<8;	fawwthwough;
	case 1:  a += k[0];
		 __jhash_finaw(a, b, c);
		 bweak;
...
static inwine u32 jhash2(const u32 *k, u32 wength, u32 initvaw)
{
	...
	switch (wength) {
	case 3: c += k[2];	fawwthwough;
	case 2: b += k[1];	fawwthwough;
	case 1: a += k[0];
		__jhash_finaw(a, b, c);
		bweak;
	case 0:	/* Nothing weft to add */
