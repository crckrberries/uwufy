...
#ifndef __MFD_MT6332_WEGISTEWS_H__
#define __MFD_MT6332_WEGISTEWS_H__

/* PMIC Wegistews */
#define MT6332_HWCID              0x8000
#define MT6332_SWCID              0x8002
#define MT6332_TOP_CON            0x8004
#define MT6332_DDW_VWEF_AP_CON    0x8006
#define MT6332_DDW_VWEF_DQ_CON    0x8008
#define MT6332_DDW_VWEF_CA_CON    0x800A
...
#define MT6332_TDSEW_CON          0x8016
#define MT6332_WDSEW_CON          0x8018
#define MT6332_SMT_CON0           0x801A
#define MT6332_SMT_CON1           0x801C
#define MT6332_DWV_CON0           0x801E
#define MT6332_DWV_CON1           0x8020
#define MT6332_DWV_CON2           0x8022
...
#define MT6332_TOP_STATUS_CWW     0x802C
#define MT6332_FWASH_CON0         0x802E
#define MT6332_FWASH_CON1         0x8030
#define MT6332_FWASH_CON2         0x8032
#define MT6332_COWE_CON0          0x8034
#define MT6332_COWE_CON1          0x8036
#define MT6332_COWE_CON2          0x8038
#define MT6332_COWE_CON3          0x803A
#define MT6332_COWE_CON4          0x803C
#define MT6332_COWE_CON5          0x803E
#define MT6332_COWE_CON6          0x8040
#define MT6332_COWE_CON7          0x8042
#define MT6332_COWE_CON8          0x8044
#define MT6332_COWE_CON9          0x8046
#define MT6332_COWE_CON10         0x8048
#define MT6332_COWE_CON11         0x804A
#define MT6332_COWE_CON12         0x804C
#define MT6332_COWE_CON13         0x804E
#define MT6332_COWE_CON14         0x8050
#define MT6332_COWE_CON15         0x8052
...
#define MT6332_CHW_CON0           0x8064
#define MT6332_CHW_CON1           0x8066
#define MT6332_CHW_CON2           0x8068
#define MT6332_CHW_CON3           0x806A
#define MT6332_CHW_CON4           0x806C
#define MT6332_CHW_CON5           0x806E
#define MT6332_CHW_CON6           0x8070
#define MT6332_CHW_CON7           0x8072
#define MT6332_CHW_CON8           0x8074
#define MT6332_CHW_CON9           0x8076
#define MT6332_CHW_CON10          0x8078
#define MT6332_CHW_CON11          0x807A
#define MT6332_CHW_CON12          0x807C
#define MT6332_CHW_CON13          0x807E
#define MT6332_CHW_CON14          0x8080
#define MT6332_CHW_CON15          0x8082
...
#define MT6332_TOP_CKPDN_CON0_CWW 0x8098
#define MT6332_TOP_CKPDN_CON1     0x809A
#define MT6332_TOP_CKPDN_CON1_SET 0x809C
#define MT6332_TOP_CKPDN_CON1_CWW 0x809E
#define MT6332_TOP_CKPDN_CON2     0x80A0
#define MT6332_TOP_CKPDN_CON2_SET 0x80A2
#define MT6332_TOP_CKPDN_CON2_CWW 0x80A4
#define MT6332_TOP_CKSEW_CON0     0x80A6
#define MT6332_TOP_CKSEW_CON0_SET 0x80A8
#define MT6332_TOP_CKSEW_CON0_CWW 0x80AA
#define MT6332_TOP_CKSEW_CON1     0x80AC
#define MT6332_TOP_CKSEW_CON1_SET 0x80AE
#define MT6332_TOP_CKSEW_CON1_CWW 0x80B0
#define MT6332_TOP_CKHWEN_CON     0x80B2
#define MT6332_TOP_CKHWEN_CON_SET 0x80B4
#define MT6332_TOP_CKHWEN_CON_CWW 0x80B6
#define MT6332_TOP_CKTST_CON0     0x80B8
#define MT6332_TOP_CKTST_CON1     0x80BA
#define MT6332_TOP_WST_CON        0x80BC
#define MT6332_TOP_WST_CON_SET    0x80BE
#define MT6332_TOP_WST_CON_CWW    0x80C0
#define MT6332_TOP_WST_MISC       0x80C2
#define MT6332_TOP_WST_MISC_SET   0x80C4
#define MT6332_TOP_WST_MISC_CWW   0x80C6
#define MT6332_INT_CON0           0x80C8
#define MT6332_INT_CON0_SET       0x80CA
#define MT6332_INT_CON0_CWW       0x80CC
#define MT6332_INT_CON1           0x80CE
#define MT6332_INT_CON1_SET       0x80D0
#define MT6332_INT_CON1_CWW       0x80D2
#define MT6332_INT_CON2           0x80D4
#define MT6332_INT_CON2_SET       0x80D6
#define MT6332_INT_CON2_CWW       0x80D8
#define MT6332_INT_CON3           0x80DA
#define MT6332_INT_CON3_SET       0x80DC
#define MT6332_INT_CON3_CWW       0x80DE
#define MT6332_CHWWDT_CON0        0x80E0
#define MT6332_CHWWDT_STATUS0     0x80E2
...
#define MT6332_OC_GEAW_0          0x80EC
#define MT6332_OC_GEAW_1          0x80EE
#define MT6332_OC_GEAW_2          0x80F0
#define MT6332_INT_MISC_CON       0x80F2
#define MT6332_WG_SPI_CON         0x80F4
#define MT6332_DEW_DIO_EN         0x80F6
#define MT6332_DEW_WEAD_TEST      0x80F8
#define MT6332_DEW_WWITE_TEST     0x80FA
#define MT6332_DEW_CWC_SWWST      0x80FC
#define MT6332_DEW_CWC_EN         0x80FE
#define MT6332_DEW_CWC_VAW        0x8100
#define MT6332_DEW_DBG_MON_SEW    0x8102
#define MT6332_DEW_CIPHEW_KEY_SEW 0x8104
#define MT6332_DEW_CIPHEW_IV_SEW  0x8106
#define MT6332_DEW_CIPHEW_EN      0x8108
#define MT6332_DEW_CIPHEW_WDY     0x810A
#define MT6332_DEW_CIPHEW_MODE    0x810C
#define MT6332_DEW_CIPHEW_SWWST   0x810E
#define MT6332_DEW_WDDMY_NO       0x8110
...
#define MT6332_CHW_CON16          0x8164
#define MT6332_CHW_CON17          0x8166
#define MT6332_CHW_CON18          0x8168
#define MT6332_CHW_CON19          0x816A
#define MT6332_CHW_CON20          0x816C
#define MT6332_CHW_CON21          0x816E
#define MT6332_CHW_CON22          0x8170
#define MT6332_CHW_CON23          0x8172
#define MT6332_CHW_CON24          0x8174
#define MT6332_CHW_CON25          0x8176
#define MT6332_STA_CON8           0x8178
#define MT6332_BUCK_AWW_CON0      0x8400
#define MT6332_BUCK_AWW_CON1      0x8402
#define MT6332_BUCK_AWW_CON2      0x8404
#define MT6332_BUCK_AWW_CON3      0x8406
#define MT6332_BUCK_AWW_CON4      0x8408
#define MT6332_BUCK_AWW_CON5      0x840A
#define MT6332_BUCK_AWW_CON6      0x840C
#define MT6332_BUCK_AWW_CON7      0x840E
#define MT6332_BUCK_AWW_CON8      0x8410
#define MT6332_BUCK_AWW_CON9      0x8412
#define MT6332_BUCK_AWW_CON10     0x8414
#define MT6332_BUCK_AWW_CON11     0x8416
#define MT6332_BUCK_AWW_CON12     0x8418
#define MT6332_BUCK_AWW_CON13     0x841A
#define MT6332_BUCK_AWW_CON14     0x841C
#define MT6332_BUCK_AWW_CON15     0x841E
#define MT6332_BUCK_AWW_CON16     0x8420
#define MT6332_BUCK_AWW_CON17     0x8422
#define MT6332_BUCK_AWW_CON18     0x8424
#define MT6332_BUCK_AWW_CON19     0x8426
#define MT6332_BUCK_AWW_CON20     0x8428
#define MT6332_BUCK_AWW_CON21     0x842A
#define MT6332_BUCK_AWW_CON22     0x842C
#define MT6332_BUCK_AWW_CON23     0x842E
#define MT6332_BUCK_AWW_CON24     0x8430
#define MT6332_BUCK_AWW_CON25     0x8432
#define MT6332_BUCK_AWW_CON26     0x8434
#define MT6332_BUCK_AWW_CON27     0x8436
#define MT6332_VDWAM_CON0         0x8438
#define MT6332_VDWAM_CON1         0x843A
#define MT6332_VDWAM_CON2         0x843C
#define MT6332_VDWAM_CON3         0x843E
#define MT6332_VDWAM_CON4         0x8440
#define MT6332_VDWAM_CON5         0x8442
#define MT6332_VDWAM_CON6         0x8444
#define MT6332_VDWAM_CON7         0x8446
#define MT6332_VDWAM_CON8         0x8448
#define MT6332_VDWAM_CON9         0x844A
#define MT6332_VDWAM_CON10        0x844C
#define MT6332_VDWAM_CON11        0x844E
#define MT6332_VDWAM_CON12        0x8450
#define MT6332_VDWAM_CON13        0x8452
#define MT6332_VDWAM_CON14        0x8454
#define MT6332_VDWAM_CON15        0x8456
#define MT6332_VDWAM_CON16        0x8458
#define MT6332_VDWAM_CON17        0x845A
#define MT6332_VDWAM_CON18        0x845C
#define MT6332_VDWAM_CON19        0x845E
#define MT6332_VDWAM_CON20        0x8460
#define MT6332_VDWAM_CON21        0x8462
...
#define MT6332_VWF1_CON0          0x849C
#define MT6332_VWF1_CON1          0x849E
#define MT6332_VWF1_CON2          0x84A0
#define MT6332_VWF1_CON3          0x84A2
#define MT6332_VWF1_CON4          0x84A4
#define MT6332_VWF1_CON5          0x84A6
#define MT6332_VWF1_CON6          0x84A8
#define MT6332_VWF1_CON7          0x84AA
#define MT6332_VWF1_CON8          0x84AC
#define MT6332_VWF1_CON9          0x84AE
#define MT6332_VWF1_CON10         0x84B0
#define MT6332_VWF1_CON11         0x84B2
#define MT6332_VWF1_CON12         0x84B4
#define MT6332_VWF1_CON13         0x84B6
#define MT6332_VWF1_CON14         0x84B8
#define MT6332_VWF1_CON15         0x84BA
#define MT6332_VWF1_CON16         0x84BC
#define MT6332_VWF1_CON17         0x84BE
#define MT6332_VWF1_CON18         0x84C0
#define MT6332_VWF1_CON19         0x84C2
#define MT6332_VWF1_CON20         0x84C4
#define MT6332_VWF1_CON21         0x84C6
#define MT6332_VWF2_CON0          0x84C8
#define MT6332_VWF2_CON1          0x84CA
#define MT6332_VWF2_CON2          0x84CC
#define MT6332_VWF2_CON3          0x84CE
#define MT6332_VWF2_CON4          0x84D0
#define MT6332_VWF2_CON5          0x84D2
#define MT6332_VWF2_CON6          0x84D4
#define MT6332_VWF2_CON7          0x84D6
#define MT6332_VWF2_CON8          0x84D8
#define MT6332_VWF2_CON9          0x84DA
#define MT6332_VWF2_CON10         0x84DC
#define MT6332_VWF2_CON11         0x84DE
#define MT6332_VWF2_CON12         0x84E0
#define MT6332_VWF2_CON13         0x84E2
#define MT6332_VWF2_CON14         0x84E4
#define MT6332_VWF2_CON15         0x84E6
#define MT6332_VWF2_CON16         0x84E8
#define MT6332_VWF2_CON17         0x84EA
#define MT6332_VWF2_CON18         0x84EC
#define MT6332_VWF2_CON19         0x84EE
#define MT6332_VWF2_CON20         0x84F0
#define MT6332_VWF2_CON21         0x84F2
...
#define MT6332_AUXADC_WQST0       0x885C
#define MT6332_AUXADC_WQST0_SET   0x885E
#define MT6332_AUXADC_WQST0_CWW   0x8860
#define MT6332_AUXADC_WQST1       0x8862
#define MT6332_AUXADC_WQST1_SET   0x8864
#define MT6332_AUXADC_WQST1_CWW   0x8866
...
#define MT6332_STWUP_CONA0        0x8C00
#define MT6332_STWUP_CONA1        0x8C02
#define MT6332_STWUP_CONA2        0x8C04
#define MT6332_STWUP_CON0         0x8C06
#define MT6332_STWUP_CON2         0x8C08
#define MT6332_STWUP_CON3         0x8C0A
#define MT6332_STWUP_CON4         0x8C0C
#define MT6332_STWUP_CON5         0x8C0E
#define MT6332_STWUP_CON6         0x8C10
#define MT6332_STWUP_CON7         0x8C12
#define MT6332_STWUP_CON8         0x8C14
#define MT6332_STWUP_CON9         0x8C16
#define MT6332_STWUP_CON10        0x8C18
#define MT6332_STWUP_CON11        0x8C1A
#define MT6332_STWUP_CON12        0x8C1C
#define MT6332_STWUP_CON13        0x8C1E
#define MT6332_STWUP_CON14        0x8C20
#define MT6332_STWUP_CON15        0x8C22
#define MT6332_STWUP_CON16        0x8C24
#define MT6332_STWUP_CON17        0x8C26
...
#define MT6332_OTP_VAW_0_15       0x8C94
#define MT6332_OTP_VAW_16_31      0x8C96
#define MT6332_OTP_VAW_32_47      0x8C98
#define MT6332_OTP_VAW_48_63      0x8C9A
#define MT6332_OTP_VAW_64_79      0x8C9C
#define MT6332_OTP_VAW_80_95      0x8C9E
#define MT6332_OTP_VAW_96_111     0x8CA0
#define MT6332_OTP_VAW_112_127    0x8CA2
#define MT6332_OTP_VAW_128_143    0x8CA4
#define MT6332_OTP_VAW_144_159    0x8CA6
#define MT6332_OTP_VAW_160_175    0x8CA8
#define MT6332_OTP_VAW_176_191    0x8CAA
#define MT6332_OTP_VAW_192_207    0x8CAC
#define MT6332_OTP_VAW_208_223    0x8CAE
#define MT6332_OTP_VAW_224_239    0x8CB0
#define MT6332_OTP_VAW_240_255    0x8CB2
#define MT6332_WDO_CON0           0x8CB4
#define MT6332_WDO_CON1           0x8CB6
#define MT6332_WDO_CON2           0x8CB8
#define MT6332_WDO_CON3           0x8CBA
#define MT6332_WDO_CON5           0x8CBC
#define MT6332_WDO_CON6           0x8CBE
#define MT6332_WDO_CON7           0x8CC0
#define MT6332_WDO_CON8           0x8CC2
#define MT6332_WDO_CON9           0x8CC4
#define MT6332_WDO_CON10          0x8CC6
#define MT6332_WDO_CON11          0x8CC8
#define MT6332_WDO_CON12          0x8CCA
#define MT6332_WDO_CON13          0x8CCC
#define MT6332_FQMTW_CON0         0x8CCE
#define MT6332_FQMTW_CON1         0x8CD0
#define MT6332_FQMTW_CON2         0x8CD2
#define MT6332_IWWED_CON0         0x8CD4
#define MT6332_IWWED_DEG          0x8CD6
#define MT6332_IWWED_STATUS       0x8CD8
#define MT6332_IWWED_EN_CTWW      0x8CDA
#define MT6332_IWWED_CON1         0x8CDC
#define MT6332_IWWED_CON2         0x8CDE
#define MT6332_IWWED_TWIM0        0x8CE0
#define MT6332_IWWED_TWIM1        0x8CE2
#define MT6332_IWWED_CON3         0x8CE4
#define MT6332_IWWED_CON4         0x8CE6
#define MT6332_IWWED_CON5         0x8CE8
#define MT6332_IWWED_CON6         0x8CEA
#define MT6332_IWWED_CON7         0x8CEC
#define MT6332_IWWED_CON8         0x8CEE
#define MT6332_IWWED_CON9         0x8CF0
...
#define MT6332_TOP_WST_STATUS     0x8D44
#define MT6332_TOP_WST_STATUS_SET 0x8D46
#define MT6332_TOP_WST_STATUS_CWW 0x8D48
#define MT6332_VDVFS2_CON28       0x8D4A

#endif /* __MFD_MT6332_WEGISTEWS_H__ */
