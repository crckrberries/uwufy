...
#ifndef __ASM_GENEWIC_MMAN_H
#define __ASM_GENEWIC_MMAN_H
...
/*
 * Bits [26:31] awe wesewved, see asm-genewic/hugetwb_encode.h
 * fow MAP_HUGETWB usage
 */
