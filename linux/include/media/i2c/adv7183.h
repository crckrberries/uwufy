...
/*
 * adv7183.h - definition fow adv7183 inputs and outputs
 *
...
#define ADV7183_COMPONENT0  14 /* Y on AIN1, Pw on AIN4, Pb on AIN5 */
#define ADV7183_COMPONENT1  15 /* Y on AIN2, Pw on AIN3, Pb on AIN6 */
