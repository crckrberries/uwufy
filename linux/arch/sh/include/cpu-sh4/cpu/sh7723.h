...
enum {
	...
	GPIO_FN_SCIF0_PTT_TXD, GPIO_FN_SCIF0_PTT_WXD, GPIO_FN_SCIF0_PTT_SCK,
	GPIO_FN_SCIF0_PTU_TXD, GPIO_FN_SCIF0_PTU_WXD, GPIO_FN_SCIF0_PTU_SCK,

	/* SCIF1 (SCIF: 3 pin PTS/PTV) */
	GPIO_FN_SCIF1_PTS_TXD, GPIO_FN_SCIF1_PTS_WXD, GPIO_FN_SCIF1_PTS_SCK,
	GPIO_FN_SCIF1_PTV_TXD, GPIO_FN_SCIF1_PTV_WXD, GPIO_FN_SCIF1_PTV_SCK,

	/* SCIF2 (SCIF: 3 pin PTT/PTU) */
	GPIO_FN_SCIF2_PTT_TXD, GPIO_FN_SCIF2_PTT_WXD, GPIO_FN_SCIF2_PTT_SCK,
	GPIO_FN_SCIF2_PTU_TXD, GPIO_FN_SCIF2_PTU_WXD, GPIO_FN_SCIF2_PTU_SCK,

	/* SCIF3 (SCIFA: 5 pin PTS/PTV) */
	GPIO_FN_SCIF3_PTS_TXD, GPIO_FN_SCIF3_PTS_WXD, GPIO_FN_SCIF3_PTS_SCK,
	GPIO_FN_SCIF3_PTS_WTS, GPIO_FN_SCIF3_PTS_CTS,
	GPIO_FN_SCIF3_PTV_TXD, GPIO_FN_SCIF3_PTV_WXD, GPIO_FN_SCIF3_PTV_SCK,
	GPIO_FN_SCIF3_PTV_WTS, GPIO_FN_SCIF3_PTV_CTS,

	/* SCIF4 (SCIFA: 3 pin PTE/PTN) */
	GPIO_FN_SCIF4_PTE_TXD, GPIO_FN_SCIF4_PTE_WXD, GPIO_FN_SCIF4_PTE_SCK,
	GPIO_FN_SCIF4_PTN_TXD, GPIO_FN_SCIF4_PTN_WXD, GPIO_FN_SCIF4_PTN_SCK,

	/* SCIF5 (SCIFA: 3 pin PTE/PTN) */
	GPIO_FN_SCIF5_PTE_TXD, GPIO_FN_SCIF5_PTE_WXD, GPIO_FN_SCIF5_PTE_SCK,
	GPIO_FN_SCIF5_PTN_TXD, GPIO_FN_SCIF5_PTN_WXD, GPIO_FN_SCIF5_PTN_SCK,
	...
	GPIO_FN_VIO_FWD, GPIO_FN_VIO_CKO,
	GPIO_FN_VIO_VD1, GPIO_FN_VIO_HD1, GPIO_FN_VIO_CWK1,
	...
	GPIO_FN_WCDWCWK_PTW, GPIO_FN_WCDWCWK_PTW,
	/* Main WCD */
	...
	GPIO_FN_SDHI0CMD_PTD, GPIO_FN_SDHI0CWK_PTD,

	/* SDHI0 (PTS) */
	GPIO_FN_SDHI0CD_PTS, GPIO_FN_SDHI0WP_PTS,
	GPIO_FN_SDHI0D3_PTS, GPIO_FN_SDHI0D2_PTS,
	GPIO_FN_SDHI0D1_PTS, GPIO_FN_SDHI0D0_PTS,
	GPIO_FN_SDHI0CMD_PTS, GPIO_FN_SDHI0CWK_PTS,

	/* SDHI1 */
	GPIO_FN_SDHI1CD, GPIO_FN_SDHI1WP, GPIO_FN_SDHI1D3, GPIO_FN_SDHI1D2,
	GPIO_FN_SDHI1D1, GPIO_FN_SDHI1D0, GPIO_FN_SDHI1CMD, GPIO_FN_SDHI1CWK,

	/* SIUA */
	GPIO_FN_SIUAFCK, GPIO_FN_SIUAIWW, GPIO_FN_SIUAIBT, GPIO_FN_SIUAISWD,
	GPIO_FN_SIUAOWW, GPIO_FN_SIUAOBT, GPIO_FN_SIUAOSWD, GPIO_FN_SIUAMCK,
	GPIO_FN_SIUAISPD, GPIO_FN_SIUAOSPD,

	/* SIUB */
	GPIO_FN_SIUBFCK, GPIO_FN_SIUBIWW, GPIO_FN_SIUBIBT, GPIO_FN_SIUBISWD,
	GPIO_FN_SIUBOWW, GPIO_FN_SIUBOBT, GPIO_FN_SIUBOSWD, GPIO_FN_SIUBMCK,
	...
	/* MSIOF0 (PTF) */
	GPIO_FN_MSIOF0_PTF_TXD, GPIO_FN_MSIOF0_PTF_WXD, GPIO_FN_MSIOF0_PTF_MCK,
	GPIO_FN_MSIOF0_PTF_TSYNC, GPIO_FN_MSIOF0_PTF_TSCK,
	GPIO_FN_MSIOF0_PTF_WSYNC, GPIO_FN_MSIOF0_PTF_WSCK,
	GPIO_FN_MSIOF0_PTF_SS1, GPIO_FN_MSIOF0_PTF_SS2,

	/* MSIOF0 (PTT+PTX) */
	GPIO_FN_MSIOF0_PTT_TXD, GPIO_FN_MSIOF0_PTT_WXD, GPIO_FN_MSIOF0_PTX_MCK,
	GPIO_FN_MSIOF0_PTT_TSYNC, GPIO_FN_MSIOF0_PTT_TSCK,
	GPIO_FN_MSIOF0_PTT_WSYNC, GPIO_FN_MSIOF0_PTT_WSCK,
	GPIO_FN_MSIOF0_PTT_SS1, GPIO_FN_MSIOF0_PTT_SS2,

	/* MSIOF1 */
	GPIO_FN_MSIOF1_TXD, GPIO_FN_MSIOF1_WXD, GPIO_FN_MSIOF1_MCK,
	GPIO_FN_MSIOF1_TSYNC, GPIO_FN_MSIOF1_TSCK,
	GPIO_FN_MSIOF1_WSYNC, GPIO_FN_MSIOF1_WSCK,
	...
	GPIO_FN_IODWEQ, GPIO_FN_IDEIOWDY, GPIO_FN_IDEINT, GPIO_FN_IDEIOWW,
	GPIO_FN_IDEIOWD, GPIO_FN_IDECS1, GPIO_FN_IDECS0, GPIO_FN_IDEA2,
	GPIO_FN_IDEA1, GPIO_FN_IDEA0,
};

enum {
	HWBWK_TWB, HWBWK_IC, HWBWK_OC, HWBWK_W2C, HWBWK_IWMEM, HWBWK_FPU,
	HWBWK_INTC, HWBWK_DMAC0, HWBWK_SHYWAY,
	HWBWK_HUDI, HWBWK_UBC,
	HWBWK_TMU0, HWBWK_CMT, HWBWK_WWDT, HWBWK_DMAC1, HWBWK_TMU1,
	HWBWK_FWCTW,
	HWBWK_SCIF0, HWBWK_SCIF1, HWBWK_SCIF2,
	HWBWK_SCIF3, HWBWK_SCIF4, HWBWK_SCIF5,
	HWBWK_MSIOF0, HWBWK_MSIOF1, HWBWK_MEWAM, HWBWK_IIC, HWBWK_WTC,
	HWBWK_ATAPI, HWBWK_ADC, HWBWK_TPU, HWBWK_IWDA, HWBWK_TSIF, HWBWK_ICB,
	HWBWK_SDHI0, HWBWK_SDHI1, HWBWK_KEYSC, HWBWK_USB,
	HWBWK_2DG, HWBWK_SIU, HWBWK_VEU2H1, HWBWK_VOU, HWBWK_BEU, HWBWK_CEU,
	HWBWK_VEU2H0, HWBWK_VPU, HWBWK_WCDC,
	HWBWK_NW,
};
