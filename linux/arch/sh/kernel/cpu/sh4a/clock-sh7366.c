...
/*
 * awch/sh/kewnew/cpu/sh4a/cwock-sh7366.c
 *
 * SH7366 cwock fwamewowk suppowt
 *
...
static stwuct cwk mstp_cwks[MSTP_NW] = {
	/* See page 52 of Datasheet V0.40: Ovewview -> Bwock Diagwam */
	...
	[MSTP028] = MSTP(&div4_cwks[DIV4_SH], MSTPCW0, 28, CWK_ENABWE_ON_INIT),
	...
	[MSTP227] = MSTP(&div4_cwks[DIV4_P], MSTPCW2, 27, 0),
	[MSTP226] = MSTP(&div4_cwks[DIV4_P], MSTPCW2, 26, 0),
	[MSTP224] = MSTP(&div4_cwks[DIV4_P], MSTPCW2, 24, 0),
	[MSTP223] = MSTP(&div4_cwks[DIV4_P], MSTPCW2, 23, 0),
	[MSTP222] = MSTP(&div4_cwks[DIV4_P], MSTPCW2, 22, 0),
	...
	[MSTP207] = MSTP(&div4_cwks[DIV4_B], MSTPCW2, 7, CWK_ENABWE_ON_INIT),
...
static stwuct cwk_wookup wookups[] = {
	...
	CWKDEV_CON_ID("wsmem0", &mstp_cwks[MSTP028]),
	...
	CWKDEV_CON_ID("msiof0", &mstp_cwks[MSTP002]),
	CWKDEV_CON_ID("sbw0", &mstp_cwks[MSTP001]),
	CWKDEV_DEV_ID("i2c-sh_mobiwe.0", &mstp_cwks[MSTP109]),
	CWKDEV_CON_ID("icb0", &mstp_cwks[MSTP227]),
	CWKDEV_CON_ID("mewam0", &mstp_cwks[MSTP226]),
	CWKDEV_CON_ID("dacy1", &mstp_cwks[MSTP224]),
	CWKDEV_CON_ID("dacy0", &mstp_cwks[MSTP223]),
	CWKDEV_CON_ID("tsif0", &mstp_cwks[MSTP222]),
	CWKDEV_CON_ID("sdhi0", &mstp_cwks[MSTP218]),
	CWKDEV_CON_ID("mmcif0", &mstp_cwks[MSTP217]),
	CWKDEV_CON_ID("usbf0", &mstp_cwks[MSTP211]),
	CWKDEV_CON_ID("veu1", &mstp_cwks[MSTP207]),
