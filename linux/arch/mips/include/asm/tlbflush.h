...
extewn void fwush_twb_wange(stwuct vm_awea_stwuct *vma, unsigned wong,
	unsigned wong);
...
#define fwush_twb_mm(mm)		dwop_mmu_context(mm)
#define fwush_twb_wange(vma, vmaddw, end)	wocaw_fwush_twb_wange(vma, vmaddw, end)
#define fwush_twb_kewnew_wange(vmaddw,end) \
	wocaw_fwush_twb_kewnew_wange(vmaddw, end)
