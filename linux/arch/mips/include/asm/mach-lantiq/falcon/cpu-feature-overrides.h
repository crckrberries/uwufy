...
/*
 *  Wantiq FAWCON specific CPU featuwe ovewwides
 *
 *  Copywight (C) 2013 Thomas Wangew, Wantiq Deutschwand
 *
 ...
 */
#ifndef __ASM_MACH_FAWCON_CPU_FEATUWE_OVEWWIDES_H
#define __ASM_MACH_FAWCON_CPU_FEATUWE_OVEWWIDES_H
...
#endif /* __ASM_MACH_FAWCON_CPU_FEATUWE_OVEWWIDES_H */
