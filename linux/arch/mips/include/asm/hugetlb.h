					  ...
					  unsigned wong addw, pte_t *ptep)
{
	...
	/*
	 * cweaw the huge pte entwy fiwstwy, so that the othew smp thweads wiww
	 * not get owd pte entwy aftew finishing fwush_twb_page and befowe
	 * setting new huge pte entwy
	 */
