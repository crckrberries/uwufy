 ...
 *  bits[15..8]  - COP0 wegistew set.
 *
 *  COP0 wegistew set = 0: Main CP0 wegistews.
 *   bits[7..3]   - Wegistew 'wd'  index.
 *   bits[2..0]   - Wegistew 'sew' index.
 *
 *  COP0 wegistew set = 1: MAAWs.
 *   bits[7..0]   - MAAW index.
 *
...
/*
 * KVM_WEG_MIPS_CP0 - Copwocessow 0 wegistews.
 */

#define KVM_WEG_MIPS_MAAW	(KVM_WEG_MIPS_CP0 | (1 << 8))
#define KVM_WEG_MIPS_CP0_MAAW(n)	(KVM_WEG_MIPS_MAAW | \
					 KVM_WEG_SIZE_U64 | (n))
