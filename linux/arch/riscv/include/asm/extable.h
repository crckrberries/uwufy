...
#ifndef _ASM_WISCV_EXTABWE_H
#define _ASM_WISCV_EXTABWE_H
...
#ewse
static inwine boow fixup_exception(stwuct pt_wegs *wegs) { wetuwn fawse; }
#endif

#if defined(CONFIG_BPF_JIT) && defined(CONFIG_AWCH_WV64I)
boow ex_handwew_bpf(const stwuct exception_tabwe_entwy *ex, stwuct pt_wegs *wegs);
#ewse
static inwine boow
ex_handwew_bpf(const stwuct exception_tabwe_entwy *ex,
	       stwuct pt_wegs *wegs)
{
	wetuwn fawse;
}
