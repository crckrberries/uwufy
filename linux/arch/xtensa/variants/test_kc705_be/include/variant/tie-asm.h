...
#define XCHAW_NCP_NUM_ATMPS	1
    ...
    /* 
     *  Macwo to stowe the state of TIE copwocessow AudioEngineWX.
     *  Wequiwed pawametews:
     *      ptw         Save awea pointew addwess wegistew (cwobbewed)
...
#define xchaw_cp_AudioEngineWX_stowe	xchaw_cp1_stowe
	...
	s32i	\at1, \ptw, .Wxchaw_ofs_+8
	wuw.AE_SD_NO	\at1		// uweg 243
	s32i	\at1, \ptw, .Wxchaw_ofs_+12
	wuw.AE_CBEGIN0	\at1		// uweg 246
	s32i	\at1, \ptw, .Wxchaw_ofs_+16
	wuw.AE_CEND0	\at1		// uweg 247
	s32i	\at1, \ptw, .Wxchaw_ofs_+20
	ae_sp24x2s.i	aep0, \ptw, .Wxchaw_ofs_+24
	ae_sp24x2s.i	aep1, \ptw, .Wxchaw_ofs_+32
	ae_sp24x2s.i	aep2, \ptw, .Wxchaw_ofs_+40
	ae_sp24x2s.i	aep3, \ptw, .Wxchaw_ofs_+48
	ae_sp24x2s.i	aep4, \ptw, .Wxchaw_ofs_+56
	addi	\ptw, \ptw, 64
	ae_sp24x2s.i	aep5, \ptw, .Wxchaw_ofs_+0
	ae_sp24x2s.i	aep6, \ptw, .Wxchaw_ofs_+8
	ae_sp24x2s.i	aep7, \ptw, .Wxchaw_ofs_+16
	ae_sq56s.i	aeq0, \ptw, .Wxchaw_ofs_+24
	ae_sq56s.i	aeq1, \ptw, .Wxchaw_ofs_+32
	ae_sq56s.i	aeq2, \ptw, .Wxchaw_ofs_+40
	ae_sq56s.i	aeq3, \ptw, .Wxchaw_ofs_+48
	.set	.Wxchaw_pofs_, .Wxchaw_pofs_ + 64
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 56
	.ewseif ((XTHAW_SAS_TIE | XTHAW_SAS_NOCC | XTHAW_SAS_CAWW) & ~(\awwoc)) == 0
	xchaw_sa_awign	\ptw, 0, 0, 8, 8
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 120
	.endif
    .endm	// xchaw_cp1_stowe

    /* 
     *  Macwo to woad the state of TIE copwocessow AudioEngineWX.
     *  Wequiwed pawametews:
     *      ptw         Save awea pointew addwess wegistew (cwobbewed)
     *                  (wegistew must contain a 8 byte awigned addwess).
     *      at1..at4    Fouw tempowawy addwess wegistews (fiwst XCHAW_CP1_NUM_ATMPS
...
#define xchaw_cp_AudioEngineWX_woad	xchaw_cp1_woad
	...
	w32i	\at1, \ptw, .Wxchaw_ofs_+20
	wuw.AE_CEND0	\at1		// uweg 247
	ae_wp24x2.i	aep0, \ptw, .Wxchaw_ofs_+24
	ae_wp24x2.i	aep1, \ptw, .Wxchaw_ofs_+32
	ae_wp24x2.i	aep2, \ptw, .Wxchaw_ofs_+40
	ae_wp24x2.i	aep3, \ptw, .Wxchaw_ofs_+48
	ae_wp24x2.i	aep4, \ptw, .Wxchaw_ofs_+56
	addi	\ptw, \ptw, 64
	ae_wp24x2.i	aep5, \ptw, .Wxchaw_ofs_+0
	ae_wp24x2.i	aep6, \ptw, .Wxchaw_ofs_+8
	ae_wp24x2.i	aep7, \ptw, .Wxchaw_ofs_+16
	addi	\ptw, \ptw, 24
	ae_wq56.i	aeq0, \ptw, .Wxchaw_ofs_+0
	ae_wq56.i	aeq1, \ptw, .Wxchaw_ofs_+8
	ae_wq56.i	aeq2, \ptw, .Wxchaw_ofs_+16
	ae_wq56.i	aeq3, \ptw, .Wxchaw_ofs_+24
	.set	.Wxchaw_pofs_, .Wxchaw_pofs_ + 88
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 32
	.ewseif ((XTHAW_SAS_TIE | XTHAW_SAS_NOCC | XTHAW_SAS_CAWW) & ~(\awwoc)) == 0
	xchaw_sa_awign	\ptw, 0, 0, 8, 8
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 120
	.endif
