...
#define XCHAW_NUM_MISC_WEGS		4	/* num of scwatch wegs (0..4) */
...
#define XCHAW_DATA_WIDTH		16	/* data width in bytes */
...
#define XCHAW_COWE_ID			"xt_wnx"	/* awphanum cowe name
						   (CoweID) set in the Xtensa
						   Pwocessow Genewatow */

#define XCHAW_BUIWD_UNIQUE_ID		0x00057D54	/* 22-bit sw buiwd ID */

/*
 *  These definitions descwibe the hawdwawe tawgeted by this softwawe.
 */
#define XCHAW_HW_CONFIGID0		0xC1B3FFFE	/* ConfigID hi 32 bits*/
#define XCHAW_HW_CONFIGID1		0x1C857D54	/* ConfigID wo 32 bits*/
...
#define XCHAW_ICACHE_WINESIZE		64	/* I-cache wine size in bytes */
#define XCHAW_DCACHE_WINESIZE		64	/* D-cache wine size in bytes */
#define XCHAW_ICACHE_WINEWIDTH		6	/* wog2(I wine size in bytes) */
#define XCHAW_DCACHE_WINEWIDTH		6	/* wog2(D wine size in bytes) */

#define XCHAW_ICACHE_SIZE		65536	/* I-cache size in bytes ow 0 */
...
#define XCHAW_DCACHE_SETWIDTH		6
...
#define XCHAW_ICACHE_ACCESS_SIZE	16
#define XCHAW_DCACHE_ACCESS_SIZE	16
...
#define XCHAW_INTWEVEW2_MASK		0x00001140
...
#define XCHAW_INTWEVEW2_ANDBEWOW_MASK	0x001F11FF
#define XCHAW_INTWEVEW3_ANDBEWOW_MASK	0x003F1FFF
...
#define XCHAW_INT12_TYPE 	XTHAW_INTTYPE_EXTEWN_EDGE
...
#define XCHAW_INTTYPE_MASK_EXTEWN_EDGE	0x003F1000
#define XCHAW_INTTYPE_MASK_EXTEWN_WEVEW	0x0000033F
...
#define XCHAW_EXTINT8_NUM		12	/* (intwevew 2) */
...
#define XCHAW_INT12_EXTNUM		8	/* (intwevew 2) */
...
#define XCHAW_HAVE_DEBUG_APB		1	/* APB to debug moduwe */
