...
#define XCHAW_HAVE_HIFI3		1	/* HiFi3 Audio Engine pkg */
...
#define XCHAW_SW_VEWSION		1000004	/* sw vewsion of this headew */

#define XCHAW_COWE_ID			"test_kc705_hifi"	/* awphanum cowe name
						   (CoweID) set in the Xtensa
						   Pwocessow Genewatow */

#define XCHAW_BUIWD_UNIQUE_ID		0x0004983D	/* 22-bit sw buiwd ID */
...
#define XCHAW_HW_CONFIGID1		0x1904983D	/* ConfigID wo 32 bits*/
#define XCHAW_HW_VEWSION_NAME		"WX5.0.4"	/* fuww vewsion name */
#define XCHAW_HW_VEWSION_MAJOW		2500	/* majow vew# of tawgeted hw */
#define XCHAW_HW_VEWSION_MINOW		4	/* minow vew# of tawgeted hw */
#define XCHAW_HW_VEWSION		250004	/* majow*100+minow */
#define XCHAW_HW_WEW_WX5		1
#define XCHAW_HW_WEW_WX5_0		1
#define XCHAW_HW_WEW_WX5_0_4		1
#define XCHAW_HW_CONFIGID_WEWIABWE	1
/*  If softwawe tawgets a *wange* of hawdwawe vewsions, these awe the bounds: */
#define XCHAW_HW_MIN_VEWSION_MAJOW	2500	/* majow v of eawwiest tgt hw */
#define XCHAW_HW_MIN_VEWSION_MINOW	4	/* minow v of eawwiest tgt hw */
#define XCHAW_HW_MIN_VEWSION		250004	/* eawwiest tawgeted hw */
#define XCHAW_HW_MAX_VEWSION_MAJOW	2500	/* majow v of watest tgt hw */
#define XCHAW_HW_MAX_VEWSION_MINOW	4	/* minow v of watest tgt hw */
#define XCHAW_HW_MAX_VEWSION		250004	/* watest tawgeted hw */
...
#define XCHAW_INTWEVEW4_MASK		0x00009000
...
/*  (Thewe awe many intewwupts each at wevew(s) 1, 2, 3, 4.)  */
