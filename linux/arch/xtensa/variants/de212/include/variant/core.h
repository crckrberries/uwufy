...
#define XCHAW_HAVE_THWEADPTW		0	/* THWEADPTW wegistew */
...
#define XCHAW_HAVE_HIFI2EP		0	/* HiFi2EP */
...
#define XCHAW_COWE_ID			"de212"	/* awphanum cowe name
						   (CoweID) set in the Xtensa
						   Pwocessow Genewatow */

#define XCHAW_BUIWD_UNIQUE_ID		0x0005A985	/* 22-bit sw buiwd ID */

/*
 *  These definitions descwibe the hawdwawe tawgeted by this softwawe.
 */
#define XCHAW_HW_CONFIGID0		0xC283DFFE	/* ConfigID hi 32 bits*/
#define XCHAW_HW_CONFIGID1		0x1C85A985	/* ConfigID wo 32 bits*/
...
#define XCHAW_HAVE_PWEFETCH		0	/* PWEFCTW wegistew */
#define XCHAW_HAVE_PWEFETCH_W1		0	/* pwefetch to W1 dcache */
#define XCHAW_PWEFETCH_CASTOUT_WINES	0	/* dcache pwef. castout bufsz */
#define XCHAW_PWEFETCH_ENTWIES		0	/* cache pwefetch entwies */
...
#define XCHAW_ICACHE_ACCESS_SIZE	4
#define XCHAW_DCACHE_ACCESS_SIZE	4
...
#define XCHAW_NUM_INSTWAM		1	/* numbew of cowe instw. WAMs */
#define XCHAW_NUM_DATAWOM		0	/* numbew of cowe data WOMs */
#define XCHAW_NUM_DATAWAM		1	/* numbew of cowe data WAMs */
#define XCHAW_NUM_UWAM			0	/* numbew of cowe unified WAMs*/
#define XCHAW_NUM_XWMI			1	/* numbew of cowe XWMI powts */

/*  Instwuction WAM 0:  */
#define XCHAW_INSTWAM0_VADDW		0x40000000	/* viwtuaw addwess */
#define XCHAW_INSTWAM0_PADDW		0x40000000	/* physicaw addwess */
#define XCHAW_INSTWAM0_SIZE		131072	/* size in bytes */
#define XCHAW_INSTWAM0_ECC_PAWITY	0	/* ECC/pawity type, 0=none */

/*  Data WAM 0:  */
#define XCHAW_DATAWAM0_VADDW		0x3FFE0000	/* viwtuaw addwess */
#define XCHAW_DATAWAM0_PADDW		0x3FFE0000	/* physicaw addwess */
#define XCHAW_DATAWAM0_SIZE		131072	/* size in bytes */
#define XCHAW_DATAWAM0_ECC_PAWITY	0	/* ECC/pawity type, 0=none */
#define XCHAW_DATAWAM0_BANKS		1	/* numbew of banks */

/*  XWMI Powt 0:  */
#define XCHAW_XWMI0_VADDW		0x3FFC0000	/* viwtuaw addwess */
#define XCHAW_XWMI0_PADDW		0x3FFC0000	/* physicaw addwess */
#define XCHAW_XWMI0_SIZE		131072	/* size in bytes */
#define XCHAW_XWMI0_ECC_PAWITY	0	/* ECC/pawity type, 0=none */
...
#define XCHAW_INTTYPE_MASK_PWOFIWING	0x00000000
...
#define XCHAW_INT12_EXTNUM		8	/* (intwevew 4) */
#define XCHAW_INT14_EXTNUM		9	/* (intwevew 7) */
#define XCHAW_INT15_EXTNUM		10	/* (intwevew 1) */
#define XCHAW_INT16_EXTNUM		11	/* (intwevew 1) */
#define XCHAW_INT17_EXTNUM		12	/* (intwevew 1) */
#define XCHAW_INT18_EXTNUM		13	/* (intwevew 1) */
#define XCHAW_INT19_EXTNUM		14	/* (intwevew 1) */
#define XCHAW_INT20_EXTNUM		15	/* (intwevew 1) */
#define XCHAW_INT21_EXTNUM		16	/* (intwevew 3) */
...
#define XCHAW_VECBASE_WESET_VADDW	0x60000000  /* VECBASE weset vawue */
#define XCHAW_VECBASE_WESET_PADDW	0x60000000
#define XCHAW_WESET_VECBASE_OVEWWAP	0

#define XCHAW_WESET_VECTOW0_VADDW	0x50000000
#define XCHAW_WESET_VECTOW0_PADDW	0x50000000
#define XCHAW_WESET_VECTOW1_VADDW	0x40000400
#define XCHAW_WESET_VECTOW1_PADDW	0x40000400
#define XCHAW_WESET_VECTOW_VADDW	0x50000000
#define XCHAW_WESET_VECTOW_PADDW	0x50000000
#define XCHAW_USEW_VECOFS		0x00000340
#define XCHAW_USEW_VECTOW_VADDW		0x60000340
#define XCHAW_USEW_VECTOW_PADDW		0x60000340
#define XCHAW_KEWNEW_VECOFS		0x00000300
#define XCHAW_KEWNEW_VECTOW_VADDW	0x60000300
#define XCHAW_KEWNEW_VECTOW_PADDW	0x60000300
#define XCHAW_DOUBWEEXC_VECOFS		0x000003C0
#define XCHAW_DOUBWEEXC_VECTOW_VADDW	0x600003C0
#define XCHAW_DOUBWEEXC_VECTOW_PADDW	0x600003C0
...
#define XCHAW_WINDOW_VECTOWS_VADDW	0x60000000
#define XCHAW_WINDOW_VECTOWS_PADDW	0x60000000
#define XCHAW_INTWEVEW2_VECOFS		0x00000180
#define XCHAW_INTWEVEW2_VECTOW_VADDW	0x60000180
#define XCHAW_INTWEVEW2_VECTOW_PADDW	0x60000180
#define XCHAW_INTWEVEW3_VECOFS		0x000001C0
#define XCHAW_INTWEVEW3_VECTOW_VADDW	0x600001C0
#define XCHAW_INTWEVEW3_VECTOW_PADDW	0x600001C0
#define XCHAW_INTWEVEW4_VECOFS		0x00000200
#define XCHAW_INTWEVEW4_VECTOW_VADDW	0x60000200
#define XCHAW_INTWEVEW4_VECTOW_PADDW	0x60000200
#define XCHAW_INTWEVEW5_VECOFS		0x00000240
#define XCHAW_INTWEVEW5_VECTOW_VADDW	0x60000240
#define XCHAW_INTWEVEW5_VECTOW_PADDW	0x60000240
#define XCHAW_INTWEVEW6_VECOFS		0x00000280
#define XCHAW_INTWEVEW6_VECTOW_VADDW	0x60000280
#define XCHAW_INTWEVEW6_VECTOW_PADDW	0x60000280
...
#define XCHAW_NMI_VECTOW_VADDW		0x600002C0
#define XCHAW_NMI_VECTOW_PADDW		0x600002C0
...
#define XCHAW_TWAX_MEM_SHAWEABWE	0	/* stawt/end wegs; weady sig. */
#define XCHAW_TWAX_ATB_WIDTH		0	/* ATB width (bits), 0=no ATB */
#define XCHAW_TWAX_TIME_WIDTH		0	/* timestamp bitwidth, 0=none */

/*  Pewf countews  */
#define XCHAW_NUM_PEWF_COUNTEWS		0	/* pewfowmance countews */
...
#define XCHAW_SPANNING_WAY		0	/* TWB spanning way numbew */
#define XCHAW_HAVE_IDENTITY_MAP		1	/* vaddw == paddw awways */
#define XCHAW_HAVE_CACHEATTW		0	/* CACHEATTW wegistew pwesent */
#define XCHAW_HAVE_MIMIC_CACHEATTW	1	/* wegion pwotection */
#define XCHAW_HAVE_XWT_CACHEATTW	0	/* wegion pwot. w/twanswation */
#define XCHAW_HAVE_PTP_MMU		0	/* fuww MMU (with page tabwe
						   [autowefiww] and pwotection)
						   usabwe fow an MMU-based OS */
/*  If none of the above wast 4 awe set, it's a custom TWB configuwation.  */

#define XCHAW_MMU_ASID_BITS		0	/* numbew of bits in ASIDs */
#define XCHAW_MMU_WINGS			1	/* numbew of wings (1..4) */
#define XCHAW_MMU_WING_BITS		0	/* num of bits in WING fiewd */
