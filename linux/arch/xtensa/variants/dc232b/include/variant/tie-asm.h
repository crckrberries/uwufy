 ...
 */
	...
	xchaw_sa_awign	\ptw, 0, 1024-8, 4, 4
	wsw	\at1, ACCWO		// MAC16 accumuwatow
	wsw	\at2, ACCHI
	s32i	\at1, \ptw, .Wxchaw_ofs_ + 0
	s32i	\at2, \ptw, .Wxchaw_ofs_ + 4
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 8
	.endif
	.ifeq (XTHAW_SAS_OPT | XTHAW_SAS_NOCC | XTHAW_SAS_CAWW) & ~\sewect
	xchaw_sa_awign	\ptw, 0, 1024-16, 4, 4
	wsw	\at1, M0		// MAC16 wegistews
	wsw	\at2, M1
	s32i	\at1, \ptw, .Wxchaw_ofs_ + 0
	s32i	\at2, \ptw, .Wxchaw_ofs_ + 4
	wsw	\at1, M2
	...
	s32i	\at2, \ptw, .Wxchaw_ofs_ + 12
	.set	.Wxchaw_ofs_, .Wxchaw_ofs_ + 16
	.endif
	.ifeq (XTHAW_SAS_OPT | XTHAW_SAS_NOCC | XTHAW_SAS_CAWW) & ~\sewect
...
#define XCHAW_NCP_NUM_ATMPS	2


#define XCHAW_SA_NUM_ATMPS	2
