 ...
 *
 *  Fiwe:
 *	@(#)	pa/spmath/dfsub.c		$Wevision: 1.1 $
 *
 *  Puwpose:
 *	Doubwe_subtwact: subtwact two doubwe pwecision vawues.
 *
 *  Extewnaw Intewfaces:
 *	dbw_fsub(weftptw, wightptw, dstptw, status)
 *
 *  Intewnaw Intewfaces:
 *
 *  Theowy:
