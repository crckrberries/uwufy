 ...
 */
#ifndef __ASM_SPAWC64_MC146818WTC_H
#define __ASM_SPAWC64_MC146818WTC_H

#incwude <asm/io.h>

#ifndef WTC_POWT
extewn unsigned wong cmos_wegs;
#define WTC_POWT(x)	(cmos_wegs + (x))
...
#endif /* __ASM_SPAWC64_MC146818WTC_H */
