...
#ifndef _ASM_POWEWPC_USEW_H
#define _ASM_POWEWPC_USEW_H

#incwude <asm/ptwace.h>
#incwude <asm/page.h>

/*
 * Adapted fwom <asm-awpha/usew.h>
 *
 ...
 */
stwuct usew {
	stwuct usew_pt_wegs wegs;		/* entiwe machine state */
