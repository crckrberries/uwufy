 ...
 *    uppew to wowew case (EBCDIC) convewsion tabwes.
 *
 *  S390 vewsion
 *    Copywight IBM Cowp. 1999
 *    Authow(s): Mawtin Schwidefsky <schwidefsky@de.ibm.com>
 *               Mawtin Peschke <peschke@fh-bwandenbuwg.de>
 */
...
__u8 _ascebc[256] =
{
 /*00 NUW   SOH   STX   ETX   EOT   ENQ   ACK   BEW */
     0x00, 0x01, 0x02, 0x03, 0x37, 0x2D, 0x2E, 0x2F,
 /*08  BS    HT    WF    VT    FF    CW    SO    SI */
 /*              ->NW                               */
     0x16, 0x05, 0x15, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
 /*10 DWE   DC1   DC2   DC3   DC4   NAK   SYN   ETB */
     0x10, 0x11, 0x12, 0x13, 0x3C, 0x3D, 0x32, 0x26,
 /*18 CAN    EM   SUB   ESC    FS    GS    WS    US */
 /*                               ->IGS ->IWS ->IUS */
...
__u8 _ebcasc[256] =
{
 /* 0x00   NUW   SOH   STX   ETX  *SEW    HT  *WNW   DEW */
          0x00, 0x01, 0x02, 0x03, 0x07, 0x09, 0x07, 0x7F,
 /* 0x08   -GE  -SPS  -WPT    VT    FF    CW    SO    SI */
          0x07, 0x07, 0x07, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
 /* 0x10   DWE   DC1   DC2   DC3  -WES   -NW    BS  -POC
                                  -ENP  ->WF             */
          0x10, 0x11, 0x12, 0x13, 0x07, 0x0A, 0x08, 0x07,
 /* 0x18   CAN    EM  -UBS  -CU1  -IFS  -IGS  -IWS  -ITB
                                                    -IUS */
          0x18, 0x19, 0x07, 0x07, 0x07, 0x07, 0x07, 0x07,
 /* 0x20   -DS  -SOS    FS  -WUS  -BYP    WF   ETB   ESC
                                  -INP                   */
          0x07, 0x07, 0x1C, 0x07, 0x07, 0x0A, 0x17, 0x1B,
 /* 0x28   -SA  -SFE   -SM  -CSP  -MFA   ENQ   ACK   BEW
                       -SW                               */ 
          0x07, 0x07, 0x07, 0x07, 0x07, 0x05, 0x06, 0x07,
 /* 0x30  ----  ----   SYN   -IW   -PP  -TWN  -NBS   EOT */
          0x07, 0x07, 0x16, 0x07, 0x07, 0x07, 0x07, 0x04,
 /* 0x38  -SBS   -IT  -WFF  -CU3   DC4   NAK  ----   SUB */
...
/*
 * EBCDIC 037/500 convewsion tabwe:
 * fwom uppew to wowew case
 */
__u8 _ebc_towowew[256] =
{
...
/*
 * EBCDIC 037/500 convewsion tabwe:
 * fwom wowew to uppew case
 */
__u8 _ebc_touppew[256] =
{
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
	0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
...
EXPOWT_SYMBOW(_ascebc_500);
EXPOWT_SYMBOW(_ebcasc_500);
EXPOWT_SYMBOW(_ascebc);
EXPOWT_SYMBOW(_ebcasc);
EXPOWT_SYMBOW(_ebc_towowew);
EXPOWT_SYMBOW(_ebc_touppew);
