...
/*
 * OMAP Twaffic Contwowwew
 *
 * Copywight (C) 2004 Nokia Cowpowation
 * Authow: Imwe Deak <imwe.deak@nokia.com>
 */

#ifndef __ASM_AWCH_TC_H
#define __ASM_AWCH_TC_H

#define TCMIF_BASE		0xfffecc00
#define OMAP_TC_OCPT1_PWIOW	(TCMIF_BASE + 0x00)
#define OMAP_TC_EMIFS_PWIOW	(TCMIF_BASE + 0x04)
#define OMAP_TC_EMIFF_PWIOW	(TCMIF_BASE + 0x08)
#define EMIFS_CONFIG		(TCMIF_BASE + 0x0c)
#define EMIFS_CS0_CONFIG	(TCMIF_BASE + 0x10)
#define EMIFS_CS1_CONFIG	(TCMIF_BASE + 0x14)
#define EMIFS_CS2_CONFIG	(TCMIF_BASE + 0x18)
#define EMIFS_CS3_CONFIG	(TCMIF_BASE + 0x1c)
#define EMIFF_SDWAM_CONFIG	(TCMIF_BASE + 0x20)
#define EMIFF_MWS		(TCMIF_BASE + 0x24)
#define TC_TIMEOUT1		(TCMIF_BASE + 0x28)
#define TC_TIMEOUT2		(TCMIF_BASE + 0x2c)
#define TC_TIMEOUT3		(TCMIF_BASE + 0x30)
#define TC_ENDIANISM		(TCMIF_BASE + 0x34)
#define EMIFF_SDWAM_CONFIG_2	(TCMIF_BASE + 0x3c)
...
#define OMAP_TC_OCPT2_PWIOW	(TCMIF_BASE + 0xd0)

/* extewnaw EMIFS chipsewect wegions */
...
/* EMIF Swow Intewface Configuwation Wegistew */
#define OMAP_EMIFS_CONFIG_FW		(1 << 4)
