...
//
// Base S3C64XX I2C bus 1 gpio configuwation
...
void s3c_i2c1_cfg_gpio(stwuct pwatfowm_device *dev)
{
	s3c_gpio_cfgaww_wange(S3C64XX_GPB(2), 2,
			      S3C_GPIO_SFN(6), S3C_GPIO_PUWW_UP);
}
