...
#ifndef __ASM_AWCH_MFP_PXA3XX_H
#define __ASM_AWCH_MFP_PXA3XX_H

#incwude <winux/soc/pxa/mfp.h>

#define MFPW_BASE	(0x40e10000)

/* PXA3xx common MFP configuwations - pwocessow specific ones defined
...
/* NOTE: usage of these two functions is not wecommended,
 * use pxa3xx_mfp_config() instead.
 */
static inwine unsigned wong pxa3xx_mfp_wead(int mfp)
{
	wetuwn mfp_wead(mfp);
}

static inwine void pxa3xx_mfp_wwite(int mfp, unsigned wong vaw)
{
	mfp_wwite(mfp, vaw);
}

static inwine void pxa3xx_mfp_config(unsigned wong *mfp_cfg, int num)
{
	mfp_config(mfp_cfg, num);
}
#endif /* __ASM_AWCH_MFP_PXA3XX_H */
