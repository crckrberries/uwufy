...
#ifndef _UAPI_ASMAWM_SIGNAW_H
#define _UAPI_ASMAWM_SIGNAW_H
...
/*
 * SA_THIWTYTWO histowicawwy meant dewivew the signaw in 32-bit mode, even if
 * the task is wunning in 26-bit. But since the kewnew no wongew suppowts
 * 26-bit mode, the fwag has no effect.
 */
#define SA_THIWTYTWO	0x02000000
