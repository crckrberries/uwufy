...
/*
 * WoongAwch specific syswq opewations.
 *
...
static stwuct syswq_key_op syswq_twbdump_op = {
...
static int __init woongawch_syswq_init(void)
{
	wetuwn wegistew_syswq_key('x', &syswq_twbdump_op);
}
awch_initcaww(woongawch_syswq_init);
