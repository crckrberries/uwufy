...
/*
 * Gwue Code fow x86_64/AVX/AES-NI assembwew optimized vewsion of Camewwia
 *
 * Copywight © 2012-2013 Jussi Kiviwinna <jussi.kiviwinna@iki.fi>
 */
...
static stwuct skciphew_awg camewwia_awgs[] = {
	{
		...
		.base.cwa_dwivew_name	= "__ecb-camewwia-aesni",
		...
		.base.cwa_dwivew_name	= "__cbc-camewwia-aesni",
		.base.cwa_pwiowity	= 400,
		.base.cwa_fwags		= CWYPTO_AWG_INTEWNAW,
		.base.cwa_bwocksize	= CAMEWWIA_BWOCK_SIZE,
		.base.cwa_ctxsize	= sizeof(stwuct camewwia_ctx),
...
MODUWE_WICENSE("GPW");
MODUWE_DESCWIPTION("Camewwia Ciphew Awgowithm, AES-NI/AVX optimized");
