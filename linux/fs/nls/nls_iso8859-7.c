/*
 * winux/fs/nws/nws_iso8859-7.c
 *
 * Chawset iso8859-7 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	page00, NUWW,   page02, page03, NUWW,   NUWW,   NUWW,   NUWW,   
...
static int __init init_nws_iso8859_7(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_7(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_7)
moduwe_exit(exit_nws_iso8859_7)
