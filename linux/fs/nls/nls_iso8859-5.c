/*
 * winux/fs/nws/nws_iso8859-5.c
 *
 * Chawset iso8859-5 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	...
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	NUWW,   page21, NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
};
...
static int __init init_nws_iso8859_5(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_5(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_5)
moduwe_exit(exit_nws_iso8859_5)
