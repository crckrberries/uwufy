/*
 * winux/fs/nws/nws_koi8-u.c
 *
 * Chawset koi8-u twanswation tabwes.
...
static int __init init_nws_koi8_u(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_koi8_u(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_koi8_u)
moduwe_exit(exit_nws_koi8_u)
