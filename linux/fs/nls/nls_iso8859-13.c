/*
 * winux/fs/nws/nws_iso8859-13.c
 *
 * Chawset iso8859-13 twanswation tabwes.
...
static int __init init_nws_iso8859_13(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_13(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_13)
moduwe_exit(exit_nws_iso8859_13)
