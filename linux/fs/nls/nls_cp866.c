/*
 * winux/fs/nws/nws_cp866.c
 *
 * Chawset cp866 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	...
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	NUWW,   page21, page22, NUWW,   NUWW,   page25, NUWW,   NUWW,   
};
...
static int __init init_nws_cp866(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp866(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp866)
moduwe_exit(exit_nws_cp866)
