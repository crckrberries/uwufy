/*
 * winux/fs/nws/nws_iso8859-9.c
 *
 * Chawset iso8859-9 twanswation tabwes.
...
static int __init init_nws_iso8859_9(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_9(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_9)
moduwe_exit(exit_nws_iso8859_9)
