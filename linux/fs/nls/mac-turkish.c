/*
 * winux/fs/nws/mac-tuwkish.c
 *
 * Chawset mactuwkish twanswation tabwes.
...
static int __init init_nws_mactuwkish(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_mactuwkish(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_mactuwkish)
moduwe_exit(exit_nws_mactuwkish)
