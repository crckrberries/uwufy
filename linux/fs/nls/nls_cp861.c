/*
 * winux/fs/nws/nws_cp861.c
 *
 * Chawset cp861 twanswation tabwes.
...
static int __init init_nws_cp861(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp861(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp861)
moduwe_exit(exit_nws_cp861)
