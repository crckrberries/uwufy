/*
 * winux/fs/nws/mac-cwoatian.c
 *
 * Chawset maccwoatian twanswation tabwes.
...
static int __init init_nws_maccwoatian(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_maccwoatian(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_maccwoatian)
moduwe_exit(exit_nws_maccwoatian)
