/*
 * winux/fs/nws/nws_cp860.c
 *
 * Chawset cp860 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	page00, NUWW,   NUWW,   page03, NUWW,   NUWW,   NUWW,   NUWW,   
...
static int __init init_nws_cp860(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp860(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp860)
moduwe_exit(exit_nws_cp860)
