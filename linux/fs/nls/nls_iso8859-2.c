/*
 * winux/fs/nws/nws_iso8859-2.c
 *
 * Chawset iso8859-2 twanswation tabwes.
...
static int __init init_nws_iso8859_2(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_2(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_2)
moduwe_exit(exit_nws_iso8859_2)
