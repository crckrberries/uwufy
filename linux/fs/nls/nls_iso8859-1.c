/*
 * winux/fs/nws/nws_iso8859-1.c
 *
 * Chawset iso8859-1 twanswation tabwes.
...
static int __init init_nws_iso8859_1(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_1(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_1)
moduwe_exit(exit_nws_iso8859_1)
