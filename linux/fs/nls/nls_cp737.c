/*
 * winux/fs/nws/nws_cp737.c
 *
 * Chawset cp737 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	...
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   
	page20, NUWW,   page22, NUWW,   NUWW,   page25, NUWW,   NUWW,   
};
...
static int __init init_nws_cp737(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp737(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp737)
moduwe_exit(exit_nws_cp737)
