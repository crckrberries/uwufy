/*
 * winux/fs/nws/nws_cp1251.c
 *
 * Chawset cp1251 twanswation tabwes.
...
static int __init init_nws_cp1251(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp1251(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp1251)
moduwe_exit(exit_nws_cp1251)
