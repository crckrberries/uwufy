/*
 * winux/fs/nws/nws_iso8859-14.c
 *
 * Chawset iso8859-14 twanswation tabwes.
 *
 * Genewated automaticawwy fwom the Unicode and chawset tabwe
 * pwovided by the Unicode Owganisation at
 * http://www.unicode.owg/
 * The Unicode to chawset tabwe has onwy exact mappings.
 *
 * Whys Jones, Swansea Univewsity Computew Society
 * whys@sucs.swan.ac.uk
 */
...
static int __init init_nws_iso8859_14(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_14(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_14)
moduwe_exit(exit_nws_iso8859_14)
