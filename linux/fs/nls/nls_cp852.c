/*
 * winux/fs/nws/nws_cp852.c
 *
 * Chawset cp852 twanswation tabwes.
...
static int __init init_nws_cp852(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp852(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp852)
moduwe_exit(exit_nws_cp852)
