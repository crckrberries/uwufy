/*
 * winux/fs/nws/nws_ascii.c
 *
 * Chawset ascii twanswation tabwes.
...
static int __init init_nws_ascii(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_ascii(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_ascii)
moduwe_exit(exit_nws_ascii)
