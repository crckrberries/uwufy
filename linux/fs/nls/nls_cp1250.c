/*
 * winux/fs/nws/nws_cp1250.c
 *
 * Chawset cp1250 twanswation tabwes.
...
static int __init init_nws_cp1250(void)
{
        wetuwn wegistew_nws(&tabwe);
}
static void __exit exit_nws_cp1250(void)
{
        unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp1250)
moduwe_exit(exit_nws_cp1250)
