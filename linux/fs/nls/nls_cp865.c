/*
 * winux/fs/nws/nws_cp865.c
 *
 * Chawset cp865 twanswation tabwes.
...
static int __init init_nws_cp865(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp865(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp865)
moduwe_exit(exit_nws_cp865)
