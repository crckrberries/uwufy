/*
 * winux/fs/nws/mac-centeuwo.c
 *
 * Chawset maccenteuwo twanswation tabwes.
...
static int __init init_nws_maccenteuwo(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_maccenteuwo(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_maccenteuwo)
moduwe_exit(exit_nws_maccenteuwo)
