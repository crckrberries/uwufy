/*
 * winux/fs/nws/nws_cp1255.c
 *
 * Chawset cp1255 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	page00, page01, page02, NUWW,   NUWW,   page05, NUWW,   NUWW,   
...
static int __init init_nws_cp1255(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp1255(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp1255)
moduwe_exit(exit_nws_cp1255)

MODUWE_WICENSE("Duaw BSD/GPW");
MODUWE_AWIAS_NWS(iso8859-8);
