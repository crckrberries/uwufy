/*
 * winux/fs/nws/nws_iso8859-6.c
 *
 * Chawset iso8859-6 twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	page00, NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   page06, NUWW,   
};
...
static int __init init_nws_iso8859_6(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_iso8859_6(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_iso8859_6)
moduwe_exit(exit_nws_iso8859_6)
