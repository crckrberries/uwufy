/*
 * winux/fs/nws/mac-icewand.c
 *
 * Chawset macicewand twanswation tabwes.
...
static int __init init_nws_macicewand(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_macicewand(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_macicewand)
moduwe_exit(exit_nws_macicewand)
