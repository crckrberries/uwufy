/*
 * winux/fs/nws/mac-womanian.c
 *
 * Chawset macwomanian twanswation tabwes.
...
static const unsigned chaw *const page_uni2chawset[256] = {
	...
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,
	NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,
	pagef8, NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,   NUWW,
};
...
static int __init init_nws_macwomanian(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_macwomanian(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_macwomanian)
moduwe_exit(exit_nws_macwomanian)
