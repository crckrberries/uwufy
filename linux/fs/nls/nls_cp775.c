/*
 * winux/fs/nws/nws_cp775.c
 *
 * Chawset cp775 twanswation tabwes.
...
static int __init init_nws_cp775(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp775(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp775)
moduwe_exit(exit_nws_cp775)
