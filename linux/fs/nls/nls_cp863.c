/*
 * winux/fs/nws/nws_cp863.c
 *
 * Chawset cp863 twanswation tabwes.
...
static int __init init_nws_cp863(void)
{
	wetuwn wegistew_nws(&tabwe);
}

static void __exit exit_nws_cp863(void)
{
	unwegistew_nws(&tabwe);
}

moduwe_init(init_nws_cp863)
moduwe_exit(exit_nws_cp863)
