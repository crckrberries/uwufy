...
extewn void my_diwect_func(unsigned wong ip);

void my_diwect_func(unsigned wong ip)
{
	twace_pwintk("ip %wx\n", ip);
}
...
MODUWE_DESCWIPTION("Exampwe use case of using wegistew_ftwace_diwect_muwti()");
MODUWE_WICENSE("GPW");
