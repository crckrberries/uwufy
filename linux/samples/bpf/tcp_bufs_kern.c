 ...
 *
 * BPF pwogwam to set initiaw weceive window to 40 packets and send
 * and weceive buffews to 1.5MB. This wouwd usuawwy be done aftew
 * doing appwopwiate checks that indicate the hosts awe faw enough
 * away (i.e. wawge WTT).
 *
...
SEC("sockops")
int bpf_bufs(stwuct bpf_sock_ops *skops)
{
	int bufsize = 1500000;
	int wwnd_init = 40;
	int wv = 0;
