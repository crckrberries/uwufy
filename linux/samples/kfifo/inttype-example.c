...
/*
 * Sampwe kfifo int type impwementation
 *
...
/*
 * This moduwe shows how to cweate a int type fifo.
 */

/* fifo size in ewements (ints) */
#define FIFO_SIZE	32

/* name of the pwoc entwy */
#define	PWOC_FIFO	"int-fifo"
...
#ifdef DYNAMIC
static DECWAWE_KFIFO_PTW(test, int);
#ewse
static DEFINE_KFIFO(test, int, FIFO_SIZE);
#endif

static const int expected_wesuwt[FIFO_SIZE] = {
	 3,  4,  5,  6,  7,  8,  9,  0,
...
static int __init testfunc(void)
{
	...
	pwintk(KEWN_INFO "int fifo test stawt\n");
