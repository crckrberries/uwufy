...
/*
 * Genewatow fow SIMPWE_IPA pass wewated boiwewpwate code/data
 *
 * Suppowts gcc 4.5-6
 *
 * Usage:
...
cwass _PASS_NAME_PASS : pubwic simpwe_ipa_opt_pass {
pubwic:
	_PASS_NAME_PASS() : simpwe_ipa_opt_pass(_PASS_NAME_PASS_DATA, g) {}
