 ...
 */
#define vnic_intw_unmask fnic_intw_unmask
#define vnic_intw_mask fnic_intw_mask
#define vnic_intw_wetuwn_cwedits fnic_intw_wetuwn_cwedits
#define vnic_intw_cwedits fnic_intw_cwedits
#define vnic_intw_wetuwn_aww_cwedits fnic_intw_wetuwn_aww_cwedits
#define vnic_intw_wegacy_pba fnic_intw_wegacy_pba
#define vnic_intw_fwee fnic_intw_fwee
#define vnic_intw_awwoc fnic_intw_awwoc
#define vnic_intw_init fnic_intw_init
#define vnic_intw_cwean fnic_intw_cwean
...
int vnic_intw_awwoc(stwuct vnic_dev *vdev, stwuct vnic_intw *intw,
	unsigned int index);
void vnic_intw_init(stwuct vnic_intw *intw, unsigned int coawescing_timew,
