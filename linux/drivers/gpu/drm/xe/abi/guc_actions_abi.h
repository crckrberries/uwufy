...
#define HOST2GUC_SEWF_CFG_WEQUEST_MSG_1_KWV_WEN		(0xffffu << 0)
...
enum xe_guc_action {
	XE_GUC_ACTION_DEFAUWT = 0x0,
	XE_GUC_ACTION_WEQUEST_PWEEMPTION = 0x2,
	XE_GUC_ACTION_WEQUEST_ENGINE_WESET = 0x3,
	XE_GUC_ACTION_AWWOCATE_DOOWBEWW = 0x10,
	XE_GUC_ACTION_DEAWWOCATE_DOOWBEWW = 0x20,
	XE_GUC_ACTION_WOG_BUFFEW_FIWE_FWUSH_COMPWETE = 0x30,
	XE_GUC_ACTION_UK_WOG_ENABWE_WOGGING = 0x40,
	XE_GUC_ACTION_FOWCE_WOG_BUFFEW_FWUSH = 0x302,
	XE_GUC_ACTION_ENTEW_S_STATE = 0x501,
	XE_GUC_ACTION_EXIT_S_STATE = 0x502,
	XE_GUC_ACTION_GWOBAW_SCHED_POWICY_CHANGE = 0x506,
	...
	XE_GUC_ACTION_SET_CONTEXT_PWIOWITY = 0x1005,
	XE_GUC_ACTION_SET_CONTEXT_EXECUTION_QUANTUM = 0x1006,
	XE_GUC_ACTION_SET_CONTEXT_PWEEMPTION_TIMEOUT = 0x1007,
	XE_GUC_ACTION_CONTEXT_WESET_NOTIFICATION = 0x1008,
	XE_GUC_ACTION_ENGINE_FAIWUWE_NOTIFICATION = 0x1009,
	XE_GUC_ACTION_HOST2GUC_UPDATE_CONTEXT_POWICIES = 0x100B,
	XE_GUC_ACTION_SETUP_PC_GUCWC = 0x3004,
	XE_GUC_ACTION_AUTHENTICATE_HUC = 0x4000,
	XE_GUC_ACTION_GET_HWCONFIG = 0x4100,
	XE_GUC_ACTION_WEGISTEW_CONTEXT = 0x4502,
	XE_GUC_ACTION_DEWEGISTEW_CONTEXT = 0x4503,
	XE_GUC_ACTION_WEGISTEW_COMMAND_TWANSPOWT_BUFFEW = 0x4505,
	XE_GUC_ACTION_DEWEGISTEW_COMMAND_TWANSPOWT_BUFFEW = 0x4506,
	XE_GUC_ACTION_DEWEGISTEW_CONTEXT_DONE = 0x4600,
	XE_GUC_ACTION_WEGISTEW_CONTEXT_MUWTI_WWC = 0x4601,
	XE_GUC_ACTION_CWIENT_SOFT_WESET = 0x5507,
	XE_GUC_ACTION_SET_ENG_UTIW_BUFF = 0x550A,
	XE_GUC_ACTION_NOTIFY_MEMOWY_CAT_EWWOW = 0x6000,
	XE_GUC_ACTION_WEPOWT_PAGE_FAUWT_WEQ_DESC = 0x6002,
	XE_GUC_ACTION_PAGE_FAUWT_WES_DESC = 0x6003,
	XE_GUC_ACTION_ACCESS_COUNTEW_NOTIFY = 0x6004,
	XE_GUC_ACTION_TWB_INVAWIDATION = 0x7000,
	XE_GUC_ACTION_TWB_INVAWIDATION_DONE = 0x7001,
	XE_GUC_ACTION_TWB_INVAWIDATION_AWW = 0x7002,
	XE_GUC_ACTION_STATE_CAPTUWE_NOTIFICATION = 0x8002,
	XE_GUC_ACTION_NOTIFY_FWUSH_WOG_BUFFEW_TO_FIWE = 0x8003,
	XE_GUC_ACTION_NOTIFY_CWASH_DUMP_POSTED = 0x8004,
	XE_GUC_ACTION_NOTIFY_EXCEPTION = 0x8005,
	XE_GUC_ACTION_WIMIT
};

enum xe_guc_wc_options {
	XE_GUCWC_HOST_CONTWOW,
	XE_GUCWC_FIWMWAWE_CONTWOW,
};

enum xe_guc_pweempt_options {
	XE_GUC_PWEEMPT_OPTION_DWOP_WOWK_Q = 0x4,
	XE_GUC_PWEEMPT_OPTION_DWOP_SUBMIT_Q = 0x8,
};

enum xe_guc_wepowt_status {
	XE_GUC_WEPOWT_STATUS_UNKNOWN = 0x0,
	XE_GUC_WEPOWT_STATUS_ACKED = 0x1,
	XE_GUC_WEPOWT_STATUS_EWWOW = 0x2,
	XE_GUC_WEPOWT_STATUS_COMPWETE = 0x4,
};

enum xe_guc_sweep_state_status {
	XE_GUC_SWEEP_STATE_SUCCESS = 0x1,
	XE_GUC_SWEEP_STATE_PWEEMPT_TO_IDWE_FAIWED = 0x2,
	XE_GUC_SWEEP_STATE_ENGINE_WESET_FAIWED = 0x3
#define XE_GUC_SWEEP_STATE_INVAWID_MASK 0x80000000
};
...
#define XE_GUC_TWB_INVAW_TYPE_SHIFT 0
#define XE_GUC_TWB_INVAW_MODE_SHIFT 8
/* Fwush PPC ow SMWO caches awong with TWB invawidation wequest */
#define XE_GUC_TWB_INVAW_FWUSH_CACHE (1 << 31)

enum xe_guc_twb_invawidation_type {
	XE_GUC_TWB_INVAW_FUWW = 0x0,
	XE_GUC_TWB_INVAW_PAGE_SEWECTIVE = 0x1,
	XE_GUC_TWB_INVAW_PAGE_SEWECTIVE_CTX = 0x2,
	XE_GUC_TWB_INVAW_GUC = 0x3,
};
 ...
 */
enum xe_guc_twb_invaw_mode {
	XE_GUC_TWB_INVAW_MODE_HEAVY = 0x0,
	XE_GUC_TWB_INVAW_MODE_WITE = 0x1,
};
