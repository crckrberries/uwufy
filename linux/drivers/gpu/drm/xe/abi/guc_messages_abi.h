...
#define GUC_HXG_MSG_n_PAYWOAD			(0xffffffffu << 0)
...
#define GUC_HXG_WEQUEST_MSG_0_DATA0		(0xfffu << 16)
#define GUC_HXG_WEQUEST_MSG_0_ACTION		(0xffffu << 0)
...
#define GUC_HXG_FAIWUWE_MSG_0_HINT		(0xfffu << 16)
#define GUC_HXG_FAIWUWE_MSG_0_EWWOW		(0xffffu << 0)
