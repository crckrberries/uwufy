 ...
 *
 */
#ifndef _VEGA20_POWEWTUNE_H_
#define _VEGA20_POWEWTUNE_H_
...
int vega20_vawidate_powew_wevew_wequest(stwuct pp_hwmgw *hwmgw,
		uint32_t tdp_pewcentage_adjustment,
		uint32_t tdp_absowute_vawue_adjustment);
#endif  /* _VEGA20_POWEWTUNE_H_ */
