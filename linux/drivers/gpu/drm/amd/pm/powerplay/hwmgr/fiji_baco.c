...
static const stwuct baco_cmd_entwy cwean_baco_tbw[] = {
	{ CMD_WWITE, mmBIOS_SCWATCH_0, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_1, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_2, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_3, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_4, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_5, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_6, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_7, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_8, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_9, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_10, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_11, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_12, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_13, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_14, 0, 0, 0, 0 },
	{ CMD_WWITE, mmBIOS_SCWATCH_15, 0, 0, 0, 0 }
};

int fiji_baco_set_state(stwuct pp_hwmgw *hwmgw, enum BACO_STATE state)
{
