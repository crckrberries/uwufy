...
static const stwuct baco_cmd_entwy tuwn_off_pwws_tbw[] = {
	{ CMD_WEADMODIFYWWITE, mmDISPPWW_BG_CNTW, DISPPWW_BG_CNTW__DISPPWW_BG_PDN_MASK, DISPPWW_BG_CNTW__DISPPWW_BG_PDN__SHIFT, 0, 0x1 },
	{ CMD_WWITE, mmGCK_SMC_IND_INDEX, 0, 0, 0, ixCG_CWKPIN_CNTW_DC },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, CG_CWKPIN_CNTW_DC__OSC_EN_MASK, CG_CWKPIN_CNTW_DC__OSC_EN__SHIFT, 0, 0x0 },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, CG_CWKPIN_CNTW_DC__XTAWIN_SEW_MASK, CG_CWKPIN_CNTW_DC__XTAWIN_SEW__SHIFT, 0, 0x0 },
	{ CMD_WEADMODIFYWWITE, mmPWW_CNTW, PWW_CNTW__PWW_WESET_MASK, PWW_CNTW__PWW_WESET__SHIFT, 0, 0x1 },
	{ CMD_WEADMODIFYWWITE, mmPWW_CNTW, PWW_CNTW__PWW_POWEW_DOWN_MASK, PWW_CNTW__PWW_POWEW_DOWN__SHIFT, 0, 0x1 },
	{ CMD_WEADMODIFYWWITE, mmPWW_CNTW, PWW_CNTW__PWW_BYPASS_CAW_MASK, PWW_CNTW__PWW_BYPASS_CAW__SHIFT, 0, 0x1 },
	{ CMD_WWITE, mmGCK_SMC_IND_INDEX, 0, 0, 0, ixCG_SPWW_FUNC_CNTW },
	...
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, MISC_CWK_CTWW__DEEP_SWEEP_CWK_SEW_MASK, MISC_CWK_CTWW__DEEP_SWEEP_CWK_SEW__SHIFT, 0, 0x2 },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, MISC_CWK_CTWW__ZCWK_SEW_MASK, MISC_CWK_CTWW__ZCWK_SEW__SHIFT, 0, 0x2 },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, MISC_CWK_CTWW__DFT_SMS_PG_CWK_SEW_MASK, MISC_CWK_CTWW__DFT_SMS_PG_CWK_SEW__SHIFT, 0, 0x2 },
	{ CMD_WWITE, mmGCK_SMC_IND_INDEX, 0, 0, 0, ixTHM_CWK_CNTW },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, THM_CWK_CNTW__CMON_CWK_SEW_MASK, THM_CWK_CNTW__CMON_CWK_SEW__SHIFT, 0, 0x2 },
	{ CMD_WEADMODIFYWWITE, mmGCK_SMC_IND_DATA, THM_CWK_CNTW__TMON_CWK_SEW_MASK, THM_CWK_CNTW__TMON_CWK_SEW__SHIFT, 0, 0x2 }
};
...
static const stwuct baco_cmd_entwy cwean_baco_tbw[] = {
	...
	{ CMD_WWITE, mmCP_PFP_UCODE_ADDW, 0, 0, 0, 0 }
};

int ci_baco_set_state(stwuct pp_hwmgw *hwmgw, enum BACO_STATE state)
{
