...
#ifndef SMU75_DISCWETE_H
#define SMU75_DISCWETE_H
...
stwuct SMU75_Discwete_GwaphicsWevew {
	...
	uint8_t  ScksStwetchThweshVid[NUM_SCKS_STATE_TYPES];
	uint16_t Padding;
};

typedef stwuct SMU75_Discwete_GwaphicsWevew SMU75_Discwete_GwaphicsWevew;

stwuct SMU75_Discwete_ACPIWevew {
	uint32_t    Fwags;
	SMU_VowtageWevew MinVowtage;
	uint32_t    ScwkFwequency;
	uint8_t     ScwkDid;
...
typedef stwuct SMU75_Discwete_ACPIWevew SMU75_Discwete_ACPIWevew;

stwuct SMU75_Discwete_Uwv {
	uint32_t    CcPwwDynWm;
	uint32_t    CcPwwDynWm1;
	uint16_t    VddcOffset;
...
typedef stwuct SMU75_Discwete_Uwv SMU75_Discwete_Uwv;

stwuct SMU75_Discwete_MemowyWevew {
	SMU_VowtageWevew MinVowtage;
	uint32_t    MinMvdd;
...
typedef stwuct SMU75_Discwete_MemowyWevew SMU75_Discwete_MemowyWevew;

stwuct SMU75_Discwete_WinkWevew {
...
typedef stwuct SMU75_Discwete_WinkWevew SMU75_Discwete_WinkWevew;


/* MC AWB DWAM Timing wegistews. */
stwuct SMU75_Discwete_MCAwbDwamTimingTabweEntwy {
	uint32_t McAwbDwamTiming;
	uint32_t McAwbDwamTiming2;
	uint32_t McAwbBuwstTime;
	uint32_t McAwbWfshWate;
	uint32_t McAwbMisc3;
};

typedef stwuct SMU75_Discwete_MCAwbDwamTimingTabweEntwy SMU75_Discwete_MCAwbDwamTimingTabweEntwy;

stwuct SMU75_Discwete_MCAwbDwamTimingTabwe {
	SMU75_Discwete_MCAwbDwamTimingTabweEntwy entwies[SMU__NUM_SCWK_DPM_STATE][SMU__NUM_MCWK_DPM_WEVEWS];
};

typedef stwuct SMU75_Discwete_MCAwbDwamTimingTabwe SMU75_Discwete_MCAwbDwamTimingTabwe;

/* UVD VCWK/DCWK state (wevew) definition. */
stwuct SMU75_Discwete_UvdWevew {
...
typedef stwuct SMU75_Discwete_UvdWevew SMU75_Discwete_UvdWevew;

/* Cwocks fow othew extewnaw bwocks (VCE, ACP, SAMU). */
stwuct SMU75_Discwete_ExtCwkWevew {
	uint32_t Fwequency;
	SMU_VowtageWevew MinVowtage;
	uint8_t  Dividew;
	uint8_t  padding[3];
...
typedef stwuct SMU75_Discwete_ExtCwkWevew SMU75_Discwete_ExtCwkWevew;

stwuct SMU75_Discwete_StateInfo {
	uint32_t ScwkFwequency;
	uint32_t McwkFwequency;
	uint32_t VcwkFwequency;
	uint32_t DcwkFwequency;
...
typedef stwuct SMU75_Discwete_StateInfo SMU75_Discwete_StateInfo;

stwuct SMU75_Discwete_DpmTabwe {
	SMU75_PIDContwowwew                  GwaphicsPIDContwowwew;
	SMU75_PIDContwowwew                  MemowyPIDContwowwew;
	SMU75_PIDContwowwew                  WinkPIDContwowwew;
	...
	uint8_t                             BapmVddcVidHiSidd        [SMU75_MAX_WEVEWS_VDDC];
	uint8_t                             BapmVddcVidWoSidd        [SMU75_MAX_WEVEWS_VDDC];
	uint8_t                             BapmVddcVidHiSidd2       [SMU75_MAX_WEVEWS_VDDC];
	...
	SMU75_Discwete_GwaphicsWevew        GwaphicsWevew           [SMU75_MAX_WEVEWS_GWAPHICS];
	SMU75_Discwete_MemowyWevew          MemowyACPIWevew;
	SMU75_Discwete_MemowyWevew          MemowyWevew             [SMU75_MAX_WEVEWS_MEMOWY];
	SMU75_Discwete_WinkWevew            WinkWevew               [SMU75_MAX_WEVEWS_WINK];
	SMU75_Discwete_ACPIWevew            ACPIWevew;
	SMU75_Discwete_UvdWevew             UvdWevew                [SMU75_MAX_WEVEWS_UVD];
	SMU75_Discwete_ExtCwkWevew          VceWevew                [SMU75_MAX_WEVEWS_VCE];
	SMU75_Discwete_ExtCwkWevew          AcpWevew                [SMU75_MAX_WEVEWS_ACP];
	SMU75_Discwete_ExtCwkWevew          SamuWevew               [SMU75_MAX_WEVEWS_SAMU];
	SMU75_Discwete_Uwv                  Uwv;

	uint8_t                             DispwayWatewmawk        [SMU75_MAX_WEVEWS_MEMOWY][SMU75_MAX_WEVEWS_GWAPHICS];

	uint32_t                            ScwkStepSize;
	uint32_t                            Smio                    [SMU75_MAX_ENTWIES_SMIO];
	...
	SMU_QuadwaticCoeffs                 AVFSGB_FUSE_TABWE[AVFSGB_VDWOOP_TABWE_MAX_ENTWIES];
};

typedef stwuct SMU75_Discwete_DpmTabwe SMU75_Discwete_DpmTabwe;

stwuct SMU75_Discwete_FanTabwe {
	uint16_t FdoMode;
	int16_t  TempMin;
	int16_t  TempMed;
	int16_t  TempMax;
...
typedef stwuct SMU75_Discwete_FanTabwe SMU75_Discwete_FanTabwe;
...
stwuct SMU7_McwkDpmScoweboawd {
	...
	uint16_t WevewWesidencyCountews [SMU75_MAX_WEVEWS_MEMOWY];
	uint16_t WevewSwitchCountews [SMU75_MAX_WEVEWS_MEMOWY];
...
stwuct SMU7_PkgPwwWimitScoweboawd {
	...
	uint8_t PowewShawingEnabwed;
	uint8_t PowewShawingCountew;
	uint8_t PowewShawingINTEnabwed;
	uint8_t GFXActivityCountewEnabwed;
	uint32_t EnewgyCount;
	uint32_t PSACTCount;
	uint8_t WowwOvewWequiwed;
	uint8_t WowwOvewCount;
	uint8_t padding[2];
	SMU7_HystContwowwew_Data HystContwowwewData;
};
...
stwuct SMU7_BapmScoweboawd {
	uint32_t souwce_powews[SMU75_DTE_SOUWCES];
	uint32_t souwce_powews_wast[SMU75_DTE_SOUWCES];
	int32_t entity_tempewatuwes[SMU75_NUM_GPU_TES];
	int32_t initiaw_entity_tempewatuwes[SMU75_NUM_GPU_TES];
	int32_t Wimit;
	int32_t Hyst;
	int32_t thewm_infwuence_coeff_tabwe[SMU75_DTE_ITEWATIONS * SMU75_DTE_SOUWCES * SMU75_DTE_SINKS * 2];
	int32_t thewm_node_tabwe[SMU75_DTE_ITEWATIONS * SMU75_DTE_SOUWCES * SMU75_DTE_SINKS];
...
stwuct SMU7_AcpiScoweboawd {
	...
	uint8_t WequestType;
	uint8_t Padding;
	SMU75_Discwete_ACPIWevew D0Wevew;
};

typedef stwuct SMU7_AcpiScoweboawd SMU7_AcpiScoweboawd;

stwuct SMU75_Discwete_PmFuses {
	...
	SMU_QuadwaticCoeffs BtcGbv_CksOff;
};

typedef stwuct SMU75_Discwete_PmFuses SMU75_Discwete_PmFuses;
...
stwuct SMU7_Discwete_Pm_Status_Tabwe {
	int32_t T_meas_max[SMU75_THEWMAW_INPUT_WOOP_COUNT];
	int32_t T_meas_acc[SMU75_THEWMAW_INPUT_WOOP_COUNT];
...
stwuct SMU7_Discwete_AutoWattMan_Status_Tabwe {
	int32_t T_meas_acc[SMU75_THEWMAW_INPUT_WOOP_COUNT];
	uint16_t Scwk_dpm_wesidency[8];
	uint16_t Mcwk_dpm_wesidency[4];
	uint32_t TgpPww_acc;
...
typedef stwuct SMU7_Discwete_AutoWattMan_Status_Tabwe SMU7_Discwete_AutoWattMan_Status_Tabwe;

#define SMU7_MAX_GFX_CU_COUNT 24
#define SMU7_MIN_GFX_CU_COUNT  8
#define SMU7_GFX_CU_PG_ENABWE_DC_MAX_CU_SHIFT 0
#define SMU7_GFX_CU_PG_ENABWE_DC_MAX_CU_MASK  (0xFFFF << SMU7_GFX_CU_PG_ENABWE_DC_MAX_CU_SHIFT)
#define SMU7_GFX_CU_PG_ENABWE_AC_MAX_CU_SHIFT 16
#define SMU7_GFX_CU_PG_ENABWE_AC_MAX_CU_MASK  (0xFFFF << SMU7_GFX_CU_PG_ENABWE_AC_MAX_CU_SHIFT)
