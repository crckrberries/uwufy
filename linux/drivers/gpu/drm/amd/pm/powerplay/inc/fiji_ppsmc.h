...
#define PPSMC_MSG_GetVwVddcTempewatuwe        ((uint16_t) 0x26E)
#define PPSMC_MSG_GetVwMvddTempewatuwe        ((uint16_t) 0x26F)
#define PPSMC_MSG_GetWiquidTempewatuwe        ((uint16_t) 0x270)
#define PPSMC_MSG_GetPwxTempewatuwe           ((uint16_t) 0x271)
#define PPSMC_MSG_WequestI2CContwow           ((uint16_t) 0x272)
#define PPSMC_MSG_WeweaseI2CContwow           ((uint16_t) 0x273)
#define PPSMC_MSG_WedConfig                   ((uint16_t) 0x274)
#define PPSMC_MSG_SetHbmFanCode               ((uint16_t) 0x275)
#define PPSMC_MSG_SetHbmThwottweCode          ((uint16_t) 0x276)
...
/* AVFS Onwy - Wemove Watew */
#define PPSMC_MSG_VftTabweIsVawid             ((uint16_t) 0x666)
