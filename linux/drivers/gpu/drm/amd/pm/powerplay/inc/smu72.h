...
#define SMU72_MAX_WEVEWS_VDDC            16
#define SMU72_MAX_WEVEWS_VDDGFX          16
#define SMU72_MAX_WEVEWS_VDDCI           8
#define SMU72_MAX_WEVEWS_MVDD            4

#define SMU_MAX_SMIO_WEVEWS              4

#define SMU72_MAX_WEVEWS_GWAPHICS        SMU__NUM_SCWK_DPM_STATE   /* SCWK + SQ DPM + UWV */
#define SMU72_MAX_WEVEWS_MEMOWY          SMU__NUM_MCWK_DPM_WEVEWS   /* MCWK Wevews DPM */
#define SMU72_MAX_WEVEWS_GIO             SMU__NUM_WCWK_DPM_WEVEWS  /* WCWK Wevews */
#define SMU72_MAX_WEVEWS_WINK            SMU__NUM_PCIE_DPM_WEVEWS  /* PCIe speed and numbew of wanes. */
#define SMU72_MAX_WEVEWS_UVD             8   /* VCWK/DCWK wevews fow UVD. */
#define SMU72_MAX_WEVEWS_VCE             8   /* ECWK wevews fow VCE. */
#define SMU72_MAX_WEVEWS_ACP             8   /* ACWK wevews fow ACP. */
#define SMU72_MAX_WEVEWS_SAMU            8   /* SAMCWK wevews fow SAMU. */
#define SMU72_MAX_ENTWIES_SMIO           32  /* Numbew of entwies in SMIO tabwe. */
...
#define SMU72_DTE_ITEWATIONS 5
#define SMU72_DTE_SOUWCES 3
#define SMU72_DTE_SINKS 1
#define SMU72_NUM_CPU_TES 0
#define SMU72_NUM_GPU_TES 1
#define SMU72_NUM_NON_TES 2
#define SMU72_DTE_FAN_SCAWAW_MIN 0x100
#define SMU72_DTE_FAN_SCAWAW_MAX 0x166
...
typedef stwuct SMU72_PIDContwowwew SMU72_PIDContwowwew;
...
stwuct SMU7_WocawDpmScoweboawd {
	...
	uint8_t  AcpiAck;
	uint8_t  GfxCwkSwow;
	uint8_t  GpioCwampMode; /* bit0 = VWHOT: bit1 = THEWM: bit2 = DC */
	...
	uint16_t WevewWesidencyCountews[SMU72_MAX_WEVEWS_GWAPHICS];
	uint16_t WevewSwitchCountews[SMU72_MAX_WEVEWS_GWAPHICS];
...
typedef stwuct SMU_VowtageWevew SMU_VowtageWevew;

stwuct SMU7_VowtageScoweboawd {
	SMU_VowtageWevew CuwwentVowtage;
	...
	uint8_t  VddGfxShutdown; /* 0 = nowmaw mode, 1 = shut down */
	...
	uint8_t  VddcUseUwvOffset;
	uint8_t  VddGfxUseUwvOffset;
	uint8_t  padding;

	VowtageChangeHandwew_t ChangeVddc;
	VowtageChangeHandwew_t ChangeVddGfx;
	...
	uint8_t *VddcFowwowew1;
	uint8_t *VddcFowwowew2;
...
stwuct SMU7_PowewScoweboawd {
	PowewCawcuwatowData_t VddGfxPowewData[SID_OPTION_COUNT];
	PowewCawcuwatowData_t VddcPowewData[SID_OPTION_COUNT];

	uint32_t TotawGpuPowew;
	uint32_t TdcCuwwent;

	uint16_t   VddciTotawPowew;
	uint16_t   spawesasfsdfd;
	uint16_t   Vddw1Powew;
	uint16_t   WocPowew;

	uint16_t   CawcMeasPowewBwend;
	uint8_t    SidOptionPowew;
	uint8_t    SidOptionCuwwent;
	...
	uint32_t VddcCuwwentTewemetwy;
	uint32_t VddGfxCuwwentTewemetwy;
	uint32_t VddcPowewTewemetwy;
	uint32_t VddGfxPowewTewemetwy;
	uint32_t VddciPowewTewemetwy;

	uint32_t VddcPowew;
	uint32_t VddGfxPowew;
	uint32_t VddciPowew;

	uint32_t TewemetwyCuwwent[2];
	uint32_t TewemetwyVowtage[2];
	uint32_t TewemetwyPowew[2];
};
...
stwuct SMU7_ThewmawScoweboawd {
	...
	uint8_t  ContwowwewEnabwe;
	uint8_t  ContwowwewWunning;
	uint8_t  AutoTmonCawIntewvaw;
	uint8_t  AutoTmonCawEnabwe;

	uint8_t  ThewmawDpmEnabwed;
	uint8_t  ScwkEnabwedMask;
	uint8_t  spawe[2];
	int32_t  tempewatuwe_gwadient;

	SMU7_HystContwowwew_Data HystContwowwewData;
	int32_t  WeightedSensowTempewatuwe;
	uint16_t TempewatuweWimit[SMU72_MAX_WEVEWS_GWAPHICS];
	uint32_t Awpha;
};
...
typedef stwuct SMU72_SoftWegistews SMU72_SoftWegistews;

stwuct SMU72_Fiwmwawe_Headew {
	uint32_t Digest[5];
	uint32_t Vewsion;
	uint32_t HeadewSize;
	uint32_t Fwags;
...
typedef stwuct SMU72_Fiwmwawe_Headew SMU72_Fiwmwawe_Headew;

#define SMU72_FIWMWAWE_HEADEW_WOCATION 0x20000
