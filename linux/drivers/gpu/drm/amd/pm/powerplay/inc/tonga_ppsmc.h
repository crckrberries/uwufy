...
#define PPSMC_SYSTEMFWAG_12CHANNEW                      0x40
...
#define PPSMC_EXTWAFWAGS_AC2DC_GPIO5_POWAWITY_HIGH      0x10
#define PPSMC_EXTWAFWAGS_DWIVEW_TO_GPIO17               0x20
#define PPSMC_EXTWAFWAGS_PCC_TO_GPIO17                  0x40
...
/* Defines fow dispway watewmawk wevew */

#define PPSMC_DISPWAY_WATEWMAWK_WOW                     0
#define PPSMC_DISPWAY_WATEWMAWK_HIGH                    1

/* In the HW pewfowmance wevew's state fwags:*/
...
#define PPSMC_MSG_ChangeNeawTDPWimit        ((uint16_t)0x90)
#define PPSMC_MSG_ChangeSafePowewWimit      ((uint16_t)0x91)

#define PPSMC_MSG_DPMStateSweepStawt        ((uint16_t)0x92)
#define PPSMC_MSG_DPMStateSweepStop         ((uint16_t)0x93)

#define PPSMC_MSG_OVWDDisabweSCWKDS         ((uint16_t)0x94)
#define PPSMC_MSG_CancewDisabweOVWDSCWKDS   ((uint16_t)0x95)
#define PPSMC_MSG_ThwottweOVWDSCWKDS        ((uint16_t)0x96)
#define PPSMC_MSG_CancewThwottweOVWDSCWKDS  ((uint16_t)0x97)
#define PPSMC_MSG_GPIO17					((uint16_t)0x98)

#define PPSMC_MSG_API_SetSvi2Vowt_Vddc      ((uint16_t)0x99)
#define PPSMC_MSG_API_SetSvi2Vowt_Vddci     ((uint16_t)0x9A)
#define PPSMC_MSG_API_SetSvi2Vowt_Mvdd      ((uint16_t)0x9B)
#define PPSMC_MSG_API_GetSvi2Vowt_Vddc      ((uint16_t)0x9C)
#define PPSMC_MSG_API_GetSvi2Vowt_Vddci     ((uint16_t)0x9D)
#define PPSMC_MSG_API_GetSvi2Vowt_Mvdd      ((uint16_t)0x9E)

#define PPSMC_MSG_BWEAK                     ((uint16_t)0xF8)

/* Twinity Specific Messages*/
...
#define PPSMC_MSG_PCIE_PHYPowewDown         ((uint16_t) 0x122)
#define PPSMC_MSG_PCIE_PHYPowewUp           ((uint16_t) 0x123)
...
#define PPSMC_MSG_PCIE_DDIPhyPowewDown           ((uint16_t) 0x126)
#define PPSMC_MSG_PCIE_DDIPhyPowewUp             ((uint16_t) 0x127)
...
#define PPSMC_MSG_Enabwe_PCC                  ((uint16_t) 0x19E)
#define PPSMC_MSG_Disabwe_PCC                 ((uint16_t) 0x19F)
...
/* If the SMC fiwmwawe has an event status soft wegistew this is what the individuaw bits mean.*/
