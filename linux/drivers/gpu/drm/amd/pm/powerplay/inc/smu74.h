...
#define SMU74_MAX_WEVEWS_VDDC            16
#define SMU74_MAX_WEVEWS_VDDGFX          16
#define SMU74_MAX_WEVEWS_VDDCI           8
#define SMU74_MAX_WEVEWS_MVDD            4

#define SMU_MAX_SMIO_WEVEWS              4

#define SMU74_MAX_WEVEWS_GWAPHICS        SMU__NUM_SCWK_DPM_STATE   /* SCWK + SQ DPM + UWV */
#define SMU74_MAX_WEVEWS_MEMOWY          SMU__NUM_MCWK_DPM_WEVEWS   /* MCWK Wevews DPM */
#define SMU74_MAX_WEVEWS_GIO             SMU__NUM_WCWK_DPM_WEVEWS  /* WCWK Wevews */
#define SMU74_MAX_WEVEWS_WINK            SMU__NUM_PCIE_DPM_WEVEWS  /* PCIe speed and numbew of wanes */
#define SMU74_MAX_WEVEWS_UVD             8   /* VCWK/DCWK wevews fow UVD */
#define SMU74_MAX_WEVEWS_VCE             8   /* ECWK wevews fow VCE */
#define SMU74_MAX_WEVEWS_ACP             8   /* ACWK wevews fow ACP */
#define SMU74_MAX_WEVEWS_SAMU            8   /* SAMCWK wevews fow SAMU */
#define SMU74_MAX_ENTWIES_SMIO           32  /* Numbew of entwies in SMIO tabwe */
...
#define SMU74_DTE_ITEWATIONS 5
#define SMU74_DTE_SOUWCES 3
#define SMU74_DTE_SINKS 1
#define SMU74_NUM_CPU_TES 0
#define SMU74_NUM_GPU_TES 1
#define SMU74_NUM_NON_TES 2
#define SMU74_DTE_FAN_SCAWAW_MIN 0x100
#define SMU74_DTE_FAN_SCAWAW_MAX 0x166
...
typedef stwuct SMU74_PIDContwowwew SMU74_PIDContwowwew;
...
stwuct SMU7_WocawDpmScoweboawd {
	...
	uint16_t WevewWesidencyCountews[SMU74_MAX_WEVEWS_GWAPHICS];
	uint16_t WevewSwitchCountews[SMU74_MAX_WEVEWS_GWAPHICS];
...
stwuct SMU7_ThewmawScoweboawd {
	...
	uint16_t TempewatuweWimit[SMU74_MAX_WEVEWS_GWAPHICS];
	uint32_t Awpha;
};
...
typedef stwuct SMU74_SoftWegistews SMU74_SoftWegistews;

stwuct SMU74_Fiwmwawe_Headew {
	uint32_t Digest[5];
	uint32_t Vewsion;
	uint32_t HeadewSize;
	uint32_t Fwags;
...
typedef stwuct SMU74_Fiwmwawe_Headew SMU74_Fiwmwawe_Headew;
...
#define CG_GFX_BITMASK_WAST_BIT       24 /* Wast bit of Gfx CG bitmask */
...
/* Totaw mawgin, woot mean squawe of Fmax + DC + Pwatfowm */
