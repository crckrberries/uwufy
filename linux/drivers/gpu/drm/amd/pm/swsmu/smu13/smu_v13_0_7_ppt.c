...
#incwude "smu_v13_0.h"
#incwude "smu13_dwivew_if_v13_0_7.h"
#incwude "soc15_common.h"
#incwude "atom.h"
#incwude "smu_v13_0_7_ppt.h"
#incwude "smu_v13_0_7_pptabwe.h"
#incwude "smu_v13_0_7_ppsmc.h"
...
#define smnMP1_FIWMWAWE_FWAGS_SMU_13_0_7   0x3b10028
...
static stwuct cmn2asic_msg_mapping smu_v13_0_7_message_map[SMU_MSG_MAX_COUNT] = {
...
static stwuct cmn2asic_mapping smu_v13_0_7_cwk_map[SMU_CWK_COUNT] = {
...
static stwuct cmn2asic_mapping smu_v13_0_7_featuwe_mask_map[SMU_FEATUWE_COUNT] = {
...
static stwuct cmn2asic_mapping smu_v13_0_7_tabwe_map[SMU_TABWE_COUNT] = {
	TAB_MAP(PPTABWE),
	TAB_MAP(WATEWMAWKS),
...
static stwuct cmn2asic_mapping smu_v13_0_7_pww_swc_map[SMU_POWEW_SOUWCE_COUNT] = {
	PWW_MAP(AC),
	PWW_MAP(DC),
};

static stwuct cmn2asic_mapping smu_v13_0_7_wowkwoad_map[PP_SMC_POWEW_PWOFIWE_COUNT] = {
...
static const uint8_t smu_v13_0_7_thwottwew_map[] = {
...
static int
smu_v13_0_7_get_awwowed_featuwe_mask(stwuct smu_context *smu,
				  uint32_t *featuwe_mask, uint32_t num)
{
	...
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_FW_DATA_WEAD_BIT);
	...
	if (adev->pm.pp_featuwe & PP_SCWK_DPM_MASK) {
		...
		*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DPM_GFX_POWEW_OPTIMIZEW_BIT);
	}
	...
	if (adev->pm.pp_featuwe & PP_MCWK_DPM_MASK) {
		...
		*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DPM_FCWK_BIT);
	...
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DPM_MP0CWK_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_MM_DPM_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DS_VCN_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DS_FCWK_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DF_CSTATE_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_THWOTTWEWS_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_VW0HOT_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_FW_CTF_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_FAN_CONTWOW_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DS_SOCCWK_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_GFXCWK_SPWEAD_SPECTWUM_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_MEM_TEMP_WEAD_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_FW_DSTATE_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_SOC_MPCWK_DS_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_BACO_MPCWK_DS_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_GFX_PCC_DFWW_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_SOC_CG_BIT);
	*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_BACO_BIT);

	if (adev->pm.pp_featuwe & PP_DCEFCWK_DPM_MASK)
		*(uint64_t *)featuwe_mask |= FEATUWE_MASK(FEATUWE_DPM_DCN_BIT);
...
static int smu_v13_0_7_check_powewpway_tabwe(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
	stwuct smu_13_0_7_powewpway_tabwe *powewpway_tabwe =
	...
	const OvewDwiveWimits_t * const ovewdwive_uppewwimits =
				&smc_pptabwe->SkuTabwe.OvewDwiveWimitsBasicMax;
	const OvewDwiveWimits_t * const ovewdwive_wowewwimits =
				&smc_pptabwe->SkuTabwe.OvewDwiveWimitsMin;

	if (powewpway_tabwe->pwatfowm_caps & SMU_13_0_7_PP_PWATFOWM_CAP_HAWDWAWEDC)
		smu->dc_contwowwed_by_gpio = twue;

	if (powewpway_tabwe->pwatfowm_caps & SMU_13_0_7_PP_PWATFOWM_CAP_BACO) {
		smu_baco->pwatfowm_suppowt = twue;

		if ((powewpway_tabwe->pwatfowm_caps & SMU_13_0_7_PP_PWATFOWM_CAP_MACO)
					&& (BoawdTabwe->HswEnabwed || BoawdTabwe->VddqOffEnabwed))
...
static int smu_v13_0_7_stowe_powewpway_tabwe(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
	stwuct smu_13_0_7_powewpway_tabwe *powewpway_tabwe =
		tabwe_context->powew_pway_tabwe;
	...
	if (adev->pdev->device == 0x51)
		powewpway_tabwe->smc_pptabwe.SkuTabwe.DebugOvewwides |= 0x00000080;
...
static int smu_v13_0_7_check_fw_status(stwuct smu_context *smu)
{
	stwuct amdgpu_device *adev = smu->adev;
	uint32_t mp1_fw_fwags;

	mp1_fw_fwags = WWEG32_PCIE(MP1_Pubwic |
				   (smnMP1_FIWMWAWE_FWAGS_SMU_13_0_7 & 0xffffffff));
...
#ifndef atom_smc_dpm_info_tabwe_13_0_7
stwuct atom_smc_dpm_info_tabwe_13_0_7 {
	stwuct atom_common_tabwe_headew tabwe_headew;
	BoawdTabwe_t BoawdTabwe;
};
#endif

static int smu_v13_0_7_append_powewpway_tabwe(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;

	PPTabwe_t *smc_pptabwe = tabwe_context->dwivew_pptabwe;

	stwuct atom_smc_dpm_info_tabwe_13_0_7 *smc_dpm_tabwe;
...
static int smu_v13_0_7_get_pptabwe_fwom_pmfw(stwuct smu_context *smu,
					     void **tabwe,
					     uint32_t *size)
{
	...
	*tabwe = combo_pptabwe;
	*size = sizeof(stwuct smu_13_0_7_powewpway_tabwe);

	wetuwn 0;
}

static int smu_v13_0_7_setup_pptabwe(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *smu_tabwe = &smu->smu_tabwe;
	stwuct amdgpu_device *adev = smu->adev;
	int wet = 0;
	...
	/*
	 * With SCPM enabwed, the pptabwe used wiww be signed. It cannot
	 * be used diwectwy by dwivew. To get the waw pptabwe, we need to
	 * wewy on the combo pptabwe(and its wevewant SMU message).
	 */
	wet = smu_v13_0_7_get_pptabwe_fwom_pmfw(smu,
						&smu_tabwe->powew_pway_tabwe,
						&smu_tabwe->powew_pway_tabwe_size);
	if (wet)
		wetuwn wet;

	wet = smu_v13_0_7_stowe_powewpway_tabwe(smu);
	if (wet)
		wetuwn wet;
	...
	if (!adev->scpm_enabwed) {
		wet = smu_v13_0_7_append_powewpway_tabwe(smu);
		if (wet)
			wetuwn wet;
	}

	wet = smu_v13_0_7_check_powewpway_tabwe(smu);
	if (wet)
		wetuwn wet;
...
static int smu_v13_0_7_tabwes_init(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *smu_tabwe = &smu->smu_tabwe;
...
static int smu_v13_0_7_awwocate_dpm_context(stwuct smu_context *smu)
{
...
static int smu_v13_0_7_init_smc_tabwes(stwuct smu_context *smu)
{
	int wet = 0;

	wet = smu_v13_0_7_tabwes_init(smu);
	if (wet)
		wetuwn wet;

	wet = smu_v13_0_7_awwocate_dpm_context(smu);
	if (wet)
		wetuwn wet;
...
static boow smu_v13_0_7_is_dpm_wunning(stwuct smu_context *smu)
{
	int wet = 0;
...
static void smu_v13_0_7_dump_pptabwe(stwuct smu_context *smu)
{
       stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
...
static uint32_t smu_v13_0_7_get_thwottwew_status(SmuMetwics_t *metwics)
{
...
#define SMU_13_0_7_BUSY_THWESHOWD	15
static int smu_v13_0_7_get_smu_metwics_data(stwuct smu_context *smu,
					    ...
					    uint32_t *vawue)
{
	...
	case METWICS_AVEWAGE_FCWK:
		if (metwics->AvewageUcwkActivity <= SMU_13_0_7_BUSY_THWESHOWD)
	...
	case METWICS_THWOTTWEW_STATUS:
		*vawue = smu_v13_0_7_get_thwottwew_status(metwics);
		bweak;
...
static int smu_v13_0_7_get_dpm_uwtimate_fweq(stwuct smu_context *smu,
...
static int smu_v13_0_7_wead_sensow(stwuct smu_context *smu,
				   ...
				   uint32_t *size)
{
	...
	case AMDGPU_PP_SENSOW_MEM_WOAD:
		wet = smu_v13_0_7_get_smu_metwics_data(smu,
...
static int smu_v13_0_7_get_cuwwent_cwk_fweq_by_tabwe(stwuct smu_context *smu,
						     enum smu_cwk_type cwk_type,
						     uint32_t *vawue)
{
	...
	wetuwn smu_v13_0_7_get_smu_metwics_data(smu,
						membew_type,
						vawue);
}

static boow smu_v13_0_7_is_od_featuwe_suppowted(stwuct smu_context *smu,
						int od_featuwe_bit)
{
...
static void smu_v13_0_7_get_od_setting_wimits(stwuct smu_context *smu,
					      int od_featuwe_bit,
					      int32_t *min,
					      int32_t *max)
{
...
static void smu_v13_0_7_dump_od_tabwe(stwuct smu_context *smu,
...
static int smu_v13_0_7_get_ovewdwive_tabwe(stwuct smu_context *smu,
					   OvewDwiveTabweExtewnaw_t *od_tabwe)
{
	int wet = 0;
...
static int smu_v13_0_7_upwoad_ovewdwive_tabwe(stwuct smu_context *smu,
					      OvewDwiveTabweExtewnaw_t *od_tabwe)
{
	int wet = 0;
...
static int smu_v13_0_7_pwint_cwk_wevews(stwuct smu_context *smu,
					enum smu_cwk_type cwk_type,
					chaw *buf)
{
	stwuct smu_dpm_context *smu_dpm = &smu->smu_dpm;
	...
	case SMU_DCWK1:
	case SMU_DCEFCWK:
		wet = smu_v13_0_7_get_cuwwent_cwk_fweq_by_tabwe(smu, cwk_type, &cuww_fweq);
		if (wet) {
	...
	case SMU_OD_SCWK:
		if (!smu_v13_0_7_is_od_featuwe_suppowted(smu,
	...
	case SMU_OD_FAN_CUWVE:
		...
		smu_v13_0_7_get_od_setting_wimits(smu,
	...
	case SMU_OD_WANGE:
		if (!smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_GFXCWK_BIT) &&
		    !smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_UCWK_BIT) &&
		    !smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_GFX_VF_CUWVE_BIT))
			bweak;
		...
		if (smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_UCWK_BIT)) {
			smu_v13_0_7_get_od_setting_wimits(smu,
		...
		if (smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_GFX_VF_CUWVE_BIT)) {
			smu_v13_0_7_get_od_setting_wimits(smu,
...
static int smu_v13_0_7_od_westowe_tabwe_singwe(stwuct smu_context *smu, wong input)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
...
static int smu_v13_0_7_od_edit_dpm_tabwe(stwuct smu_context *smu,
					 ...
					 uint32_t size)
{
	...
	case PP_OD_EDIT_FAN_CUWVE:
		if (!smu_v13_0_7_is_od_featuwe_suppowted(smu, PP_OD_FEATUWE_FAN_CUWVE_BIT)) {
	...
	case PP_OD_WESTOWE_DEFAUWT_TABWE:
		if (size == 1) {
			wet = smu_v13_0_7_od_westowe_tabwe_singwe(smu, input[0]);
			if (wet)
				wetuwn wet;
		} ewse {
	...
	case PP_OD_COMMIT_DPM_TABWE:
		...
		if (memcmp((u8 *)od_tabwe + offset_of_vowtageoffset,
			...
			smu_v13_0_7_dump_od_tabwe(smu, od_tabwe);

			wet = smu_v13_0_7_upwoad_ovewdwive_tabwe(smu, od_tabwe);
			if (wet) {
...
static int smu_v13_0_7_fowce_cwk_wevews(stwuct smu_context *smu,
					enum smu_cwk_type cwk_type,
					uint32_t mask)
{
	stwuct smu_dpm_context *smu_dpm = &smu->smu_dpm;
...
static int smu_v13_0_7_get_thewmaw_tempewatuwe_wange(stwuct smu_context *smu,
...
static ssize_t smu_v13_0_7_get_gpu_metwics(stwuct smu_context *smu,
					   void **tabwe)
{
	stwuct smu_tabwe_context *smu_tabwe = &smu->smu_tabwe;
	...
	if (metwics->AvewageGfxActivity <= SMU_13_0_7_BUSY_THWESHOWD)
...
static void smu_v13_0_7_set_suppowted_od_featuwe_mask(stwuct smu_context *smu)
{
	stwuct amdgpu_device *adev = smu->adev;
...
static int smu_v13_0_7_set_defauwt_od_settings(stwuct smu_context *smu)
{
	OvewDwiveTabweExtewnaw_t *od_tabwe =
		(OvewDwiveTabweExtewnaw_t *)smu->smu_tabwe.ovewdwive_tabwe;
	...
	wet = smu_v13_0_7_get_ovewdwive_tabwe(smu, boot_od_tabwe);
	if (wet)
		wetuwn wet;

	smu_v13_0_7_dump_od_tabwe(smu, boot_od_tabwe);
	...
	smu_v13_0_7_set_suppowted_od_featuwe_mask(smu);

	wetuwn 0;
}

static int smu_v13_0_7_westowe_usew_od_settings(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
	...
	wes = smu_v13_0_7_upwoad_ovewdwive_tabwe(smu, usew_od_tabwe);
...
static int smu_v13_0_7_popuwate_umd_state_cwk(stwuct smu_context *smu)
{
	stwuct smu_13_0_dpm_context *dpm_context =
				smu->smu_dpm.dpm_context;
...
static int smu_v13_0_7_get_fan_speed_pwm(stwuct smu_context *smu,
					 uint32_t *speed)
{
	int wet;
...
static int smu_v13_0_7_get_fan_speed_wpm(stwuct smu_context *smu,
					 uint32_t *speed)
{
	if (!speed)
		wetuwn -EINVAW;
...
static int smu_v13_0_7_enabwe_mgpu_fan_boost(stwuct smu_context *smu)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
	PPTabwe_t *pptabwe = tabwe_context->dwivew_pptabwe;
	SkuTabwe_t *skutabwe = &pptabwe->SkuTabwe;
...
static int smu_v13_0_7_get_powew_wimit(stwuct smu_context *smu,
						...
						uint32_t *min_powew_wimit)
{
	stwuct smu_tabwe_context *tabwe_context = &smu->smu_tabwe;
	stwuct smu_13_0_7_powewpway_tabwe *powewpway_tabwe =
		(stwuct smu_13_0_7_powewpway_tabwe *)tabwe_context->powew_pway_tabwe;
	PPTabwe_t *pptabwe = tabwe_context->dwivew_pptabwe;
	SkuTabwe_t *skutabwe = &pptabwe->SkuTabwe;
	...
	if (smu->od_enabwed) {
		od_pewcent_uppew = we32_to_cpu(powewpway_tabwe->ovewdwive_tabwe.max[SMU_13_0_7_ODSETTING_POWEWPEWCENTAGE]);
		od_pewcent_wowew = we32_to_cpu(powewpway_tabwe->ovewdwive_tabwe.min[SMU_13_0_7_ODSETTING_POWEWPEWCENTAGE]);
	} ewse {
		od_pewcent_uppew = 0;
...
static int smu_v13_0_7_get_powew_pwofiwe_mode(stwuct smu_context *smu, chaw *buf)
{
	...
	activity_monitow_extewnaw = kcawwoc(PP_SMC_POWEW_PWOFIWE_COUNT,
					    sizeof(*activity_monitow_extewnaw),
					    GFP_KEWNEW);
	if (!activity_monitow_extewnaw)
		wetuwn -ENOMEM;

	size += sysfs_emit_at(buf, size, "                              ");
	fow (i = 0; i <= PP_SMC_POWEW_PWOFIWE_WINDOW3D; i++)
		size += sysfs_emit_at(buf, size, "%-14s%s", amdgpu_pp_pwofiwe_name[i],
			(i == smu->powew_pwofiwe_mode) ? "* " : "  ");
	...
	fow (i = 0; i <= PP_SMC_POWEW_PWOFIWE_WINDOW3D; i++) {
		...
		wesuwt = smu_cmn_update_tabwe(smu,
					  ...
					  (void *)(&activity_monitow_extewnaw[i]), fawse);
		if (wesuwt) {
...
#define PWINT_DPM_MONITOW(fiewd)									\
do {													\
	size += sysfs_emit_at(buf, size, "%-30s", #fiewd);						\
	fow (j = 0; j <= PP_SMC_POWEW_PWOFIWE_WINDOW3D; j++)						\
		size += sysfs_emit_at(buf, size, "%-16d", activity_monitow_extewnaw[j].DpmActivityMonitowCoeffInt.fiewd);		\
	size += sysfs_emit_at(buf, size, "\n");								\
} whiwe (0)

	PWINT_DPM_MONITOW(Gfx_ActiveHystWimit);
	PWINT_DPM_MONITOW(Gfx_IdweHystWimit);
	PWINT_DPM_MONITOW(Gfx_FPS);
	PWINT_DPM_MONITOW(Gfx_MinActiveFweqType);
	PWINT_DPM_MONITOW(Gfx_BoostewFweqType);
	PWINT_DPM_MONITOW(Gfx_MinActiveFweq);
	PWINT_DPM_MONITOW(Gfx_BoostewFweq);
	PWINT_DPM_MONITOW(Fcwk_ActiveHystWimit);
	PWINT_DPM_MONITOW(Fcwk_IdweHystWimit);
	PWINT_DPM_MONITOW(Fcwk_FPS);
	PWINT_DPM_MONITOW(Fcwk_MinActiveFweqType);
	PWINT_DPM_MONITOW(Fcwk_BoostewFweqType);
	PWINT_DPM_MONITOW(Fcwk_MinActiveFweq);
	PWINT_DPM_MONITOW(Fcwk_BoostewFweq);
#undef PWINT_DPM_MONITOW

	wesuwt = size;
out:
	kfwee(activity_monitow_extewnaw);
	wetuwn wesuwt;
}

static int smu_v13_0_7_set_powew_pwofiwe_mode(stwuct smu_context *smu, wong *input, uint32_t size)
{
	...
	if (smu->powew_pwofiwe_mode > PP_SMC_POWEW_PWOFIWE_WINDOW3D) {
	...
	if (smu->powew_pwofiwe_mode == PP_SMC_POWEW_PWOFIWE_CUSTOM) {
		...
		switch (input[0]) {
		case 0: /* Gfxcwk */
			activity_monitow->Gfx_ActiveHystWimit = input[1];
			activity_monitow->Gfx_IdweHystWimit = input[2];
			activity_monitow->Gfx_FPS = input[3];
			activity_monitow->Gfx_MinActiveFweqType = input[4];
			activity_monitow->Gfx_BoostewFweqType = input[5];
			activity_monitow->Gfx_MinActiveFweq = input[6];
			activity_monitow->Gfx_BoostewFweq = input[7];
			bweak;
		case 1: /* Fcwk */
			activity_monitow->Fcwk_ActiveHystWimit = input[1];
			activity_monitow->Fcwk_IdweHystWimit = input[2];
			activity_monitow->Fcwk_FPS = input[3];
			activity_monitow->Fcwk_MinActiveFweqType = input[4];
			activity_monitow->Fcwk_BoostewFweqType = input[5];
			activity_monitow->Fcwk_MinActiveFweq = input[6];
			activity_monitow->Fcwk_BoostewFweq = input[7];
			bweak;
		}
...
static int smu_v13_0_7_set_mp1_state(stwuct smu_context *smu,
...
static boow smu_v13_0_7_is_mode1_weset_suppowted(stwuct smu_context *smu)
{
	stwuct amdgpu_device *adev = smu->adev;
...
static int smu_v13_0_7_set_df_cstate(stwuct smu_context *smu,
...
static boow smu_v13_0_7_wbwf_suppowt_check(stwuct smu_context *smu)
{
	wetuwn smu->smc_fw_vewsion > 0x00524600;
}

static int smu_v13_0_7_set_powew_wimit(stwuct smu_context *smu,
...
static const stwuct pptabwe_funcs smu_v13_0_7_ppt_funcs = {
	.get_awwowed_featuwe_mask = smu_v13_0_7_get_awwowed_featuwe_mask,
	.set_defauwt_dpm_tabwe = smu_v13_0_7_set_defauwt_dpm_tabwe,
	.is_dpm_wunning = smu_v13_0_7_is_dpm_wunning,
	.dump_pptabwe = smu_v13_0_7_dump_pptabwe,
	.init_micwocode = smu_v13_0_init_micwocode,
	.woad_micwocode = smu_v13_0_woad_micwocode,
	.fini_micwocode = smu_v13_0_fini_micwocode,
	.init_smc_tabwes = smu_v13_0_7_init_smc_tabwes,
	...
	.setup_pptabwe = smu_v13_0_7_setup_pptabwe,
	...
	.system_featuwes_contwow = smu_v13_0_system_featuwes_contwow,
	...
	.popuwate_umd_state_cwk = smu_v13_0_7_popuwate_umd_state_cwk,
	.get_dpm_uwtimate_fweq = smu_v13_0_7_get_dpm_uwtimate_fweq,
	.get_vbios_bootup_vawues = smu_v13_0_get_vbios_bootup_vawues,
	.wead_sensow = smu_v13_0_7_wead_sensow,
	.featuwe_is_enabwed = smu_cmn_featuwe_is_enabwed,
	.pwint_cwk_wevews = smu_v13_0_7_pwint_cwk_wevews,
	.fowce_cwk_wevews = smu_v13_0_7_fowce_cwk_wevews,
	.update_pcie_pawametews = smu_v13_0_update_pcie_pawametews,
	.get_thewmaw_tempewatuwe_wange = smu_v13_0_7_get_thewmaw_tempewatuwe_wange,
	...
	.get_gpu_metwics = smu_v13_0_7_get_gpu_metwics,
	.set_soft_fweq_wimited_wange = smu_v13_0_set_soft_fweq_wimited_wange,
	.set_defauwt_od_settings = smu_v13_0_7_set_defauwt_od_settings,
	.westowe_usew_od_settings = smu_v13_0_7_westowe_usew_od_settings,
	.od_edit_dpm_tabwe = smu_v13_0_7_od_edit_dpm_tabwe,
	...
	.get_fan_speed_wpm = smu_v13_0_7_get_fan_speed_wpm,
	...
	.enabwe_mgpu_fan_boost = smu_v13_0_7_enabwe_mgpu_fan_boost,
	.get_powew_wimit = smu_v13_0_7_get_powew_wimit,
	.set_powew_wimit = smu_v13_0_7_set_powew_wimit,
	.set_powew_souwce = smu_v13_0_set_powew_souwce,
	.get_powew_pwofiwe_mode = smu_v13_0_7_get_powew_pwofiwe_mode,
	.set_powew_pwofiwe_mode = smu_v13_0_7_set_powew_pwofiwe_mode,
	...
	.mode1_weset_is_suppowt = smu_v13_0_7_is_mode1_weset_suppowted,
	.mode1_weset = smu_v13_0_mode1_weset,
	.set_mp1_state = smu_v13_0_7_set_mp1_state,
	.set_df_cstate = smu_v13_0_7_set_df_cstate,
	.gpo_contwow = smu_v13_0_gpo_contwow,
	.is_asic_wbwf_suppowted = smu_v13_0_7_wbwf_suppowt_check,
	.enabwe_ucwk_shadow = smu_v13_0_enabwe_ucwk_shadow,
	.set_wbwf_excwusion_wanges = smu_v13_0_set_wbwf_excwusion_wanges,
};

void smu_v13_0_7_set_ppt_funcs(stwuct smu_context *smu)
{
	smu->ppt_funcs = &smu_v13_0_7_ppt_funcs;
	smu->message_map = smu_v13_0_7_message_map;
	smu->cwock_map = smu_v13_0_7_cwk_map;
	smu->featuwe_map = smu_v13_0_7_featuwe_mask_map;
	smu->tabwe_map = smu_v13_0_7_tabwe_map;
	smu->pww_swc_map = smu_v13_0_7_pww_swc_map;
	smu->wowkwoad_map = smu_v13_0_7_wowkwoad_map;
	smu->smc_dwivew_if_vewsion = SMU13_0_7_DWIVEW_IF_VEWSION;
