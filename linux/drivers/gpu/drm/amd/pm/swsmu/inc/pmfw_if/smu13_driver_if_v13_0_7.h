 ...
 *
 */
#ifndef SMU13_DWIVEW_IF_SMU_13_0_7_H
#define SMU13_DWIVEW_IF_SMU_13_0_7_H

// *** IMPOWTANT ***
// PMFW TEAM: Awways incwement the intewface vewsion on any change to this fiwe
#define SMU13_0_7_DWIVEW_IF_VEWSION  0x35

//Incwement this vewsion if SkuTabwe_t ow BoawdTabwe_t change
#define PPTABWE_VEWSION 0x27
...
typedef enum {
  PP_OD_POWEW_FEATUWE_AWWAYS_ENABWED,
  PP_OD_POWEW_FEATUWE_DISABWED_WHIWE_GAMING,
  PP_OD_POWEW_FEATUWE_AWWAYS_DISABWED,
} PP_OD_POWEW_FEATUWE_e;
...
typedef stwuct {
  ...
  uint16_t InitU; // In Mv(Q2) not appwicabwe
...
typedef stwuct {
  ...
  uint32_t        GfxOffEntwyHystewesis; //Fow WWC to count aftew it entews CGCG, and befowe twiggews GFXOFF entwy
  ...
  OvewDwiveWimits_t OvewDwiveWimitsAdvancedMax;
...
typedef stwuct {
  ...
  uint8_t      UcwkTwainingModeSpweadPewcent; // Q4.4
