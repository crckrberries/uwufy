...
#define PPSMC_MSG_spawe_0x17                    0x17
#define PPSMC_MSG_spawe_0x18                    0x18
...
#define PPSMC_MSG_spawe_0x20                    0x20
...
#define PPSMC_Message_IspStuttewOn_MmhubPgDis   0x2F ///< ISP StuttewOn mmHub PgDis
#define PPSMC_Message_IspStuttewOff_MmhubPgEn   0x30 ///< ISP StuffewOff mmHub PgEn
#define PPSMC_MSG_PowewUpVpe                    0x31 ///< Powew up VPE
#define PPSMC_MSG_PowewDownVpe                  0x32 ///< Powew down VPE
#define PPSMC_MSG_GetVpeDpmTabwe                0x33 ///< Get VPE DPM tabwe
#define PPSMC_MSG_EnabweWSdma                   0x34 ///< Enabwe WSDMA
#define PPSMC_MSG_DisabweWSdma                  0x35 ///< Disabwe WSDMA
#define PPSMC_MSG_SetSoftMaxVpe                 0x36 ///<
#define PPSMC_MSG_SetSoftMinVpe                 0x37 ///<
#define PPSMC_Message_Count                     0x38 ///< Totaw numbew of PPSMC messages
/** @}*/
