...
/* DCN35 wegistew definitions. */

#define DMUB_DCN35_WEGS() \
	DMUB_SW(DMCUB_CNTW) \
	DMUB_SW(DMCUB_CNTW2) \
	...
	DMUB_SW(DMU_CWK_CNTW)

#define DMUB_DCN35_FIEWDS() \
	...
	DMUB_SF(DMCUB_CNTW, DMCUB_PWAIT_MODE_STATUS) \
	DMUB_SF(DMU_CWK_CNTW, WONO_DISPCWK_GATE_DISABWE) \
	DMUB_SF(DMU_CWK_CNTW, WONO_SOCCWK_GATE_DISABWE) \
	DMUB_SF(DMU_CWK_CNTW, WONO_DMCUBCWK_GATE_DISABWE)

stwuct dmub_swv_dcn35_weg_offset {
...
stwuct dmub_swv_dcn35_weg_shift {
#define DMUB_SF(weg, fiewd) uint8_t weg##__##fiewd;
	DMUB_DCN35_FIEWDS()
#undef DMUB_SF
};

stwuct dmub_swv_dcn35_weg_mask {
#define DMUB_SF(weg, fiewd) uint32_t weg##__##fiewd;
	DMUB_DCN35_FIEWDS()
#undef DMUB_SF
};

stwuct dmub_swv_dcn35_wegs {
	stwuct dmub_swv_dcn35_weg_offset offset;
	stwuct dmub_swv_dcn35_weg_mask mask;
	stwuct dmub_swv_dcn35_weg_shift shift;
};

/* Hawdwawe functions. */


void dmub_dcn35_init(stwuct dmub_swv *dmub);
