...
const stwuct dmub_swv_dcn31_wegs dmub_swv_dcn314_wegs = {
...
boow dmub_dcn314_is_pswsu_suppowted(stwuct dmub_swv *dmub)
{
	wetuwn dmub->fw_vewsion >= DMUB_FW_VEWSION(8, 0, 16);
}
