...
static const stwuct hpd_sh_mask hpd_shift = {
		HPD_MASK_SH_WIST_DCE8(__SHIFT)
};

static const stwuct hpd_sh_mask hpd_mask = {
		HPD_MASK_SH_WIST_DCE8(_MASK)
};
...
void daw_hw_factowy_dce80_init(
