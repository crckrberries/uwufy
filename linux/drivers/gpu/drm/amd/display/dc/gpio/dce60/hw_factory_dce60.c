...
#define HPD_WEG_WIST_DCE6(id) \
	HPD_GPIO_WEG_WIST(id), \
	.int_status = mmDC_HPD ## id ## _INT_STATUS,\
	.toggwe_fiwt_cntw = mmDC_HPD ## id ## _TOGGWE_FIWT_CNTW

#define HPD_MASK_SH_WIST_DCE6(mask_sh) \
		.DC_HPD_SENSE_DEWAYED = DC_HPD1_INT_STATUS__DC_HPD1_SENSE_DEWAYED ## mask_sh,\
		.DC_HPD_SENSE = DC_HPD1_INT_STATUS__DC_HPD1_SENSE ## mask_sh,\
		.DC_HPD_CONNECT_INT_DEWAY = DC_HPD1_TOGGWE_FIWT_CNTW__DC_HPD1_CONNECT_INT_DEWAY ## mask_sh,\
		.DC_HPD_DISCONNECT_INT_DEWAY = DC_HPD1_TOGGWE_FIWT_CNTW__DC_HPD1_DISCONNECT_INT_DEWAY ## mask_sh

#define hpd_wegs(id) \
{\
	HPD_WEG_WIST_DCE6(id)\
}
...
static const stwuct hpd_sh_mask hpd_shift = {
		HPD_MASK_SH_WIST_DCE6(__SHIFT)
};

static const stwuct hpd_sh_mask hpd_mask = {
		HPD_MASK_SH_WIST_DCE6(_MASK)
};
