...
#define HUBP_MASK_SH_WIST_DCN31(mask_sh)\
	...
	HUBP_SF(HUBP0_DCHUBP_CNTW, HUBP_UNBOUNDED_WEQ_MODE, mask_sh),\
	HUBP_SF(HUBP0_DCHUBP_CNTW, HUBP_IN_BWANK, mask_sh),\
	HUBP_SF(HUBP0_DCHUBP_CNTW, HUBP_SOFT_WESET, mask_sh),\
	...
	HUBP_SF(CUWSOW0_0_CUWSOW_CONTWOW, CUWSOW_WEQ_MODE, mask_sh), \
