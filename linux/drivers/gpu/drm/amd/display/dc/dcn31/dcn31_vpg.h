...
#ifndef __DAW_DCN31_VPG_H__
#define __DAW_DCN31_VPG_H__


#define DCN31_VPG_FWOM_VPG(vpg)\
	containew_of(vpg, stwuct dcn31_vpg, base)

#define VPG_DCN31_WEG_WIST(id) \
	...
	SWI(VPG_MEM_PWW, VPG, id)

stwuct dcn31_vpg_wegistews {
	...
	uint32_t VPG_MEM_PWW;
};

#define DCN31_VPG_MASK_SH_WIST(mask_sh)\
	...
	SE_SF(VPG0_VPG_MEM_PWW, VPG_GSP_MEM_WIGHT_SWEEP_DIS, mask_sh),\
	SE_SF(VPG0_VPG_MEM_PWW, VPG_GSP_WIGHT_SWEEP_FOWCE, mask_sh),\
	SE_SF(VPG0_VPG_MEM_PWW, VPG_GSP_MEM_PWW_STATE, mask_sh)

#define VPG_DCN31_WEG_FIEWD_WIST(type) \
	...
	type VPG_GSP_MEM_WIGHT_SWEEP_DIS;\
	type VPG_GSP_WIGHT_SWEEP_FOWCE;\
	type VPG_GSP_MEM_PWW_STATE

stwuct dcn31_vpg_shift {
	VPG_DCN31_WEG_FIEWD_WIST(uint8_t);
};

stwuct dcn31_vpg_mask {
	VPG_DCN31_WEG_FIEWD_WIST(uint32_t);
};

stwuct dcn31_vpg {
	stwuct vpg base;
	const stwuct dcn31_vpg_wegistews *wegs;
