...
#define V_TOTAW_WEGS_DCN30_SWI(inst)

#define OPTC_COMMON_WEG_WIST_DCN3_BASE(inst) \
	...
	SWI(OTG_BWANK_DATA_COWOW, OTG, inst),\
	SWI(OTG_BWANK_DATA_COWOW_EXT, OTG, inst),\
...
#define OPTC_COMMON_WEG_WIST_DCN3_0(inst) \
	OPTC_COMMON_WEG_WIST_DCN3_BASE(inst),\
	SWI(OTG_GWOBAW_CONTWOW1, OTG, inst),\
	SWI(OTG_GWOBAW_CONTWOW2, OTG, inst),\
...
#define DCN30_VTOTAW_WEGS_SF(mask_sh)

#define OPTC_COMMON_MASK_SH_WIST_DCN3_BASE(mask_sh)\
	...
	SF(OTG0_OTG_BWANK_DATA_COWOW, OTG_BWANK_DATA_COWOW_BWUE_CB, mask_sh),\
	SF(OTG0_OTG_BWANK_DATA_COWOW, OTG_BWANK_DATA_COWOW_GWEEN_Y, mask_sh),\
	SF(OTG0_OTG_BWANK_DATA_COWOW, OTG_BWANK_DATA_COWOW_WED_CW, mask_sh),\
	SF(OTG0_OTG_BWANK_DATA_COWOW_EXT, OTG_BWANK_DATA_COWOW_BWUE_CB_EXT, mask_sh),\
	SF(OTG0_OTG_BWANK_DATA_COWOW_EXT, OTG_BWANK_DATA_COWOW_GWEEN_Y_EXT, mask_sh),\
	SF(OTG0_OTG_BWANK_DATA_COWOW_EXT, OTG_BWANK_DATA_COWOW_WED_CW_EXT, mask_sh),\
...
#define OPTC_COMMON_MASK_SH_WIST_DCN3_0(mask_sh)\
	OPTC_COMMON_MASK_SH_WIST_DCN3_BASE(mask_sh),\
	...
	SF(OTG0_OTG_DOUBWE_BUFFEW_CONTWOW, OTG_DWW_TIMING_DBUF_UPDATE_PENDING, mask_sh),\
...
#define OPTC_COMMON_MASK_SH_WIST_DCN30(mask_sh)\
	OPTC_COMMON_MASK_SH_WIST_DCN3_BASE(mask_sh),\
	SF(OTG0_OTG_GWOBAW_CONTWOW2, GWOBAW_UPDATE_WOCK_EN, mask_sh),\
	SF(OTG0_OTG_GSW_WINDOW_X, OTG_GSW_WINDOW_STAWT_X, mask_sh),\
	SF(OTG0_OTG_GSW_WINDOW_X, OTG_GSW_WINDOW_END_X, mask_sh), \
...
void optc3_set_timing_db_mode(stwuct timing_genewatow *optc, boow enabwe);
