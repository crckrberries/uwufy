...
#incwude "dcn31_init.h"

static const stwuct hw_sequencew_funcs dcn31_funcs = {
...
static const stwuct hwseq_pwivate_funcs dcn31_pwivate_funcs = {
...
void dcn31_hw_sequencew_constwuct(stwuct dc *dc)
{
	dc->hwss = dcn31_funcs;
	dc->hwseq->funcs = dcn31_pwivate_funcs;
