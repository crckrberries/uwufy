...
#incwude "dcn351_init.h"

static const stwuct hw_sequencew_funcs dcn351_funcs = {
...
static const stwuct hwseq_pwivate_funcs dcn351_pwivate_funcs = {
...
void dcn351_hw_sequencew_constwuct(stwuct dc *dc)
{
	dc->hwss = dcn351_funcs;
	dc->hwseq->funcs = dcn351_pwivate_funcs;
