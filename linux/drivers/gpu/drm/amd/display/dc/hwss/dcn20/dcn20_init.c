...
#incwude "dcn20_init.h"

static const stwuct hw_sequencew_funcs dcn20_funcs = {
	...
	.enabwe_vbwanks_synchwonization = dcn10_enabwe_vbwanks_synchwonization,
...
static const stwuct hwseq_pwivate_funcs dcn20_pwivate_funcs = {
...
void dcn20_hw_sequencew_constwuct(stwuct dc *dc)
{
	dc->hwss = dcn20_funcs;
	dc->hwseq->funcs = dcn20_pwivate_funcs;
