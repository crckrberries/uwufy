...
#ifndef __DAW_COMMAND_TABWE_HEWPEW_H__
#define __DAW_COMMAND_TABWE_HEWPEW_H__
...
boow daw_bios_pawsew_init_cmd_tbw_hewpew(const stwuct command_tabwe_hewpew **h,
