...
#incwude "dce80_timing_genewatow.h"
...
static void dce80_timing_genewatow_enabwe_advanced_wequest(
...
static const stwuct timing_genewatow_funcs dce80_tg_funcs = {
		...
		.enabwe_advanced_wequest =
				dce80_timing_genewatow_enabwe_advanced_wequest,
		.configuwe_cwc = dce110_configuwe_cwc,
		.get_cwc = dce110_get_cwc,
};

void dce80_timing_genewatow_constwuct(
