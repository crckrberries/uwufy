...
#ifndef _DCE_CWK_MGW_H_
#define _DCE_CWK_MGW_H_

#incwude "dc.h"

/* functions shawed by othew dce cwk mgws */
...
void dce_cwk_mgw_constwuct(
		...
		stwuct cwk_mgw_intewnaw *cwk_mgw_dce);

void dce_cwock_wead_ss_info(stwuct cwk_mgw_intewnaw *dccg_dce);

int dce12_get_dp_wef_fweq_khz(stwuct cwk_mgw *dccg);
