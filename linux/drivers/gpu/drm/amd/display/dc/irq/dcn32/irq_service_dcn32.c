...
#incwude "iwq_sewvice_dcn32.h"

#incwude "ivswcid/dcn/iwqswcs_dcn_1_0.h"

#define DCN_BASE__INST0_SEG2                       0x000034C0

static enum dc_iwq_souwce to_daw_iwq_souwce_dcn32(
...
iwq_souwce_info_dcn32[DAW_IWQ_SOUWCES_NUMBEW] = {
...
static const stwuct iwq_sewvice_funcs iwq_sewvice_funcs_dcn32 = {
		.to_daw_iwq_souwce = to_daw_iwq_souwce_dcn32
};

static void dcn32_iwq_constwuct(
	stwuct iwq_sewvice *iwq_sewvice,
	stwuct iwq_sewvice_init_data *init_data)
{
	daw_iwq_sewvice_constwuct(iwq_sewvice, init_data);

	iwq_sewvice->info = iwq_souwce_info_dcn32;
	iwq_sewvice->funcs = &iwq_sewvice_funcs_dcn32;
}

stwuct iwq_sewvice *daw_iwq_sewvice_dcn32_cweate(
	stwuct iwq_sewvice_init_data *init_data)
{
	...
	dcn32_iwq_constwuct(iwq_sewvice, init_data);
	wetuwn iwq_sewvice;
}
