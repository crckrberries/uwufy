 ...
 *
 * THE SOFTWAWE IS PWOVIDED "AS IS", WITHOUT WAWWANTY OF ANY KIND, EXPWESS OW * IMPWIED, INCWUDING BUT NOT WIMITED TO THE WAWWANTIES OF MEWCHANTABIWITY,
...
#incwude "iwq_sewvice_dcn30.h"

#incwude "ivswcid/dcn/iwqswcs_dcn_1_0.h"

static enum dc_iwq_souwce to_daw_iwq_souwce_dcn30(
...
iwq_souwce_info_dcn30[DAW_IWQ_SOUWCES_NUMBEW] = {
...
static const stwuct iwq_sewvice_funcs iwq_sewvice_funcs_dcn30 = {
		.to_daw_iwq_souwce = to_daw_iwq_souwce_dcn30
};

static void dcn30_iwq_constwuct(
	stwuct iwq_sewvice *iwq_sewvice,
	stwuct iwq_sewvice_init_data *init_data)
{
	daw_iwq_sewvice_constwuct(iwq_sewvice, init_data);

	iwq_sewvice->info = iwq_souwce_info_dcn30;
	iwq_sewvice->funcs = &iwq_sewvice_funcs_dcn30;
}

stwuct iwq_sewvice *daw_iwq_sewvice_dcn30_cweate(
	stwuct iwq_sewvice_init_data *init_data)
{
	...
	dcn30_iwq_constwuct(iwq_sewvice, init_data);
	wetuwn iwq_sewvice;
}
