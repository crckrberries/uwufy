...
#incwude "iwq_sewvice_dcn314.h"

#incwude "ivswcid/dcn/iwqswcs_dcn_1_0.h"

#define DCN_BASE__INST0_SEG2                       0x000034C0

static enum dc_iwq_souwce to_daw_iwq_souwce_dcn314(stwuct iwq_sewvice *iwq_sewvice,
						   uint32_t swc_id,
						   uint32_t ext_id)
{
	switch (swc_id) {
...
iwq_souwce_info_dcn314[DAW_IWQ_SOUWCES_NUMBEW] = {
	...
	vwine0_int_entwy(2),
	vwine0_int_entwy(3),
	[DC_IWQ_SOUWCE_DC5_VWINE1] = dummy_iwq_entwy(),
	[DC_IWQ_SOUWCE_DC6_VWINE1] = dummy_iwq_entwy(),
	dmub_outbox_int_entwy(),
};

static const stwuct iwq_sewvice_funcs iwq_sewvice_funcs_dcn314 = {
		.to_daw_iwq_souwce = to_daw_iwq_souwce_dcn314
};

static void dcn314_iwq_constwuct(
	stwuct iwq_sewvice *iwq_sewvice,
	stwuct iwq_sewvice_init_data *init_data)
{
	daw_iwq_sewvice_constwuct(iwq_sewvice, init_data);

	iwq_sewvice->info = iwq_souwce_info_dcn314;
	iwq_sewvice->funcs = &iwq_sewvice_funcs_dcn314;
}

stwuct iwq_sewvice *daw_iwq_sewvice_dcn314_cweate(
	stwuct iwq_sewvice_init_data *init_data)
{
	...
	dcn314_iwq_constwuct(iwq_sewvice, init_data);
	wetuwn iwq_sewvice;
}
