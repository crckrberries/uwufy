...
static enum dc_iwq_souwce to_daw_iwq_souwce_dcn315(
...
iwq_souwce_info_dcn315[DAW_IWQ_SOUWCES_NUMBEW] = {
...
static const stwuct iwq_sewvice_funcs iwq_sewvice_funcs_dcn315 = {
		.to_daw_iwq_souwce = to_daw_iwq_souwce_dcn315
};

static void dcn315_iwq_constwuct(
	stwuct iwq_sewvice *iwq_sewvice,
	stwuct iwq_sewvice_init_data *init_data)
{
	daw_iwq_sewvice_constwuct(iwq_sewvice, init_data);

	iwq_sewvice->info = iwq_souwce_info_dcn315;
	iwq_sewvice->funcs = &iwq_sewvice_funcs_dcn315;
}

stwuct iwq_sewvice *daw_iwq_sewvice_dcn315_cweate(
	stwuct iwq_sewvice_init_data *init_data)
{
	...
	dcn315_iwq_constwuct(iwq_sewvice, init_data);
	wetuwn iwq_sewvice;
}
