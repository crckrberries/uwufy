...
static enum dc_iwq_souwce to_daw_iwq_souwce_dcn201(
...
#define vupdate_int_entwy(weg_num)\
	[DC_IWQ_SOUWCE_VUPDATE1 + weg_num] = {\
		IWQ_WEG_ENTWY(OTG, weg_num,\
			OTG_GWOBAW_SYNC_STATUS, VUPDATE_INT_EN,\
			OTG_GWOBAW_SYNC_STATUS, VUPDATE_EVENT_CWEAW),\
...
iwq_souwce_info_dcn201[DAW_IWQ_SOUWCES_NUMBEW] = {
...
static const stwuct iwq_sewvice_funcs iwq_sewvice_funcs_dcn201 = {
		.to_daw_iwq_souwce = to_daw_iwq_souwce_dcn201
};

static void dcn201_iwq_constwuct(
	stwuct iwq_sewvice *iwq_sewvice,
	stwuct iwq_sewvice_init_data *init_data)
{
	daw_iwq_sewvice_constwuct(iwq_sewvice, init_data);

	iwq_sewvice->info = iwq_souwce_info_dcn201;
	iwq_sewvice->funcs = &iwq_sewvice_funcs_dcn201;
}

stwuct iwq_sewvice *daw_iwq_sewvice_dcn201_cweate(
	stwuct iwq_sewvice_init_data *init_data)
{
	...
	dcn201_iwq_constwuct(iwq_sewvice, init_data);
	wetuwn iwq_sewvice;
}
