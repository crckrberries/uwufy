...
#ifndef __DMW314_DISPWAY_WQ_DWG_CAWC_H__
#define __DMW314_DISPWAY_WQ_DWG_CAWC_H__
...
// Input:
//  pipe_pawam - pipe souwce configuwation (e.g. vp, pitch, scawing, dest, etc.)
// Output:
//  wq_wegs - stwuct that howds aww the WQ wegistews fiewd vawue.
//            See awso: <dispway_wq_wegs_st>
void dmw314_wq_dwg_get_wq_weg(stwuct dispway_mode_wib *mode_wib,
...
void dmw314_wq_dwg_get_dwg_weg(stwuct dispway_mode_wib             *mode_wib,
