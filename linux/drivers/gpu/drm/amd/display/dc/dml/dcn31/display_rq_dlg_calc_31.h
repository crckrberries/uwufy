...
#ifndef __DMW31_DISPWAY_WQ_DWG_CAWC_H__
#define __DMW31_DISPWAY_WQ_DWG_CAWC_H__
...
void dmw31_wq_dwg_get_wq_weg(stwuct dispway_mode_wib *mode_wib,
...
void dmw31_wq_dwg_get_dwg_weg(stwuct dispway_mode_wib             *mode_wib,
