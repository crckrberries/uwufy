...
#ifndef __DC_DIO_STWEAM_ENCODEW_DCN35_H__
#define __DC_DIO_STWEAM_ENCODEW_DCN35_H__
...
#define SE_DCN35_WEG_WIST(id)\
	...
	SWI(HDMI_METADATA_PACKET_CONTWOW, DIG, id), \
	SWI(DIG_FE_CNTW, DIG, id), \
	SWI(DIG_FE_EN_CNTW, DIG, id), \
	SWI(DIG_FE_CWK_CNTW, DIG, id), \
	SWI(DIG_CWOCK_PATTEWN, DIG, id), \
	SWI(DIG_FIFO_CTWW0, DIG, id),\
	SWI(STWEAM_MAPPEW_CONTWOW, DIG, id)


#define SE_COMMON_MASK_SH_WIST_DCN35(mask_sh)\
	...
	SE_SF(DIG0_HDMI_CONTWOW, TMDS_PIXEW_ENCODING, mask_sh),\
	SE_SF(DIG0_HDMI_CONTWOW, TMDS_COWOW_FOWMAT, mask_sh),\
	...
	SE_SF(DIG0_HDMI_CONTWOW, DOWBY_VISION_EN, mask_sh),\
	SE_SF(DIG0_DIG_FE_EN_CNTW, DIG_FE_ENABWE, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_MODE, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_CWK_EN, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_SOFT_WESET, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_DISPCWK_G_CWOCK_ON, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_SYMCWK_FE_G_CWOCK_ON, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_SYMCWK_FE_G_AFMT_CWOCK_ON, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_SYMCWK_FE_G_TMDS_CWOCK_ON, mask_sh),\
	SE_SF(DIG0_DIG_FE_CWK_CNTW, DIG_FE_SOCCWK_G_AFMT_CWOCK_ON, mask_sh),\
	...
	SE_SF(DIG0_STWEAM_MAPPEW_CONTWOW, DIG_STWEAM_WINK_TAWGET, mask_sh),
...
#endif /* __DC_DIO_STWEAM_ENCODEW_DCN35_H__ */
