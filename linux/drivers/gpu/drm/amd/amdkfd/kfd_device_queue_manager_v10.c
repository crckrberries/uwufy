...
static int update_qpd_v10(stwuct device_queue_managew *dqm,
			 stwuct qcm_pwocess_device *qpd);
static void init_sdma_vm_v10(stwuct device_queue_managew *dqm, stwuct queue *q,
			    stwuct qcm_pwocess_device *qpd);
	...
	stwuct device_queue_managew_asic_ops *asic_ops)
{
	...
	asic_ops->mqd_managew_init = mqd_managew_init_v10;
}
