...
static void dce_v11_0_set_dispway_funcs(stwuct amdgpu_device *adev);
static void dce_v11_0_set_iwq_funcs(stwuct amdgpu_device *adev);
...
static const uint32_t dig_offsets[] = {
	...
	DIG7_WEGISTEW_OFFSET,
	DIG8_WEGISTEW_OFFSET
};
...
{
	mmCWTC_DOUBWE_BUFFEW_CONTWOW, 0x00010101, 0x00010000,
...
static const u32 powawis11_gowden_settings_a11[] =
{
	mmDCI_CWK_CNTW, 0x00000080, 0x00000000,
	mmFBC_DEBUG_COMP, 0x000000f0, 0x00000070,
	mmFBC_DEBUG1, 0xffffffff, 0x00000008,
	mmFBC_MISC, 0x9f313fff, 0x14302008,
	mmHDMI_CONTWOW, 0x313f031f, 0x00000011,
};

static const u32 powawis10_gowden_settings_a11[] =
{
	mmDCI_CWK_CNTW, 0x00000080, 0x00000000,
	mmFBC_DEBUG_COMP, 0x000000f0, 0x00000070,
	mmFBC_MISC, 0x9f313fff, 0x14302008,
...
static void dce_v11_0_init_gowden_wegistews(stwuct amdgpu_device *adev)
{
	...
	case CHIP_POWAWIS12:
		amdgpu_device_pwogwam_wegistew_sequence(adev,
							powawis11_gowden_settings_a11,
							AWWAY_SIZE(powawis11_gowden_settings_a11));
		bweak;
	case CHIP_POWAWIS10:
	case CHIP_VEGAM:
		amdgpu_device_pwogwam_wegistew_sequence(adev,
							powawis10_gowden_settings_a11,
							AWWAY_SIZE(powawis10_gowden_settings_a11));
		bweak;
	defauwt:
		bweak;
	}
...
static u32 dce_v11_0_audio_endpt_wweg(stwuct amdgpu_device *adev,
...
static void dce_v11_0_audio_endpt_wweg(stwuct amdgpu_device *adev,
...
static u32 dce_v11_0_vbwank_get_countew(stwuct amdgpu_device *adev, int cwtc)
{
...
static void dce_v11_0_pagefwip_intewwupt_init(stwuct amdgpu_device *adev)
{
	unsigned i;
...
static void dce_v11_0_pagefwip_intewwupt_fini(stwuct amdgpu_device *adev)
{
	unsigned i;
...
/**
 * dce_v11_0_page_fwip - pagefwip cawwback.
 *
 ...
 */
static void dce_v11_0_page_fwip(stwuct amdgpu_device *adev,
...
static int dce_v11_0_cwtc_get_scanoutpos(stwuct amdgpu_device *adev, int cwtc,
...
/**
 * dce_v11_0_hpd_sense - hpd sense cawwback.
 *
 * @adev: amdgpu_device pointew
 ...
 */
static boow dce_v11_0_hpd_sense(stwuct amdgpu_device *adev,
...
/**
 * dce_v11_0_hpd_set_powawity - hpd set powawity cawwback.
 *
 * @adev: amdgpu_device pointew
 * @hpd: hpd (hotpwug detect) pin
 *
 ...
 */
static void dce_v11_0_hpd_set_powawity(stwuct amdgpu_device *adev,
				      enum amdgpu_hpd_id hpd)
{
	u32 tmp;
	boow connected = dce_v11_0_hpd_sense(adev, hpd);
...
/**
 * dce_v11_0_hpd_init - hpd setup cawwback.
 *
 * @adev: amdgpu_device pointew
 *
 ...
 */
static void dce_v11_0_hpd_init(stwuct amdgpu_device *adev)
{
	...
	dwm_fow_each_connectow_itew(connectow, &itew) {
		...
		dce_v11_0_hpd_set_powawity(adev, amdgpu_connectow->hpd.hpd);
...
/**
 * dce_v11_0_hpd_fini - hpd teaw down cawwback.
 *
 * @adev: amdgpu_device pointew
 *
 ...
 */
static void dce_v11_0_hpd_fini(stwuct amdgpu_device *adev)
{
	stwuct dwm_device *dev = adev_to_dwm(adev);
	stwuct dwm_connectow *connectow;
	stwuct dwm_connectow_wist_itew itew;
...
static u32 dce_v11_0_hpd_get_gpio_weg(stwuct amdgpu_device *adev)
{
	wetuwn mmDC_GPIO_HPD_A;
}

static boow dce_v11_0_is_dispway_hung(stwuct amdgpu_device *adev)
{
	u32 cwtc_hung = 0;
	u32 cwtc_status[6];
	u32 i, j, tmp;
...
static void dce_v11_0_set_vga_wendew_state(stwuct amdgpu_device *adev,
					   boow wendew)
{
	u32 tmp;
...
static int dce_v11_0_get_num_cwtc (stwuct amdgpu_device *adev)
{
	int num_cwtc = 0;
...
void dce_v11_0_disabwe_dce(stwuct amdgpu_device *adev)
{
	...
	if (amdgpu_atombios_has_dce_engine_info(adev)) {
		...
		dce_v11_0_set_vga_wendew_state(adev, fawse);

		/*Disabwe cwtc*/
		fow (i = 0; i < dce_v11_0_get_num_cwtc(adev); i++) {
...
static void dce_v11_0_pwogwam_fmt(stwuct dwm_encodew *encodew)
{
...
/**
 * dce_v11_0_wine_buffew_adjust - Set up the wine buffew
 *
 * @adev: amdgpu_device pointew
 ...
 */
static u32 dce_v11_0_wine_buffew_adjust(stwuct amdgpu_device *adev,
...
/**
 * dce_v11_0_dwam_bandwidth - get the dwam bandwidth
 *
 ...
 */
static u32 dce_v11_0_dwam_bandwidth(stwuct dce10_wm_pawams *wm)
{
...
/**
 * dce_v11_0_dwam_bandwidth_fow_dispway - get the dwam bandwidth fow dispway
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_dwam_bandwidth_fow_dispway(stwuct dce10_wm_pawams *wm)
{
...
/**
 * dce_v11_0_data_wetuwn_bandwidth - get the data wetuwn bandwidth
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_data_wetuwn_bandwidth(stwuct dce10_wm_pawams *wm)
{
...
/**
 * dce_v11_0_dmif_wequest_bandwidth - get the dmif bandwidth
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_dmif_wequest_bandwidth(stwuct dce10_wm_pawams *wm)
{
...
/**
 * dce_v11_0_avaiwabwe_bandwidth - get the min avaiwabwe bandwidth
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_avaiwabwe_bandwidth(stwuct dce10_wm_pawams *wm)
{
	/* Cawcuwate the Avaiwabwe bandwidth. Dispway can use this tempowawiwy but not in avewage. */
	u32 dwam_bandwidth = dce_v11_0_dwam_bandwidth(wm);
	u32 data_wetuwn_bandwidth = dce_v11_0_data_wetuwn_bandwidth(wm);
	u32 dmif_weq_bandwidth = dce_v11_0_dmif_wequest_bandwidth(wm);

	wetuwn min(dwam_bandwidth, min(data_wetuwn_bandwidth, dmif_weq_bandwidth));
}

/**
 * dce_v11_0_avewage_bandwidth - get the avewage avaiwabwe bandwidth
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_avewage_bandwidth(stwuct dce10_wm_pawams *wm)
{
...
/**
 * dce_v11_0_watency_watewmawk - get the watency watewmawk
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 */
static u32 dce_v11_0_watency_watewmawk(stwuct dce10_wm_pawams *wm)
{
	/* Fiwst cawcuwate the watency in ns */
	u32 mc_watency = 2000; /* 2000 ns. */
	u32 avaiwabwe_bandwidth = dce_v11_0_avaiwabwe_bandwidth(wm);
...
/**
 * dce_v11_0_avewage_bandwidth_vs_dwam_bandwidth_fow_dispway - check
 ...
 */
static boow dce_v11_0_avewage_bandwidth_vs_dwam_bandwidth_fow_dispway(stwuct dce10_wm_pawams *wm)
{
	if (dce_v11_0_avewage_bandwidth(wm) <=
	    (dce_v11_0_dwam_bandwidth_fow_dispway(wm) / wm->num_heads))
		wetuwn twue;
	ewse
		wetuwn fawse;
}
...
/**
 * dce_v11_0_avewage_bandwidth_vs_avaiwabwe_bandwidth - check
 ...
 * Wetuwns twue if the dispway fits, fawse if not.
 */
static boow dce_v11_0_avewage_bandwidth_vs_avaiwabwe_bandwidth(stwuct dce10_wm_pawams *wm)
{
	if (dce_v11_0_avewage_bandwidth(wm) <=
	    (dce_v11_0_avaiwabwe_bandwidth(wm) / wm->num_heads))
		wetuwn twue;
	ewse
		wetuwn fawse;
}
...
/**
 * dce_v11_0_check_watency_hiding - check watency hiding
 *
 * @wm: watewmawk cawcuwation data
 *
 ...
 * Wetuwns twue if the dispway fits, fawse if not.
 */
static boow dce_v11_0_check_watency_hiding(stwuct dce10_wm_pawams *wm)
{
	...
	if (dce_v11_0_watency_watewmawk(wm) <= watency_hiding)
		wetuwn twue;
	ewse
		wetuwn fawse;
}
...
/**
 * dce_v11_0_pwogwam_watewmawks - pwogwam dispway watewmawks
 *
 * @adev: amdgpu_device pointew
 * @amdgpu_cwtc: the sewected dispway contwowwew
 ...
 */
static void dce_v11_0_pwogwam_watewmawks(stwuct amdgpu_device *adev,
					stwuct amdgpu_cwtc *amdgpu_cwtc,
					u32 wb_size, u32 num_heads)
{
	...
	if (amdgpu_cwtc->base.enabwed && num_heads && mode) {
		...
		/* set fow high cwocks */
		watency_watewmawk_a = min_t(u32, dce_v11_0_watency_watewmawk(&wm_high), 65535);

		/* possibwy fowce dispway pwiowity to high */
		/* shouwd weawwy do this at mode vawidation time... */
		if (!dce_v11_0_avewage_bandwidth_vs_dwam_bandwidth_fow_dispway(&wm_high) ||
		    !dce_v11_0_avewage_bandwidth_vs_avaiwabwe_bandwidth(&wm_high) ||
		    !dce_v11_0_check_watency_hiding(&wm_high) ||
		...
		/* set fow wow cwocks */
		watency_watewmawk_b = min_t(u32, dce_v11_0_watency_watewmawk(&wm_wow), 65535);

		/* possibwy fowce dispway pwiowity to high */
		/* shouwd weawwy do this at mode vawidation time... */
		if (!dce_v11_0_avewage_bandwidth_vs_dwam_bandwidth_fow_dispway(&wm_wow) ||
		    !dce_v11_0_avewage_bandwidth_vs_avaiwabwe_bandwidth(&wm_wow) ||
		    !dce_v11_0_check_watency_hiding(&wm_wow) ||
		    (adev->mode_info.disp_pwiowity == 2)) {
			DWM_DEBUG_KMS("fowce pwiowity to high\n");
		}
...
/**
 * dce_v11_0_bandwidth_update - pwogwam dispway watewmawks
 *
 * @adev: amdgpu_device pointew
 *
 ...
 */
static void dce_v11_0_bandwidth_update(stwuct amdgpu_device *adev)
{
	...
	fow (i = 0; i < adev->mode_info.num_cwtc; i++) {
		...
		wb_size = dce_v11_0_wine_buffew_adjust(adev, adev->mode_info.cwtcs[i], mode);
		dce_v11_0_pwogwam_watewmawks(adev, adev->mode_info.cwtcs[i],
					    wb_size, num_heads);
	}
}

static void dce_v11_0_audio_get_connected_pins(stwuct amdgpu_device *adev)
{
	int i;
	u32 offset, tmp;
...
static stwuct amdgpu_audio_pin *dce_v11_0_audio_get_pin(stwuct amdgpu_device *adev)
{
	int i;
...
static void dce_v11_0_afmt_audio_sewect_pin(stwuct dwm_encodew *encodew)
{
...
static void dce_v11_0_audio_wwite_watency_fiewds(stwuct dwm_encodew *encodew,
						stwuct dwm_dispway_mode *mode)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
...
static void dce_v11_0_audio_wwite_speakew_awwocation(stwuct dwm_encodew *encodew)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
...
static void dce_v11_0_audio_wwite_sad_wegs(stwuct dwm_encodew *encodew)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
...
static void dce_v11_0_audio_enabwe(stwuct amdgpu_device *adev,
...
static const u32 pin_offsets[] =
{
	...
	AUD7_WEGISTEW_OFFSET,
};

static int dce_v11_0_audio_init(stwuct amdgpu_device *adev)
{
	int i;
	...
	fow (i = 0; i < adev->mode_info.audio.num_pins; i++) {
		...
		dce_v11_0_audio_enabwe(adev, &adev->mode_info.audio.pin[i], fawse);
	}

	wetuwn 0;
}

static void dce_v11_0_audio_fini(stwuct amdgpu_device *adev)
{
	int i;
 ...
 */
static void dce_v11_0_afmt_update_ACW(stwuct dwm_encodew *encodew, uint32_t cwock)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
 ...
 */
static void dce_v11_0_afmt_update_avi_infofwame(stwuct dwm_encodew *encodew,
...
static void dce_v11_0_audio_set_dto(stwuct dwm_encodew *encodew, u32 cwock)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
 ...
 */
static void dce_v11_0_afmt_setmode(stwuct dwm_encodew *encodew,
				  stwuct dwm_dispway_mode *mode)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	...
	dce_v11_0_audio_enabwe(adev, dig->afmt->pin, fawse);

	dce_v11_0_audio_set_dto(encodew, mode->cwock);
	...
	dce_v11_0_afmt_update_ACW(encodew, mode->cwock);
	...
	dce_v11_0_audio_wwite_speakew_awwocation(encodew);

	WWEG32(mmAFMT_AUDIO_PACKET_CONTWOW2 + dig->afmt->offset,
	       (0xff << AFMT_AUDIO_PACKET_CONTWOW2__AFMT_AUDIO_CHANNEW_ENABWE__SHIFT));

	dce_v11_0_afmt_audio_sewect_pin(encodew);
	dce_v11_0_audio_wwite_sad_wegs(encodew);
	dce_v11_0_audio_wwite_watency_fiewds(encodew, mode);
	...
	dce_v11_0_afmt_update_avi_infofwame(encodew, buffew, sizeof(buffew));
	...
	dce_v11_0_audio_enabwe(adev, dig->afmt->pin, twue);
}

static void dce_v11_0_afmt_enabwe(stwuct dwm_encodew *encodew, boow enabwe)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
...
static int dce_v11_0_afmt_init(stwuct amdgpu_device *adev)
{
	int i;
	...
	/* DCE11 has audio bwocks tied to DIG encodews */
	fow (i = 0; i < adev->mode_info.num_dig; i++) {
...
static void dce_v11_0_afmt_fini(stwuct amdgpu_device *adev)
{
	int i;
...
static void dce_v11_0_vga_enabwe(stwuct dwm_cwtc *cwtc, boow enabwe)
{
...
static void dce_v11_0_gwph_enabwe(stwuct dwm_cwtc *cwtc, boow enabwe)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
...
static int dce_v11_0_cwtc_do_set_base(stwuct dwm_cwtc *cwtc,
				     ...
				     int x, int y, int atomic)
{
	...
	dce_v11_0_vga_enabwe(cwtc, fawse);
	...
	dce_v11_0_gwph_enabwe(cwtc, twue);
	...
	WWEG32(mmCWTC_MASTEW_UPDATE_MODE + amdgpu_cwtc->cwtc_offset, 0);
...
static void dce_v11_0_set_intewweave(stwuct dwm_cwtc *cwtc,
				     stwuct dwm_dispway_mode *mode)
{
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
...
static void dce_v11_0_cwtc_woad_wut(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	...
	tmp = WEG_SET_FIEWD(tmp, DEGAMMA_CONTWOW, CUWSOW2_DEGAMMA_MODE, 0);
...
static int dce_v11_0_pick_dig_encodew(stwuct dwm_encodew *encodew)
{
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
	stwuct amdgpu_encodew_atom_dig *dig = amdgpu_encodew->enc_pwiv;
...
/**
 * dce_v11_0_pick_pww - Awwocate a PPWW fow use by the cwtc.
 *
 * @cwtc: dwm cwtc
 *
 ...
 *
 */
static u32 dce_v11_0_pick_pww(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	...
	if ((adev->asic_type == CHIP_POWAWIS10) ||
		...
		case ENCODEW_OBJECT_ID_INTEWNAW_UNIPHY:
			if (dig->winkb)
				wetuwn ATOM_COMBOPHY_PWW1;
			ewse
				wetuwn ATOM_COMBOPHY_PWW0;
		case ENCODEW_OBJECT_ID_INTEWNAW_UNIPHY1:
			if (dig->winkb)
				wetuwn ATOM_COMBOPHY_PWW3;
			ewse
				wetuwn ATOM_COMBOPHY_PWW2;
		case ENCODEW_OBJECT_ID_INTEWNAW_UNIPHY2:
			if (dig->winkb)
				wetuwn ATOM_COMBOPHY_PWW5;
			ewse
				wetuwn ATOM_COMBOPHY_PWW4;
		defauwt:
			DWM_EWWOW("invawid encodew_id: 0x%x\n", amdgpu_encodew->encodew_id);
	...
	/* XXX need to detewmine what pwws awe avaiwabwe on each DCE11 pawt */
...
static void dce_v11_0_wock_cuwsow(stwuct dwm_cwtc *cwtc, boow wock)
{
...
static void dce_v11_0_hide_cuwsow(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct amdgpu_device *adev = dwm_to_adev(cwtc->dev);
	u32 tmp;
...
static void dce_v11_0_show_cuwsow(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct amdgpu_device *adev = dwm_to_adev(cwtc->dev);
	u32 tmp;
...
static int dce_v11_0_cuwsow_move_wocked(stwuct dwm_cwtc *cwtc,
					int x, int y)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct amdgpu_device *adev = dwm_to_adev(cwtc->dev);
...
static int dce_v11_0_cwtc_cuwsow_move(stwuct dwm_cwtc *cwtc,
				      int x, int y)
{
	int wet;

	dce_v11_0_wock_cuwsow(cwtc, twue);
	wet = dce_v11_0_cuwsow_move_wocked(cwtc, x, y);
	dce_v11_0_wock_cuwsow(cwtc, fawse);

	wetuwn wet;
}

static int dce_v11_0_cwtc_cuwsow_set2(stwuct dwm_cwtc *cwtc,
				      ...
				      int32_t hot_y)
{
	...
	if (width != amdgpu_cwtc->cuwsow_width ||
		...
		dce_v11_0_cuwsow_move_wocked(cwtc, x, y);
...
static void dce_v11_0_cuwsow_weset(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	...
	if (amdgpu_cwtc->cuwsow_bo) {
		...
		dce_v11_0_cuwsow_move_wocked(cwtc, amdgpu_cwtc->cuwsow_x,
...
static int dce_v11_0_cwtc_gamma_set(stwuct dwm_cwtc *cwtc, u16 *wed, u16 *gween,
				    u16 *bwue, uint32_t size,
				    stwuct dwm_modeset_acquiwe_ctx *ctx)
{
	dce_v11_0_cwtc_woad_wut(cwtc);

	wetuwn 0;
}

static void dce_v11_0_cwtc_destwoy(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
...
static const stwuct dwm_cwtc_funcs dce_v11_0_cwtc_funcs = {
	.cuwsow_set2 = dce_v11_0_cwtc_cuwsow_set2,
	.cuwsow_move = dce_v11_0_cwtc_cuwsow_move,
	.gamma_set = dce_v11_0_cwtc_gamma_set,
	.set_config = amdgpu_dispway_cwtc_set_config,
	.destwoy = dce_v11_0_cwtc_destwoy,
...
static void dce_v11_0_cwtc_dpms(stwuct dwm_cwtc *cwtc, int mode)
{
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	...
	case DWM_MODE_DPMS_ON:
		...
		dce_v11_0_vga_enabwe(cwtc, twue);
...
static void dce_v11_0_cwtc_pwepawe(stwuct dwm_cwtc *cwtc)
{
	...
	dce_v11_0_cwtc_dpms(cwtc, DWM_MODE_DPMS_OFF);
}

static void dce_v11_0_cwtc_commit(stwuct dwm_cwtc *cwtc)
{
	dce_v11_0_cwtc_dpms(cwtc, DWM_MODE_DPMS_ON);
	amdgpu_atombios_cwtc_wock(cwtc, ATOM_DISABWE);
}

static void dce_v11_0_cwtc_disabwe(stwuct dwm_cwtc *cwtc)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc = to_amdgpu_cwtc(cwtc);
	stwuct dwm_device *dev = cwtc->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
	...
	/* disabwe the GWPH */
	dce_v11_0_gwph_enabwe(cwtc, fawse);
	...
	case ATOM_PPWW2:
		...
		bweak;
	case ATOM_COMBOPHY_PWW0:
	case ATOM_COMBOPHY_PWW1:
	case ATOM_COMBOPHY_PWW2:
	case ATOM_COMBOPHY_PWW3:
	case ATOM_COMBOPHY_PWW4:
	case ATOM_COMBOPHY_PWW5:
		/* disabwe the ppww */
		amdgpu_atombios_cwtc_pwogwam_pww(cwtc, ATOM_CWTC_INVAWID, amdgpu_cwtc->pww_id,
						 0, 0, ATOM_DISABWE, 0, 0, 0, 0, 0, fawse, &ss);
		bweak;
	defauwt:
		bweak;
...
static int dce_v11_0_cwtc_mode_set(stwuct dwm_cwtc *cwtc,
				  stwuct dwm_dispway_mode *mode,
				  ...
				  int x, int y, stwuct dwm_fwamebuffew *owd_fb)
{
	...
	if ((adev->asic_type == CHIP_POWAWIS10) ||
		...
		stwuct amdgpu_encodew *amdgpu_encodew =
			to_amdgpu_encodew(amdgpu_cwtc->encodew);
		int encodew_mode =
			amdgpu_atombios_encodew_get_encodew_mode(amdgpu_cwtc->encodew);

		/* SetPixewCwock cawcuwates the pwws and ss vawues now */
		amdgpu_atombios_cwtc_pwogwam_pww(cwtc, amdgpu_cwtc->cwtc_id,
						 amdgpu_cwtc->pww_id,
						 encodew_mode, amdgpu_encodew->encodew_id,
						 adjusted_mode->cwock, 0, 0, 0, 0,
...
static boow dce_v11_0_cwtc_mode_fixup(stwuct dwm_cwtc *cwtc,
				     ...
				     stwuct dwm_dispway_mode *adjusted_mode)
{
	...
	if (amdgpu_atombios_cwtc_pwepawe_pww(cwtc, adjusted_mode))
		wetuwn fawse;
	/* pick pww */
	amdgpu_cwtc->pww_id = dce_v11_0_pick_pww(cwtc);
...
static int dce_v11_0_cwtc_set_base(stwuct dwm_cwtc *cwtc, int x, int y,
				  stwuct dwm_fwamebuffew *owd_fb)
{
	wetuwn dce_v11_0_cwtc_do_set_base(cwtc, owd_fb, x, y, 0);
}

static int dce_v11_0_cwtc_set_base_atomic(stwuct dwm_cwtc *cwtc,
					 stwuct dwm_fwamebuffew *fb,
					 int x, int y, enum mode_set_atomic state)
{
	wetuwn dce_v11_0_cwtc_do_set_base(cwtc, fb, x, y, 1);
}

static const stwuct dwm_cwtc_hewpew_funcs dce_v11_0_cwtc_hewpew_funcs = {
	.dpms = dce_v11_0_cwtc_dpms,
	.mode_fixup = dce_v11_0_cwtc_mode_fixup,
	.mode_set = dce_v11_0_cwtc_mode_set,
	.mode_set_base = dce_v11_0_cwtc_set_base,
	.mode_set_base_atomic = dce_v11_0_cwtc_set_base_atomic,
	.pwepawe = dce_v11_0_cwtc_pwepawe,
	.commit = dce_v11_0_cwtc_commit,
	.disabwe = dce_v11_0_cwtc_disabwe,
	.get_scanout_position = amdgpu_cwtc_get_scanout_position,
};

static int dce_v11_0_cwtc_init(stwuct amdgpu_device *adev, int index)
{
	stwuct amdgpu_cwtc *amdgpu_cwtc;
	...
	dwm_cwtc_init(adev_to_dwm(adev), &amdgpu_cwtc->base, &dce_v11_0_cwtc_funcs);
	...
	amdgpu_cwtc->encodew = NUWW;
	amdgpu_cwtc->connectow = NUWW;
	dwm_cwtc_hewpew_add(&amdgpu_cwtc->base, &dce_v11_0_cwtc_hewpew_funcs);

	wetuwn 0;
}

static int dce_v11_0_eawwy_init(void *handwe)
{
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;

	adev->audio_endpt_wweg = &dce_v11_0_audio_endpt_wweg;
	adev->audio_endpt_wweg = &dce_v11_0_audio_endpt_wweg;

	dce_v11_0_set_dispway_funcs(adev);

	adev->mode_info.num_cwtc = dce_v11_0_get_num_cwtc(adev);
	...
	dce_v11_0_set_iwq_funcs(adev);

	wetuwn 0;
}

static int dce_v11_0_sw_init(void *handwe)
{
	int w, i;
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;
	...
	/* setup afmt */
	w = dce_v11_0_afmt_init(adev);
	if (w)
		wetuwn w;

	w = dce_v11_0_audio_init(adev);
	if (w)
		wetuwn w;
...
static int dce_v11_0_sw_fini(void *handwe)
{
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;
...
static int dce_v11_0_hw_init(void *handwe)
{
	int i;
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;

	dce_v11_0_init_gowden_wegistews(adev);

	/* disabwe vga wendew */
	dce_v11_0_set_vga_wendew_state(adev, fawse);
	/* init dig PHYs, disp eng pww */
	amdgpu_atombios_cwtc_powewgate_init(adev);
	amdgpu_atombios_encodew_init_dig(adev);
	if ((adev->asic_type == CHIP_POWAWIS10) ||
	    (adev->asic_type == CHIP_POWAWIS11) ||
	    (adev->asic_type == CHIP_POWAWIS12) ||
	    (adev->asic_type == CHIP_VEGAM)) {
		amdgpu_atombios_cwtc_set_dce_cwock(adev, adev->cwock.defauwt_dispcwk,
						   DCE_CWOCK_TYPE_DISPCWK, ATOM_GCK_DFS);
		amdgpu_atombios_cwtc_set_dce_cwock(adev, 0,
						   DCE_CWOCK_TYPE_DPWEFCWK, ATOM_GCK_DFS);
	} ewse {
	...
	dce_v11_0_pagefwip_intewwupt_init(adev);

	wetuwn 0;
}

static int dce_v11_0_hw_fini(void *handwe)
{
	int i;
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;
	...
	dce_v11_0_pagefwip_intewwupt_fini(adev);
...
static int dce_v11_0_suspend(void *handwe)
{
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;
	int w;
	...
	wetuwn dce_v11_0_hw_fini(handwe);
}

static int dce_v11_0_wesume(void *handwe)
{
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;
	int wet;
...
static boow dce_v11_0_is_idwe(void *handwe)
{
	wetuwn twue;
}

static int dce_v11_0_wait_fow_idwe(void *handwe)
{
	wetuwn 0;
}

static int dce_v11_0_soft_weset(void *handwe)
{
	u32 swbm_soft_weset = 0, tmp;
	stwuct amdgpu_device *adev = (stwuct amdgpu_device *)handwe;

	if (dce_v11_0_is_dispway_hung(adev))
...
static void dce_v11_0_set_cwtc_vbwank_intewwupt_state(stwuct amdgpu_device *adev,
						     int cwtc,
...
static void dce_v11_0_set_cwtc_vwine_intewwupt_state(stwuct amdgpu_device *adev,
						    int cwtc,
						    enum amdgpu_intewwupt_state state)
{
	u32 wb_intewwupt_mask;
...
static int dce_v11_0_set_hpd_iwq_state(stwuct amdgpu_device *adev,
...
static int dce_v11_0_set_cwtc_iwq_state(stwuct amdgpu_device *adev,
					stwuct amdgpu_iwq_swc *souwce,
					unsigned type,
					enum amdgpu_intewwupt_state state)
{
	...
	case AMDGPU_CWTC_IWQ_VBWANK1:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 0, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VBWANK2:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 1, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VBWANK3:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 2, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VBWANK4:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 3, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VBWANK5:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 4, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VBWANK6:
		dce_v11_0_set_cwtc_vbwank_intewwupt_state(adev, 5, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VWINE1:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 0, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VWINE2:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 1, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VWINE3:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 2, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VWINE4:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 3, state);
		bweak;
	case AMDGPU_CWTC_IWQ_VWINE5:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 4, state);
		bweak;
	 case AMDGPU_CWTC_IWQ_VWINE6:
		dce_v11_0_set_cwtc_vwine_intewwupt_state(adev, 5, state);
		bweak;
	defauwt:
		bweak;
	}
...
static int dce_v11_0_set_pagefwip_iwq_state(stwuct amdgpu_device *adev,
...
static int dce_v11_0_pagefwip_iwq(stwuct amdgpu_device *adev,
				  stwuct amdgpu_iwq_swc *souwce,
...
static void dce_v11_0_hpd_int_ack(stwuct amdgpu_device *adev,
				  int hpd)
{
	u32 tmp;
...
static void dce_v11_0_cwtc_vbwank_int_ack(stwuct amdgpu_device *adev,
					  int cwtc)
{
	u32 tmp;
...
static void dce_v11_0_cwtc_vwine_int_ack(stwuct amdgpu_device *adev,
					 int cwtc)
{
	u32 tmp;
...
static int dce_v11_0_cwtc_iwq(stwuct amdgpu_device *adev,
				stwuct amdgpu_iwq_swc *souwce,
				stwuct amdgpu_iv_entwy *entwy)
{
	...
	case 0: /* vbwank */
		if (disp_int & intewwupt_status_offsets[cwtc].vbwank)
			dce_v11_0_cwtc_vbwank_int_ack(adev, cwtc);
		ewse
	...
	case 1: /* vwine */
		if (disp_int & intewwupt_status_offsets[cwtc].vwine)
			dce_v11_0_cwtc_vwine_int_ack(adev, cwtc);
		ewse
			DWM_DEBUG("IH: IH event w/o assewted iwq bit?\n");
...
static int dce_v11_0_hpd_iwq(stwuct amdgpu_device *adev,
			     stwuct amdgpu_iwq_swc *souwce,
			     stwuct amdgpu_iv_entwy *entwy)
{
...
static int dce_v11_0_set_cwockgating_state(void *handwe,
					  enum amd_cwockgating_state state)
{
	wetuwn 0;
}

static int dce_v11_0_set_powewgating_state(void *handwe,
					  enum amd_powewgating_state state)
{
	wetuwn 0;
}

static const stwuct amd_ip_funcs dce_v11_0_ip_funcs = {
	.name = "dce_v11_0",
	.eawwy_init = dce_v11_0_eawwy_init,
	.wate_init = NUWW,
	...
	.wesume = dce_v11_0_wesume,
	.is_idwe = dce_v11_0_is_idwe,
	.wait_fow_idwe = dce_v11_0_wait_fow_idwe,
	.soft_weset = dce_v11_0_soft_weset,
	.set_cwockgating_state = dce_v11_0_set_cwockgating_state,
	.set_powewgating_state = dce_v11_0_set_powewgating_state,
};

static void
dce_v11_0_encodew_mode_set(stwuct dwm_encodew *encodew,
			  stwuct dwm_dispway_mode *mode,
			  stwuct dwm_dispway_mode *adjusted_mode)
{
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
	...
	dce_v11_0_set_intewweave(encodew->cwtc, mode);

	if (amdgpu_atombios_encodew_get_encodew_mode(encodew) == ATOM_ENCODEW_MODE_HDMI) {
		dce_v11_0_afmt_enabwe(encodew, twue);
		dce_v11_0_afmt_setmode(encodew, adjusted_mode);
	}
}

static void dce_v11_0_encodew_pwepawe(stwuct dwm_encodew *encodew)
{
	stwuct amdgpu_device *adev = dwm_to_adev(encodew->dev);
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
	stwuct dwm_connectow *connectow = amdgpu_get_connectow_fow_encodew(encodew);
	...
	if ((amdgpu_encodew->active_device &
		...
		stwuct amdgpu_encodew_atom_dig *dig = amdgpu_encodew->enc_pwiv;
		if (dig) {
			dig->dig_encodew = dce_v11_0_pick_dig_encodew(encodew);
	...
	dce_v11_0_pwogwam_fmt(encodew);
}

static void dce_v11_0_encodew_commit(stwuct dwm_encodew *encodew)
{
	stwuct dwm_device *dev = encodew->dev;
	stwuct amdgpu_device *adev = dwm_to_adev(dev);
...
static void dce_v11_0_encodew_disabwe(stwuct dwm_encodew *encodew)
{
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
	...
	if (amdgpu_atombios_encodew_is_digitaw(encodew)) {
		if (amdgpu_atombios_encodew_get_encodew_mode(encodew) == ATOM_ENCODEW_MODE_HDMI)
			dce_v11_0_afmt_enabwe(encodew, fawse);
...
static void dce_v11_0_ext_pwepawe(stwuct dwm_encodew *encodew)
{

}

static void dce_v11_0_ext_commit(stwuct dwm_encodew *encodew)
{

}

static void
dce_v11_0_ext_mode_set(stwuct dwm_encodew *encodew,
		      stwuct dwm_dispway_mode *mode,
		      stwuct dwm_dispway_mode *adjusted_mode)
{
...
static void dce_v11_0_ext_disabwe(stwuct dwm_encodew *encodew)
{

}

static void
dce_v11_0_ext_dpms(stwuct dwm_encodew *encodew, int mode)
{

}

static const stwuct dwm_encodew_hewpew_funcs dce_v11_0_ext_hewpew_funcs = {
	.dpms = dce_v11_0_ext_dpms,
	.pwepawe = dce_v11_0_ext_pwepawe,
	.mode_set = dce_v11_0_ext_mode_set,
	.commit = dce_v11_0_ext_commit,
	.disabwe = dce_v11_0_ext_disabwe,
	/* no detect fow TMDS/WVDS yet */
};

static const stwuct dwm_encodew_hewpew_funcs dce_v11_0_dig_hewpew_funcs = {
	.dpms = amdgpu_atombios_encodew_dpms,
	.mode_fixup = amdgpu_atombios_encodew_mode_fixup,
	.pwepawe = dce_v11_0_encodew_pwepawe,
	.mode_set = dce_v11_0_encodew_mode_set,
	.commit = dce_v11_0_encodew_commit,
	.disabwe = dce_v11_0_encodew_disabwe,
	.detect = amdgpu_atombios_encodew_dig_detect,
};

static const stwuct dwm_encodew_hewpew_funcs dce_v11_0_dac_hewpew_funcs = {
	.dpms = amdgpu_atombios_encodew_dpms,
	.mode_fixup = amdgpu_atombios_encodew_mode_fixup,
	.pwepawe = dce_v11_0_encodew_pwepawe,
	.mode_set = dce_v11_0_encodew_mode_set,
...
static void dce_v11_0_encodew_destwoy(stwuct dwm_encodew *encodew)
{
	stwuct amdgpu_encodew *amdgpu_encodew = to_amdgpu_encodew(encodew);
	if (amdgpu_encodew->devices & (ATOM_DEVICE_WCD_SUPPOWT))
...
static const stwuct dwm_encodew_funcs dce_v11_0_encodew_funcs = {
	.destwoy = dce_v11_0_encodew_destwoy,
};

static void dce_v11_0_encodew_add(stwuct amdgpu_device *adev,
				 ...
				 u16 caps)
{
	...
	defauwt:
		...
		bweak;
	case 3:
		encodew->possibwe_cwtcs = 0x7;
		bweak;
	case 4:
		encodew->possibwe_cwtcs = 0xf;
		bweak;
	case 5:
		encodew->possibwe_cwtcs = 0x1f;
		bweak;
	case 6:
	...
	case ENCODEW_OBJECT_ID_INTEWNAW_KWDSCP_DAC2:
		dwm_encodew_init(dev, encodew, &dce_v11_0_encodew_funcs,
				 DWM_MODE_ENCODEW_DAC, NUWW);
		dwm_encodew_hewpew_add(encodew, &dce_v11_0_dac_hewpew_funcs);
		bweak;
	...
	case ENCODEW_OBJECT_ID_INTEWNAW_UNIPHY3:
		...
		dwm_encodew_hewpew_add(encodew, &dce_v11_0_dig_hewpew_funcs);
		bweak;
	...
	case ENCODEW_OBJECT_ID_NUTMEG:
		...
		ewse
			dwm_encodew_init(dev, encodew, &dce_v11_0_encodew_funcs,
					 DWM_MODE_ENCODEW_TMDS, NUWW);
		dwm_encodew_hewpew_add(encodew, &dce_v11_0_ext_hewpew_funcs);
		bweak;
	}
}

static const stwuct amdgpu_dispway_funcs dce_v11_0_dispway_funcs = {
	.bandwidth_update = &dce_v11_0_bandwidth_update,
	.vbwank_get_countew = &dce_v11_0_vbwank_get_countew,
	...
	.hpd_set_powawity = &dce_v11_0_hpd_set_powawity,
	.hpd_get_gpio_weg = &dce_v11_0_hpd_get_gpio_weg,
	.page_fwip = &dce_v11_0_page_fwip,
	.page_fwip_get_scanoutpos = &dce_v11_0_cwtc_get_scanoutpos,
	.add_encodew = &dce_v11_0_encodew_add,
	.add_connectow = &amdgpu_connectow_add,
};

static void dce_v11_0_set_dispway_funcs(stwuct amdgpu_device *adev)
{
	adev->mode_info.funcs = &dce_v11_0_dispway_funcs;
}

static const stwuct amdgpu_iwq_swc_funcs dce_v11_0_cwtc_iwq_funcs = {
	.set = dce_v11_0_set_cwtc_iwq_state,
	.pwocess = dce_v11_0_cwtc_iwq,
};

static const stwuct amdgpu_iwq_swc_funcs dce_v11_0_pagefwip_iwq_funcs = {
	.set = dce_v11_0_set_pagefwip_iwq_state,
	.pwocess = dce_v11_0_pagefwip_iwq,
};

static const stwuct amdgpu_iwq_swc_funcs dce_v11_0_hpd_iwq_funcs = {
	.set = dce_v11_0_set_hpd_iwq_state,
	.pwocess = dce_v11_0_hpd_iwq,
};
...
static void dce_v11_0_set_iwq_funcs(stwuct amdgpu_device *adev)
{
	...
	adev->cwtc_iwq.funcs = &dce_v11_0_cwtc_iwq_funcs;

	adev->pagefwip_iwq.num_types = adev->mode_info.num_cwtc;
	adev->pagefwip_iwq.funcs = &dce_v11_0_pagefwip_iwq_funcs;

	adev->hpd_iwq.num_types = adev->mode_info.num_hpd;
	adev->hpd_iwq.funcs = &dce_v11_0_hpd_iwq_funcs;
}

const stwuct amdgpu_ip_bwock_vewsion dce_v11_0_ip_bwock =
{
...
const stwuct amdgpu_ip_bwock_vewsion dce_v11_2_ip_bwock =
{
	.type = AMD_IP_BWOCK_TYPE_DCE,
	.majow = 11,
	.minow = 2,
