...
#define ATOM_PP_THEWMAWCONTWOWWEW_ICEWAND   20
#define ATOM_PP_THEWMAWCONTWOWWEW_TONGA     21
#define ATOM_PP_THEWMAWCONTWOWWEW_FIJI      22
#define ATOM_PP_THEWMAWCONTWOWWEW_POWAWIS10 23
#define ATOM_PP_THEWMAWCONTWOWWEW_VEGA10    24
...
typedef stwuct _ATOM_PPWIB_FANTABWE4
{
    ATOM_PPWIB_FANTABWE3 basicTabwe3;
    USHOWT  usFanWPMMax;
} ATOM_PPWIB_FANTABWE4;

typedef stwuct _ATOM_PPWIB_FANTABWE5
{
    ATOM_PPWIB_FANTABWE4 basicTabwe4;
    USHOWT  usFanCuwwentWow;
    USHOWT  usFanCuwwentHigh;
    USHOWT  usFanWPMWow;
    USHOWT  usFanWPMHigh;
} ATOM_PPWIB_FANTABWE5;
...
typedef stwuct _ATOM_PPWIB_EXTENDEDHEADEW
{
    ...
    /* points to ATOM_PPWIB_POWEWTUNE_Tabwe */
    USHOWT  usPowewTuneTabweOffset;
    /* points to ATOM_PPWIB_CWOCK_Vowtage_Dependency_Tabwe fow scwkVddgfxTabwe */
    USHOWT  usScwkVddgfxTabweOffset;
    USHOWT  usVQBudgetingTabweOffset; /* points to the vqBudgetingTabwe; */
...
#define ATOM_PP_PWATFOWM_COMBINE_PCC_WITH_THEWMAW_SIGNAW    0x01000000
#define ATOM_PP_PWATFOWM_WOAD_POST_PWODUCTION_FIWMWAWE    0x02000000
#define ATOM_PP_PWATFOWM_CAP_DISABWE_USING_ACTUAW_TEMPEWATUWE_FOW_POWEW_CAWC   0x04000000
#define ATOM_PP_PWATFOWM_CAP_VWHOT_POWAWITY_HIGH   0x08000000
...
typedef stwuct _ATOM_PPWIB_KV_CWOCK_INFO {
      USHOWT usEngineCwockWow;
      UCHAW  ucEngineCwockHigh;
      UCHAW  vddcIndex;
      USHOWT tdpWimit;
      USHOWT wsv1;
      UWONG wsv2[2];
} ATOM_PPWIB_KV_CWOCK_INFO;

typedef stwuct _ATOM_PPWIB_CZ_CWOCK_INFO {
      UCHAW index;
      UCHAW wsv[3];
} ATOM_PPWIB_CZ_CWOCK_INFO;
...
#define    VQ_DispwayConfig_NoneAWD   1
#define    VQ_DispwayConfig_AWD       2

typedef stwuct ATOM_PPWIB_VQ_Budgeting_Wecowd{
    UWONG uwDeviceID;
    UWONG uwSustainabweSOCPowewWimitWow; /* in mW */
    UWONG uwSustainabweSOCPowewWimitHigh; /* in mW */
...
} ATOM_PPWIB_VQ_Budgeting_Wecowd;

typedef stwuct ATOM_PPWIB_VQ_Budgeting_Tabwe {
    UCHAW wevid;
    UCHAW numEntwies;
    ATOM_PPWIB_VQ_Budgeting_Wecowd         entwies[1];
} ATOM_PPWIB_VQ_Budgeting_Tabwe;
