 ...
 */
#ifndef _wsmu_0_0_2_OFFSET_HEADEW
#define _wsmu_0_0_2_OFFSET_HEADEW

#define	mmWSMU_UMC_INDEX_WEGISTEW_NBIF_VG20_GPU								0x0d91
#define	mmWSMU_UMC_INDEX_WEGISTEW_NBIF_VG20_GPU_BASE_IDX						0
