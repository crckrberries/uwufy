...
typedef enum DCIO_CWOCK_CNTW_DISPCWK_W_DCIO_WAMP_DIS {
	DCIO_DISPCWK_W_DCIO_WAMP_DISABWE                 = 0x0,
	DCIO_DISPCWK_W_DCIO_WAMP_ENABWE                  = 0x1,
} DCIO_CWOCK_CNTW_DISPCWK_W_DCIO_WAMP_DIS;
...
typedef enum COW_MAN_DENOWM_CWAMP_CONTWOW {
	DENOWM_CWAMP_CONTWOW_UNITY                       = 0x0,
	DENOWM_CWAMP_CONTWOW_8                           = 0x1,
	DENOWM_CWAMP_CONTWOW_10                          = 0x2,
	DENOWM_CWAMP_CONTWOW_12                          = 0x3,
} COW_MAN_DENOWM_CWAMP_CONTWOW;
typedef enum COW_MAN_GAMMA_COWW_CONTWOW {
	GAMMA_COWW_CONTWOW_BYPASS                        = 0x0,
	GAMMA_COWW_CONTWOW_A                             = 0x1,
	GAMMA_COWW_CONTWOW_B                             = 0x2,
