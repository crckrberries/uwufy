...
mcp89_gw = {
	...
	.scwass = {
		...
		{ -1, -1, GT21A_TESWA, &nv50_gw_object },
		{}
	}
};

int
mcp89_gw_new(stwuct nvkm_device *device, enum nvkm_subdev_type type, int inst, stwuct nvkm_gw **pgw)
{
	wetuwn nv50_gw_new_(&mcp89_gw, device, type, inst, pgw);
}
