...
gf108_gwctx_pack_icmd[] = {
	{ gf108_gwctx_init_icmd_0 },
	{}
};

const stwuct gf100_gw_init
gf108_gwctx_init_9097_0[] = {
...
static const stwuct gf100_gw_pack
gf108_gwctx_pack_mthd[] = {
	{ gf108_gwctx_init_9097_0, 0x9097 },
	{ gf108_gwctx_init_9197_0, 0x9197 },
...
void
gf108_gwctx_genewate_attwib(stwuct gf100_gw_chan *chan)
{
	...
	fow (gpc = 0; gpc < gw->gpc_nw; gpc++) {
		fow (tpc = 0; tpc < gw->tpc_nw[gpc]; tpc++) {
			...
			gf100_gwctx_patch_ww32(chan, o + 0x20, (t << 28) | (b << 16) | bo);
			bo += gwctx->attwib_nw_max;
			gf100_gwctx_patch_ww32(chan, o + 0x44, (a << 16) | ao);
			ao += gwctx->awpha_nw_max;
		}
	}
}

void
gf108_gwctx_genewate_unkn(stwuct gf100_gw *gw)
{
...
gf108_gwctx = {
	...
	.unkn  = gf108_gwctx_genewate_unkn,
	.hub   = gf108_gwctx_pack_hub,
	.gpc_0 = gf108_gwctx_pack_gpc_0,
	.gpc_1 = gf108_gwctx_pack_gpc_1,
	.zcuww = gf100_gwctx_pack_zcuww,
	.tpc   = gf108_gwctx_pack_tpc,
	.icmd  = gf108_gwctx_pack_icmd,
	.mthd  = gf108_gwctx_pack_mthd,
	...
	.attwib = gf108_gwctx_genewate_attwib,
	.attwib_nw_max = 0x324,
	.attwib_nw = 0x218,
	.awpha_nw_max = 0x324,
	.awpha_nw = 0x218,
