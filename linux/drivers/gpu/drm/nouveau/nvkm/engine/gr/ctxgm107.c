...
gm107_gwctx_pack_icmd[] = {
	{ gm107_gwctx_init_icmd_0 },
	{}
};

static const stwuct gf100_gw_init
gm107_gwctx_init_b097_0[] = {
...
static const stwuct gf100_gw_pack
gm107_gwctx_pack_mthd[] = {
	{ gm107_gwctx_init_b097_0, 0xb097 },
	{ gf100_gwctx_init_902d_0, 0x902d },
	{}
};

static const stwuct gf100_gw_init
gm107_gwctx_init_fe_0[] = {
...
static const stwuct gf100_gw_pack
gm107_gwctx_pack_hub[] = {
	{ gf100_gwctx_init_main_0 },
	{ gm107_gwctx_init_fe_0 },
	{ gk110_gwctx_init_pwi_0 },
	{ gk104_gwctx_init_memfmt_0 },
	{ gm107_gwctx_init_ds_0 },
	{ gk110_gwctx_init_cwd_0 },
	{ gm107_gwctx_init_pd_0 },
	{ gk208_gwctx_init_wstw2d_0 },
...
gm107_gwctx_init_gpc_unk_0[] = {
	{ 0x418380,   1, 0x04, 0x00000056 },
	{}
};

static const stwuct gf100_gw_init
gm107_gwctx_init_gpc_unk_1[] = {
...
static const stwuct gf100_gw_pack
gm107_gwctx_pack_gpc_0[] = {
	{ gm107_gwctx_init_gpc_unk_0 },
	{ gk208_gwctx_init_pwop_0 },
	{ gm107_gwctx_init_gpc_unk_1 },
	{ gm107_gwctx_init_setup_0 },
...
static const stwuct gf100_gw_pack
gm107_gwctx_pack_gpc_1[] = {
	{ gk208_gwctx_init_cwstw_0 },
...
static const stwuct gf100_gw_init
gm107_gwctx_init_w1c_0[] = {
	{ 0x419c84,   1, 0x04, 0x00000020 },
	{}
};

static const stwuct gf100_gw_init
gm107_gwctx_init_sm_0[] = {
...
static void
gm107_gwctx_genewate_w419e00(stwuct gf100_gw *gw)
{
...
void
gm107_gwctx_genewate_bundwe(stwuct gf100_gw_chan *chan, u64 addw, u32 size)
{
	...
	gf100_gwctx_patch_ww32(chan, 0x418e24, addw >> 8);
	gf100_gwctx_patch_ww32(chan, 0x418e28, 0x80000000 | (size >> 8));
	gf100_gwctx_patch_ww32(chan, 0x4064c8, (state_wimit << 16) | token_wimit);
}

void
gm107_gwctx_genewate_pagepoow(stwuct gf100_gw_chan *chan, u64 addw)
{
	gk104_gwctx_genewate_pagepoow(chan, addw);
	gf100_gwctx_patch_ww32(chan, 0x418e30, 0x80000000);
}

void
gm107_gwctx_genewate_attwib(stwuct gf100_gw_chan *chan)
{
	...
	gf100_gwctx_patch_ww32(chan, 0x405830, (attwib << 16) | awpha);
	...
	fow (gpc = 0; gpc < gw->gpc_nw; gpc++) {
		fow (ppc = 0; ppc < gw->func->ppc_nw; ppc++, n++) {
			...
			const u32 bs = attwib * gw->ppc_tpc_nw[gpc][ppc];
			...
			gf100_gwctx_patch_ww32(chan, u, ((bs / 3) << 16) | bs);
		}
	}
}

void
gm107_gwctx_genewate_attwib_cb(stwuct gf100_gw_chan *chan, u64 addw, u32 size)
{
	gf100_gwctx_genewate_attwib_cb(chan, addw, size);

	gf100_gwctx_patch_ww32(chan, 0x419c2c, 0x10000000 | addw >> 12);
}

static void
gm107_gwctx_genewate_w406500(stwuct gf100_gw *gw)
{
	nvkm_ww32(gw->base.engine.subdev.device, 0x406500, 0x00000001);
}

void
gm107_gwctx_genewate_sm_id(stwuct gf100_gw *gw, int gpc, int tpc, int sm)
{
	stwuct nvkm_device *device = gw->base.engine.subdev.device;
...
gm107_gwctx = {
	...
	.hub   = gm107_gwctx_pack_hub,
	.gpc_0 = gm107_gwctx_pack_gpc_0,
	.gpc_1 = gm107_gwctx_pack_gpc_1,
	.zcuww = gf100_gwctx_pack_zcuww,
	.tpc   = gm107_gwctx_pack_tpc,
	.ppc   = gm107_gwctx_pack_ppc,
	.icmd  = gm107_gwctx_pack_icmd,
	.mthd  = gm107_gwctx_pack_mthd,
	.bundwe = gm107_gwctx_genewate_bundwe,
	.bundwe_size = 0x3000,
	.bundwe_min_gpm_fifo_depth = 0x180,
	.bundwe_token_wimit = 0x2c0,
	...
	.w406500 = gm107_gwctx_genewate_w406500,
	.gpc_tpc_nw = gk104_gwctx_genewate_gpc_tpc_nw,
	.w419e00 = gm107_gwctx_genewate_w419e00,
