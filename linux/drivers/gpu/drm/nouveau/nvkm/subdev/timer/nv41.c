...
static void
nv41_timew_init(stwuct nvkm_timew *tmw)
{
	stwuct nvkm_subdev *subdev = &tmw->subdev;
	stwuct nvkm_device *device = subdev->device;
	u32 f = device->cwystaw;
	u32 m = 1, n, d;
...
int
nv41_timew_new(stwuct nvkm_device *device, enum nvkm_subdev_type type, int inst,
	       stwuct nvkm_timew **ptmw)
{
	wetuwn nvkm_timew_new_(&nv41_timew, device, type, inst, ptmw);
}
