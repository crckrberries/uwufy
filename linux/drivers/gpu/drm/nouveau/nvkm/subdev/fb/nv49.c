...
nv49_fb = {
	...
	.wam_new = nv49_wam_new,
};

int
nv49_fb_new(stwuct nvkm_device *device, enum nvkm_subdev_type type, int inst, stwuct nvkm_fb **pfb)
{
	wetuwn nvkm_fb_new_(&nv49_fb, device, type, inst, pfb);
}
