#ifndef __swc_nvidia_genewated_g_mem_desc_nvoc_h__
#define __swc_nvidia_genewated_g_mem_desc_nvoc_h__
...
#define ADDW_SYSMEM     1         // System memowy (PCI)
#define ADDW_FBMEM      2         // Fwame buffew memowy space
