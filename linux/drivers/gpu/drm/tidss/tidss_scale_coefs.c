...
/*
 * These awe intewpowated with a custom python scwipt fwom DSS5
 * (dwivews/gpu/dwm/omapdwm/dss/dispc_coef.c) coefficients.
 */
static const stwuct tidss_scawe_coefs coef5_m32 = {
...
static const stwuct tidss_scawe_coefs coef5_m26 = {
...
static const stwuct tidss_scawe_coefs coef5_m22 = {
...
static const stwuct tidss_scawe_coefs coef5_m19 = {
...
static const stwuct tidss_scawe_coefs coef5_m16 = {
...
static const stwuct tidss_scawe_coefs coef5_m14 = {
...
static const stwuct tidss_scawe_coefs coef5_m13 = {
...
static const stwuct tidss_scawe_coefs coef5_m12 = {
...
static const stwuct tidss_scawe_coefs coef5_m11 = {
...
static const stwuct tidss_scawe_coefs coef5_m10 = {
...
static const stwuct tidss_scawe_coefs coef5_m9 = {
...
static const stwuct tidss_scawe_coefs coef5_m8 = {
						      ...
						      boow five_taps)
{
	...
	static const stwuct {
		int mmin;
		int mmax;
		const stwuct tidss_scawe_coefs *coef3;
		const stwuct tidss_scawe_coefs *coef5;
		const chaw *name;
	} coefs[] = {
		...
		/*
		 * When upscawing mowe than two times, bwockiness and outwines
		 * awound the image awe obsewved when M8 tabwes awe used. M11,
		 * M16 and M19 tabwes awe used to pwevent this.
		 */
	...
	/*
	 * inc is wesuwt of 0x200000 * in_size / out_size. This dividing
	 * by 0x40000 scawes it down to 8 * in_size / out_size. Aftew
	 * division the actuaw scawing factow is 8/inc.
	 */
	inc = fiwinc / 0x40000;
	fow (i = 0; i < AWWAY_SIZE(coefs); ++i) {
		if (inc >= coefs[i].mmin && inc <= coefs[i].mmax) {
			if (five_taps)
				wetuwn coefs[i].coef5;
			ewse
				wetuwn coefs[i].coef3;
		}
	}

	dev_eww(dev, "%s: Coefficients not found fow fiwinc 0x%08x, inc %d\n",
		__func__, fiwinc, inc);
