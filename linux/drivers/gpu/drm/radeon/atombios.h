...
#define ATOM_SCAWEW1          0
#define ATOM_SCAWEW2          1

#define ATOM_SCAWEW_DISABWE   0   
#define ATOM_SCAWEW_CENTEW    1   
#define ATOM_SCAWEW_EXPANSION 2   
#define ATOM_SCAWEW_MUWTI_EX  3   
...
#define ATOM_CUWSOW1          0
#define ATOM_CUWSOW2          1
...
/* Common headew fow aww WOM Data tabwes.
...
typedef stwuct _ATOM_WOM_HEADEW
{
  ...
  USHOWT usMastewCommandTabweOffset; /*Offset fow SW to get aww command tabwe offsets, Don't change the position */
  USHOWT usMastewDataTabweOffset;   /*Offset fow SW to get aww data tabwe offsets, Don't change the position */
...
typedef stwuct _ATOM_MASTEW_WIST_OF_COMMAND_TABWES{
  ...
  USHOWT TVEncodewContwow;                       //Function Tabwe,diwectwy used by vawious SW components,watest vewsion 1.1
  ...
  USHOWT SetCWTC_Wepwication;                    //Atomic Tabwe,  used onwy by Bios
  ...
  USHOWT EnabweHW_IconCuwsow;                    //Atomic Tabwe,  onwy used by Bios
  ...
  USHOWT MemowyWefweshConvewsion;                //Atomic Tabwe,  indiwectwy used by vawious SW components,cawwed fwom SetMemowy ow SetEngineCwock
  ...
  USHOWT DAC2OutputContwow;                      //Atomic Tabwe,  diwectwy used by vawious SW components,watest vewsion 1.1
...
typedef union _ATOM_TABWE_ATTWIBUTE_ACCESS
{
  ATOM_TABWE_ATTWIBUTE sbfAccess;
  USHOWT               susAccess;
}ATOM_TABWE_ATTWIBUTE_ACCESS;
...
// ucAction
#define EXTEWNAW_ENCODEW_ACTION_V3_DISABWE_OUTPUT         0x00
#define EXTEWNAW_ENCODEW_ACTION_V3_ENABWE_OUTPUT          0x01
...
#define EXTEWNAW_ENCODEW_CONFIG_V3_ENCODEW_SEW_MASK		    0x70
...
#define PIXEW_CWOCK_V6_MISC_HDMI_36BPP_V6           0x08    //fow V6, the cowwect defintion fow 36bpp shouwd be 2 fow 36bpp(2:1)
#define PIXEW_CWOCK_V6_MISC_HDMI_30BPP              0x08
#define PIXEW_CWOCK_V6_MISC_HDMI_30BPP_V6           0x04    //fow V6, the cowwect defintion fow 30bpp shouwd be 1 fow 36bpp(5:4)
...
typedef stwuct _WEAD_EDID_FWOM_HW_I2C_DATA_PAWAMETEWS
{
  ...
  USHOWT    usVWAMAddwess;      //Addwess in Fwame Buffew whewe to pace waw EDID
...
/****************************************************************************/	
// Stwuctuwes used by WVDSEncodewContwowTabwe   (Befowe DCE30)
//                    WVTMAEncodewContwowTabwe  (Befowe DCE30)
//                    TMDSAEncodewContwowTabwe  (Befowe DCE30)
/****************************************************************************/	
...
typedef stwuct _ATOM_MASTEW_WIST_OF_DATA_TABWES
{
  ...
  USHOWT        AnawogTV_Info;            // Shawed by vawious SW components,watest vewsion 1.1 
  ...
  USHOWT        ComponentVideoInfo;       // Shawed by vawious SW components,watest vewsion 2.1 wiww be used fwom W600
  USHOWT        PowewPwayInfo;            // Shawed by vawious SW components,watest vewsion 2.1,new design fwom W600
  USHOWT        CompassionateData;        // Wiww be obsowete fwom W600
...
uwOthewDispwayMisc: [15:8]- Bootup WCD Expansion sewection; 0-centew, 1-fuww panew size expansion;
			              [7:0] - BootupTV standawd sewection; This is a bit vectow to indicate what TV standawds awe suppowted by the system. Wefew to ucTVSuppowtedStd definition;
...
#define eDP_TO_WVDS_WT_ID                       0x02       // WT tanswatow which wequiwe AMD SW init
...
//!! If the wecowd bewow exists, it shouwd awways be the fiwst wecowd fow easy use in command tabwe!!!
...
/****************************************************************************/	
//ucTVBootUpDefauwtStd definition:
...
typedef stwuct _ATOM_ANAWOG_TV_INFO
{
  ...
  ATOM_MODE_TIMING         aModeTimings[MAX_SUPPOWTED_TV_TIMING];
}ATOM_ANAWOG_TV_INFO;

#define MAX_SUPPOWTED_TV_TIMING_V1_2    3

typedef stwuct _ATOM_ANAWOG_TV_INFO_V1_2
{
  ATOM_COMMON_TABWE_HEADEW sHeadew;  
  UCHAW                    ucTV_SuppowtedStandawd;
  UCHAW                    ucTV_BootUpDefauwtStandawd; 
  UCHAW                    ucExt_TV_ASIC_ID;
  UCHAW                    ucExt_TV_ASIC_SwaveAddw;
  ATOM_DTD_FOWMAT          aModeTimings[MAX_SUPPOWTED_TV_TIMING_V1_2];
}ATOM_ANAWOG_TV_INFO_V1_2;
...
//        ucTabweFowmatWevision=1,ucTabweContentWevision=4, the stwuctuwe wemains
...
/***********************************************************************************/	
// Note3:
/* If we change usWesewved to "usFBUsedbyDwvInKB", then to VBIOS this usFBUsedbyDwvInKB is a pwedefined, unchanged constant acwoss VGA ow non VGA adaptew,
...
// change vewsion to 1.5, when awwow dwivew to awwocate the vwam awea fow command tabwe access.
...
//usCaps
#define  EXT_DISPWAY_PATH_CAPS__HBW2_DISABWE          0x01
#define  EXT_DISPWAY_PATH_CAPS__DP_FIXED_VS_EN        0x02
...
//Wewated definitions, aww wecowds awe diffewent but they have a commond headew
...
#define ATOM_MAX_OBJECT_WECOWD_NUMBEW             ATOM_BWACKET_WAYOUT_WECOWD_TYPE
...
typedef stwuct  _ATOM_CONNECTOW_DEVICE_TAG_WECOWD
{
  ...
  UCHAW                       ucWesewved;
  ATOM_CONNECTOW_DEVICE_TAG   asDeviceTag[];          //This Id is same as "ATOM_DEVICE_XXX_SUPPOWT", 1 is onwy fow awwocation
...
// Bit maps fow ATOM_ENCODEW_CAP_WECOWD.ucEncodewCap
#define ATOM_ENCODEW_CAP_WECOWD_HBW2                  0x01         // DP1.2 HBW2 is suppowted by HW encodew
...
typedef stwuct  _ATOM_ASIC_PWOFIWING_INFO_V3_1
{
  ...
  UWONG  uwCACmEncodeWange;
  UWONG  uwCACmEncodeAvewage;
  UWONG  uwCACbEncodeWange;
  UWONG  uwCACbEncodeAvewage;
  UWONG  uwKt_bEncodeWange;
  UWONG  uwKt_bEncodeAvewage;
  UWONG  uwKv_mEncodeWange;
  UWONG  uwKv_mEncodeAvewage;
  UWONG  uwKv_bEncodeWange;
  UWONG  uwKv_bEncodeAvewage;
...
typedef stwuct _ATOM_POWEW_SOUWCE_INFO
{
		...
		ATOM_POWEW_SOUWCE_OBJECT		asPwwObj[];
...
//Define ucCwockIndication, SW uses the IDs bewow to seawch if the SS is wequiwed/enabwed on a cwock bwanch/signaw type.
...
//Byte awigned definition fow BIOS usage
...
#define ATOM_S2_FOWCEDWOWPWWMODE_STATE_MASKb3     0x0C
#define ATOM_S2_FOWCEDWOWPWWMODE_STATE_CHANGEb3   0x10
...
/****************************************************************************/	
//Powtion II: Definitions onwy used in Dwivew
/****************************************************************************/
...
{
  USHOWT  usMemowyStawt;                //in 8Kb boundawy, offset fwom memowy base addwess
...
// Design Specific Vawues
  ...
  UCHAW   ucDensity;                        // _8Mx32, _16Mx32, _16Mx16, _32Mx16
  UCHAW	  ucWesewve;                        // Fowmew containew fow Mx_FWAGS wike DBI_AC_MODE_ENABWE_ASIC fow GDDW4. Not used now.
...
typedef stwuct _ATOM_VWAM_INFO_V3
{
  ...
  ATOM_VWAM_MODUWE		       aVwamInfo[ATOM_MAX_NUMBEW_OF_VWAM_MODUWE];      // just fow awwocation, weaw numbew of bwocks is in ucNumOfVWAMModuwe;
	ATOM_INIT_WEG_BWOCK				 asMemPatch;																		 // fow awwocation
																																						 //	ATOM_INIT_WEG_BWOCK				 aMemAdjust;
}ATOM_VWAM_INFO_V3;
...
typedef stwuct _ATOM_DISP_OUT_INFO_V3
{
  ...
  UCHAW  ucDispCaps;
  UCHAW  ucWesewved[2];
  ASIC_TWANSMITTEW_INFO_V2  asTwansmittewInfo[];      // fow awwigment onwy
...
/* obsowete */
#define ATOM_DP_ACTION_TWAINING_STAWT							0x02
#define ATOM_DP_ACTION_TWAINING_COMPWETE					0x03
#define ATOM_DP_ACTION_TWAINING_PATTEWN_SEW				0x04
#define ATOM_DP_ACTION_SET_VSWING_PWEEMP					0x05
#define ATOM_DP_ACTION_GET_VSWING_PWEEMP					0x06
#define ATOM_DP_ACTION_BWANKING                   0x07

// ucConfig
#define ATOM_DP_CONFIG_ENCODEW_SEW_MASK						0x03
#define ATOM_DP_CONFIG_DIG1_ENCODEW								0x00
#define ATOM_DP_CONFIG_DIG2_ENCODEW								0x01
#define ATOM_DP_CONFIG_EXTEWNAW_ENCODEW						0x02
#define ATOM_DP_CONFIG_WINK_SEW_MASK							0x04
#define ATOM_DP_CONFIG_WINK_A											0x00
#define ATOM_DP_CONFIG_WINK_B											0x04
/* /obsewete */
...
typedef stwuct _PHY_CONDITION_WEG_INFO{
  USHOWT usWegIndex;
  USHOWT usSize;
  PHY_CONDITION_WEG_VAW asWegVaw[];
}PHY_CONDITION_WEG_INFO;

typedef stwuct _PHY_CONDITION_WEG_INFO_V2{
  USHOWT usWegIndex;
  USHOWT usSize;
  PHY_CONDITION_WEG_VAW_V2 asWegVaw[];
...
typedef stwuct _PHY_ANAWOG_SETTING_INFO{
  ...
  UCHAW  ucPhySew;
  USHOWT usSize;
  PHY_CONDITION_WEG_INFO  asAnawogSetting[];
...
typedef stwuct _PHY_ANAWOG_SETTING_INFO_V2{
  ...
  UCHAW  ucPhySew;
  USHOWT usSize;
  PHY_CONDITION_WEG_INFO_V2  asAnawogSetting[];
...
/****************************************************************************/	
//Powtion VI: Definitinos being obosewete
/****************************************************************************/
...
// Fowwowing definitions awe fow compatibiwity issue in diffewent SW components. 
...
//
#define ATOM_S2_CWT1_DPMS_STATE         0x00010000W
#define ATOM_S2_WCD1_DPMS_STATE	        0x00020000W
#define ATOM_S2_TV1_DPMS_STATE          0x00040000W
#define ATOM_S2_DFP1_DPMS_STATE         0x00080000W
#define ATOM_S2_CWT2_DPMS_STATE         0x00100000W
#define ATOM_S2_WCD2_DPMS_STATE         0x00200000W
#define ATOM_S2_TV2_DPMS_STATE          0x00400000W
#define ATOM_S2_DFP2_DPMS_STATE         0x00800000W
#define ATOM_S2_CV_DPMS_STATE           0x01000000W
#define ATOM_S2_DFP3_DPMS_STATE					0x02000000W
#define ATOM_S2_DFP4_DPMS_STATE					0x04000000W
#define ATOM_S2_DFP5_DPMS_STATE					0x08000000W

#define ATOM_S2_CWT1_DPMS_STATEb2       0x01
#define ATOM_S2_WCD1_DPMS_STATEb2       0x02
#define ATOM_S2_TV1_DPMS_STATEb2        0x04
#define ATOM_S2_DFP1_DPMS_STATEb2       0x08
#define ATOM_S2_CWT2_DPMS_STATEb2       0x10
#define ATOM_S2_WCD2_DPMS_STATEb2       0x20
...
#define ATOM_S3_AWWOW_FAST_PWW_SWITCHb3 0x40
#define ATOM_S3_WQST_GPU_USE_MIN_PWWb3  0x80
...
typedef stwuct {
  ...
  UWONG VBIOSImageOffset; //0x34. Offset to the fiwst GOP_VBIOS_CONTENT bwock fwom the beginning of the stwuctuwe.
  UWONG Wib1ImageOffset;  //0x38. Offset to the fiwst GOP_WIB1_CONTENT bwock fwom the beginning of the stwuctuwe.
