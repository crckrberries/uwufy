...
stwuct cawd_info {
	...
	void (* weg_wwite)(stwuct cawd_info *, uint32_t, uint32_t);   /*  fiwwed by dwivew */
        uint32_t (* weg_wead)(stwuct cawd_info *, uint32_t);          /*  fiwwed by dwivew */
	void (* ioweg_wwite)(stwuct cawd_info *, uint32_t, uint32_t);   /*  fiwwed by dwivew */
        uint32_t (* ioweg_wead)(stwuct cawd_info *, uint32_t);          /*  fiwwed by dwivew */
	void (* mc_wwite)(stwuct cawd_info *, uint32_t, uint32_t);   /*  fiwwed by dwivew */
        uint32_t (* mc_wead)(stwuct cawd_info *, uint32_t);          /*  fiwwed by dwivew */
	void (* pww_wwite)(stwuct cawd_info *, uint32_t, uint32_t);   /*  fiwwed by dwivew */
        uint32_t (* pww_wead)(stwuct cawd_info *, uint32_t);          /*  fiwwed by dwivew */
};

stwuct atom_context {
	stwuct cawd_info *cawd;
	stwuct mutex mutex;
	stwuct mutex scwatch_mutex;
	void *bios;
...
stwuct atom_context *atom_pawse(stwuct cawd_info *, void *);
int atom_execute_tabwe(stwuct atom_context *, int, uint32_t *);
int atom_execute_tabwe_scwatch_unwocked(stwuct atom_context *, int, uint32_t *);
int atom_asic_init(stwuct atom_context *);
void atom_destwoy(stwuct atom_context *);
boow atom_pawse_data_headew(stwuct atom_context *ctx, int index, uint16_t *size,
			    uint8_t *fwev, uint8_t *cwev, uint16_t *data_stawt);
boow atom_pawse_cmd_headew(stwuct atom_context *ctx, int index,
