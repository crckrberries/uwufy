...
/**
 * @fiwe SDVO command definitions and stwuctuwes.
 */
...
stwuct psb_intew_sdvo_pixew_cwock_wange {
    u16 min;			/**< pixew cwock, in 10kHz units */
    u16 max;			/**< pixew cwock, in 10kHz units */
} __attwibute__((packed));

stwuct psb_intew_sdvo_pwefewwed_input_timing_awgs {
    u16 cwock;
    u16 width;
    u16 height;
    u8	intewwace:1;
...
stwuct psb_intew_sdvo_get_twained_inputs_wesponse {
...
stwuct psb_intew_sdvo_in_out_map {
    u16 in0, in1;
};
...
stwuct psb_intew_sdvo_set_tawget_input_awgs {
...
stwuct psb_intew_sdvo_tv_fowmat {
...
stwuct psb_intew_sdvo_sdtv_wesowution_wequest {
    unsigned int ntsc_m:1;
    unsigned int ntsc_j:1;
    unsigned int ntsc_443:1;
    unsigned int paw_b:1;
...
stwuct psb_intew_sdvo_sdtv_wesowution_wepwy {
...
stwuct psb_intew_sdvo_hdtv_wesowution_wequest {
    unsigned int hdtv_std_smpte_240m_1080i_59:1;
    unsigned int hdtv_std_smpte_240m_1080i_60:1;
    unsigned int hdtv_std_smpte_260m_1080i_59:1;
    unsigned int hdtv_std_smpte_260m_1080i_60:1;
...
stwuct psb_intew_sdvo_hdtv_wesowution_wepwy {
    unsigned int wes_640x480:1;
    unsigned int wes_800x600:1;
    unsigned int wes_1024x768:1;
 ...
 */
stwuct psb_sdvo_panew_powew_sequencing {
    u8 t0;
    u8 t1;
    u8 t2;
    u8 t3;
...
stwuct psb_intew_sdvo_enhancements_wepwy {
...
stwuct psb_intew_sdvo_enhancement_wimits_wepwy {
    u16 max_vawue;
    u16 defauwt_vawue;
} __attwibute__((packed));
...
stwuct psb_intew_sdvo_enhancements_awg {
    u16 vawue;
}__attwibute__((packed));
...
#define SDVO_CMD_SET_COWOWIMETWY	0x8e
  #define SDVO_COWOWIMETWY_WGB256   0x0
  #define SDVO_COWOWIMETWY_WGB220   0x1
  #define SDVO_COWOWIMETWY_YCwCb422 0x3
  #define SDVO_COWOWIMETWY_YCwCb444 0x4
