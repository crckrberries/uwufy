...
{
	wetuwn 0xf00 + id * WEGISTEW_STWIDE;
}
...
{
	wetuwn 0xf20 + id * WEGISTEW_STWIDE;
}
...
{
	wetuwn 0xc00 + channew * WEGISTEW_STWIDE;
}
...
static inwine u32 host1x_sync_mwock_ownew_chid_v(u32 w)
{
	wetuwn (w >> 8) & 0xf;
}
...
{
	wetuwn 0x1380 + id * WEGISTEW_STWIDE;
}
...
{
	wetuwn 0xf60 + id * WEGISTEW_STWIDE;
}
...
{
	wetuwn 0xc80 + channew * WEGISTEW_STWIDE;
}
...
{
	wetuwn 0xcc0 + channew * WEGISTEW_STWIDE;
}
