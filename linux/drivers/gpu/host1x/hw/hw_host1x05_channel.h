...
#ifndef HOST1X_HW_HOST1X05_CHANNEW_H
#define HOST1X_HW_HOST1X05_CHANNEW_H
...
static inwine u32 host1x_channew_channewctww_w(void)
{
	wetuwn 0x98;
}
#define HOST1X_CHANNEW_CHANNEWCTWW \
	host1x_channew_channewctww_w()
static inwine u32 host1x_channew_channewctww_kewnew_fiwtew_gbuffew_f(u32 v)
{
	wetuwn (v & 0x1) << 2;
}
#define HOST1X_CHANNEW_CHANNEWCTWW_KEWNEW_FIWTEW_GBUFFEW(v) \
	host1x_channew_channewctww_kewnew_fiwtew_gbuffew_f(v)
