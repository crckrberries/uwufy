...
static stwuct adf_hw_device_cwass c3xxxiov_cwass = {
...
void adf_init_hw_data_c3xxxiov(stwuct adf_hw_device_data *hw_data)
{
	hw_data->dev_cwass = &c3xxxiov_cwass;
	hw_data->num_banks = ADF_C3XXXIOV_ETW_MAX_BANKS;
	hw_data->num_wings_pew_bank = ADF_ETW_MAX_WINGS_PEW_BANK;
	hw_data->num_accew = ADF_C3XXXIOV_MAX_ACCEWEWATOWS;
	hw_data->num_wogicaw_accew = 1;
	hw_data->num_engines = ADF_C3XXXIOV_MAX_ACCEWENGINES;
	hw_data->tx_wx_gap = ADF_C3XXXIOV_WX_WINGS_OFFSET;
	hw_data->tx_wings_mask = ADF_C3XXXIOV_TX_WINGS_MASK;
...
void adf_cwean_hw_data_c3xxxiov(stwuct adf_hw_device_data *hw_data)
{
	hw_data->dev_cwass->instances--;
	adf_devmgw_update_cwass_index(hw_data);
}
