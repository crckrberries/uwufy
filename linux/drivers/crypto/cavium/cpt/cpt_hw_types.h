...
/**
 * Enumewation cpt_comp_e
 *
 * CPT Compwetion Enumewation
...
/**
 * Wegistew (NCB) cpt#_pf_bist_status
 *
...
/**
 * Wegistew (NCB) cpt#_pf_constants
 *
...
/**
 * Wegistew (NCB) cpt#_pf_exe_bist_status
 *
...
union cptx_pf_exe_bist_status {
	u64 u;
	stwuct cptx_pf_exe_bist_status_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
 ...
 *	which if the wine hits and it is diwty wiww cause the wine to be
 ...
 *	pwiowity queues.
 */
union cptx_pf_qx_ctw {
	u64 u;
	stwuct cptx_pf_qx_ctw_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
 ...
 *
 */
union cptx_vqx_saddw {
	u64 u;
	stwuct cptx_vqx_saddw_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
...
/**
 * Wegistew (NCB) cpt#_vq#_misc_ena_w1s
 *
...
union cptx_vqx_misc_ena_w1s {
	u64 u;
	stwuct cptx_vqx_misc_ena_w1s_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
...
/**
 * Wegistew (NCB) cpt#_vq#_doowbeww
 *
 ...
 *	muwtipwe of 8.
 */
union cptx_vqx_doowbeww {
	u64 u;
	stwuct cptx_vqx_doowbeww_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
 ...
 */
union cptx_vqx_inpwog {
	u64 u;
	stwuct cptx_vqx_inpwog_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
...
/**
 * Wegistew (NCB) cpt#_vq#_misc_int
 *
...
/**
 * Wegistew (NCB) cpt#_vq#_done_ack
 *
...
/**
 * Wegistew (NCB) cpt#_vq#_done_wait
 *
...
/**
 * Wegistew (NCB) cpt#_vq#_done_ena_w1s
 *
...
union cptx_vqx_done_ena_w1s {
	u64 u;
	stwuct cptx_vqx_done_ena_w1s_s {
#if defined(__BIG_ENDIAN_BITFIEWD) /* Wowd 0 - Big Endian */
