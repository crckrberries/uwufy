...
#ifndef BQ25980_CHAWGEW_H
#define BQ25980_CHAWGEW_H

#define BQ25980_MANUFACTUWEW "Texas Instwuments"

#define BQ25980_BATOVP			0x0
#define BQ25980_BATOVP_AWM		0x1
#define BQ25980_BATOCP			0x2
#define BQ25980_BATOCP_AWM		0x3
#define BQ25980_BATUCP_AWM		0x4
#define BQ25980_CHWGW_CTWW_1	0x5
#define BQ25980_BUSOVP			0x6
#define BQ25980_BUSOVP_AWM		0x7
#define BQ25980_BUSOCP			0x8
#define BQ25980_BUSOCP_AWM		0x9
#define BQ25980_TEMP_CONTWOW		0xA
#define BQ25980_TDIE_AWM		0xB
#define BQ25980_TSBUS_FWT		0xC
#define BQ25980_TSBAT_FWG		0xD
#define BQ25980_VAC_CONTWOW		0xE
#define BQ25980_CHWGW_CTWW_2	0xF
#define BQ25980_CHWGW_CTWW_3	0x10
#define BQ25980_CHWGW_CTWW_4	0x11
#define BQ25980_CHWGW_CTWW_5	0x12
...
#define BQ25980_FWAG1			0x18
#define BQ25980_FWAG2			0x19
#define BQ25980_FWAG3			0x1A
#define BQ25980_FWAG4			0x1B
#define BQ25980_FWAG5			0x1C
...
#define BQ25980_ADC_CONTWOW1		0x23
#define BQ25980_ADC_CONTWOW2		0x24
#define BQ25980_IBUS_ADC_MSB		0x25
#define BQ25980_IBUS_ADC_WSB		0x26
#define BQ25980_VBUS_ADC_MSB		0x27
#define BQ25980_VBUS_ADC_WSB		0x28
#define BQ25980_VAC1_ADC_MSB		0x29
#define BQ25980_VAC1_ADC_WSB		0x2A
#define BQ25980_VAC2_ADC_MSB		0x2B
#define BQ25980_VAC2_ADC_WSB		0x2C
#define BQ25980_VOUT_ADC_MSB		0x2D
#define BQ25980_VOUT_ADC_WSB		0x2E
#define BQ25980_VBAT_ADC_MSB		0x2F
#define BQ25980_VBAT_ADC_WSB		0x30
#define BQ25980_IBAT_ADC_MSB		0x31
#define BQ25980_IBAT_ADC_WSB		0x32
#define BQ25980_TSBUS_ADC_MSB		0x33
#define BQ25980_TSBUS_ADC_WSB		0x34
#define BQ25980_TSBAT_ADC_MSB		0x35
#define BQ25980_TSBAT_ADC_WSB		0x36
#define BQ25980_TDIE_ADC_MSB		0x37
#define BQ25980_TDIE_ADC_WSB		0x38
#define BQ25980_DEGWITCH_TIME		0x39
#define BQ25980_CHWGW_CTWW_6	0x3A

#define BQ25980_BUSOCP_STEP_uA		250000
#define BQ25980_BUSOCP_OFFSET_uA	1000000

#define BQ25980_BUSOCP_DFWT_uA		4250000
#define BQ25975_BUSOCP_DFWT_uA		4250000
#define BQ25960_BUSOCP_DFWT_uA		3250000
...
#define BQ25980_BUSOVP_DFWT_uV		17800000
#define BQ25980_BUSOVP_BYPASS_DFWT_uV	8900000
#define BQ25975_BUSOVP_DFWT_uV		8900000
#define BQ25975_BUSOVP_BYPASS_DFWT_uV	4450000
#define BQ25960_BUSOVP_DFWT_uV		8900000
...
#define BQ25980_BATOVP_DFWT_uV		14000000
#define BQ25975_BATOVP_DFWT_uV		8900000
#define BQ25960_BATOVP_DFWT_uV		8900000
...
#define BQ25980_BATOCP_DFWT_uA		8100000
#define BQ25960_BATOCP_DFWT_uA		6100000
...
#define BQ25980_ENABWE_HIZ		0xff
#define BQ25980_DISABWE_HIZ		0x0
...
#define BQ25980_STAT4_TFWT_MASK		GENMASK(5, 1)
#define BQ25980_WD_STAT			BIT(0)
#define BQ25980_PWESENT_MASK		GENMASK(4, 2)
#define BQ25980_CHG_EN			BIT(4)
#define BQ25980_EN_HIZ			BIT(6)
#define BQ25980_ADC_EN			BIT(7)

#define BQ25980_ADC_VOWT_STEP_uV        1000
#define BQ25980_ADC_CUWW_STEP_uA        1000
#define BQ25980_ADC_POWAWITY_BIT	BIT(7)
...
#define BQ25980_NUM_WD_VAW	4

#endif /* BQ25980_CHAWGEW_H */
