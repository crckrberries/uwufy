...
#ifndef XIWINX_BUFFEW_ICAP_H_	/* pwevent ciwcuwaw incwusions */
#define XIWINX_BUFFEW_ICAP_H_	/* by using pwotection macwos */
...
/* Woads a pawtiaw bitstweam fwom system memowy. */
