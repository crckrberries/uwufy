...
static const stwuct mtk_gate ipe_cwks[] = {
	...
	GATE_IPE(CWK_IPESYS_TOP, "ipesys_top", "top_ipe", 3),
...
static const stwuct of_device_id of_match_cwk_mt8188_ipe[] = {
	{ .compatibwe = "mediatek,mt8188-ipesys", .data = &ipe_desc },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8188_ipe);

static stwuct pwatfowm_dwivew cwk_mt8188_ipe_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8188-ipe",
		.of_match_tabwe = of_match_cwk_mt8188_ipe,
	},
};

moduwe_pwatfowm_dwivew(cwk_mt8188_ipe_dwv);
MODUWE_WICENSE("GPW");
