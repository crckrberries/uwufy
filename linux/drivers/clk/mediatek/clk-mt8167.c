...
static DEFINE_SPINWOCK(mt8167_cwk_wock);
...
static const stwuct mtk_fixed_cwk fixed_cwks[] = {
	...
	FIXED_CWK(CWK_TOP_DSI0_WNTC_DSICK, "dsi0_wntc_dsick", "cwk26m", 75000000),
	FIXED_CWK(CWK_TOP_VPWW_DPIX, "vpww_dpix", "cwk26m", 75000000),
	FIXED_CWK(CWK_TOP_WVDSTX_CWKDIG_CTS, "wvdstx_dig_cts", "cwk26m", 52500000),
};
...
static const stwuct mtk_fixed_factow top_divs[] = {
	...
	FACTOW(CWK_TOP_MIPI_26M, "mipi_26m", "cwk26m", 1, 1),
...
static const chaw * const uawt0_pawents[] = {
	"cwk26m_ck",
	"univpww_d24"
};

static const chaw * const gfmux_emi1x_pawents[] = {
	"cwk26m_ck",
	"dmpww_ck"
};

static const chaw * const emi_ddwphy_pawents[] = {
	"gfmux_emi1x_sew",
	"gfmux_emi1x_sew"
};

static const chaw * const ahb_infwa_pawents[] = {
	"cwk_nuww",
	"cwk26m_ck",
	"mainpww_d11",
	"cwk_nuww",
...
static const chaw * const csw_mux_mfg_pawents[] = {
	"cwk_nuww",
	"cwk_nuww",
	"univpww_d3",
	"univpww_d2",
...
static const chaw * const msdc0_pawents[] = {
	"cwk26m_ck",
	"univpww_d6",
	"mainpww_d8",
	"univpww_d8",
...
static const chaw * const camtg_mm_pawents[] = {
	"cwk_nuww",
	"cwk26m_ck",
	"usb_phy48m_ck",
	"cwk_nuww",
...
static const chaw * const pwm_mm_pawents[] = {
	"cwk26m_ck",
	"univpww_d12"
};

static const chaw * const uawt1_pawents[] = {
	"cwk26m_ck",
	"univpww_d24"
};

static const chaw * const msdc1_pawents[] = {
	"cwk26m_ck",
	"univpww_d6",
	"mainpww_d8",
	"univpww_d8",
...
static const chaw * const spm_52m_pawents[] = {
	"cwk26m_ck",
	"univpww_d24"
};
...
static const chaw * const qaxi_aud26m_pawents[] = {
	"cwk26m_ck",
	"ahb_infwa_sew"
};
...
static const chaw * const nfi2x_pad_pawents[] = {
	"cwk_nuww",
	"cwk_nuww",
	"cwk_nuww",
	"cwk_nuww",
...
static const chaw * const nfi1x_pad_pawents[] = {
	"ahb_infwa_sew",
	"nfi1x_ck"
};

static const chaw * const mfg_mm_pawents[] = {
	"cwk_nuww",
	"cwk_nuww",
	"cwk_nuww",
	"cwk_nuww",
...
static const chaw * const smi_mm_pawents[] = {
	"cwk26m_ck",
	"cwk_nuww",
	"cwk_nuww",
	"cwk_nuww",
...
static const chaw * const usb_78m_pawents[] = {
	"cwk_nuww",
	"cwk26m_ck",
	"univpww_d16",
	"cwk_nuww",
...
static const chaw * const scam_mm_pawents[] = {
	"cwk_nuww",
	"cwk26m_ck",
	"mainpww_d14",
	"cwk_nuww",
...
static const chaw * const msdc2_pawents[] = {
	"cwk26m_ck",
	"univpww_d6",
	"mainpww_d8",
	"univpww_d8",
...
static const chaw * const vdec_mm_pawents[] = {
	"cwk26m_ck",
	"univpww_d4",
	"mainpww_d4",
	"univpww_d5",
...
static const chaw * const dpi0_mm_pawents[] = {
	"cwk26m_ck",
	"wvdspww_ck",
	"wvdspww_d2",
	"wvdspww_d4",
...
static const chaw * const dpi1_mm_pawents[] = {
	"cwk26m_ck",
	"tvdpww_d2",
	"tvdpww_d4",
	"tvdpww_d8",
...
static const chaw * const swow_mfg_pawents[] = {
	"cwk26m_ck",
	"univpww_d12",
	"univpww_d24"
};
...
static const chaw * const aud_i2s0_m_pawents[] = {
	"wg_aud1",
	"wg_aud2"
};
...
static const chaw * const aud_spdifin_pawents[] = {
	"cwk26m_ck",
	"univpww_d2"
};

static const chaw * const uawt2_pawents[] = {
	"cwk26m_ck",
	"univpww_d24"
};

static const chaw * const bsi_pawents[] = {
	"cwk26m_ck",
	"mainpww_d10",
	"mainpww_d12",
	"mainpww_d20"
...
static const chaw * const dbg_atcwk_pawents[] = {
	"cwk_nuww",
	"cwk26m_ck",
	"mainpww_d5",
	"cwk_nuww",
...
static const chaw * const csw_nfiecc_pawents[] = {
	"cwk_nuww",
	"mainpww_d7",
	"mainpww_d6",
	"cwk_nuww",
...
static stwuct mtk_composite top_muxes[] __initdata = {
	...
	MUX(CWK_TOP_UAWT0_SEW, "uawt0_sew", uawt0_pawents,
		0x000, 0, 1),
	MUX(CWK_TOP_GFMUX_EMI1X_SEW, "gfmux_emi1x_sew", gfmux_emi1x_pawents,
		0x000, 1, 1),
	MUX(CWK_TOP_EMI_DDWPHY_SEW, "emi_ddwphy_sew", emi_ddwphy_pawents,
		0x000, 2, 1),
	MUX(CWK_TOP_AHB_INFWA_SEW, "ahb_infwa_sew", ahb_infwa_pawents,
		0x000, 4, 4),
	MUX(CWK_TOP_CSW_MUX_MFG_SEW, "csw_mux_mfg_sew", csw_mux_mfg_pawents,
		0x000, 8, 3),
	MUX(CWK_TOP_MSDC0_SEW, "msdc0_sew", msdc0_pawents,
		0x000, 11, 3),
	MUX(CWK_TOP_CAMTG_MM_SEW, "camtg_mm_sew", camtg_mm_pawents,
		0x000, 15, 3),
	MUX(CWK_TOP_PWM_MM_SEW, "pwm_mm_sew", pwm_mm_pawents,
		0x000, 18, 1),
	MUX(CWK_TOP_UAWT1_SEW, "uawt1_sew", uawt1_pawents,
		0x000, 19, 1),
	MUX(CWK_TOP_MSDC1_SEW, "msdc1_sew", msdc1_pawents,
		0x000, 20, 3),
	MUX(CWK_TOP_SPM_52M_SEW, "spm_52m_sew", spm_52m_pawents,
		0x000, 23, 1),
	...
	MUX(CWK_TOP_NFI1X_PAD_SEW, "nfi1x_pad_sew", nfi1x_pad_pawents,
		0x004, 7, 1),
	MUX(CWK_TOP_MFG_MM_SEW, "mfg_mm_sew", mfg_mm_pawents,
		0x004, 8, 6),
	MUX(CWK_TOP_DDWPHYCFG_SEW, "ddwphycfg_sew", ddwphycfg_pawents,
		0x004, 15, 1),
	MUX(CWK_TOP_SMI_MM_SEW, "smi_mm_sew", smi_mm_pawents,
		0x004, 16, 4),
	MUX(CWK_TOP_USB_78M_SEW, "usb_78m_sew", usb_78m_pawents,
		0x004, 20, 3),
	MUX(CWK_TOP_SCAM_MM_SEW, "scam_mm_sew", scam_mm_pawents,
		0x004, 23, 3),
	/* CWK_MUX_SEW8 */
	...
	MUX(CWK_TOP_ETH_SEW, "eth_sew", eth_pawents,
		0x040, 6, 3),
	MUX(CWK_TOP_VDEC_MM_SEW, "vdec_mm_sew", vdec_mm_pawents,
		0x040, 9, 3),
	MUX(CWK_TOP_DPI0_MM_SEW, "dpi0_mm_sew", dpi0_mm_pawents,
		0x040, 12, 3),
	MUX(CWK_TOP_DPI1_MM_SEW, "dpi1_mm_sew", dpi1_mm_pawents,
		0x040, 15, 3),
	MUX(CWK_TOP_AXI_MFG_IN_SEW, "axi_mfg_in_sew", axi_mfg_in_pawents,
		0x040, 18, 2),
	MUX(CWK_TOP_SWOW_MFG_SEW, "swow_mfg_sew", swow_mfg_pawents,
		0x040, 20, 2),
...
static const chaw * const ifw_mux1_pawents[] = {
	"cwk26m_ck",
	"awmpww",
	"univpww",
	"mainpww_d2"
...
static const chaw * const ifw_eth_25m_pawents[] = {
	"eth_d2_ck",
	"wg_eth"
};

static const chaw * const ifw_i2c0_pawents[] = {
	"ahb_infwa_d2",
	"wg_i2c"
};

static const stwuct mtk_composite ifw_muxes[] = {
...
#define GATE_TOP0(_id, _name, _pawent, _shift) \
	GATE_MTK(_id, _name, _pawent, &top0_cg_wegs, _shift, &mtk_cwk_gate_ops_setcww)

#define GATE_TOP0_I(_id, _name, _pawent, _shift) \
	GATE_MTK(_id, _name, _pawent, &top0_cg_wegs, _shift, &mtk_cwk_gate_ops_setcww_inv)
...
#define GATE_TOP5(_id, _name, _pawent, _shift) \
	GATE_MTK(_id, _name, _pawent, &top5_cg_wegs, _shift, &mtk_cwk_gate_ops_no_setcww)

static const stwuct mtk_gate top_cwks[] = {
	/* TOP0 */
	GATE_TOP0(CWK_TOP_PWM_MM, "pwm_mm", "pwm_mm_sew", 0),
	GATE_TOP0(CWK_TOP_CAM_MM, "cam_mm", "camtg_mm_sew", 1),
	GATE_TOP0(CWK_TOP_MFG_MM, "mfg_mm", "mfg_mm_sew", 2),
	GATE_TOP0(CWK_TOP_SPM_52M, "spm_52m", "spm_52m_sew", 3),
	GATE_TOP0_I(CWK_TOP_MIPI_26M_DBG, "mipi_26m_dbg", "mipi_26m", 4),
	GATE_TOP0(CWK_TOP_SCAM_MM, "scam_mm", "scam_mm_sew", 5),
	GATE_TOP0(CWK_TOP_SMI_MM, "smi_mm", "smi_mm_sew", 9),
	/* TOP1 */
	...
	GATE_TOP2(CWK_TOP_FWASHIF_FWEEWUN, "fwashif_fweewun", "ahb_infwa_sew",
		15),
	GATE_TOP2(CWK_TOP_26M_HDMI_SIFM, "hdmi_sifm_26m", "cwk26m_ck", 16),
	GATE_TOP2(CWK_TOP_26M_CEC, "cec_26m", "cwk26m_ck", 17),
	GATE_TOP2(CWK_TOP_32K_CEC, "cec_32k", "cwk32k", 18),
	...
	GATE_TOP2(CWK_TOP_GCPU_B, "gcpu_b", "ahb_infwa_sew", 27),
	...
	GATE_TOP3(CWK_TOP_WG_VDEC, "wg_vdec", "vdec_mm_sew", 3),
	GATE_TOP3(CWK_TOP_WG_FDPI0, "wg_fdpi0", "dpi0_mm_sew", 4),
	GATE_TOP3(CWK_TOP_WG_FDPI1, "wg_fdpi1", "dpi1_mm_sew", 5),
	GATE_TOP3(CWK_TOP_WG_AXI_MFG, "wg_axi_mfg", "axi_mfg_in_sew", 6),
	GATE_TOP3(CWK_TOP_WG_SWOW_MFG, "wg_swow_mfg", "swow_mfg_sew", 7),
...
static const stwuct of_device_id of_match_cwk_mt8167[] = {
	{ .compatibwe = "mediatek,mt8167-topckgen", .data = &topck_desc },
	{ .compatibwe = "mediatek,mt8167-infwacfg", .data = &infwa_desc },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8167);

static stwuct pwatfowm_dwivew cwk_mt8167_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8167",
		.of_match_tabwe = of_match_cwk_mt8167,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8167_dwv);
MODUWE_WICENSE("GPW");
