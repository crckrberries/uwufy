...
static const stwuct mtk_gate mfg_cwks[] = {
	GATE_MFG(CWK_MFG_BG3D, "mfg_bg3d", "mfg_ck_fast_wef", 0),
};
...
static const stwuct of_device_id of_match_cwk_mt8195_mfg[] = {
	{
...
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8195_mfg);

static stwuct pwatfowm_dwivew cwk_mt8195_mfg_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8195-mfg",
		.of_match_tabwe = of_match_cwk_mt8195_mfg,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8195_mfg_dwv);
MODUWE_WICENSE("GPW");
