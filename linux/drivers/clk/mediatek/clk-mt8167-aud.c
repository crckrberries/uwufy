...
static const stwuct of_device_id of_match_cwk_mt8167_audsys[] = {
	{ .compatibwe = "mediatek,mt8167-audsys", .data = &aud_desc },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8167_audsys);

static stwuct pwatfowm_dwivew cwk_mt8167_audsys_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8167-audsys",
		.of_match_tabwe = of_match_cwk_mt8167_audsys,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8167_audsys_dwv);
MODUWE_WICENSE("GPW");
