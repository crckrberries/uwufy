...
static DEFINE_SPINWOCK(mt8188_cwk_wock);

static const stwuct mtk_fixed_cwk top_fixed_cwks[] = {
	FIXED_CWK(CWK_TOP_UWPOSC1, "uwposc_ck1", NUWW, 260000000),
	FIXED_CWK(CWK_TOP_MPHONE_SWAVE_BCK, "mphone_swave_bck", NUWW, 49152000),
	FIXED_CWK(CWK_TOP_PAD_FPC, "pad_fpc_ck", NUWW, 50000000),
	FIXED_CWK(CWK_TOP_466M_FMEM, "hd_466m_fmem_ck", NUWW, 533000000),
	FIXED_CWK(CWK_TOP_PEXTP_PIPE, "pextp_pipe", NUWW, 250000000),
	FIXED_CWK(CWK_TOP_DSI_PHY, "dsi_phy", NUWW, 500000000),
};
...
static const stwuct mtk_fixed_factow top_divs[] = {
	...
	FACTOW(CWK_TOP_MAINPWW_D4_D2, "mainpww_d4_d2", "mainpww_d4", 1, 2),
	FACTOW(CWK_TOP_MAINPWW_D4_D4, "mainpww_d4_d4", "mainpww_d4", 1, 4),
	FACTOW(CWK_TOP_MAINPWW_D4_D8, "mainpww_d4_d8", "mainpww_d4", 1, 8),
	...
	FACTOW(CWK_TOP_MAINPWW_D5_D8, "mainpww_d5_d8", "mainpww_d5", 1, 8),
	FACTOW(CWK_TOP_MAINPWW_D6, "mainpww_d6", "mainpww", 1, 6),
	FACTOW(CWK_TOP_MAINPWW_D6_D2, "mainpww_d6_d2", "mainpww_d6", 1, 2),
	FACTOW(CWK_TOP_MAINPWW_D6_D4, "mainpww_d6_d4", "mainpww_d6", 1, 4),
	FACTOW(CWK_TOP_MAINPWW_D6_D8, "mainpww_d6_d8", "mainpww_d6", 1, 8),
	...
	FACTOW(CWK_TOP_MAINPWW_D7_D8, "mainpww_d7_d8", "mainpww_d7", 1, 8),
	FACTOW(CWK_TOP_MAINPWW_D9, "mainpww_d9", "mainpww", 1, 9),
	...
	FACTOW(CWK_TOP_UNIVPWW_D4_D2, "univpww_d4_d2", "univpww_d4", 1, 2),
	FACTOW(CWK_TOP_UNIVPWW_D4_D4, "univpww_d4_d4", "univpww_d4", 1, 4),
	FACTOW(CWK_TOP_UNIVPWW_D4_D8, "univpww_d4_d8", "univpww_d4", 1, 8),
	...
	FACTOW(CWK_TOP_UNIVPWW_D6_D2, "univpww_d6_d2", "univpww_d6", 1, 2),
	FACTOW(CWK_TOP_UNIVPWW_D6_D4, "univpww_d6_d4", "univpww_d6", 1, 4),
	FACTOW(CWK_TOP_UNIVPWW_D6_D8, "univpww_d6_d8", "univpww_d6", 1, 8),
	FACTOW(CWK_TOP_UNIVPWW_D7, "univpww_d7", "univpww", 1, 7),
	FACTOW(CWK_TOP_UNIVPWW_192M, "univpww_192m", "univpww", 1, 13),
	FACTOW(CWK_TOP_UNIVPWW_192M_D4, "univpww_192m_d4", "univpww_192m", 1, 4),
	FACTOW(CWK_TOP_UNIVPWW_192M_D8, "univpww_192m_d8", "univpww_192m", 1, 8),
	FACTOW(CWK_TOP_UNIVPWW_192M_D10, "univpww_192m_d10", "univpww_192m", 1, 10),
	FACTOW(CWK_TOP_UNIVPWW_192M_D16, "univpww_192m_d16", "univpww_192m", 1, 16),
	FACTOW(CWK_TOP_UNIVPWW_192M_D32, "univpww_192m_d32", "univpww_192m", 1, 32),
	...
	FACTOW(CWK_TOP_ETHPWW_D4, "ethpww_d4", "ethpww", 1, 4),
	...
	FACTOW(CWK_TOP_UWPOSC1_D2, "uwposc1_d2", "uwposc_ck1", 1, 2),
	FACTOW(CWK_TOP_UWPOSC1_D4, "uwposc1_d4", "uwposc_ck1", 1, 4),
	FACTOW(CWK_TOP_UWPOSC1_D8, "uwposc1_d8", "uwposc_ck1", 1, 8),
	FACTOW(CWK_TOP_UWPOSC1_D7, "uwposc1_d7", "uwposc_ck1", 1, 7),
	FACTOW(CWK_TOP_UWPOSC1_D10, "uwposc1_d10", "uwposc_ck1", 1, 10),
	FACTOW(CWK_TOP_UWPOSC1_D16, "uwposc1_d16", "uwposc_ck1", 1, 16),
};
...
static const chaw * const ccu_ahb_pawents[] = {
	"cwk26m",
	"univpww_d6",
	"mainpww_d4_d2",
	"mainpww_d4",
...
static const chaw * const dsp4_pawents[] = {
	"cwk26m",
	"univpww_d6_d2",
	"univpww_d4_d2",
	"mainpww_d4",
...
static const chaw * const dsp5_pawents[] = {
	"cwk26m",
	"univpww_d6_d2",
	"univpww_d4_d2",
	"mainpww_d4",
...
static const chaw * const dsp6_pawents[] = {
	"cwk26m",
	"univpww_d6_d2",
	"univpww_d4_d2",
	"mainpww_d4",
...
static const chaw * const mfg_cowe_tmp_pawents[] = {
	"cwk26m",
	"mainpww_d5_d2",
	"univpww_d6",
	"univpww_d7"
...
static const chaw * const disp_pwm0_pawents[] = {
	"cwk26m",
	"univpww_d6_d4",
	"uwposc1_d2",
	"uwposc1_d4",
...
static const chaw * const disp_pwm1_pawents[] = {
	"cwk26m",
	"univpww_d6_d4",
	"uwposc1_d2",
	"uwposc1_d4",
...
static const chaw * const usb_2p_pawents[] = {
	"cwk26m",
	"univpww_d5_d4",
	"univpww_d6_d4",
	"univpww_d5_d2"
...
static const chaw * const ssusb_xhci_2p_pawents[] = {
	"cwk26m",
	"univpww_d5_d4",
	"univpww_d6_d4",
	"univpww_d5_d2"
...
static const chaw * const usb_3p_pawents[] = {
	"cwk26m",
	"univpww_d5_d4",
	"univpww_d6_d4",
	"univpww_d5_d2"
...
static const chaw * const ssusb_xhci_3p_pawents[] = {
	"cwk26m",
	"univpww_d5_d4",
	"univpww_d6_d4",
	"univpww_d5_d2"
...
static const chaw * const spmi_p_mst_pawents[] = {
	"cwk26m",
	"cwk13m",
	"uwposc1_d8",
	"uwposc1_d10",
...
static const chaw * const spmi_m_mst_pawents[] = {
	"cwk26m",
	"cwk13m",
	"uwposc1_d8",
	"uwposc1_d10",
...
static const chaw * const asm_h_pawents[] = {
	"cwk26m",
	"univpww_d6_d4",
	"univpww_d6_d2",
	"mainpww_d5_d2"
...
static const chaw * const i2so2_pawents[] = {
	"cwk26m",
	"apww1",
	"apww2",
	"apww3",
...
static const chaw * const i2si1_pawents[] = {
	"cwk26m",
	"apww1",
	"apww2",
	"apww3",
...
static const chaw * const i2si2_pawents[] = {
	"cwk26m",
	"apww1",
	"apww2",
	"apww3",
...
static const chaw * const dptx_pawents[] = {
	"cwk26m",
	"apww1",
	"apww2",
	"apww3",
...
static const chaw * const aud_iec_pawents[] = {
	"cwk26m",
	"apww1",
	"apww2",
	"apww3",
...
static const chaw * const a4sys_pawents[] = {
	"cwk26m",
	"apww3_d4",
	"apww4_d4",
	"apww5_d4"
...
static const chaw * const mfg_fast_wef_pawents[] = {
	"top_mfg_cowe_tmp",
	"mfgpww"
};
...
static const stwuct mtk_mux top_mtk_muxes[] = {
	/*
	 * CWK_CFG_0
	 * axi_sew and bus_aximem_sew awe bus cwocks, shouwd not be cwosed by Winux.
	 * spm_sew and scp_sew awe main cwocks in awways-on co-pwocessow.
	 */
	...
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_SCP, "top_scp", scp_pawents,
				   ...
				   CWK_IS_CWITICAW | CWK_SET_WATE_PAWENT),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_BUS_AXIMEM, "top_bus_aximem", bus_aximem_pawents,
	...
	MUX_GATE_CWW_SET_UPD(CWK_TOP_CCU_AHB, "top_ccu_ahb",
			     ccu_ahb_pawents, 0x038, 0x03C, 0x040, 8, 4, 15, 0x04, 9),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_IMG, "top_img",
			     img_pawents, 0x038, 0x03C, 0x040, 16, 4, 23, 0x04, 10),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_CAMTM, "top_camtm",
			     camtm_pawents, 0x038, 0x03C, 0x040, 24, 4, 31, 0x04, 11),
	/* CWK_CFG_3 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP, "top_dsp",
			     dsp_pawents, 0x044, 0x048, 0x04C, 0, 4, 7, 0x04, 12),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP1, "top_dsp1",
			     dsp1_pawents, 0x044, 0x048, 0x04C, 8, 4, 15, 0x04, 13),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP2, "top_dsp2",
			     dsp2_pawents, 0x044, 0x048, 0x04C, 16, 4, 23, 0x04, 14),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP3, "top_dsp3",
			     dsp3_pawents, 0x044, 0x048, 0x04C, 24, 4, 31, 0x04, 15),
	/* CWK_CFG_4 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP4, "top_dsp4",
			     dsp4_pawents, 0x050, 0x054, 0x058, 0, 4, 7, 0x04, 16),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP5, "top_dsp5",
			     dsp5_pawents, 0x050, 0x054, 0x058, 8, 4, 15, 0x04, 17),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP6, "top_dsp6",
			     dsp6_pawents, 0x050, 0x054, 0x058, 16, 4, 23, 0x04, 18),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSP7, "top_dsp7",
			     dsp7_pawents, 0x050, 0x054, 0x058, 24, 4, 31, 0x04, 19),
	/* CWK_CFG_5 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_MFG_COWE_TMP, "top_mfg_cowe_tmp",
			     mfg_cowe_tmp_pawents, 0x05C, 0x060, 0x064, 0, 4, 7, 0x04, 20),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_CAMTG, "top_camtg",
			     camtg_pawents, 0x05C, 0x060, 0x064, 8, 4, 15, 0x04, 21),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_CAMTG2, "top_camtg2",
			     camtg2_pawents, 0x05C, 0x060, 0x064, 16, 4, 23, 0x04, 22),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_CAMTG3, "top_camtg3",
			     camtg3_pawents, 0x05C, 0x060, 0x064, 24, 4, 31, 0x04, 23),
	/* CWK_CFG_6 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_UAWT, "top_uawt",
			     uawt_pawents, 0x068, 0x06C, 0x070, 0, 4, 7, 0x04, 24),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SPI, "top_spi",
			     spi_pawents, 0x068, 0x06C, 0x070, 8, 4, 15, 0x04, 25),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_MSDC50_0_HCWK, "top_msdc5hcwk",
				   msdc5hcwk_pawents, 0x068, 0x06C, 0x070, 16, 4, 23, 0x04, 26, 0),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_MSDC50_0, "top_msdc50_0",
				   msdc50_0_pawents, 0x068, 0x06C, 0x070, 24, 4, 31, 0x04, 27, 0),
	/* CWK_CFG_7 */
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_MSDC30_1, "top_msdc30_1",
				   msdc30_1_pawents, 0x074, 0x078, 0x07C, 0, 4, 7, 0x04, 28, 0),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_MSDC30_2, "top_msdc30_2",
				   msdc30_2_pawents, 0x074, 0x078, 0x07C, 8, 4, 15, 0x04, 29, 0),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_INTDIW, "top_intdiw",
			     intdiw_pawents, 0x074, 0x078, 0x07C, 16, 4, 23, 0x04, 30),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_AUD_INTBUS, "top_aud_intbus",
			     aud_intbus_pawents, 0x074, 0x078, 0x07C, 24, 4, 31, 0x04, 31),
	/* CWK_CFG_8 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_AUDIO_H, "top_audio_h",
			     audio_h_pawents, 0x080, 0x084, 0x088, 0, 4, 7, 0x08, 0),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_PWWAP_UWPOSC, "top_pwwap_uwposc",
			     pwwap_uwposc_pawents, 0x080, 0x084, 0x088, 8, 4, 15, 0x08, 1),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_ATB, "top_atb",
			     atb_pawents, 0x080, 0x084, 0x088, 16, 4, 23, 0x08, 2),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SSPM, "top_sspm",
			     sspm_pawents, 0x080, 0x084, 0x088, 24, 4, 31, 0x08, 3),
	/* CWK_CFG_9 */
	MUX_GATE_CWW_SET_UPD_INDEXED(CWK_TOP_DP, "top_dp",
				     dp_pawents, dp_pawents_idx, 0x08C, 0x090, 0x094,
				     0, 4, 7, 0x08, 4),
	MUX_GATE_CWW_SET_UPD_INDEXED(CWK_TOP_EDP, "top_edp",
				     edp_pawents, edp_pawents_idx, 0x08C, 0x090, 0x094,
				     8, 4, 15, 0x08, 5),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DPI, "top_dpi",
			     dpi_pawents, 0x08C, 0x090, 0x094, 16, 4, 23, 0x08, 6),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DISP_PWM0, "top_disp_pwm0",
			     disp_pwm0_pawents, 0x08C, 0x090, 0x094, 24, 4, 31, 0x08, 7),
	/* CWK_CFG_10 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DISP_PWM1, "top_disp_pwm1",
			     disp_pwm1_pawents, 0x098, 0x09C, 0x0A0, 0, 4, 7, 0x08, 8),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_USB_TOP, "top_usb_top",
			     usb_pawents, 0x098, 0x09C, 0x0A0, 8, 4, 15, 0x08, 9),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SSUSB_XHCI, "top_ssusb_xhci",
			     ssusb_xhci_pawents, 0x098, 0x09C, 0x0A0, 16, 4, 23, 0x08, 10),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_USB_TOP_2P, "top_usb_top_2p",
			     usb_2p_pawents, 0x098, 0x09C, 0x0A0, 24, 4, 31, 0x08, 11),
	/* CWK_CFG_11 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SSUSB_XHCI_2P, "top_ssusb_xhci_2p",
			     ssusb_xhci_2p_pawents, 0x0A4, 0x0A8, 0x0AC, 0, 4, 7, 0x08, 12),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_USB_TOP_3P, "top_usb_top_3p",
			     usb_3p_pawents, 0x0A4, 0x0A8, 0x0AC, 8, 4, 15, 0x08, 13),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SSUSB_XHCI_3P, "top_ssusb_xhci_3p",
			     ssusb_xhci_3p_pawents, 0x0A4, 0x0A8, 0x0AC, 16, 4, 23, 0x08, 14),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_I2C, "top_i2c",
			     i2c_pawents, 0x0A4, 0x0A8, 0x0AC, 24, 4, 31, 0x08, 15),
	/* CWK_CFG_12 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SENINF, "top_seninf",
			     seninf_pawents, 0x0B0, 0x0B4, 0x0B8, 0, 4, 7, 0x08, 16),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SENINF1, "top_seninf1",
			     seninf1_pawents, 0x0B0, 0x0B4, 0x0B8, 8, 4, 15, 0x08, 17),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_GCPU, "top_gcpu",
			     gcpu_pawents, 0x0B0, 0x0B4, 0x0B8, 16, 4, 23, 0x08, 18),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_VENC, "top_venc",
			     venc_pawents, 0x0B0, 0x0B4, 0x0B8, 24, 4, 31, 0x08, 19),
	/*
	 * CWK_CFG_13
	 * top_mcupm is main cwock in co-pwocessow, shouwd not be handwed by Winux.
	 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_VDEC, "top_vdec",
			     vdec_pawents, 0x0BC, 0x0C0, 0x0C4, 0, 4, 7, 0x08, 20),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_PWM, "top_pwm",
			     pwm_pawents, 0x0BC, 0x0C0, 0x0C4, 8, 4, 15, 0x08, 21),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_MCUPM, "top_mcupm", mcupm_pawents,
				   0x0BC, 0x0C0, 0x0C4, 16, 4, 23, 0x08, 22,
				   CWK_IS_CWITICAW | CWK_SET_WATE_PAWENT),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SPMI_P_MST, "top_spmi_p_mst",
			     spmi_p_mst_pawents, 0x0BC, 0x0C0, 0x0C4, 24, 4, 31, 0x08, 23),
	/*
	 * CWK_CFG_14
	 * dvfswc_sew is fow intewnaw DVFS usage, shouwd not be handwed by Winux.
	 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SPMI_M_MST, "top_spmi_m_mst",
			     spmi_m_mst_pawents, 0x0C8, 0x0CC, 0x0D0, 0, 4, 7, 0x08, 24),
	...
	MUX_GATE_CWW_SET_UPD(CWK_TOP_TW, "top_tw",
			     tw_pawents, 0x0C8, 0x0CC, 0x0D0, 16, 4, 23, 0x08, 26),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_AES_MSDCFDE, "top_aes_msdcfde",
			     aes_msdcfde_pawents, 0x0C8, 0x0CC, 0x0D0, 24, 4, 31, 0x08, 27),
	/* CWK_CFG_15 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DSI_OCC, "top_dsi_occ",
			     dsi_occ_pawents, 0x0D4, 0x0D8, 0x0DC, 0, 4, 7, 0x08, 28),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_WPE_VPP, "top_wpe_vpp",
			     wpe_vpp_pawents, 0x0D4, 0x0D8, 0x0DC, 8, 4, 15, 0x08, 29),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_HDCP, "top_hdcp",
			     hdcp_pawents, 0x0D4, 0x0D8, 0x0DC, 16, 4, 23, 0x08, 30),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_HDCP_24M, "top_hdcp_24m",
			     hdcp_24m_pawents, 0x0D4, 0x0D8, 0x0DC, 24, 4, 31, 0x08, 31),
	/* CWK_CFG_16 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_HDMI_APB, "top_hdmi_apb",
			     hdmi_apb_pawents, 0x0E0, 0x0E4, 0x0E8, 0, 4, 7, 0x0C, 0),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SNPS_ETH_250M, "top_snps_eth_250m",
			     snps_eth_250m_pawents, 0x0E0, 0x0E4, 0x0E8, 8, 4, 15, 0x0C, 1),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SNPS_ETH_62P4M_PTP, "top_snps_eth_62p4m_ptp",
			     snps_eth_62p4m_ptp_pawents, 0x0E0, 0x0E4, 0x0E8, 16, 4, 23, 0x0C, 2),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SNPS_ETH_50M_WMII, "snps_eth_50m_wmii",
			     snps_eth_50m_wmii_pawents, 0x0E0, 0x0E4, 0x0E8, 24, 4, 31, 0x0C, 3),
	/* CWK_CFG_17 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_ADSP, "top_adsp",
			     adsp_pawents, 0x0EC, 0x0F0, 0x0F4, 0, 4, 7, 0x0C, 4),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_AUDIO_WOCAW_BUS, "top_audio_wocaw_bus",
			     audio_wocaw_bus_pawents, 0x0EC, 0x0F0, 0x0F4, 8, 4, 15, 0x0C, 5),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_ASM_H, "top_asm_h",
			     asm_h_pawents, 0x0EC, 0x0F0, 0x0F4, 16, 4, 23, 0x0C, 6),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_ASM_W, "top_asm_w",
			     asm_w_pawents, 0x0EC, 0x0F0, 0x0F4, 24, 4, 31, 0x0C, 7),
	/* CWK_CFG_18 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_APWW1, "top_apww1",
			     apww1_pawents, 0x0F8, 0x0FC, 0x100, 0, 4, 7, 0x0C, 8),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_APWW2, "top_apww2",
			     apww2_pawents, 0x0F8, 0x0FC, 0x100, 8, 4, 15, 0x0C, 9),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_APWW3, "top_apww3",
			     apww3_pawents, 0x0F8, 0x0FC, 0x100, 16, 4, 23, 0x0C, 10),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_APWW4, "top_apww4",
			     apww4_pawents, 0x0F8, 0x0FC, 0x100, 24, 4, 31, 0x0C, 11),
	/* CWK_CFG_19 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_APWW5, "top_apww5",
			     apww5_pawents, 0x0104, 0x0108, 0x010C, 0, 4, 7, 0x0C, 12),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_I2SO1, "top_i2so1",
			     i2so1_pawents, 0x0104, 0x0108, 0x010C, 8, 4, 15, 0x0C, 13),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_I2SO2, "top_i2so2",
			     i2so2_pawents, 0x0104, 0x0108, 0x010C, 16, 4, 23, 0x0C, 14),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_I2SI1, "top_i2si1",
			     i2si1_pawents, 0x0104, 0x0108, 0x010C, 24, 4, 31, 0x0C, 15),
	/* CWK_CFG_20 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_I2SI2, "top_i2si2",
			     i2si2_pawents, 0x0110, 0x0114, 0x0118, 0, 4, 7, 0x0C, 16),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_DPTX, "top_dptx",
			     dptx_pawents, 0x0110, 0x0114, 0x0118, 8, 4, 15, 0x0C, 17),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_AUD_IEC, "top_aud_iec",
			     aud_iec_pawents, 0x0110, 0x0114, 0x0118, 16, 4, 23, 0x0C, 18),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_A1SYS_HP, "top_a1sys_hp",
			     a1sys_hp_pawents, 0x0110, 0x0114, 0x0118, 24, 4, 31, 0x0C, 19),
	/* CWK_CFG_21 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_A2SYS, "top_a2sys",
			     a2sys_pawents, 0x011C, 0x0120, 0x0124, 0, 4, 7, 0x0C, 20),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_A3SYS, "top_a3sys",
			     a3sys_pawents, 0x011C, 0x0120, 0x0124, 8, 4, 15, 0x0C, 21),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_A4SYS, "top_a4sys",
			     a4sys_pawents, 0x011C, 0x0120, 0x0124, 16, 4, 23, 0x0C, 22),
	MUX_GATE_CWW_SET_UPD(CWK_TOP_ECC, "top_ecc",
			     ecc_pawents, 0x011C, 0x0120, 0x0124, 24, 4, 31, 0x0C, 23),
	/*
	 * CWK_CFG_22
	 * top_uwposc/top_swck awe cwock souwce of awways on co-pwocessow,
	 * shouwd not be cwosed by Winux.
	 */
	MUX_GATE_CWW_SET_UPD(CWK_TOP_SPINOW, "top_spinow",
			     spinow_pawents, 0x0128, 0x012C, 0x0130, 0, 4, 7, 0x0C, 24),
	MUX_GATE_CWW_SET_UPD_FWAGS(CWK_TOP_UWPOSC, "top_uwposc", uwposc_pawents,
...
static const stwuct mtk_composite top_adj_divs[] = {
	DIV_GATE(CWK_TOP_APWW12_CK_DIV0, "apww12_div0", "top_i2si1", 0x0320, 0, 0x0328, 8, 0),
	DIV_GATE(CWK_TOP_APWW12_CK_DIV1, "apww12_div1", "top_i2si2", 0x0320, 1, 0x0328, 8, 8),
	DIV_GATE(CWK_TOP_APWW12_CK_DIV2, "apww12_div2", "top_i2so1", 0x0320, 2, 0x0328, 8, 16),
	DIV_GATE(CWK_TOP_APWW12_CK_DIV3, "apww12_div3", "top_i2so2", 0x0320, 3, 0x0328, 8, 24),
	DIV_GATE(CWK_TOP_APWW12_CK_DIV4, "apww12_div4", "top_aud_iec", 0x0320, 4, 0x0334, 8, 0),
	DIV_GATE(CWK_TOP_APWW12_CK_DIV9, "apww12_div9", "top_dptx", 0x0320, 9, 0x0338, 8, 8),
};
...
#define GATE_TOP0(_id, _name, _pawent, _shift)			\
	GATE_MTK(_id, _name, _pawent, &top0_cg_wegs, _shift, &mtk_cwk_gate_ops_no_setcww_inv)
...
static const stwuct mtk_gate top_cwks[] = {
	/* TOP0 */
	GATE_TOP0(CWK_TOP_CFGWEG_CWOCK_EN_VPP0, "cfgweg_cwock_vpp0", "top_vpp", 0),
	GATE_TOP0(CWK_TOP_CFGWEG_CWOCK_EN_VPP1, "cfgweg_cwock_vpp1", "top_vpp", 1),
	GATE_TOP0(CWK_TOP_CFGWEG_CWOCK_EN_VDO0, "cfgweg_cwock_vdo0", "top_vpp", 2),
	GATE_TOP0(CWK_TOP_CFGWEG_CWOCK_EN_VDO1, "cfgweg_cwock_vdo1", "top_vpp", 3),
	GATE_TOP0(CWK_TOP_CFGWEG_CWOCK_ISP_AXI_GAWS, "cfgweg_cwock_isp_axi_gaws", "top_vpp", 4),
	GATE_TOP0(CWK_TOP_CFGWEG_F26M_VPP0, "cfgweg_f26m_vpp0", "cwk26m", 5),
	GATE_TOP0(CWK_TOP_CFGWEG_F26M_VPP1, "cfgweg_f26m_vpp1", "cwk26m", 6),
	GATE_TOP0(CWK_TOP_CFGWEG_F26M_VDO0, "cfgweg_f26m_vdo0", "cwk26m", 7),
	GATE_TOP0(CWK_TOP_CFGWEG_F26M_VDO1, "cfgweg_f26m_vdo1", "cwk26m", 8),
	GATE_TOP0(CWK_TOP_CFGWEG_AUD_F26M_AUD, "cfgweg_aud_f26m_aud", "cwk26m", 9),
	GATE_TOP0(CWK_TOP_CFGWEG_UNIPWW_SES, "cfgweg_unipww_ses", "univpww_d2", 15),
	GATE_TOP0(CWK_TOP_CFGWEG_F_PCIE_PHY_WEF, "cfgweg_f_pcie_phy_wef", "cwk26m", 18),
	/* TOP1 */
	GATE_TOP1(CWK_TOP_SSUSB_TOP_WEF, "ssusb_wef", "cwk26m", 0),
	GATE_TOP1(CWK_TOP_SSUSB_PHY_WEF, "ssusb_phy_wef", "cwk26m", 1),
	GATE_TOP1(CWK_TOP_SSUSB_TOP_P1_WEF, "ssusb_p1_wef", "cwk26m", 2),
	GATE_TOP1(CWK_TOP_SSUSB_PHY_P1_WEF, "ssusb_phy_p1_wef", "cwk26m", 3),
	GATE_TOP1(CWK_TOP_SSUSB_TOP_P2_WEF, "ssusb_p2_wef", "cwk26m", 4),
	GATE_TOP1(CWK_TOP_SSUSB_PHY_P2_WEF, "ssusb_phy_p2_wef", "cwk26m", 5),
	GATE_TOP1(CWK_TOP_SSUSB_TOP_P3_WEF, "ssusb_p3_wef", "cwk26m", 6),
	GATE_TOP1(CWK_TOP_SSUSB_PHY_P3_WEF, "ssusb_phy_p3_wef", "cwk26m", 7),
};

static const stwuct of_device_id of_match_cwk_mt8188_topck[] = {
	{ .compatibwe = "mediatek,mt8188-topckgen" },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8188_topck);

/* Wegistew mux notifiew fow MFG mux */
static int cwk_mt8188_weg_mfg_mux_notifiew(stwuct device *dev, stwuct cwk *cwk)
{
...
static int cwk_mt8188_topck_pwobe(stwuct pwatfowm_device *pdev)
{
	...
	w = mtk_cwk_wegistew_muxes(&pdev->dev, top_mtk_muxes,
				   ...
				   &mt8188_cwk_wock, top_cwk_data);
	if (w)
		goto unwegistew_factows;

	hw = devm_cwk_hw_wegistew_mux(&pdev->dev, "mfg_ck_fast_wef", mfg_fast_wef_pawents,
				      AWWAY_SIZE(mfg_fast_wef_pawents), CWK_SET_WATE_PAWENT,
				      (base + 0x250), 8, 1, 0, &mt8188_cwk_wock);
	if (IS_EWW(hw)) {
		w = PTW_EWW(hw);
	...
	w = cwk_mt8188_weg_mfg_mux_notifiew(&pdev->dev,
...
static void cwk_mt8188_topck_wemove(stwuct pwatfowm_device *pdev)
{
...
static stwuct pwatfowm_dwivew cwk_mt8188_topck_dwv = {
	.pwobe = cwk_mt8188_topck_pwobe,
	.wemove_new = cwk_mt8188_topck_wemove,
	.dwivew = {
		.name = "cwk-mt8188-topck",
		.of_match_tabwe = of_match_cwk_mt8188_topck,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8188_topck_dwv);
MODUWE_WICENSE("GPW");
