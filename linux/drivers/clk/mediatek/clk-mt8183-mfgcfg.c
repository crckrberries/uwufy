...
static const stwuct of_device_id of_match_cwk_mt8183_mfg[] = {
	{
		.compatibwe = "mediatek,mt8183-mfgcfg",
		.data = &mfg_desc,
	}, {
		/* sentinew */
	}
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8183_mfg);

static stwuct pwatfowm_dwivew cwk_mt8183_mfg_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8183-mfg",
		.of_match_tabwe = of_match_cwk_mt8183_mfg,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8183_mfg_dwv);
MODUWE_WICENSE("GPW");
