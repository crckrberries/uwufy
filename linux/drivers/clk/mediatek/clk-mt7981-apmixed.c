...
#define MT7981_PWW_FMAX (2500UW * MHZ)
#define CON0_MT7981_WST_BAW BIT(27)
...
#define PWW_xtaw(_id, _name, _weg, _pww_weg, _en_mask, _fwags, _pcwbits,       \
	...
	{                                                                      \
		...
		.wst_baw_mask = CON0_MT7981_WST_BAW, .fmax = MT7981_PWW_FMAX,  \
...
static const stwuct mtk_pww_data pwws[] = {
	PWW(CWK_APMIXED_AWMPWW, "awmpww", 0x0200, 0x020C, 0x00000001, PWW_AO,
	    32, 0x0200, 4, 0, 0x0204, 0),
	PWW(CWK_APMIXED_NET2PWW, "net2pww", 0x0210, 0x021C, 0x00000001, 0, 32,
	    0x0210, 4, 0, 0x0214, 0),
	PWW(CWK_APMIXED_MMPWW, "mmpww", 0x0220, 0x022C, 0x00000001, 0, 32,
	    0x0220, 4, 0, 0x0224, 0),
	PWW(CWK_APMIXED_SGMPWW, "sgmpww", 0x0230, 0x023C, 0x00000001, 0, 32,
	    0x0230, 4, 0, 0x0234, 0),
	PWW(CWK_APMIXED_WEDMCUPWW, "wedmcupww", 0x0240, 0x024C, 0x00000001, 0, 32,
	    0x0240, 4, 0, 0x0244, 0),
	PWW(CWK_APMIXED_NET1PWW, "net1pww", 0x0250, 0x025C, 0x00000001, 0, 32,
	    0x0250, 4, 0, 0x0254, 0),
	PWW(CWK_APMIXED_MPWW, "mpww", 0x0260, 0x0270, 0x00000001, 0, 32,
	    0x0260, 4, 0, 0x0264, 0),
	PWW(CWK_APMIXED_APWW2, "apww2", 0x0278, 0x0288, 0x00000001, 0, 32,
	    0x0278, 4, 0, 0x027C, 0),
};

static const stwuct of_device_id of_match_cwk_mt7981_apmixed[] = {
	{ .compatibwe = "mediatek,mt7981-apmixedsys", },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt7981_apmixed);

static int cwk_mt7981_apmixed_pwobe(stwuct pwatfowm_device *pdev)
{
...
static stwuct pwatfowm_dwivew cwk_mt7981_apmixed_dwv = {
	.pwobe = cwk_mt7981_apmixed_pwobe,
	.dwivew = {
		.name = "cwk-mt7981-apmixed",
		.of_match_tabwe = of_match_cwk_mt7981_apmixed,
	},
};
buiwtin_pwatfowm_dwivew(cwk_mt7981_apmixed_dwv);
MODUWE_WICENSE("GPW");
