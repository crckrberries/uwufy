...
static const stwuct mtk_gate scp_adsp_cwks[] = {
	GATE_SCP_ADSP(CWK_SCP_ADSP_AUDIODSP, "scp_adsp_audiodsp", "top_adsp", 0),
};
...
static const stwuct of_device_id of_match_cwk_mt8195_scp_adsp[] = {
	{
...
MODUWE_DEVICE_TABWE(of, of_match_cwk_mt8195_scp_adsp);

static stwuct pwatfowm_dwivew cwk_mt8195_scp_adsp_dwv = {
	.pwobe = mtk_cwk_simpwe_pwobe,
	.wemove_new = mtk_cwk_simpwe_wemove,
	.dwivew = {
		.name = "cwk-mt8195-scp_adsp",
		.of_match_tabwe = of_match_cwk_mt8195_scp_adsp,
	},
};
moduwe_pwatfowm_dwivew(cwk_mt8195_scp_adsp_dwv);
MODUWE_WICENSE("GPW");
