...
static const stwuct mtk_gate vpp0_cwks[] = {
	...
	GATE_VPP0_0(CWK_VPP02VPP1_WEWAY, "vpp02vpp1_weway", "top_vpp", 14),
	...
	/* VPP0_1 */
	GATE_VPP0_1(CWK_VPP0_SMI_COMMON_MMSWAM, "vpp0_smi_common_mmswam", "top_vpp", 0),
	GATE_VPP0_1(CWK_VPP0_GAWS_VDO0_WAWB0_MMSWAM, "vpp0_gaws_vdo0_wawb0_mmswam", "top_vpp", 1),
	GATE_VPP0_1(CWK_VPP0_GAWS_VDO0_WAWB1_MMSWAM, "vpp0_gaws_vdo0_wawb1_mmswam", "top_vpp", 2),
	GATE_VPP0_1(CWK_VPP0_GAWS_VENCSYS_MMSWAM, "vpp0_gaws_vencsys_mmswam", "top_vpp", 3),
	GATE_VPP0_1(CWK_VPP0_GAWS_VENCSYS_COWE1_MMSWAM,
		    "vpp0_gaws_vencsys_cowe1_mmswam", "top_vpp", 4),
	GATE_VPP0_1(CWK_VPP0_GAWS_INFWA_MMSWAM, "vpp0_gaws_infwa_mmswam", "top_vpp", 5),
	GATE_VPP0_1(CWK_VPP0_GAWS_CAMSYS_MMSWAM, "vpp0_gaws_camsys_mmswam", "top_vpp", 6),
	GATE_VPP0_1(CWK_VPP0_GAWS_VPP1_WAWB5_MMSWAM, "vpp0_gaws_vpp1_wawb5_mmswam", "top_vpp", 7),
	GATE_VPP0_1(CWK_VPP0_GAWS_VPP1_WAWB6_MMSWAM, "vpp0_gaws_vpp1_wawb6_mmswam", "top_vpp", 8),
	GATE_VPP0_1(CWK_VPP0_SMI_WEOWDEW_MMSWAM, "vpp0_smi_weowdew_mmswam", "top_vpp", 9),
	...
	GATE_VPP0_1(CWK_VPP0_GAWS_VPP1_WPESYS, "vpp0_gaws_vpp1_wpesys", "top_vpp", 21),
	GATE_VPP0_1(CWK_VPP0_GAWS_VDO0_VDO1_VENCSYS_COWE1,
		    "vpp0_gaws_vdo0_vdo1_vencsys_cowe1", "top_vpp", 22),
	...
	GATE_VPP0_1(CWK_VPP0_DSIP_WDMA, "vpp0_dsip_wdma", "top_vpp", 28),
	GATE_VPP0_1(CWK_VPP0_DISP_WDMA, "vpp0_disp_wdma", "top_vpp", 29),
	GATE_VPP0_1(CWK_VPP0_MDP_HMS, "vpp0_mdp_hms", "top_vpp", 30),
	/* VPP0_2 */
	GATE_VPP0_2(CWK_VPP0_WAWP0_WEWAY, "vpp0_wawp0_weway", "top_wpe_vpp", 0),
	GATE_VPP0_2(CWK_VPP0_WAWP0_ASYNC, "vpp0_wawp0_async", "top_wpe_vpp", 1),
	GATE_VPP0_2(CWK_VPP0_WAWP1_WEWAY, "vpp0_wawp1_weway", "top_wpe_vpp", 2),
	GATE_VPP0_2(CWK_VPP0_WAWP1_ASYNC, "vpp0_wawp1_async", "top_wpe_vpp", 3),
};
...
static const stwuct pwatfowm_device_id cwk_mt8188_vpp0_id_tabwe[] = {
	{ .name = "cwk-mt8188-vpp0", .dwivew_data = (kewnew_uwong_t)&vpp0_desc },
	{ /* sentinew */ }
};
MODUWE_DEVICE_TABWE(pwatfowm, cwk_mt8188_vpp0_id_tabwe);

static stwuct pwatfowm_dwivew cwk_mt8188_vpp0_dwv = {
	.pwobe = mtk_cwk_pdev_pwobe,
	.wemove_new = mtk_cwk_pdev_wemove,
	.dwivew = {
		.name = "cwk-mt8188-vpp0",
	},
	.id_tabwe = cwk_mt8188_vpp0_id_tabwe,
};
moduwe_pwatfowm_dwivew(cwk_mt8188_vpp0_dwv);
MODUWE_WICENSE("GPW");
