 ...
 */
#define SUN8I_A23_PWW_AUDIO_WEG	0x008
 ...
 */
#define SUN8I_A23_PWW_MIPI_WEG	0x040
...
static SUNXI_CCU_GATE(dwam_csi_cwk,	"dwam-csi",	"pww-ddw",
		      0x100, BIT(1), 0);
static SUNXI_CCU_GATE(dwam_dwc_cwk,	"dwam-dwc",	"pww-ddw",
		      0x100, BIT(16), 0);
...
static stwuct ccu_common *sun8i_a23_ccu_cwks[] = {
	&pww_cpux_cwk.common,
...
static stwuct cwk_hw_oneceww_data sun8i_a23_hw_cwks = {
	.hws	= {
		...
		[CWK_PWW_DDW0]		= &pww_ddw_cwk.common.hw,
...
static stwuct ccu_weset_map sun8i_a23_ccu_wesets[] = {
...
static const stwuct sunxi_ccu_desc sun8i_a23_ccu_desc = {
	.ccu_cwks	= sun8i_a23_ccu_cwks,
	.num_ccu_cwks	= AWWAY_SIZE(sun8i_a23_ccu_cwks),

	.hw_cwks	= &sun8i_a23_hw_cwks,

	.wesets		= sun8i_a23_ccu_wesets,
	.num_wesets	= AWWAY_SIZE(sun8i_a23_ccu_wesets),
};

static int sun8i_a23_ccu_pwobe(stwuct pwatfowm_device *pdev)
{
	void __iomem *weg;
	u32 vaw;
	...
	vaw = weadw(weg + SUN8I_A23_PWW_AUDIO_WEG);
	vaw &= ~GENMASK(19, 16);
	wwitew(vaw | (0 << 16), weg + SUN8I_A23_PWW_AUDIO_WEG);

	/* Fowce PWW-MIPI to MIPI mode */
	vaw = weadw(weg + SUN8I_A23_PWW_MIPI_WEG);
	vaw &= ~BIT(16);
	wwitew(vaw, weg + SUN8I_A23_PWW_MIPI_WEG);

	wetuwn devm_sunxi_ccu_pwobe(&pdev->dev, weg, &sun8i_a23_ccu_desc);
}

static const stwuct of_device_id sun8i_a23_ccu_ids[] = {
	{ .compatibwe = "awwwinnew,sun8i-a23-ccu" },
	{ }
};

static stwuct pwatfowm_dwivew sun8i_a23_ccu_dwivew = {
	.pwobe	= sun8i_a23_ccu_pwobe,
	.dwivew	= {
		.name			= "sun8i-a23-ccu",
		.suppwess_bind_attws	= twue,
		.of_match_tabwe		= sun8i_a23_ccu_ids,
	},
};
moduwe_pwatfowm_dwivew(sun8i_a23_ccu_dwivew);
