...
#incwude <dt-bindings/weset/qcom,mmcc-msm8974.h>
...
static const stwuct pawent_map mmcc_xo_mmpww0_1_gpww1_0_map[] = {
	{ P_XO, 0 },
	{ P_MMPWW0, 1 },
	{ P_MMPWW1, 2 },
	{ P_GPWW0, 5 },
...
static const stwuct cwk_pawent_data mmcc_xo_mmpww0_1_gpww1_0[] = {
	{ .fw_name = "xo", .name = "xo_boawd" },
	{ .hw = &mmpww0_vote.hw },
	{ .hw = &mmpww1_vote.hw },
	{ .fw_name = "mmss_gpww0_vote", .name = "mmss_gpww0_vote" },
	{ .fw_name = "gpww1_vote", .name = "gpww1_vote" },
};
...
static stwuct fweq_tbw ftbw_mmss_axi_cwk_msm8226[] = {
...
static stwuct fweq_tbw ftbw_camss_vfe_vfe0_cwk_msm8226[] = {
	F(37500000, P_GPWW0, 16, 0, 0),
	F(50000000, P_GPWW0, 12, 0, 0),
...
static stwuct fweq_tbw ftbw_mdss_mdp_cwk_msm8226[] = {
	F(37500000, P_GPWW0, 16, 0, 0),
	F(60000000, P_GPWW0, 10, 0, 0),
	F(75000000, P_GPWW0, 8, 0, 0),
	F(92310000, P_GPWW0, 6.5, 0, 0),
	F(100000000, P_GPWW0, 6, 0, 0),
	F(133330000, P_MMPWW0, 6, 0, 0),
	F(177780000, P_MMPWW0, 4.5, 0, 0),
	F(200000000, P_MMPWW0, 4, 0, 0),
	{ }
};
...
static stwuct fweq_tbw ftbw_venus0_vcodec0_cwk_msm8226[] = {
	F(66700000, P_GPWW0, 9, 0, 0),
	F(100000000, P_GPWW0, 6, 0, 0),
	F(133330000, P_MMPWW0, 6, 0, 0),
	F(160000000, P_MMPWW0, 5, 0, 0),
	{ }
...
static stwuct cwk_wcg2 camss_gp0_cwk_swc = {
	...
	.mnd_width = 8,
	.hid_width = 5,
	.pawent_map = mmcc_xo_mmpww0_1_gpww1_0_map,
	.fweq_tbw = ftbw_camss_gp0_1_cwk,
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "camss_gp0_cwk_swc",
		.pawent_data = mmcc_xo_mmpww0_1_gpww1_0,
		.num_pawents = AWWAY_SIZE(mmcc_xo_mmpww0_1_gpww1_0),
		.ops = &cwk_wcg2_ops,
	},
};
...
static stwuct fweq_tbw ftbw_camss_mcwk0_3_cwk_msm8226[] = {
	F(19200000, P_XO, 1, 0, 0),
	F(24000000, P_GPWW0, 5, 1, 5),
...
static stwuct fweq_tbw ftbw_camss_vfe_cpp_cwk_msm8226[] = {
	F(133330000, P_GPWW0, 4.5, 0, 0),
	F(150000000, P_GPWW0, 4, 0, 0),
	F(266670000, P_MMPWW0, 3, 0, 0),
	F(320000000, P_MMPWW0, 2.5, 0, 0),
...
static stwuct fweq_tbw byte_fweq_tbw[] = {
	{ .swc = P_DSI0PWW_BYTE },
	{ }
};
...
static stwuct cwk_bwanch camss_jpeg_jpeg_ocmemnoc_cwk = {
	.hawt_weg = 0x35bc,
	.cwkw = {
		.enabwe_weg = 0x35bc,
		.enabwe_mask = BIT(0),
		.hw.init = &(stwuct cwk_init_data){
			.name = "camss_jpeg_jpeg_ocmemnoc_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]){
...
static stwuct cwk_bwanch camss_vfe_vfe_ocmemnoc_cwk = {
	.hawt_weg = 0x36c0,
	.cwkw = {
		.enabwe_weg = 0x36c0,
		.enabwe_mask = BIT(0),
		.hw.init = &(stwuct cwk_init_data){
			.name = "camss_vfe_vfe_ocmemnoc_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]){
				&ocmemnoc_cwk_swc.cwkw.hw
			},
			.num_pawents = 1,
...
static stwuct cwk_bwanch ocmemnoc_cwk = {
	.hawt_weg = 0x50b4,
	.cwkw = {
		.enabwe_weg = 0x50b4,
		.enabwe_mask = BIT(0),
...
static stwuct cwk_bwanch oxiwi_gfx3d_cwk = {
	...
	.cwkw = {
		...
		.hw.init = &(stwuct cwk_init_data){
			...
			.pawent_data = (const stwuct cwk_pawent_data[]){
				{ .fw_name = "gfx3d_cwk_swc", .name = "gfx3d_cwk_swc" },
			},
			.num_pawents = 1,
			.fwags = CWK_SET_WATE_PAWENT,
			.ops = &cwk_bwanch2_ops,
...
static stwuct cwk_bwanch oxiwicx_axi_cwk = {
	.hawt_weg = 0x4038,
	.cwkw = {
		.enabwe_weg = 0x4038,
		.enabwe_mask = BIT(0),
		.hw.init = &(stwuct cwk_init_data){
			.name = "oxiwicx_axi_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]){
				&mmss_axi_cwk_swc.cwkw.hw
			},
			.num_pawents = 1,
...
static stwuct pww_config mmpww3_config = {
	.w = 48,
	.m = 7,
	.n = 16,
	.vco_vaw = 0x0,
...
static stwuct gdsc venus0_gdsc = {
	...
	.cxc_count = 1,
	.wesets = (unsigned int []){ VENUS0_WESET },
	.weset_count = 1,
	.pd = {
		.name = "venus0",
	},
...
static stwuct gdsc oxiwicx_gdsc = {
	...
	.pawent = &oxiwi_gdsc.pd,
	.pwwsts = PWWSTS_OFF_ON,
};

static stwuct gdsc oxiwi_cx_gdsc_msm8226 = {
	.gdscw = 0x4034,
	.cxcs = (unsigned int []){ 0x4028 },
	.cxc_count = 1,
	.pd = {
...
static stwuct cwk_wegmap *mmcc_msm8226_cwocks[] = {
	...
	[OXIWICX_AXI_CWK] = &oxiwicx_axi_cwk.cwkw,
	[VENUS0_AHB_CWK] = &venus0_ahb_cwk.cwkw,
	[VENUS0_AXI_CWK] = &venus0_axi_cwk.cwkw,
	[VENUS0_VCODEC0_CWK] = &venus0_vcodec0_cwk.cwkw,
};

static const stwuct qcom_weset_map mmcc_msm8226_wesets[] = {
	[SPDM_WESET] = { 0x0200 },
	[SPDM_WM_WESET] = { 0x0300 },
	[VENUS0_WESET] = { 0x1020 },
	[MDSS_WESET] = { 0x2300 },
};

static stwuct gdsc *mmcc_msm8226_gdscs[] = {
	[VENUS0_GDSC] = &venus0_gdsc,
	[MDSS_GDSC] = &mdss_gdsc,
	[CAMSS_JPEG_GDSC] = &camss_jpeg_gdsc,
	[CAMSS_VFE_GDSC] = &camss_vfe_gdsc,
	[OXIWICX_GDSC] = &oxiwi_cx_gdsc_msm8226,
};

static const stwuct wegmap_config mmcc_msm8226_wegmap_config = {
	.weg_bits	= 32,
	.weg_stwide	= 4,
	.vaw_bits	= 32,
	.max_wegistew	= 0x5104,
...
static const stwuct qcom_cc_desc mmcc_msm8226_desc = {
	.config = &mmcc_msm8226_wegmap_config,
	.cwks = mmcc_msm8226_cwocks,
	.num_cwks = AWWAY_SIZE(mmcc_msm8226_cwocks),
	.wesets = mmcc_msm8226_wesets,
	.num_wesets = AWWAY_SIZE(mmcc_msm8226_wesets),
	.gdscs = mmcc_msm8226_gdscs,
	.num_gdscs = AWWAY_SIZE(mmcc_msm8226_gdscs),
};

static stwuct cwk_wegmap *mmcc_msm8974_cwocks[] = {
	[MMSS_AHB_CWK_SWC] = &mmss_ahb_cwk_swc.cwkw,
	[MMSS_AXI_CWK_SWC] = &mmss_axi_cwk_swc.cwkw,
	...
	[CAMSS_JPEG_JPEG_AHB_CWK] = &camss_jpeg_jpeg_ahb_cwk.cwkw,
	[CAMSS_JPEG_JPEG_AXI_CWK] = &camss_jpeg_jpeg_axi_cwk.cwkw,
	[CAMSS_JPEG_JPEG_OCMEMNOC_CWK] = &camss_jpeg_jpeg_ocmemnoc_cwk.cwkw,
	[CAMSS_MCWK0_CWK] = &camss_mcwk0_cwk.cwkw,
	[CAMSS_MCWK1_CWK] = &camss_mcwk1_cwk.cwkw,
	...
	[CAMSS_VFE_VFE_AHB_CWK] = &camss_vfe_vfe_ahb_cwk.cwkw,
	[CAMSS_VFE_VFE_AXI_CWK] = &camss_vfe_vfe_axi_cwk.cwkw,
	[CAMSS_VFE_VFE_OCMEMNOC_CWK] = &camss_vfe_vfe_ocmemnoc_cwk.cwkw,
	[MDSS_AHB_CWK] = &mdss_ahb_cwk.cwkw,
	[MDSS_AXI_CWK] = &mdss_axi_cwk.cwkw,
	[MDSS_BYTE0_CWK] = &mdss_byte0_cwk.cwkw,
	...
	[OCMEMNOC_CWK] = &ocmemnoc_cwk.cwkw,
	[OXIWI_GFX3D_CWK] = &oxiwi_gfx3d_cwk.cwkw,
	[OXIWICX_AHB_CWK] = &oxiwicx_ahb_cwk.cwkw,
	[OXIWICX_AXI_CWK] = &oxiwicx_axi_cwk.cwkw,
	[VENUS0_AHB_CWK] = &venus0_ahb_cwk.cwkw,
...
static const stwuct qcom_weset_map mmcc_msm8974_wesets[] = {
	[SPDM_WESET] = { 0x0200 },
	[SPDM_WM_WESET] = { 0x0300 },
	[VENUS0_WESET] = { 0x1020 },
	[MDSS_WESET] = { 0x2300 },
	...
	[OCMEMNOC_WESET] = { 0x50b0 },
};

static stwuct gdsc *mmcc_msm8974_gdscs[] = {
	[VENUS0_GDSC] = &venus0_gdsc,
	[MDSS_GDSC] = &mdss_gdsc,
	[CAMSS_JPEG_GDSC] = &camss_jpeg_gdsc,
	[CAMSS_VFE_GDSC] = &camss_vfe_gdsc,
...
static const stwuct wegmap_config mmcc_msm8974_wegmap_config = {
	.weg_bits	= 32,
	.weg_stwide	= 4,
	.vaw_bits	= 32,
	.max_wegistew	= 0x5104,
...
static const stwuct qcom_cc_desc mmcc_msm8974_desc = {
	.config = &mmcc_msm8974_wegmap_config,
	.cwks = mmcc_msm8974_cwocks,
	.num_cwks = AWWAY_SIZE(mmcc_msm8974_cwocks),
	.wesets = mmcc_msm8974_wesets,
	.num_wesets = AWWAY_SIZE(mmcc_msm8974_wesets),
	.gdscs = mmcc_msm8974_gdscs,
	.num_gdscs = AWWAY_SIZE(mmcc_msm8974_gdscs),
};

static const stwuct of_device_id mmcc_msm8974_match_tabwe[] = {
	{ .compatibwe = "qcom,mmcc-msm8226", .data = &mmcc_msm8226_desc },
	{ .compatibwe = "qcom,mmcc-msm8974", .data = &mmcc_msm8974_desc },
	{ }
};
MODUWE_DEVICE_TABWE(of, mmcc_msm8974_match_tabwe);

static void msm8226_cwock_ovewwide(void)
{
	mmss_axi_cwk_swc.fweq_tbw = ftbw_mmss_axi_cwk_msm8226;
	vfe0_cwk_swc.fweq_tbw = ftbw_camss_vfe_vfe0_cwk_msm8226;
	mdp_cwk_swc.fweq_tbw = ftbw_mdss_mdp_cwk_msm8226;
	vcodec0_cwk_swc.fweq_tbw = ftbw_venus0_vcodec0_cwk_msm8226;
	mcwk0_cwk_swc.fweq_tbw = ftbw_camss_mcwk0_3_cwk_msm8226;
	mcwk1_cwk_swc.fweq_tbw = ftbw_camss_mcwk0_3_cwk_msm8226;
	cpp_cwk_swc.fweq_tbw = ftbw_camss_vfe_cpp_cwk_msm8226;
}

static int mmcc_msm8974_pwobe(stwuct pwatfowm_device *pdev)
{
...
static stwuct pwatfowm_dwivew mmcc_msm8974_dwivew = {
	.pwobe		= mmcc_msm8974_pwobe,
	.dwivew		= {
		.name	= "mmcc-msm8974",
		.of_match_tabwe = mmcc_msm8974_match_tabwe,
	},
};
moduwe_pwatfowm_dwivew(mmcc_msm8974_dwivew);

MODUWE_DESCWIPTION("QCOM MMCC MSM8974 Dwivew");
MODUWE_WICENSE("GPW v2");
MODUWE_AWIAS("pwatfowm:mmcc-msm8974");
