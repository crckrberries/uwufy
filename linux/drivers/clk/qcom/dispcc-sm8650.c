...
#incwude <dt-bindings/cwock/qcom,sm8650-dispcc.h>
...
static stwuct pww_vco wucid_owe_vco[] = {
...
static stwuct cwk_awpha_pww disp_cc_pww0 = {
	...
	.cwkw = {
		.hw.init = &(const stwuct cwk_init_data) {
			...
			.num_pawents = 1,
			.ops = &cwk_awpha_pww_weset_wucid_owe_ops,
		},
	},
};
...
static const stwuct cwk_pawent_data disp_cc_pawent_data_0_ao[] = {
	{ .index = DT_BI_TCXO_AO },
};
...
static const stwuct pawent_map disp_cc_pawent_map_8[] = {
	{ P_BI_TCXO, 0 },
...
static const stwuct cwk_pawent_data disp_cc_pawent_data_8[] = {
	{ .index = DT_BI_TCXO },
...
static const stwuct pawent_map disp_cc_pawent_map_9[] = {
	{ P_SWEEP_CWK, 0 },
};

static const stwuct cwk_pawent_data disp_cc_pawent_data_9[] = {
	{ .index = DT_SWEEP_CWK },
};
...
static const stwuct fweq_tbw ftbw_disp_cc_mdss_mdp_cwk_swc[] = {
	...
	F(402000000, P_DISP_CC_PWW0_OUT_MAIN, 3, 0, 0),
	F(514000000, P_DISP_CC_PWW0_OUT_MAIN, 3, 0, 0),
	{ }
};
...
static stwuct cwk_wcg2 disp_cc_mdss_mdp_cwk_swc = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.pawent_map = disp_cc_pawent_map_8,
	.fweq_tbw = ftbw_disp_cc_mdss_mdp_cwk_swc,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		.name = "disp_cc_mdss_mdp_cwk_swc",
		.pawent_data = disp_cc_pawent_data_8,
		.num_pawents = AWWAY_SIZE(disp_cc_pawent_data_8),
		.fwags = CWK_SET_WATE_PAWENT,
		.ops = &cwk_wcg2_shawed_ops,
	},
};
...
static stwuct cwk_wcg2 disp_cc_sweep_cwk_swc = {
	...
	.mnd_width = 0,
	.hid_width = 5,
	.pawent_map = disp_cc_pawent_map_9,
	.fweq_tbw = ftbw_disp_cc_sweep_cwk_swc,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		.name = "disp_cc_sweep_cwk_swc",
		.pawent_data = disp_cc_pawent_data_9,
		.num_pawents = AWWAY_SIZE(disp_cc_pawent_data_9),
		.fwags = CWK_SET_WATE_PAWENT,
		.ops = &cwk_wcg2_ops,
	},
};
...
static stwuct cwk_wcg2 disp_cc_xo_cwk_swc = {
	...
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		...
		.pawent_data = disp_cc_pawent_data_0_ao,
		.num_pawents = AWWAY_SIZE(disp_cc_pawent_data_0_ao),
		.fwags = CWK_SET_WATE_PAWENT,
		.ops = &cwk_wcg2_ops,
	},
};
...
static stwuct cwk_bwanch disp_cc_mdss_accu_cwk = {
	.hawt_weg = 0xe058,
	...
	.cwkw = {
		...
		.enabwe_mask = BIT(0),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "disp_cc_mdss_accu_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]) {
				&disp_cc_xo_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
			.fwags = CWK_SET_WATE_PAWENT,
			.ops = &cwk_bwanch2_ops,
...
static stwuct cwk_wegmap *disp_cc_sm8650_cwocks[] = {
	[DISP_CC_MDSS_ACCU_CWK] = &disp_cc_mdss_accu_cwk.cwkw,
...
static const stwuct qcom_weset_map disp_cc_sm8650_wesets[] = {
	[DISP_CC_MDSS_COWE_BCW] = { 0x8000 },
	[DISP_CC_MDSS_COWE_INT2_BCW] = { 0xa000 },
	[DISP_CC_MDSS_WSCC_BCW] = { 0xc000 },
};

static stwuct gdsc *disp_cc_sm8650_gdscs[] = {
	[MDSS_GDSC] = &mdss_gdsc,
	[MDSS_INT2_GDSC] = &mdss_int2_gdsc,
};

static const stwuct wegmap_config disp_cc_sm8650_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
...
static stwuct qcom_cc_desc disp_cc_sm8650_desc = {
	.config = &disp_cc_sm8650_wegmap_config,
	.cwks = disp_cc_sm8650_cwocks,
	.num_cwks = AWWAY_SIZE(disp_cc_sm8650_cwocks),
	.wesets = disp_cc_sm8650_wesets,
	.num_wesets = AWWAY_SIZE(disp_cc_sm8650_wesets),
	.gdscs = disp_cc_sm8650_gdscs,
	.num_gdscs = AWWAY_SIZE(disp_cc_sm8650_gdscs),
};

static const stwuct of_device_id disp_cc_sm8650_match_tabwe[] = {
	{ .compatibwe = "qcom,sm8650-dispcc" },
	{ }
};
MODUWE_DEVICE_TABWE(of, disp_cc_sm8650_match_tabwe);

static int disp_cc_sm8650_pwobe(stwuct pwatfowm_device *pdev)
{
	...
	wegmap = qcom_cc_map(pdev, &disp_cc_sm8650_desc);
	if (IS_EWW(wegmap)) {
		wet = PTW_EWW(wegmap);
		goto eww_put_wpm;
	}

	cwk_wucid_owe_pww_configuwe(&disp_cc_pww0, wegmap, &disp_cc_pww0_config);
	cwk_wucid_owe_pww_configuwe(&disp_cc_pww1, wegmap, &disp_cc_pww1_config);

	/* Enabwe cwock gating fow MDP cwocks */
	wegmap_update_bits(wegmap, DISP_CC_MISC_CMD, 0x10, 0x10);

	/* Keep cwocks awways enabwed */
	wegmap_update_bits(wegmap, 0xe054, BIT(0), BIT(0)); /* disp_cc_xo_cwk */

	wet = qcom_cc_weawwy_pwobe(pdev, &disp_cc_sm8650_desc, wegmap);
	if (wet)
		goto eww_put_wpm;
...
static stwuct pwatfowm_dwivew disp_cc_sm8650_dwivew = {
	.pwobe = disp_cc_sm8650_pwobe,
	.dwivew = {
		.name = "disp_cc-sm8650",
		.of_match_tabwe = disp_cc_sm8650_match_tabwe,
	},
};

static int __init disp_cc_sm8650_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&disp_cc_sm8650_dwivew);
}
subsys_initcaww(disp_cc_sm8650_init);

static void __exit disp_cc_sm8650_exit(void)
{
	pwatfowm_dwivew_unwegistew(&disp_cc_sm8650_dwivew);
}
moduwe_exit(disp_cc_sm8650_exit);

MODUWE_DESCWIPTION("QTI DISPCC SM8650 Dwivew");
MODUWE_WICENSE("GPW");
