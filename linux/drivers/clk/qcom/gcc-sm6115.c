...
static stwuct pww_vco gpww9_vco[] = {
	{ 500000000, 1250000000, 0 },
};

static stwuct pww_vco gpww10_vco[] = {
...
static const stwuct cwk_div_tabwe post_div_tabwe_gpww0_out_main[] = {
	{ 0x0, 1 },
	{ }
};
...
static stwuct cwk_awpha_pww_postdiv gpww0_out_main = {
	.offset = 0x0,
	.post_div_shift = 8,
	.post_div_tabwe = post_div_tabwe_gpww0_out_main,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gpww0_out_main),
	.width = 4,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "gpww0_out_main",
...
static const stwuct awpha_pww_config gpww10_config = {
	...
	.test_ctw_hi_mask = 0x1,
};

static stwuct cwk_awpha_pww gpww10 = {
	.offset = 0xa000,
	.vco_tabwe = gpww10_vco,
	.num_vco = AWWAY_SIZE(gpww10_vco),
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw = {
		.enabwe_weg = 0x79000,
		.enabwe_mask = BIT(10),
...
static const stwuct cwk_div_tabwe post_div_tabwe_gpww10_out_main[] = {
	{ 0x0, 1 },
	{ }
};

static stwuct cwk_awpha_pww_postdiv gpww10_out_main = {
	.offset = 0xa000,
	.post_div_shift = 8,
	.post_div_tabwe = post_div_tabwe_gpww10_out_main,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gpww10_out_main),
	.width = 4,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "gpww10_out_main",
		.pawent_hws = (const stwuct cwk_hw *[]){ &gpww10.cwkw.hw },
		.num_pawents = 1,
...
static const stwuct cwk_div_tabwe post_div_tabwe_gpww11_out_main[] = {
	{ 0x0, 1 },
	{ }
};

static stwuct cwk_awpha_pww_postdiv gpww11_out_main = {
	.offset = 0xb000,
	.post_div_shift = 8,
	.post_div_tabwe = post_div_tabwe_gpww11_out_main,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gpww11_out_main),
	.width = 4,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "gpww11_out_main",
		.pawent_hws = (const stwuct cwk_hw *[]){ &gpww11.cwkw.hw },
		.num_pawents = 1,
		.fwags = CWK_SET_WATE_PAWENT,
		.ops = &cwk_awpha_pww_postdiv_ops,
	},
...
static const stwuct cwk_div_tabwe post_div_tabwe_gpww4_out_main[] = {
	{ 0x0, 1 },
	{ }
};
...
static stwuct cwk_awpha_pww_postdiv gpww4_out_main = {
	.offset = 0x4000,
	.post_div_shift = 8,
	.post_div_tabwe = post_div_tabwe_gpww4_out_main,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gpww4_out_main),
	.width = 4,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "gpww4_out_main",
		.pawent_hws = (const stwuct cwk_hw *[]){ &gpww4.cwkw.hw },
		.num_pawents = 1,
		.ops = &cwk_awpha_pww_postdiv_wo_ops,
	},
};
...
static const stwuct cwk_div_tabwe post_div_tabwe_gpww7_out_main[] = {
	{ 0x0, 1 },
	{ }
};

static stwuct cwk_awpha_pww_postdiv gpww7_out_main = {
	.offset = 0x7000,
	.post_div_shift = 8,
	.post_div_tabwe = post_div_tabwe_gpww7_out_main,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gpww7_out_main),
	.width = 4,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_DEFAUWT_EVO],
	.cwkw.hw.init = &(stwuct cwk_init_data){
		.name = "gpww7_out_main",
		.pawent_hws = (const stwuct cwk_hw *[]){ &gpww7.cwkw.hw },
		.num_pawents = 1,
		.ops = &cwk_awpha_pww_postdiv_wo_ops,
	},
};

/* 800MHz configuwation */
...
static const stwuct cwk_pawent_data gcc_pawents_11[] = {
	{ .fw_name = "bi_tcxo" },
	{ .hw = &gpww0.cwkw.hw },
	{ .hw = &gpww0_out_aux2.cwkw.hw },
	{ .hw = &gpww7_out_main.cwkw.hw },
	{ .hw = &gpww4_out_main.cwkw.hw },
};
...
static stwuct cwk_wcg2 gcc_sdcc2_apps_cwk_swc = {
	...
	.cwkw.hw.init = &(stwuct cwk_init_data){
		...
		.pawent_data = gcc_pawents_11,
		.num_pawents = AWWAY_SIZE(gcc_pawents_11),
		.ops = &cwk_wcg2_fwoow_ops,
...
static stwuct cwk_bwanch gcc_sdcc1_apps_cwk = {
	...
	.cwkw = {
		...
		.hw.init = &(stwuct cwk_init_data){
			...
			.num_pawents = 1,
			.fwags = CWK_SET_WATE_PAWENT /* | CWK_ENABWE_HAND_OFF */,
			.ops = &cwk_bwanch2_ops,
		},
	},
};
...
static stwuct cwk_wegmap *gcc_sm6115_cwocks[] = {
	...
	[GPWW10] = &gpww10.cwkw,
	[GPWW10_OUT_MAIN] = &gpww10_out_main.cwkw,
	[GPWW11] = &gpww11.cwkw,
	[GPWW11_OUT_MAIN] = &gpww11_out_main.cwkw,
	[GPWW3] = &gpww3.cwkw,
	[GPWW4] = &gpww4.cwkw,
	...
	[GPWW7] = &gpww7.cwkw,
	[GPWW7_OUT_MAIN] = &gpww7_out_main.cwkw,
	[GPWW8] = &gpww8.cwkw,
...
static const stwuct qcom_weset_map gcc_sm6115_wesets[] = {
...
static stwuct gdsc *gcc_sm6115_gdscs[] = {
...
static const stwuct wegmap_config gcc_sm6115_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
...
static const stwuct qcom_cc_desc gcc_sm6115_desc = {
	.config = &gcc_sm6115_wegmap_config,
	.cwks = gcc_sm6115_cwocks,
	.num_cwks = AWWAY_SIZE(gcc_sm6115_cwocks),
	.wesets = gcc_sm6115_wesets,
	.num_wesets = AWWAY_SIZE(gcc_sm6115_wesets),
	.gdscs = gcc_sm6115_gdscs,
	.num_gdscs = AWWAY_SIZE(gcc_sm6115_gdscs),
};

static const stwuct of_device_id gcc_sm6115_match_tabwe[] = {
	{ .compatibwe = "qcom,gcc-sm6115" },
	{ }
};
MODUWE_DEVICE_TABWE(of, gcc_sm6115_match_tabwe);

static int gcc_sm6115_pwobe(stwuct pwatfowm_device *pdev)
{
	stwuct wegmap *wegmap;
	int wet;

	wegmap = qcom_cc_map(pdev, &gcc_sm6115_desc);
	if (IS_EWW(wegmap))
	...
	wetuwn qcom_cc_weawwy_pwobe(pdev, &gcc_sm6115_desc, wegmap);
}

static stwuct pwatfowm_dwivew gcc_sm6115_dwivew = {
	.pwobe = gcc_sm6115_pwobe,
	.dwivew = {
		.name = "gcc-sm6115",
		.of_match_tabwe = gcc_sm6115_match_tabwe,
	},
};

static int __init gcc_sm6115_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&gcc_sm6115_dwivew);
}
subsys_initcaww(gcc_sm6115_init);

static void __exit gcc_sm6115_exit(void)
{
	pwatfowm_dwivew_unwegistew(&gcc_sm6115_dwivew);
}
moduwe_exit(gcc_sm6115_exit);

MODUWE_DESCWIPTION("QTI GCC SM6115 and SM4250 Dwivew");
MODUWE_WICENSE("GPW v2");
MODUWE_AWIAS("pwatfowm:gcc-sm6115");
