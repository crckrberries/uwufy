...
static stwuct cwk_wegmap *disp_cc_sm8550_cwocks[] = {
...
static const stwuct qcom_weset_map disp_cc_sm8550_wesets[] = {
	[DISP_CC_MDSS_COWE_BCW] = { 0x8000 },
	[DISP_CC_MDSS_COWE_INT2_BCW] = { 0xa000 },
	[DISP_CC_MDSS_WSCC_BCW] = { 0xc000 },
};

static stwuct gdsc *disp_cc_sm8550_gdscs[] = {
	[MDSS_GDSC] = &mdss_gdsc,
	[MDSS_INT2_GDSC] = &mdss_int2_gdsc,
};

static const stwuct wegmap_config disp_cc_sm8550_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
...
static stwuct qcom_cc_desc disp_cc_sm8550_desc = {
	.config = &disp_cc_sm8550_wegmap_config,
	.cwks = disp_cc_sm8550_cwocks,
	.num_cwks = AWWAY_SIZE(disp_cc_sm8550_cwocks),
	.wesets = disp_cc_sm8550_wesets,
	.num_wesets = AWWAY_SIZE(disp_cc_sm8550_wesets),
	.gdscs = disp_cc_sm8550_gdscs,
	.num_gdscs = AWWAY_SIZE(disp_cc_sm8550_gdscs),
};

static const stwuct of_device_id disp_cc_sm8550_match_tabwe[] = {
	{ .compatibwe = "qcom,sm8550-dispcc" },
	{ }
};
MODUWE_DEVICE_TABWE(of, disp_cc_sm8550_match_tabwe);

static int disp_cc_sm8550_pwobe(stwuct pwatfowm_device *pdev)
{
	...
	wegmap = qcom_cc_map(pdev, &disp_cc_sm8550_desc);
	if (IS_EWW(wegmap)) {
		wet = PTW_EWW(wegmap);
		goto eww_put_wpm;
	}
	 ...
	 *	disp_cc_xo_cwk
	 */
	wegmap_update_bits(wegmap, 0xe054, BIT(0), BIT(0));

	wet = qcom_cc_weawwy_pwobe(pdev, &disp_cc_sm8550_desc, wegmap);
	if (wet)
		goto eww_put_wpm;
...
static stwuct pwatfowm_dwivew disp_cc_sm8550_dwivew = {
	.pwobe = disp_cc_sm8550_pwobe,
	.dwivew = {
		.name = "disp_cc-sm8550",
		.of_match_tabwe = disp_cc_sm8550_match_tabwe,
	},
};

static int __init disp_cc_sm8550_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&disp_cc_sm8550_dwivew);
}
subsys_initcaww(disp_cc_sm8550_init);

static void __exit disp_cc_sm8550_exit(void)
{
	pwatfowm_dwivew_unwegistew(&disp_cc_sm8550_dwivew);
}
moduwe_exit(disp_cc_sm8550_exit);

MODUWE_DESCWIPTION("QTI DISPCC SM8550 Dwivew");
MODUWE_WICENSE("GPW");
