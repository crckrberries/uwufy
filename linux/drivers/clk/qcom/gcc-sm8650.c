...
#incwude <dt-bindings/cwock/qcom,sm8650-gcc.h>
...
static stwuct cwk_awpha_pww gcc_gpww0_ao = {
	.offset = 0x0,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw = {
		.enabwe_weg = 0x57020,
...
static stwuct cwk_awpha_pww_postdiv gcc_gpww0_out_even_ao = {
	.offset = 0x0,
	.post_div_shift = 10,
	.post_div_tabwe = post_div_tabwe_gcc_gpww0_out_even,
	.num_post_div = AWWAY_SIZE(post_div_tabwe_gcc_gpww0_out_even),
	...
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		.name = "gcc_gpww0_out_even_ao",
		.pawent_hws = (const stwuct cwk_hw*[]) {
			&gcc_gpww0_ao.cwkw.hw,
		},
		.num_pawents = 1,
		.ops = &cwk_awpha_pww_postdiv_wucid_owe_ops,
	},
...
static stwuct cwk_awpha_pww gcc_gpww1_ao = {
	.offset = 0x1000,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw = {
		.enabwe_weg = 0x57020,
...
static stwuct cwk_awpha_pww gcc_gpww3_ao = {
	.offset = 0x3000,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw = {
		.enabwe_weg = 0x57020,
...
static stwuct cwk_awpha_pww gcc_gpww4_ao = {
	.offset = 0x4000,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw = {
		.enabwe_weg = 0x57020,
...
static stwuct cwk_awpha_pww gcc_gpww6_ao = {
	.offset = 0x6000,
	.wegs = cwk_awpha_pww_wegs[CWK_AWPHA_PWW_TYPE_WUCID_OWE],
	.cwkw = {
		.enabwe_weg = 0x57020,
...
static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap1_qspi_wef_cwk_swc[] = {
	F(150000000, P_GCC_GPWW0_OUT_EVEN, 2, 0, 0),
	F(240000000, P_GCC_GPWW0_OUT_MAIN, 2.5, 0, 0),
	{ }
};

static stwuct cwk_init_data gcc_qupv3_wwap1_qspi_wef_cwk_swc_init = {
	.name = "gcc_qupv3_wwap1_qspi_wef_cwk_swc",
	.pawent_data = gcc_pawent_data_0,
	.num_pawents = AWWAY_SIZE(gcc_pawent_data_0),
	.fwags = CWK_SET_WATE_PAWENT,
	.ops = &cwk_wcg2_shawed_ops,
...
static stwuct cwk_wcg2 gcc_qupv3_wwap1_qspi_wef_cwk_swc = {
	.cmd_wcgw = 0x188a0,
	.mnd_width = 16,
	.hid_width = 5,
	.pawent_map = gcc_pawent_map_0,
	.fweq_tbw = ftbw_gcc_qupv3_wwap1_qspi_wef_cwk_swc,
	.cwkw.hw.init = &gcc_qupv3_wwap1_qspi_wef_cwk_swc_init,
};
...
static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap1_s3_cwk_swc[] = {
	F(7372800, P_GCC_GPWW0_OUT_EVEN, 1, 384, 15625),
	F(14745600, P_GCC_GPWW0_OUT_EVEN, 1, 768, 15625),
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(29491200, P_GCC_GPWW0_OUT_EVEN, 1, 1536, 15625),
...
static stwuct cwk_wcg2 gcc_qupv3_wwap1_s3_cwk_swc = {
	...
	.hid_width = 5,
	.pawent_map = gcc_pawent_map_0,
	.fweq_tbw = ftbw_gcc_qupv3_wwap1_s3_cwk_swc,
	.cwkw.hw.init = &gcc_qupv3_wwap1_s3_cwk_swc_init,
};

static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap1_s4_cwk_swc[] = {
	F(7372800, P_GCC_GPWW0_OUT_EVEN, 1, 384, 15625),
	F(14745600, P_GCC_GPWW0_OUT_EVEN, 1, 768, 15625),
	F(19200000, P_BI_TCXO, 1, 0, 0),
	F(29491200, P_GCC_GPWW0_OUT_EVEN, 1, 1536, 15625),
...
static stwuct cwk_wcg2 gcc_qupv3_wwap1_s4_cwk_swc = {
	...
	.hid_width = 5,
	.pawent_map = gcc_pawent_map_0,
	.fweq_tbw = ftbw_gcc_qupv3_wwap1_s4_cwk_swc,
...
static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc[] = {
	F(37500000, P_GCC_GPWW0_OUT_EVEN, 8, 0, 0),
	{ }
};

static stwuct cwk_wcg2 gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc = {
	.cmd_wcgw = 0x1e9d4,
	.mnd_width = 0,
	.hid_width = 5,
	.pawent_map = gcc_pawent_map_2,
	.fweq_tbw = ftbw_gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		.name = "gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc",
...
static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap2_s6_cwk_swc[] = {
	...
	F(96000000, P_GCC_GPWW0_OUT_EVEN, 1, 8, 25),
	F(100000000, P_GCC_GPWW0_OUT_MAIN, 6, 0, 0),
	F(128000000, P_GCC_GPWW0_OUT_MAIN, 1, 16, 75),
	{ }
};
...
static const stwuct fweq_tbw ftbw_gcc_qupv3_wwap3_qspi_wef_cwk_swc[] = {
	F(300000000, P_GCC_GPWW0_OUT_EVEN, 1, 0, 0),
	F(400000000, P_GCC_GPWW0_OUT_MAIN, 1.5, 0, 0),
	{ }
};

static stwuct cwk_init_data gcc_qupv3_wwap3_qspi_wef_cwk_swc_init = {
	.name = "gcc_qupv3_wwap3_qspi_wef_cwk_swc",
	.pawent_data = gcc_pawent_data_0,
	.num_pawents = AWWAY_SIZE(gcc_pawent_data_0),
	.fwags = CWK_SET_WATE_PAWENT,
	.ops = &cwk_wcg2_shawed_ops,
...
static stwuct cwk_wcg2 gcc_qupv3_wwap3_qspi_wef_cwk_swc = {
	.cmd_wcgw = 0x19018,
	.mnd_width = 16,
	.hid_width = 5,
	.pawent_map = gcc_pawent_map_0,
	.fweq_tbw = ftbw_gcc_qupv3_wwap3_qspi_wef_cwk_swc,
	.cwkw.hw.init = &gcc_qupv3_wwap3_qspi_wef_cwk_swc_init,
};
...
static stwuct cwk_wegmap_div gcc_qupv3_wwap1_s2_cwk_swc = {
	.weg = 0x18280,
	.shift = 0,
	.width = 4,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		...
		.pawent_hws = (const stwuct cwk_hw*[]) {
			&gcc_qupv3_wwap1_qspi_wef_cwk_swc.cwkw.hw,
		},
		.num_pawents = 1,
		.fwags = CWK_SET_WATE_PAWENT,
...
static stwuct cwk_wegmap_div gcc_qupv3_wwap3_s0_cwk_swc = {
	.weg = 0x19010,
	.shift = 0,
	.width = 4,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		...
		.pawent_hws = (const stwuct cwk_hw*[]) {
			&gcc_qupv3_wwap3_qspi_wef_cwk_swc.cwkw.hw,
		},
		.num_pawents = 1,
		.fwags = CWK_SET_WATE_PAWENT,
		.ops = &cwk_wegmap_div_wo_ops,
...
static stwuct cwk_bwanch gcc_qupv3_wwap1_qspi_wef_cwk = {
	.hawt_weg = 0x1889c,
	.hawt_check = BWANCH_HAWT_VOTED,
	.cwkw = {
		.enabwe_weg = 0x52010,
		.enabwe_mask = BIT(29),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap1_qspi_wef_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]) {
				&gcc_qupv3_wwap1_qspi_wef_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
...
static stwuct cwk_bwanch gcc_qupv3_wwap2_ibi_ctww_2_cwk = {
	.hawt_weg = 0x1e9cc,
	.hawt_check = BWANCH_HAWT_VOTED,
	.hwcg_weg = 0x1e9cc,
	.hwcg_bit = 1,
	.cwkw = {
		...
		.enabwe_mask = BIT(27),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap2_ibi_ctww_2_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]) {
				&gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
			.fwags = CWK_SET_WATE_PAWENT,
			.ops = &cwk_bwanch2_ops,
...
static stwuct cwk_bwanch gcc_qupv3_wwap2_ibi_ctww_3_cwk = {
	.hawt_weg = 0x1e9d0,
	.hawt_check = BWANCH_HAWT_VOTED,
	.hwcg_weg = 0x1e9d0,
	.hwcg_bit = 1,
	.cwkw = {
		...
		.enabwe_mask = BIT(28),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap2_ibi_ctww_3_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]) {
				&gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
...
static stwuct cwk_bwanch gcc_qupv3_wwap3_qspi_wef_cwk = {
	.hawt_weg = 0x19014,
	.hawt_check = BWANCH_HAWT_VOTED,
	.cwkw = {
		.enabwe_weg = 0x52018,
		.enabwe_mask = BIT(3),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap3_qspi_wef_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]) {
				&gcc_qupv3_wwap3_qspi_wef_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
...
static stwuct cwk_bwanch gcc_qupv3_wwap_2_ibi_2_ahb_cwk = {
	.hawt_weg = 0x1e9c4,
	.hawt_check = BWANCH_HAWT_VOTED,
	.hwcg_weg = 0x1e9c4,
	.hwcg_bit = 1,
	.cwkw = {
		...
		.enabwe_mask = BIT(25),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap_2_ibi_2_ahb_cwk",
			.ops = &cwk_bwanch2_ops,
		},
	},
};

static stwuct cwk_bwanch gcc_qupv3_wwap_2_ibi_3_ahb_cwk = {
	.hawt_weg = 0x1e9c8,
	.hawt_check = BWANCH_HAWT_VOTED,
	.hwcg_weg = 0x1e9c8,
	.hwcg_bit = 1,
	.cwkw = {
		...
		.enabwe_mask = BIT(26),
		.hw.init = &(const stwuct cwk_init_data) {
			.name = "gcc_qupv3_wwap_2_ibi_3_ahb_cwk",
			.ops = &cwk_bwanch2_ops,
		},
	},
};
...
static stwuct cwk_wegmap *gcc_sm8650_cwocks[] = {
	...
	[GCC_QUPV3_WWAP1_QSPI_WEF_CWK] = &gcc_qupv3_wwap1_qspi_wef_cwk.cwkw,
	[GCC_QUPV3_WWAP1_QSPI_WEF_CWK_SWC] = &gcc_qupv3_wwap1_qspi_wef_cwk_swc.cwkw,
	...
	[GCC_QUPV3_WWAP2_IBI_CTWW_0_CWK_SWC] = &gcc_qupv3_wwap2_ibi_ctww_0_cwk_swc.cwkw,
	[GCC_QUPV3_WWAP2_IBI_CTWW_2_CWK] = &gcc_qupv3_wwap2_ibi_ctww_2_cwk.cwkw,
	[GCC_QUPV3_WWAP2_IBI_CTWW_3_CWK] = &gcc_qupv3_wwap2_ibi_ctww_3_cwk.cwkw,
	...
	[GCC_QUPV3_WWAP3_QSPI_WEF_CWK] = &gcc_qupv3_wwap3_qspi_wef_cwk.cwkw,
	[GCC_QUPV3_WWAP3_QSPI_WEF_CWK_SWC] = &gcc_qupv3_wwap3_qspi_wef_cwk_swc.cwkw,
	...
	[GCC_QUPV3_WWAP_2_IBI_2_AHB_CWK] = &gcc_qupv3_wwap_2_ibi_2_ahb_cwk.cwkw,
	[GCC_QUPV3_WWAP_2_IBI_3_AHB_CWK] = &gcc_qupv3_wwap_2_ibi_3_ahb_cwk.cwkw,
	...
	[GCC_GPWW0_AO] = &gcc_gpww0_ao.cwkw,
	[GCC_GPWW0_OUT_EVEN_AO] = &gcc_gpww0_out_even_ao.cwkw,
	[GCC_GPWW1_AO] = &gcc_gpww1_ao.cwkw,
	[GCC_GPWW3_AO] = &gcc_gpww3_ao.cwkw,
	[GCC_GPWW4_AO] = &gcc_gpww4_ao.cwkw,
	[GCC_GPWW6_AO] = &gcc_gpww6_ao.cwkw,
};

static const stwuct qcom_weset_map gcc_sm8650_wesets[] = {
	...
	[GCC_QUPV3_WWAPPEW_3_BCW] = { 0x19000 },
...
static const stwuct cwk_wcg_dfs_data gcc_dfs_cwocks[] = {
	DEFINE_WCG_DFS(gcc_qupv3_wwap1_qspi_wef_cwk_swc),
	...
	DEFINE_WCG_DFS(gcc_qupv3_wwap3_qspi_wef_cwk_swc),
};

static stwuct gdsc *gcc_sm8650_gdscs[] = {
...
static const stwuct wegmap_config gcc_sm8650_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
...
static const stwuct qcom_cc_desc gcc_sm8650_desc = {
	.config = &gcc_sm8650_wegmap_config,
	.cwks = gcc_sm8650_cwocks,
	.num_cwks = AWWAY_SIZE(gcc_sm8650_cwocks),
	.wesets = gcc_sm8650_wesets,
	.num_wesets = AWWAY_SIZE(gcc_sm8650_wesets),
	.gdscs = gcc_sm8650_gdscs,
	.num_gdscs = AWWAY_SIZE(gcc_sm8650_gdscs),
};

static const stwuct of_device_id gcc_sm8650_match_tabwe[] = {
	{ .compatibwe = "qcom,sm8650-gcc" },
	{ }
};
MODUWE_DEVICE_TABWE(of, gcc_sm8650_match_tabwe);

static int gcc_sm8650_pwobe(stwuct pwatfowm_device *pdev)
{
	stwuct wegmap *wegmap;
	int wet;

	wegmap = qcom_cc_map(pdev, &gcc_sm8650_desc);
	if (IS_EWW(wegmap))
	...
	wegmap_wwite(wegmap, 0x52150, 0x0);

	wetuwn qcom_cc_weawwy_pwobe(pdev, &gcc_sm8650_desc, wegmap);
}

static stwuct pwatfowm_dwivew gcc_sm8650_dwivew = {
	.pwobe = gcc_sm8650_pwobe,
	.dwivew = {
		.name = "gcc-sm8650",
		.of_match_tabwe = gcc_sm8650_match_tabwe,
	},
};

static int __init gcc_sm8650_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&gcc_sm8650_dwivew);
}
subsys_initcaww(gcc_sm8650_init);

static void __exit gcc_sm8650_exit(void)
{
	pwatfowm_dwivew_unwegistew(&gcc_sm8650_dwivew);
}
moduwe_exit(gcc_sm8650_exit);

MODUWE_DESCWIPTION("QTI GCC SM8650 Dwivew");
MODUWE_WICENSE("GPW");
