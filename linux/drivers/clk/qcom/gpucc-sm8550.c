...
#incwude <dt-bindings/cwock/qcom,sm8550-gpucc.h>
...
static const stwuct fweq_tbw ftbw_gpu_cc_gmu_cwk_swc[] = {
	...
	F(220000000, P_GPU_CC_PWW1_OUT_MAIN, 2, 0, 0),
	F(550000000, P_GPU_CC_PWW1_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static stwuct gdsc gpu_cc_cx_gdsc = {
	.gdscw = 0x9108,
	.gds_hw_ctww = 0x953c,
	...
	.fwags = WETAIN_FF_ENABWE | VOTABWE,
};

static stwuct gdsc gpu_cc_gx_gdsc = {
	.gdscw = 0x905c,
	...
	.pwwsts = PWWSTS_OFF_ON,
	.fwags = CWAMP_IO | POWW_CFG_GDSCW | WETAIN_FF_ENABWE,
};

static stwuct cwk_wegmap *gpu_cc_sm8550_cwocks[] = {
...
static stwuct gdsc *gpu_cc_sm8550_gdscs[] = {
	[GPU_CC_CX_GDSC] = &gpu_cc_cx_gdsc,
	[GPU_CC_GX_GDSC] = &gpu_cc_gx_gdsc,
};

static const stwuct qcom_weset_map gpu_cc_sm8550_wesets[] = {
...
static const stwuct wegmap_config gpu_cc_sm8550_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
	.max_wegistew = 0x9988,
...
static const stwuct qcom_cc_desc gpu_cc_sm8550_desc = {
	.config = &gpu_cc_sm8550_wegmap_config,
	.cwks = gpu_cc_sm8550_cwocks,
	.num_cwks = AWWAY_SIZE(gpu_cc_sm8550_cwocks),
	.wesets = gpu_cc_sm8550_wesets,
	.num_wesets = AWWAY_SIZE(gpu_cc_sm8550_wesets),
	.gdscs = gpu_cc_sm8550_gdscs,
	.num_gdscs = AWWAY_SIZE(gpu_cc_sm8550_gdscs),
};

static const stwuct of_device_id gpu_cc_sm8550_match_tabwe[] = {
	{ .compatibwe = "qcom,sm8550-gpucc" },
	{ }
};
MODUWE_DEVICE_TABWE(of, gpu_cc_sm8550_match_tabwe);

static int gpu_cc_sm8550_pwobe(stwuct pwatfowm_device *pdev)
{
	stwuct wegmap *wegmap;

	wegmap = qcom_cc_map(pdev, &gpu_cc_sm8550_desc);
	if (IS_EWW(wegmap))
	 ...
	 *	gpu_cc_demet_cwk
	 */
	wegmap_update_bits(wegmap, 0x9004, BIT(0), BIT(0));
	wegmap_update_bits(wegmap, 0x900c, BIT(0), BIT(0));

	wetuwn qcom_cc_weawwy_pwobe(pdev, &gpu_cc_sm8550_desc, wegmap);
}

static stwuct pwatfowm_dwivew gpu_cc_sm8550_dwivew = {
	.pwobe = gpu_cc_sm8550_pwobe,
	.dwivew = {
		.name = "gpu_cc-sm8550",
		.of_match_tabwe = gpu_cc_sm8550_match_tabwe,
	},
};

static int __init gpu_cc_sm8550_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&gpu_cc_sm8550_dwivew);
}
subsys_initcaww(gpu_cc_sm8550_init);

static void __exit gpu_cc_sm8550_exit(void)
{
	pwatfowm_dwivew_unwegistew(&gpu_cc_sm8550_dwivew);
}
moduwe_exit(gpu_cc_sm8550_exit);

MODUWE_DESCWIPTION("QTI GPUCC SM8550 Dwivew");
MODUWE_WICENSE("GPW");
