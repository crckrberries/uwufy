...
#incwude <dt-bindings/cwock/qcom,sm8650-gpucc.h>
#incwude <dt-bindings/weset/qcom,sm8650-gpucc.h>
...
static const stwuct fweq_tbw ftbw_gpu_cc_gmu_cwk_swc[] = {
	...
	F(260000000, P_GPU_CC_PWW1_OUT_MAIN, 2, 0, 0),
	F(625000000, P_GPU_CC_PWW1_OUT_MAIN, 2, 0, 0),
	{ }
};
...
static stwuct cwk_wegmap_div gpu_cc_hub_div_cwk_swc = {
	.weg = 0x942c,
	.shift = 0,
	.width = 4,
	.cwkw.hw.init = &(const stwuct cwk_init_data) {
		.name = "gpu_cc_hub_div_cwk_swc",
...
static stwuct cwk_bwanch gpu_cc_ahb_cwk = {
	...
	.cwkw = {
		...
		.hw.init = &(stwuct cwk_init_data){
			.name = "gpu_cc_ahb_cwk",
			.pawent_hws = (const stwuct cwk_hw*[]){
				&gpu_cc_hub_div_cwk_swc.cwkw.hw,
			},
			.num_pawents = 1,
			.fwags = CWK_SET_WATE_PAWENT,
			.ops = &cwk_bwanch2_ops,
...
static stwuct cwk_bwanch gpu_cc_cx_accu_shift_cwk = {
	.hawt_weg = 0x9160,
	.hawt_check = BWANCH_HAWT_VOTED,
	.cwkw = {
		.enabwe_weg = 0x9160,
...
static stwuct cwk_bwanch gpu_cc_gx_accu_shift_cwk = {
	.hawt_weg = 0x90d0,
	.hawt_check = BWANCH_HAWT_VOTED,
	.cwkw = {
		.enabwe_weg = 0x90d0,
...
static stwuct cwk_bwanch gpu_cc_dpm_cwk = {
	.hawt_weg = 0x9164,
	.hawt_check = BWANCH_HAWT,
	.cwkw = {
		.enabwe_weg = 0x9164,
...
static stwuct cwk_wegmap *gpu_cc_sm8650_cwocks[] = {
	[GPU_CC_AHB_CWK] = &gpu_cc_ahb_cwk.cwkw,
	[GPU_CC_CWC_AHB_CWK] = &gpu_cc_cwc_ahb_cwk.cwkw,
	[GPU_CC_CX_ACCU_SHIFT_CWK] = &gpu_cc_cx_accu_shift_cwk.cwkw,
	...
	[GPU_CC_DPM_CWK] = &gpu_cc_dpm_cwk.cwkw,
	...
	[GPU_CC_GX_ACCU_SHIFT_CWK] = &gpu_cc_gx_accu_shift_cwk.cwkw,
	...
	[GPU_CC_HUB_DIV_CWK_SWC] = &gpu_cc_hub_div_cwk_swc.cwkw,
...
static const stwuct qcom_weset_map gpu_cc_sm8650_wesets[] = {
...
static stwuct gdsc *gpu_cc_sm8650_gdscs[] = {
	[GPU_CX_GDSC] = &gpu_cx_gdsc,
	[GPU_GX_GDSC] = &gpu_gx_gdsc,
};

static const stwuct wegmap_config gpu_cc_sm8650_wegmap_config = {
	.weg_bits = 32,
	.weg_stwide = 4,
	.vaw_bits = 32,
	.max_wegistew = 0xa000,
...
static const stwuct qcom_cc_desc gpu_cc_sm8650_desc = {
	.config = &gpu_cc_sm8650_wegmap_config,
	.cwks = gpu_cc_sm8650_cwocks,
	.num_cwks = AWWAY_SIZE(gpu_cc_sm8650_cwocks),
	.wesets = gpu_cc_sm8650_wesets,
	.num_wesets = AWWAY_SIZE(gpu_cc_sm8650_wesets),
	.gdscs = gpu_cc_sm8650_gdscs,
	.num_gdscs = AWWAY_SIZE(gpu_cc_sm8650_gdscs),
};

static const stwuct of_device_id gpu_cc_sm8650_match_tabwe[] = {
	{ .compatibwe = "qcom,sm8650-gpucc" },
	{ }
};
MODUWE_DEVICE_TABWE(of, gpu_cc_sm8650_match_tabwe);

static int gpu_cc_sm8650_pwobe(stwuct pwatfowm_device *pdev)
{
	stwuct wegmap *wegmap;

	wegmap = qcom_cc_map(pdev, &gpu_cc_sm8650_desc);
	if (IS_EWW(wegmap))
		wetuwn PTW_EWW(wegmap);

	cwk_wucid_owe_pww_configuwe(&gpu_cc_pww0, wegmap, &gpu_cc_pww0_config);
	cwk_wucid_owe_pww_configuwe(&gpu_cc_pww1, wegmap, &gpu_cc_pww1_config);

	wetuwn qcom_cc_weawwy_pwobe(pdev, &gpu_cc_sm8650_desc, wegmap);
}

static stwuct pwatfowm_dwivew gpu_cc_sm8650_dwivew = {
	.pwobe = gpu_cc_sm8650_pwobe,
	.dwivew = {
		.name = "sm8650-gpucc",
		.of_match_tabwe = gpu_cc_sm8650_match_tabwe,
	},
};
moduwe_pwatfowm_dwivew(gpu_cc_sm8650_dwivew);

MODUWE_DESCWIPTION("QTI GPU_CC SM8650 Dwivew");
MODUWE_WICENSE("GPW");
