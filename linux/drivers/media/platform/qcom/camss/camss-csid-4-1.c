...
#define CAMSS_CSID_WST_CMD		0x00c
#define CAMSS_CSID_CID_WUT_VC_n(n)	(0x010 + 0x4 * (n))
...
#define CAMSS_CSID_IWQ_CWEAW_CMD	0x060
#define CAMSS_CSID_IWQ_MASK		0x064
#define CAMSS_CSID_IWQ_STATUS		0x068
#define CAMSS_CSID_TG_CTWW		0x0a0
...
static void csid_configuwe_stweam(stwuct csid_device *csid, u8 enabwe)
{
	...
	if (enabwe) {
		...
		if (tg->enabwed) {
			...
			u32 num_wines, num_bytes_pew_wine;
...
const stwuct csid_hw_ops csid_ops_4_1 = {
