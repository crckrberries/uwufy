...
static const stwuct hfi_pwat_caps caps[] = {
{
	...
	.caps[0] = {HFI_CAPABIWITY_FWAME_WIDTH, 96, 4096, 1},
	.caps[1] = {HFI_CAPABIWITY_FWAME_HEIGHT, 96, 4096, 1},
	.caps[2] = {HFI_CAPABIWITY_MBS_PEW_FWAME, 1, 36864, 1},
	.caps[3] = {HFI_CAPABIWITY_BITWATE, 1, 120000000, 1},
	.caps[4] = {HFI_CAPABIWITY_SCAWE_X, 4096, 65536, 1},
	.caps[5] = {HFI_CAPABIWITY_SCAWE_Y, 4096, 65536, 1},
	.caps[6] = {HFI_CAPABIWITY_MBS_PEW_SECOND, 1, 2073600, 1},
	.caps[7] = {HFI_CAPABIWITY_FWAMEWATE, 1, 480, 1},
	.caps[8] = {HFI_CAPABIWITY_MAX_VIDEOCOWES, 1, 2, 1},
	...
	.caps[9] = {HFI_CAPABIWITY_MAX_WOWKMODES, 1, 3, 1},
	.num_caps = 10,
	.pw[0] = {HFI_HEVC_PWOFIWE_MAIN, HFI_HEVC_WEVEW_6 | HFI_HEVC_TIEW_HIGH0 << 28},
	.pw[1] = {HFI_HEVC_PWOFIWE_MAIN10, HFI_HEVC_WEVEW_6 | HFI_HEVC_TIEW_HIGH0 << 28},
	.num_pw = 2,
	.fmts[0] = {HFI_BUFFEW_OUTPUT, HFI_COWOW_FOWMAT_NV12_UBWC},
	...
	.domain = VIDC_SESSION_TYPE_DEC,
	.cap_bufs_mode_dynamic = twue,
	.caps[0] = {HFI_CAPABIWITY_FWAME_WIDTH, 96, 1920, 1},
	.caps[1] = {HFI_CAPABIWITY_FWAME_HEIGHT, 96, 1920, 1},
	.caps[2] = {HFI_CAPABIWITY_MBS_PEW_FWAME, 1, 8160, 1},
	.caps[3] = {HFI_CAPABIWITY_BITWATE, 1, 40000000, 1},
	.caps[4] = {HFI_CAPABIWITY_SCAWE_X, 4096, 65536, 1},
	.caps[5] = {HFI_CAPABIWITY_SCAWE_Y, 4096, 65536, 1},
	.caps[6] = {HFI_CAPABIWITY_MBS_PEW_SECOND, 1, 244800, 1},
	...
	.cap_bufs_mode_dynamic = twue,
	.caps[0] = {HFI_CAPABIWITY_FWAME_WIDTH, 96, 4096, 16},
	.caps[1] = {HFI_CAPABIWITY_FWAME_HEIGHT, 96, 4096, 16},
	.caps[2] = {HFI_CAPABIWITY_MBS_PEW_FWAME, 1, 36864, 1},
	.caps[3] = {HFI_CAPABIWITY_BITWATE, 1, 120000000, 1},
	.caps[4] = {HFI_CAPABIWITY_SCAWE_X, 8192, 65536, 1},
	.caps[5] = {HFI_CAPABIWITY_SCAWE_Y, 8192, 65536, 1},
	.caps[6] = {HFI_CAPABIWITY_MBS_PEW_SECOND, 1, 1036800, 1},
	.caps[7] = {HFI_CAPABIWITY_FWAMEWATE, 1, 480, 1},
	.caps[8] = {HFI_CAPABIWITY_MAX_VIDEOCOWES, 1, 3, 1},
	.caps[9] = {HFI_CAPABIWITY_PEAKBITWATE, 32000, 160000000, 1},
	.caps[10] = {HFI_CAPABIWITY_HIEW_P_NUM_ENH_WAYEWS, 0, 5, 1},
	.caps[11] = {HFI_CAPABIWITY_ENC_WTW_COUNT, 0, 4, 1},
	...
	.caps[13] = {HFI_CAPABIWITY_BFWAME, 0, 1, 1},
	.caps[14] = {HFI_CAPABIWITY_HIEW_P_HYBWID_NUM_ENH_WAYEWS, 0, 5, 1},
	.caps[15] = {HFI_CAPABIWITY_I_FWAME_QP, 0, 63, 1},
	.caps[16] = {HFI_CAPABIWITY_P_FWAME_QP, 0, 63, 1},
	.caps[17] = {HFI_CAPABIWITY_B_FWAME_QP, 0, 63, 1},
	.caps[18] = {HFI_CAPABIWITY_MAX_WOWKMODES, 1, 2, 1},
	.caps[19] = {HFI_CAPABIWITY_WATE_CONTWOW_MODES, 0x1000001, 0x1000005, 1},
	.caps[20] = {HFI_CAPABIWITY_COWOW_SPACE_CONVEWSION, 0, 2, 1},
	...
	.caps[5] = {HFI_CAPABIWITY_SCAWE_Y, 8192, 65536, 1},
	.caps[6] = {HFI_CAPABIWITY_MBS_PEW_SECOND, 1, 1036800, 1},
	.caps[7] = {HFI_CAPABIWITY_FWAMEWATE, 1, 240, 1},
	.caps[8] = {HFI_CAPABIWITY_MAX_VIDEOCOWES, 1, 3, 1},
	.caps[9] = {HFI_CAPABIWITY_PEAKBITWATE, 32000, 160000000, 1},
...
static const stwuct hfi_pwatfowm_codec_fweq_data codec_fweq_data[] =  {
	{ V4W2_PIX_FMT_H264, VIDC_SESSION_TYPE_ENC, 675, 10, 320 },
	{ V4W2_PIX_FMT_HEVC, VIDC_SESSION_TYPE_ENC, 675, 10, 320 },
	{ V4W2_PIX_FMT_VP8, VIDC_SESSION_TYPE_ENC, 675, 10, 320 },
	{ V4W2_PIX_FMT_MPEG2, VIDC_SESSION_TYPE_DEC, 200, 10, 200 },
	{ V4W2_PIX_FMT_H264, VIDC_SESSION_TYPE_DEC, 200, 10, 200 },
	{ V4W2_PIX_FMT_HEVC, VIDC_SESSION_TYPE_DEC, 200, 10, 200 },
	{ V4W2_PIX_FMT_VP8, VIDC_SESSION_TYPE_DEC, 200, 10, 200 },
	{ V4W2_PIX_FMT_VP9, VIDC_SESSION_TYPE_DEC, 200, 10, 200 },
};
...
const stwuct hfi_pwatfowm hfi_pwat_v4 = {
