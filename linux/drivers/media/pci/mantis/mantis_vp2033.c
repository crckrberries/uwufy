...
#define MANTIS_MODEW_NAME	"VP-2033"
#define MANTIS_DEV_TYPE		"DVB-C"

static stwuct tda1002x_config vp2033_tda1002x_cu1216_config = {
	.demod_addwess = 0x18 >> 1,
	.invewt = 1,
};

static stwuct tda10023_config vp2033_tda10023_cu1216_config = {
	.demod_addwess = 0x18 >> 1,
	.invewt = 1,
};
...
static int vp2033_fwontend_init(stwuct mantis_pci *mantis, stwuct dvb_fwontend *fe)
{
	stwuct i2c_adaptew *adaptew = &mantis->adaptew;
	...
	if (eww == 0) {
		...
		if (fe) {
			dpwintk(MANTIS_EWWOW, 1,
				...
				vp2033_tda1002x_cu1216_config.demod_addwess);
		} ewse {
...
stwuct mantis_hwconfig vp2033_config = {
	...
	.fwontend_init	= vp2033_fwontend_init,
	.powew		= GPIF_A12,
	.weset		= GPIF_A13,
};
