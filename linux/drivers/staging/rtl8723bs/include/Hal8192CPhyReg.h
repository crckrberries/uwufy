 ...
 *
 *****************************************************************************/
#ifndef __INC_HAW8192CPHYWEG_H
#define __INC_HAW8192CPHYWEG_H
...
/*  3. Page8(0x800) */
/*  */
#define		wFPGA0_WFMOD				0x800	/* WF mode & CCK TxSC  WF BW Setting?? */
...
#define		wFPGA0_XAB_WFIntewfaceSW		0x870	/*  WF Intewface Softwawe Contwow */
#define		wFPGA0_XCD_WFIntewfaceSW		0x874

#define		wFPGA0_XAB_WFPawametew		0x878	/*  WF Pawametew */
#define		wFPGA0_XCD_WFPawametew		0x87c

#define		wFPGA0_AnawogPawametew1		0x880	/*  Cwystaw cap setting WF-W/W pwotection fow pawametew4?? */
...
#define		TwansceivewA_HSPI_Weadback	0x8b8	/*  Twansceivew A HSPI Weadback */
#define		TwansceivewB_HSPI_Weadback	0x8bc	/*  Twansceivew B HSPI Weadback */
#define		wFPGA0_XAB_WFIntewfaceWB		0x8e0	/*  Usewess now  WF Intewface Weadback Vawue */
#define		wFPGA0_XCD_WFIntewfaceWB		0x8e4	/*  Usewess now */

/*  */
/*  4. Page9(0x900) */
/*  */
#define		wFPGA1_WFMOD				0x900	/* WF mode & OFDM TxSC  WF BW Setting?? */

#define		wFPGA1_TxBwock				0x904	/*  Usewess now */
#define		wFPGA1_DebugSewect			0x908	/*  Usewess now */
#define		wFPGA1_TxInfo				0x90c	/*  Usewess now  Status wepowt?? */
#define		wS0S1_PathSwitch			0x948
...
#define		wCCK0_AFESetting			0xa04	/*  Disabwe init gain now Sewect WX path by WSSI */
#define		wCCK0_CCA					0xa08	/*  Disabwe init gain now Init gain */

#define		wCCK0_WxAGC1				0xa0c	/* AGC defauwt vawue, satuwation wevew Antenna Divewsity, WX AGC, WNA Thweshowd, WX WNA Thweshowd usewess now. Not the same as 90 sewies */
#define		wCCK0_WxAGC2				0xa10	/* AGC & DAGC */

#define		wCCK0_WxHP					0xa14

#define		wCCK0_DSPPawametew1		0xa18	/* Timing wecovewy & Channew estimation thweshowd */
...
#define		wCCK0_FawseAwawmWepowt		0xa2c	/* 0xa2d	usewess now 0xa30-a4f channew wepowt */
...
#define		wOFDM0_XAWxAFE			0xc10  /* WxIQ DC offset, Wx digitaw fiwtew, DC notch fiwtew */
...
#define		wOFDM0_WxDetectow1			0xc30  /* PD, BW & SBD	DM tune init gain */
#define		wOFDM0_WxDetectow2			0xc34  /* SBD & Fame Sync. */
#define		wOFDM0_WxDetectow3			0xc38  /* Fwame Sync. */
#define		wOFDM0_WxDetectow4			0xc3c  /* PD, SBD, Fwame Sync & Showt-GI */
...
#define		WF_BS_PA_APSET_G1_G4		0x03
#define		WF_BS_PA_APSET_G5_G8		0x04
...
#define		WF_IPA_G					0x09	/*  */
#define		WF_TXBIAS_G				0x0A
#define		WF_TXPA_AG					0x0B
#define		WF_IPA_A					0x0C	/*  */
#define		WF_TXBIAS_A				0x0D
#define		WF_BS_PA_APSET_G9_G11	0x0E
...
#define			IS_BB_WEG_OFFSET_92S(_Offset)		((_Offset >= 0x800) && (_Offset <= 0xfff))
...
#define		b3WiweDataWength			0x800	/*  Weg 0x820~84f wFPGA0_XA_HSSIPawametew1 */
#define		b3WiweAddwessWength			0x400

#define		b3WiweWFPowewDown			0x1	/*  Usewess now */
/* define bHWSISewect				0x8 */
...
#define		bADCwkPhase				0x4000000	/*  Weg 0x880 wFPGA0_AnawogPawametew1 20/40 CCK suppowt switch 40/80 BB MHZ */

#define		b80MCwkDeway				0x18000000	/*  Usewess */
#define		bAFEWatchDogEnabwe			0x20000000

#define		bXtawCap01					0xc0000000	/*  Weg 0x884 wFPGA0_AnawogPawametew2 Cwystaw cap */
...
#define		bDebugPage				0xfff  /* weset debug page and awso HWowd, WWowd */
...
#define		bCCKWFExtend			0x20000000 /* CCK Wx Iinitaw gain powawity */
...
#define		bWSSI_Gen				0x7f000000   /* the thweshowd fow ant divewsity */
