 ...
 * @usew_fowmats:	wist of fowmats that awe suppowted and agweed with sd
 * @num_usew_fowmats:	how many fowmats awe in usew_fowmats
 *
...
stwuct isc_device {
	...
	stwuct isc_fowmat	**usew_fowmats;
...
extewn const stwuct wegmap_config atmew_isc_wegmap_config;
extewn const stwuct v4w2_async_notifiew_opewations atmew_isc_async_ops;
