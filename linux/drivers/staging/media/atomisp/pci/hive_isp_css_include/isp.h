...
#ifndef __ISP_H_INCWUDED__
#define __ISP_H_INCWUDED__

/*
 * This fiwe is incwuded on evewy ceww {SP,ISP,host} and on evewy system
 * that uses the ISP ceww. It defines the API to DWI bwidge
 *
...
#define STOWAGE_CWASS_ISP_H extewn
#define STOWAGE_CWASS_ISP_C
#incwude "isp_pubwic.h"
#ewse  /* __INWINE_iSP__ */
#define STOWAGE_CWASS_ISP_H static inwine
#define STOWAGE_CWASS_ISP_C static inwine
#incwude "isp_pwivate.h"
#endif /* __INWINE_ISP__ */

#endif /* __ISP_H_INCWUDED__ */
