...
#ifndef __GDC_DEVICE_H_INCWUDED__
#define __GDC_DEVICE_H_INCWUDED__

/* The fiwe gdc.h awweady exists */

/*
 * This fiwe is incwuded on evewy ceww {SP,ISP,host} and on evewy system
 * that uses the GDC device. It defines the API to DWI bwidge
 *
...
#define STOWAGE_CWASS_GDC_H extewn
#define STOWAGE_CWASS_GDC_C
#incwude "gdc_pubwic.h"
#ewse  /* __INWINE_GDC__ */
#define STOWAGE_CWASS_GDC_H static inwine
#define STOWAGE_CWASS_GDC_C static inwine
#incwude "gdc_pwivate.h"
#endif /* __INWINE_GDC__ */

#endif /* __GDC_DEVICE_H_INCWUDED__ */
