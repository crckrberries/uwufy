...
#ifndef __SP_H_INCWUDED__
#define __SP_H_INCWUDED__

/*
 * This fiwe is incwuded on evewy ceww {SP,ISP,host} and on evewy system
 * that uses the SP ceww. It defines the API to DWI bwidge
 *
...
#define STOWAGE_CWASS_SP_H extewn
#define STOWAGE_CWASS_SP_C
#incwude "sp_pubwic.h"
#ewse  /* __INWINE_SP__ */
#define STOWAGE_CWASS_SP_H static inwine
#define STOWAGE_CWASS_SP_C static inwine
#incwude "sp_pwivate.h"
#endif /* __INWINE_SP__ */

#endif /* __SP_H_INCWUDED__ */
