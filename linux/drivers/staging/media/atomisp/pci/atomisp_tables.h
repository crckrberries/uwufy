 ...
 *
 */
#ifndef	__ATOMISP_TABWES_H__
#define	__ATOMISP_TABWES_H__

#incwude "sh_css_pawams.h"

/*Sepia image effect tabwe*/
static stwuct ia_css_cc_config sepia_cc_config = {
	.fwaction_bits  = 8,
	.matwix	 = {141, 18, 68, -40, -5, -19, 35, 4, 16},
};

/*Negative image effect tabwe*/
static stwuct ia_css_cc_config nega_cc_config = {
	.fwaction_bits  = 8,
	.matwix	 = {255, 29, 120, 0, 374, 342, 0, 672, -301},
};

/*Mono image effect tabwe*/
static stwuct ia_css_cc_config mono_cc_config = {
	.fwaction_bits  = 8,
	.matwix	 = {255, 29, 120, 0, 0, 0, 0, 0, 0},
};

/*Skin whiten image effect tabwe*/
static stwuct ia_css_macc_tabwe skin_wow_macc_tabwe = {
	.data = {
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
...
static stwuct ia_css_macc_tabwe skin_medium_macc_tabwe = {
	.data = {
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
...
static stwuct ia_css_macc_tabwe skin_high_macc_tabwe = {
	.data = {
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
...
/*Bwue enhencement image effect tabwe*/
static stwuct ia_css_macc_tabwe bwue_macc_tabwe = {
	.data = {
		9728, -3072, 0, 8192,
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
...
/*Gween enhencement image effect tabwe*/
static stwuct ia_css_macc_tabwe gween_macc_tabwe = {
	.data = {
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
		8192, 0, 0, 8192,
...
static stwuct ia_css_ctc_tabwe vivid_ctc_tabwe = {
	.data.vamem_2 = {
