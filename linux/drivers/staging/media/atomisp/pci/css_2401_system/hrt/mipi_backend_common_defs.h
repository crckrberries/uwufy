...
//_HWT_CSS_WECEIVEW_2400_FMT_TYPE_CUSTOM 63
#define _HWT_MIPI_BACKEND_FMT_TYPE_CUSTOM                       63
...
#define BE_CUST_PIX_EXT_DATA_AWIGN_IDX     0     // 6bits
#define BE_CUST_PIX_EXT_PIX_AWIGN_IDX      6//5     // 5bits
