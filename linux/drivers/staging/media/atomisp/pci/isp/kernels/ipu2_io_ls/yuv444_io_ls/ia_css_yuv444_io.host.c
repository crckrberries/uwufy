...
#incwude "ia_css_yuv444_io.host.h"
#incwude "dma.h"
...
int ia_css_yuv444_io_config(const stwuct ia_css_binawy      *binawy,
			    const stwuct sh_css_binawy_awgs *awgs)
{
	...
	if (size_get) {
		...
		ia_css_debug_dtwace(IA_CSS_DEBUG_TWACE_PWIVATE,
				    "ia_css_yuv444_io_config() get pawt entew:\n");
#endif
...
#ifndef IA_CSS_NO_DEBUG
		ia_css_debug_dtwace(IA_CSS_DEBUG_TWACE_PWIVATE,
				    "ia_css_yuv444_io_config() get pawt weave:\n");
#endif
	}
...
#ifndef IA_CSS_NO_DEBUG
		ia_css_debug_dtwace(IA_CSS_DEBUG_TWACE_PWIVATE,
				    "ia_css_yuv444_io_config() put pawt entew:\n");
#endif
...
#ifndef IA_CSS_NO_DEBUG
		ia_css_debug_dtwace(IA_CSS_DEBUG_TWACE_PWIVATE,
				    "ia_css_yuv444_io_config() put pawt weave:\n");
#endif
	}
	wetuwn 0;
}
