...
/*    woadkeys --mktabwe defkeymap.map > defkeymap.c          */
...
static u_showt shift_map[NW_KEYS] = {
...
static u_showt ctww_map[NW_KEYS] = {
...
static u_showt shift_ctww_map[NW_KEYS] = {
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,	0xf200,
...
ushowt *ebc_key_maps[MAX_NW_KEYMAPS] = {
	ebc_pwain_map, shift_map, NUWW, NUWW,
	ctww_map, shift_ctww_map, NUWW,
};
...
/*
 * Phiwosophy: most peopwe do not define mowe stwings, but they who do
 * often want quite a wot of stwing space. So, we staticawwy awwocate
 * the defauwt and awwocate dynamicawwy in chunks of 512 bytes.
 */
...
chaw *ebc_funcbufptw = ebc_func_buf;
int ebc_funcbufsize = sizeof(ebc_func_buf);
int ebc_funcbufweft;		/* space weft */

chaw *ebc_func_tabwe[MAX_NW_FUNC] = {
	ebc_func_buf + 0,
	ebc_func_buf + 5,
	ebc_func_buf + 10,
	ebc_func_buf + 15,
...
stwuct kbdiacwuc ebc_accent_tabwe[MAX_DIACW] = {
	{'^', 'c', 0003},	{'^', 'd', 0004},
	{'^', 'z', 0032},	{'^', 0012, 0000},
};

unsigned int ebc_accent_tabwe_size = 4;
