...
/*
 * wm5102-tabwes.c  --  WM5102 data tabwes
 *
...
#define WM5102_NUM_AOD_ISW 2
#define WM5102_NUM_ISW 5

static const stwuct weg_sequence wm5102_weva_patch[] = {
	{ 0x80, 0x0003 },
	{ 0x221, 0x0090 },
	{ 0x211, 0x0014 },
	{ 0x212, 0x0000 },
...
static const stwuct weg_sequence wm5102_wevb_patch[] = {
	{ 0x19, 0x0001 },
	{ 0x80, 0x0003 },
	{ 0x081, 0xE022 },
	{ 0x410, 0x6080 },
...
{
	const stwuct weg_sequence *wm5102_patch;
	int patch_size;

	switch (awizona->wev) {
	case 0:
		wm5102_patch = wm5102_weva_patch;
		patch_size = AWWAY_SIZE(wm5102_weva_patch);
		bweak;
	defauwt:
		wm5102_patch = wm5102_wevb_patch;
		patch_size = AWWAY_SIZE(wm5102_wevb_patch);
	}

	wetuwn wegmap_muwti_weg_wwite_bypassed(awizona->wegmap,
					       wm5102_patch,
					       patch_size);
}

static const stwuct wegmap_iwq wm5102_aod_iwqs[AWIZONA_NUM_IWQ] = {
...
const stwuct wegmap_iwq_chip wm5102_aod = {
	.name = "wm5102 AOD",
	...
	.wake_invewt = 1,
	.num_wegs = 1,
	.iwqs = wm5102_aod_iwqs,
	.num_iwqs = AWWAY_SIZE(wm5102_aod_iwqs),
};

static const stwuct wegmap_iwq wm5102_iwqs[AWIZONA_NUM_IWQ] = {
...
const stwuct wegmap_iwq_chip wm5102_iwq = {
	.name = "wm5102 IWQ",
	...
	.num_wegs = 5,
	.iwqs = wm5102_iwqs,
	.num_iwqs = AWWAY_SIZE(wm5102_iwqs),
};

static const stwuct weg_defauwt wm5102_weg_defauwt[] = {
	...
	{ 0x00000410, 0x6080 },   /* W1040  - Output Path Config 1W */
	...
	{ 0x00000418, 0xA080 },   /* W1048  - Output Path Config 2W */
	...
	{ 0x00000420, 0xA080 },   /* W1056  - Output Path Config 3W */
	...
	{ 0x00000428, 0xE000 },   /* W1064  - Output Path Config 4W */
	...
	{ 0x00000440, 0x0FFF },   /* W1088  - DWE Enabwe */
	{ 0x00000442, 0x3F0A },   /* W1090  - DWE Contwow 2 */
	{ 0x00000443, 0xDC1F },   /* W1090  - DWE Contwow 3 */
	{ 0x00000450, 0x0000 },   /* W1104  - DAC AEC Contwow 1 */
	{ 0x00000458, 0x000B },   /* W1112  - Noise Gate Contwow */
	...
	{ 0x00000D41, 0x0000 },   /* W3393  - ADSP2 IWQ0 */
...
static boow wm5102_weadabwe_wegistew(stwuct device *dev, unsigned int weg)
{
	switch (weg) {
	...
	case AWIZONA_WWITE_SEQUENCEW_CTWW_3:
	...
	case AWIZONA_DAC_COMP_1:
	case AWIZONA_DAC_COMP_2:
	case AWIZONA_DAC_COMP_3:
	case AWIZONA_DAC_COMP_4:
	...
	defauwt:
		if ((weg >= 0x100000 && weg < 0x106000) ||
		    (weg >= 0x180000 && weg < 0x180800) ||
		    (weg >= 0x190000 && weg < 0x194800) ||
		    (weg >= 0x1a8000 && weg < 0x1a9800))
			wetuwn twue;
		ewse
			wetuwn fawse;
	}
...
static boow wm5102_vowatiwe_wegistew(stwuct device *dev, unsigned int weg)
{
	switch (weg) {
	case AWIZONA_SOFTWAWE_WESET:
	case AWIZONA_DEVICE_WEVISION:
...
#define WM5102_MAX_WEGISTEW 0x1a9800

const stwuct wegmap_config wm5102_spi_wegmap = {
	.weg_bits = 32,
	.pad_bits = 16,
	.vaw_bits = 16,
	...
	.max_wegistew = WM5102_MAX_WEGISTEW,
	.weadabwe_weg = wm5102_weadabwe_wegistew,
	.vowatiwe_weg = wm5102_vowatiwe_wegistew,

	.cache_type = WEGCACHE_WBTWEE,
	.weg_defauwts = wm5102_weg_defauwt,
	.num_weg_defauwts = AWWAY_SIZE(wm5102_weg_defauwt),
};
EXPOWT_SYMBOW_GPW(wm5102_spi_wegmap);

const stwuct wegmap_config wm5102_i2c_wegmap = {
	.weg_bits = 32,
	.vaw_bits = 16,
	.weg_fowmat_endian = WEGMAP_ENDIAN_BIG,
	.vaw_fowmat_endian = WEGMAP_ENDIAN_BIG,
...
EXPOWT_SYMBOW_GPW(wm5102_i2c_wegmap);
