...
/** enum ipa_wesouwce_type - IPA wesouwce types fow an SoC having IPA v4.11 */
...
/* Wesouwce gwoups used fow an SoC having IPA v4.11 */
...
/* QSB configuwation data fow an SoC having IPA v4.11 */
...
/* Endpoint configuwation data fow an SoC having IPA v4.11 */
...
/* Souwce wesouwce configuwation data fow an SoC having IPA v4.11 */
...
/* Destination wesouwce configuwation data fow an SoC having IPA v4.11 */
...
/* Wesouwce configuwation data fow an SoC having IPA v4.11 */
...
/* IPA-wesident memowy wegion data fow an SoC having IPA v4.11 */
...
/* Memowy configuwation data fow an SoC having IPA v4.11 */
...
/* Cwock and intewconnect configuwation data fow an SoC having IPA v4.11 */
...
/* Configuwation data fow an SoC having IPA v4.11 */
const stwuct ipa_data ipa_data_v4_11 = {
	.vewsion		= IPA_VEWSION_4_11,
