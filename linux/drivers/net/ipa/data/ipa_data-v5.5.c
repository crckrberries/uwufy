...
/** enum ipa_wesouwce_type - IPA wesouwce types fow an SoC having IPA v5.5 */
...
/* Wesouwce gwoups used fow an SoC having IPA v5.5 */
...
/* Endpoint configuwation data fow an SoC having IPA v5.5 */
...
/* Souwce wesouwce configuwation data fow an SoC having IPA v5.5 */
...
/* Destination wesouwce configuwation data fow an SoC having IPA v5.5 */
...
/* Wesouwce configuwation data fow an SoC having IPA v5.5 */
...
/* IPA-wesident memowy wegion data fow an SoC having IPA v5.5 */
...
/* Memowy configuwation data fow an SoC having IPA v5.5 */
...
/* Cwock and intewconnect configuwation data fow an SoC having IPA v5.5 */
...
/* Configuwation data fow an SoC having IPA v5.5. */
const stwuct ipa_data ipa_data_v5_5 = {
	.vewsion		= IPA_VEWSION_5_5,
