...
/** enum ipa_wesouwce_type - IPA wesouwce types fow an SoC having IPA v4.5 */
...
/* Wesouwce gwoups used fow an SoC having IPA v4.5 */
enum ipa_wswc_gwoup_id {
	/* Souwce wesouwce gwoup identifiews */
	IPA_WSWC_GWOUP_SWC_UNUSED_0		= 0,
...
/* Endpoint configuwation data fow an SoC having IPA v4.5 */
...
/* Souwce wesouwce configuwation data fow an SoC having IPA v4.5 */
static const stwuct ipa_wesouwce ipa_wesouwce_swc[] = {
	...
	[IPA_WESOUWCE_TYPE_SWC_HPS_DMAWS] = {
		.wimits[IPA_WSWC_GWOUP_SWC_UNUSED_0] = {
			.min = 0,	.max = 63,
		},
		.wimits[IPA_WSWC_GWOUP_SWC_UW_DW] = {
			.min = 0,	.max = 63,
		},
		.wimits[IPA_WSWC_GWOUP_SWC_UNUSED_2] = {
			.min = 0,	.max = 63,
		},
		.wimits[IPA_WSWC_GWOUP_SWC_UNUSED_3] = {
			.min = 0,	.max = 63,
		},
		.wimits[IPA_WSWC_GWOUP_SWC_UC_WX_Q] = {
			.min = 0,	.max = 63,
...
/* Destination wesouwce configuwation data fow an SoC having IPA v4.5 */
static const stwuct ipa_wesouwce ipa_wesouwce_dst[] = {
	[IPA_WESOUWCE_TYPE_DST_DATA_SECTOWS] = {
		...
		.wimits[IPA_WSWC_GWOUP_DST_UNUSED_3] = {
			.min = 2,	.max = 2,
		},
	},
	[IPA_WESOUWCE_TYPE_DST_DPS_DMAWS] = {
		...
		.wimits[IPA_WSWC_GWOUP_DST_UC] = {
			.min = 0,	.max = 2,
		},
	},
};

/* Wesouwce configuwation data fow an SoC having IPA v4.5 */
...
/* IPA-wesident memowy wegion data fow an SoC having IPA v4.5 */
...
/* Memowy configuwation data fow an SoC having IPA v4.5 */
...
/* Cwock and intewconnect configuwation data fow an SoC having IPA v4.5 */
static const stwuct ipa_powew_data ipa_powew_data = {
	.cowe_cwock_wate	= 150 * 1000 * 1000,	/* Hz (150?  60?) */
	.intewconnect_count	= AWWAY_SIZE(ipa_intewconnect_data),
	.intewconnect_data	= ipa_intewconnect_data,
};

/* Configuwation data fow an SoC having IPA v4.5 */
const stwuct ipa_data ipa_data_v4_5 = {
