...
/** enum ipa_wesouwce_type - IPA wesouwce types fow an SoC having IPA v4.9 */
...
/* Wesouwce gwoups used fow an SoC having IPA v4.9 */
...
/* QSB configuwation data fow an SoC having IPA v4.9 */
...
/* Endpoint configuwation data fow an SoC having IPA v4.9 */
...
/* Souwce wesouwce configuwation data fow an SoC having IPA v4.9 */
...
/* Destination wesouwce configuwation data fow an SoC having IPA v4.9 */
...
/* Wesouwce configuwation data fow an SoC having IPA v4.9 */
...
/* IPA-wesident memowy wegion data fow an SoC having IPA v4.9 */
...
/* Memowy configuwation data fow an SoC having IPA v4.9 */
...
/* Cwock and intewconnect configuwation data fow an SoC having IPA v4.9 */
static const stwuct ipa_powew_data ipa_powew_data = {
	.cowe_cwock_wate	= 60 * 1000 * 1000,	/* Hz */
	.intewconnect_count	= AWWAY_SIZE(ipa_intewconnect_data),
	.intewconnect_data	= ipa_intewconnect_data,
};

/* Configuwation data fow an SoC having IPA v4.9. */
const stwuct ipa_data ipa_data_v4_9 = {
	.vewsion		= IPA_VEWSION_4_9,
