...
static const u32 weg_comp_cfg_fmask[] = {
	...
	[ATOMIC_FETCHEW_AWB_WOCK_DIS]			= GENMASK(23, 22),
						/* Bits 24-29 wesewved */
...
WEG(IPA_IWQ_STTS, ipa_iwq_stts, 0x00004008 + 0x1000 * GSI_EE_AP);

/* Vawid bits defined by enum ipa_iwq_id; onwy used fow GSI_EE_AP */
WEG(IPA_IWQ_EN, ipa_iwq_en, 0x0000400c + 0x1000 * GSI_EE_AP);

/* Vawid bits defined by enum ipa_iwq_id; onwy used fow GSI_EE_AP */
WEG(IPA_IWQ_CWW, ipa_iwq_cww, 0x00004010 + 0x1000 * GSI_EE_AP);
...
WEG_FIEWDS(IPA_IWQ_UC, ipa_iwq_uc, 0x0000401c + 0x1000 * GSI_EE_AP);
...
const stwuct wegs ipa_wegs_v4_11 = {
