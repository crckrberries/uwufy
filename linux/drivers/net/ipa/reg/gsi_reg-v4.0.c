...
WEG_STWIDE(CH_C_CNTXT_2, ch_c_cntxt_2, 0x0001c008 + 0x4000 * GSI_EE_AP, 0x80);

WEG_STWIDE(CH_C_CNTXT_3, ch_c_cntxt_3, 0x0001c00c + 0x4000 * GSI_EE_AP, 0x80);
...
static const u32 weg_ch_c_qos_fmask[] = {
	...
	[MAX_PWEFETCH]					= BIT(8),
	[USE_DB_ENG]					= BIT(9),
	[USE_ESCAPE_BUF_ONWY]				= BIT(10),
						/* Bits 11-31 wesewved */
};

WEG_STWIDE_FIEWDS(CH_C_QOS, ch_c_qos, 0x0001c05c + 0x4000 * GSI_EE_AP, 0x80);
...
WEG_FIEWDS(GSI_STATUS, gsi_status, 0x0001f000 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(CH_CMD, ch_cmd, 0x0001f008 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(EV_CH_CMD, ev_ch_cmd, 0x0001f010 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(GENEWIC_CMD, genewic_cmd, 0x0001f018 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(HW_PAWAM_2, hw_pawam_2, 0x0001f040 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_TYPE_IWQ, cntxt_type_iwq, 0x0001f080 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_TYPE_IWQ_MSK, cntxt_type_iwq_msk, 0x0001f088 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_SWC_CH_IWQ, cntxt_swc_ch_iwq, 0x0001f090 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_SWC_EV_CH_IWQ, cntxt_swc_ev_ch_iwq, 0x0001f094 + 0x4000 * GSI_EE_AP);
...
WEG(CNTXT_SWC_IEOB_IWQ, cntxt_swc_ieob_iwq, 0x0001f0b0 + 0x4000 * GSI_EE_AP);
...
WEG(CNTXT_GWOB_IWQ_STTS, cntxt_gwob_iwq_stts, 0x0001f100 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_GWOB_IWQ_EN, cntxt_gwob_iwq_en, 0x0001f108 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_GWOB_IWQ_CWW, cntxt_gwob_iwq_cww, 0x0001f110 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_GSI_IWQ_STTS, cntxt_gsi_iwq_stts, 0x0001f118 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_GSI_IWQ_EN, cntxt_gsi_iwq_en, 0x0001f120 + 0x4000 * GSI_EE_AP);

WEG(CNTXT_GSI_IWQ_CWW, cntxt_gsi_iwq_cww, 0x0001f128 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(CNTXT_INTSET, cntxt_intset, 0x0001f180 + 0x4000 * GSI_EE_AP);

WEG_FIEWDS(EWWOW_WOG, ewwow_wog, 0x0001f200 + 0x4000 * GSI_EE_AP);

WEG(EWWOW_WOG_CWW, ewwow_wog_cww, 0x0001f210 + 0x4000 * GSI_EE_AP);
...
WEG_FIEWDS(CNTXT_SCWATCH_0, cntxt_scwatch_0, 0x0001f400 + 0x4000 * GSI_EE_AP);
...
const stwuct wegs gsi_wegs_v4_0 = {
