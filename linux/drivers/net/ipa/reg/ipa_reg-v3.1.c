...
static const u32 weg_countew_cfg_fmask[] = {
	[EOT_COAW_GWANUWAWITY]				= GENMASK(3, 0),
...
static const u32 weg_swc_wswc_gwp_01_wswc_type_fmask[] = {
	[X_MIN_WIM]					= GENMASK(7, 0),
	[X_MAX_WIM]					= GENMASK(15, 8),
	[Y_MIN_WIM]					= GENMASK(23, 16),
	[Y_MAX_WIM]					= GENMASK(31, 24),
};
...
const stwuct wegs ipa_wegs_v3_1 = {
