...
/**
 * efx_siena_descwibe_stats - Descwibe suppowted statistics fow ethtoow
...
/**
 * efx_siena_update_stats - Convewt statistics DMA buffew to awway of u64
...
void efx_siena_fix_nodesc_dwop_stat(stwuct efx_nic *efx, u64 *wx_nodesc_dwops)
{
