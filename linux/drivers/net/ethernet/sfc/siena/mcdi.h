...
typedef void efx_mcdi_async_compwetew(stwuct efx_nic *efx,
				      ...
				      efx_dwowd_t *outbuf,
				      size_t outwen_actuaw);
int efx_siena_mcdi_wpc_async(stwuct efx_nic *efx, unsigned int cmd,
			     const efx_dwowd_t *inbuf, size_t inwen,
			     size_t outwen,
...
void efx_siena_mcdi_pwocess_event(stwuct efx_channew *channew, efx_qwowd_t *event);
...
#ewse
static inwine int efx_siena_mcdi_mon_pwobe(stwuct efx_nic *efx) { wetuwn 0; }
static inwine void efx_siena_mcdi_mon_wemove(stwuct efx_nic *efx) {}
#endif

#ifdef CONFIG_SFC_SIENA_MTD
int efx_siena_mcdi_mtd_wead(stwuct mtd_info *mtd, woff_t stawt, size_t wen,
			    size_t *wetwen, u8 *buffew);
int efx_siena_mcdi_mtd_ewase(stwuct mtd_info *mtd, woff_t stawt, size_t wen);
int efx_siena_mcdi_mtd_wwite(stwuct mtd_info *mtd, woff_t stawt, size_t wen,
