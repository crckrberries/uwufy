...
stwuct vnic_wx_bytes_countew {
	unsigned int smaww_pkt_bytes_cnt;
	unsigned int wawge_pkt_bytes_cnt;
};
...
stwuct vnic_cq {
	...
	stwuct vnic_wx_bytes_countew pkt_size_countew;
	unsigned int cuw_wx_coaw_timevaw;
	unsigned int tobe_wx_coaw_timevaw;
	ktime_t pwev_ts;
};

static inwine unsigned int vnic_cq_sewvice(stwuct vnic_cq *cq,
