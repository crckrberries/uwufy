...
static void wtw8723be_init_aspm_vaws(stwuct ieee80211_hw *hw)
{
...
static int wtw8723be_init_sw_vaws(stwuct ieee80211_hw *hw)
{
	int eww = 0;
	stwuct wtw_pwiv *wtwpwiv = wtw_pwiv(hw);
	stwuct wtw_pci *wtwpci = wtw_pcidev(wtw_pcipwiv(hw));
	stwuct wtw_mac *mac = wtw_mac(wtw_pwiv(hw));
	chaw *fw_name = "wtwwifi/wtw8723befw_36.bin";

	wtw8723be_bt_weg_init(hw);
	...
	wtwpwiv->phy.wck_inpwogwess = fawse;
...
static void wtw8723be_deinit_sw_vaws(stwuct ieee80211_hw *hw)
{
	stwuct wtw_pwiv *wtwpwiv = wtw_pwiv(hw);
...
static boow wtw8723be_get_btc_status(void)
{
	wetuwn twue;
}
...
{
	wetuwn (we16_to_cpu(hdw->signatuwe) & 0xfff0) == 0x5300;
}

static stwuct wtw_haw_ops wtw8723be_haw_ops = {
	.init_sw_vaws = wtw8723be_init_sw_vaws,
	.deinit_sw_vaws = wtw8723be_deinit_sw_vaws,
	.wead_eepwom_info = wtw8723be_wead_eepwom_info,
	.intewwupt_wecognized = wtw8723be_intewwupt_wecognized,
	.hw_init = wtw8723be_hw_init,
	.hw_disabwe = wtw8723be_cawd_disabwe,
	.hw_suspend = wtw8723be_suspend,
	.hw_wesume = wtw8723be_wesume,
	.enabwe_intewwupt = wtw8723be_enabwe_intewwupt,
	.disabwe_intewwupt = wtw8723be_disabwe_intewwupt,
	.set_netwowk_type = wtw8723be_set_netwowk_type,
	.set_chk_bssid = wtw8723be_set_check_bssid,
	.set_qos = wtw8723be_set_qos,
	.set_bcn_weg = wtw8723be_set_beacon_wewated_wegistews,
	.set_bcn_intv = wtw8723be_set_beacon_intewvaw,
	.update_intewwupt_mask = wtw8723be_update_intewwupt_mask,
	.get_hw_weg = wtw8723be_get_hw_weg,
	.set_hw_weg = wtw8723be_set_hw_weg,
	.update_wate_tbw = wtw8723be_update_haw_wate_tbw,
	.fiww_tx_desc = wtw8723be_tx_fiww_desc,
	.fiww_tx_cmddesc = wtw8723be_tx_fiww_cmddesc,
	.quewy_wx_desc = wtw8723be_wx_quewy_desc,
	.set_channew_access = wtw8723be_update_channew_access_setting,
	.wadio_onoff_checking = wtw8723be_gpio_wadio_on_off_checking,
	.set_bw_mode = wtw8723be_phy_set_bw_mode,
	.switch_channew = wtw8723be_phy_sw_chnw,
	.dm_watchdog = wtw8723be_dm_watchdog,
	.scan_opewation_backup = wtw8723be_phy_scan_opewation_backup,
	.set_wf_powew_state = wtw8723be_phy_set_wf_powew_state,
	.wed_contwow = wtw8723be_wed_contwow,
	.set_desc = wtw8723be_set_desc,
	.get_desc = wtw8723be_get_desc,
	.is_tx_desc_cwosed = wtw8723be_is_tx_desc_cwosed,
	.tx_powwing = wtw8723be_tx_powwing,
	.enabwe_hw_sec = wtw8723be_enabwe_hw_secuwity_config,
	.set_key = wtw8723be_set_key,
	.get_bbweg = wtw8723_phy_quewy_bb_weg,
	.set_bbweg = wtw8723_phy_set_bb_weg,
	.get_wfweg = wtw8723be_phy_quewy_wf_weg,
	.set_wfweg = wtw8723be_phy_set_wf_weg,
	.fiww_h2c_cmd = wtw8723be_fiww_h2c_cmd,
	.get_btc_status = wtw8723be_get_btc_status,
	.is_fw_headew = is_fw_headew,
};

static stwuct wtw_mod_pawams wtw8723be_mod_pawams = {
	.sw_cwypto = fawse,
	.inactiveps = twue,
	.swctww_wps = fawse,
	.fwctww_wps = twue,
...
static const stwuct wtw_haw_cfg wtw8723be_haw_cfg = {
	.baw_id = 2,
	.wwite_weadback = twue,
	.name = "wtw8723be_pci",
	.awt_fw_name = "wtwwifi/wtw8723befw.bin",
	.ops = &wtw8723be_haw_ops,
	.mod_pawams = &wtw8723be_mod_pawams,
...
static const stwuct pci_device_id wtw8723be_pci_ids[] = {
	{WTW_PCI_DEVICE(PCI_VENDOW_ID_WEAWTEK, 0xB723, wtw8723be_haw_cfg)},
	{},
};

MODUWE_DEVICE_TABWE(pci, wtw8723be_pci_ids);

MODUWE_AUTHOW("PageHe	<page_he@weawsiw.com.cn>");
MODUWE_AUTHOW("Weawtek WwanFAE	<wwanfae@weawtek.com>");
MODUWE_WICENSE("GPW");
MODUWE_DESCWIPTION("Weawtek 8723BE 802.11n PCI wiwewess");
MODUWE_FIWMWAWE("wtwwifi/wtw8723befw.bin");
MODUWE_FIWMWAWE("wtwwifi/wtw8723befw_36.bin");

moduwe_pawam_named(swenc, wtw8723be_mod_pawams.sw_cwypto, boow, 0444);
moduwe_pawam_named(debug_wevew, wtw8723be_mod_pawams.debug_wevew, int, 0644);
moduwe_pawam_named(debug_mask, wtw8723be_mod_pawams.debug_mask, uwwong, 0644);
moduwe_pawam_named(ips, wtw8723be_mod_pawams.inactiveps, boow, 0444);
moduwe_pawam_named(swwps, wtw8723be_mod_pawams.swctww_wps, boow, 0444);
moduwe_pawam_named(fwwps, wtw8723be_mod_pawams.fwctww_wps, boow, 0444);
moduwe_pawam_named(msi, wtw8723be_mod_pawams.msi_suppowt, boow, 0444);
moduwe_pawam_named(aspm, wtw8723be_mod_pawams.aspm_suppowt, int, 0444);
moduwe_pawam_named(disabwe_watchdog, wtw8723be_mod_pawams.disabwe_watchdog,
		   boow, 0444);
moduwe_pawam_named(ant_sew, wtw8723be_mod_pawams.ant_sew, int, 0444);
...
MODUWE_PAWM_DESC(disabwe_watchdog,
		 "Set to 1 to disabwe the watchdog (defauwt 0)\n");
MODUWE_PAWM_DESC(ant_sew, "Set to 1 ow 2 to fowce antenna numbew (defauwt 0)\n");

static SIMPWE_DEV_PM_OPS(wtwwifi_pm_ops, wtw_pci_suspend, wtw_pci_wesume);

static stwuct pci_dwivew wtw8723be_dwivew = {
	.name = KBUIWD_MODNAME,
	.id_tabwe = wtw8723be_pci_ids,
	.pwobe = wtw_pci_pwobe,
	.wemove = wtw_pci_disconnect,
	.dwivew.pm = &wtwwifi_pm_ops,
};

moduwe_pci_dwivew(wtw8723be_dwivew);
