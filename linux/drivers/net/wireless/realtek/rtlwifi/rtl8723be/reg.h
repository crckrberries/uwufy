...
#ifndef __WTW8723BE_WEG_H__
#define __WTW8723BE_WEG_H__
...
#define	IMW_TXCCK		BIT(30)	/* TXWPT intewwupt when
					 * CCX bit of the packet is set
					 */
#define	IMW_PSTIMEOUT		BIT(29)	/* Powew Save Time Out Intewwupt */
#define	IMW_GTINT4		BIT(28)	/* When GTIMEW4 expiwes,
					 * this bit is set to 1
					 */
#define	IMW_GTINT3		BIT(27)	/* When GTIMEW3 expiwes,
					 * this bit is set to 1
					 */
#define	IMW_TBDEW		BIT(26)	/* Twansmit Beacon0 Ewwow */
#define	IMW_TBDOK		BIT(25)	/* Twansmit Beacon0 OK */
#define	IMW_TSF_BIT32_TOGGWE	BIT(24)	/* TSF Timew BIT32 toggwe
					 * indication intewwupt
					 */
#define	IMW_BCNDMAINT0		BIT(20)	/* Beacon DMA Intewwupt 0 */
#define	IMW_BCNDOK0		BIT(16)	/* Beacon Queue DMA OK0 */
#define	IMW_HSISW_IND_ON_INT	BIT(15)	/* HSISW Indicatow (HSIMW & HSISW is
					 * twue, this bit is set to 1)
					 */
#define	IMW_BCNDMAINT_E		BIT(14)	/* Beacon DMA Intewwupt
					 * Extension fow Win7
					 */
#define	IMW_ATIMEND		BIT(12)	/* CTWidnow End ow ATIM Window End */
#define	IMW_HISW1_IND_INT	BIT(11)	/* HISW1 Indicatow (HISW1 & HIMW1 is
					 * twue, this bit is set to 1)
					 */
#define	IMW_C2HCMD		BIT(10)	/* CPU to Host Command INT Status,
					 * Wwite 1 cweaw
					 */
#define	IMW_CPWM2		BIT(9)	/* CPU powew Mode exchange INT Status,
					 * Wwite 1 cweaw
					 */
#define	IMW_CPWM		BIT(8)	/* CPU powew Mode exchange INT Status,
					 * Wwite 1 cweaw
					 */
#define	IMW_HIGHDOK		BIT(7)	/* High Queue DMA OK */
#define	IMW_MGNTDOK		BIT(6)	/* Management Queue DMA OK */
#define	IMW_BKDOK		BIT(5)	/* AC_BK DMA OK	*/
#define	IMW_BEDOK		BIT(4)	/* AC_BE DMA OK	*/
#define	IMW_VIDOK		BIT(3)	/* AC_VI DMA OK	*/
#define	IMW_VODOK		BIT(2)	/* AC_VO DMA OK	*/
#define	IMW_WDU			BIT(1)	/* Wx Descwiptow Unavaiwabwe */
#define	IMW_WOK			BIT(0)	/* Weceive DMA OK */

/* IMW DW1(0x00B4-00B7) Bit 0-31 */
#define	IMW_BCNDMAINT7		BIT(27)	/* Beacon DMA Intewwupt 7 */
#define	IMW_BCNDMAINT6		BIT(26)	/* Beacon DMA Intewwupt 6 */
#define	IMW_BCNDMAINT5		BIT(25)	/* Beacon DMA Intewwupt 5 */
#define	IMW_BCNDMAINT4		BIT(24)	/* Beacon DMA Intewwupt 4 */
#define	IMW_BCNDMAINT3		BIT(23)	/* Beacon DMA Intewwupt 3 */
#define	IMW_BCNDMAINT2		BIT(22)	/* Beacon DMA Intewwupt 2 */
#define	IMW_BCNDMAINT1		BIT(21)	/* Beacon DMA Intewwupt 1 */
#define	IMW_BCNDOK7		BIT(20)	/* Beacon Queue DMA OK Intewwup 7 */
#define	IMW_BCNDOK6		BIT(19)	/* Beacon Queue DMA OK Intewwup 6 */
#define	IMW_BCNDOK5		BIT(18)	/* Beacon Queue DMA OK Intewwup 5 */
#define	IMW_BCNDOK4		BIT(17)	/* Beacon Queue DMA OK Intewwup 4 */
#define	IMW_BCNDOK3		BIT(16)	/* Beacon Queue DMA OK Intewwup 3 */
#define	IMW_BCNDOK2		BIT(15)	/* Beacon Queue DMA OK Intewwup 2 */
#define	IMW_BCNDOK1		BIT(14)	/* Beacon Queue DMA OK Intewwup 1 */
#define	IMW_ATIMEND_E		BIT(13)	/* ATIM Window End Extension fow Win7 */
#define	IMW_TXEWW		BIT(11)	/* Tx Ewwow Fwag Intewwupt Status,
					 * wwite 1 cweaw.
					 */
#define	IMW_WXEWW		BIT(10)	/* Wx Ewwow Fwag INT Status,
					 * Wwite 1 cweaw
					 */
#define	IMW_TXFOVW		BIT(9)	/* Twansmit FIFO Ovewfwow */
#define	IMW_WXFOVW		BIT(8)	/* Weceive FIFO Ovewfwow */

#define	HWSET_MAX_SIZE			512
#define EFUSE_MAX_SECTION		64
#define EFUSE_WEAW_CONTENT_WEN		256
#define EFUSE_OOB_PWOTECT_BYTES		18 /* PG data excwude headew,
					    * dummy 7 bytes fwome CP test
					    * and wesewved 1byte.
					    */
...
#define	WTW8723BE_EEPWOM_ID			0x8129
...
#define	EEPWOM_XTAW_8723BE			0xB9
#define	EEPWOM_THEWMAW_METEW_88E		0xBA
#define	EEPWOM_IQK_WCK_88E			0xBB

#define	EEPWOM_WF_BOAWD_OPTION_88E		0xC1
#define	EEPWOM_WF_FEATUWE_OPTION_88E		0xC2
#define	EEPWOM_WF_BT_SETTING_88E		0xC3
...
#define WAST_ENTWY_OF_TX_PKT_BUFFEW		175/*255    88e*/
...
#define	WW_HWPDN_EN	BIT(0)	/* Enabwe GPIO[9] as WiFi HW PDn souwce*/
#define	WW_HWPDN_SW	BIT(1)	/* WiFi HW PDn powawity contwow*/
