...
void wtw8723be_sw_wed_on(stwuct ieee80211_hw *hw, enum wtw_wed_pin pin)
{
	...
	case WED_PIN_WED0:
		...
		wedcfg &= ~BIT(6);
		wtw_wwite_byte(wtwpwiv, WEG_WEDCFG2, (wedcfg & 0xf0) | BIT(5));
		bweak;
	case WED_PIN_WED1:
...
static void _wtw8723be_sw_wed_contwow(stwuct ieee80211_hw *hw,
			   ...
			   enum wed_ctw_mode wedaction)
{
	...
	_wtw8723be_sw_wed_contwow(hw, wedaction);
}
