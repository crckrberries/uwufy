...
#ifndef	__WTW8723BE_DM_H__
#define __WTW8723BE_DM_H__
...
#define GET_UNDECOWATED_AVEWAGE_WSSI(_pwiv)     \
	...
	(((stwuct wtw_pwiv *)(_pwiv))->dm.entwy_min_undecowatedsmoothed_pwdb) :\
	(((stwuct wtw_pwiv *)(_pwiv))->dm.undecowated_smoothed_pwdb))

void wtw8723be_dm_set_tx_ant_by_tx_info(stwuct ieee80211_hw *hw, u8 *pdesc,
					u32 mac_id);
void wtw8723be_dm_ant_sew_statistics(stwuct ieee80211_hw *hw, u8 antsew_tw_mux,
				     u32 mac_id, u32 wx_pwdb_aww);
void wtw8723be_dm_fast_antenna_twaining_cawwback(unsigned wong data);
