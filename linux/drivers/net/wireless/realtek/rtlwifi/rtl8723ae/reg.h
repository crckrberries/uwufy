...
#ifndef __WTW8723E_WEG_H__
#define __WTW8723E_WEG_H__
...
/* 8723E sewies PCIE Host IMW/ISW bit */
/* IMW DW0 Bit 0-31 */
#define	PHIMW_TIMEOUT2					BIT(31)
#define	PHIMW_TIMEOUT1					BIT(30)
#define	PHIMW_PSTIMEOUT				BIT(29)
#define	PHIMW_GTINT4					BIT(28)
#define	PHIMW_GTINT3					BIT(27)
#define	PHIMW_TXBCNEWW					BIT(26)
#define	PHIMW_TXBCNOK					BIT(25)
#define	PHIMW_TSF_BIT32_TOGGWE			BIT(24)
#define	PHIMW_BCNDMAINT3				BIT(23)
#define	PHIMW_BCNDMAINT2				BIT(22)
#define	PHIMW_BCNDMAINT1				BIT(21)
#define	PHIMW_BCNDMAINT0				BIT(20)
#define	PHIMW_BCNDOK3					BIT(19)
#define	PHIMW_BCNDOK2					BIT(18)
#define	PHIMW_BCNDOK1					BIT(17)
#define	PHIMW_BCNDOK0					BIT(16)
#define	PHIMW_HSISW_IND_ON			BIT(15)
#define	PHIMW_BCNDMAINT_E				BIT(14)
#define	PHIMW_ATIMEND_E				BIT(13)
#define	PHIMW_ATIM_CTW_END			BIT(12)
#define	PHIMW_HISWE_IND				BIT(11)
#define	PHIMW_C2HCMD					BIT(10)
#define	PHIMW_CPWM2					BIT(9)
#define	PHIMW_CPWM					BIT(8)
#define	PHIMW_HIGHDOK					BIT(7)
#define	PHIMW_MGNTDOK					BIT(6)
#define	PHIMW_BKDOK					BIT(5)
#define	PHIMW_BEDOK					BIT(4)
#define	PHIMW_VIDOK					BIT(3)
#define	PHIMW_VODOK					BIT(2)
#define	PHIMW_WDU						BIT(1)
#define	PHIMW_WOK						BIT(0)

/* PCIE Host Intewwupt Status Extension bit */
#define	PHIMW_BCNDMAINT7				BIT(23)
#define	PHIMW_BCNDMAINT6				BIT(22)
#define	PHIMW_BCNDMAINT5				BIT(21)
#define	PHIMW_BCNDMAINT4				BIT(20)
#define	PHIMW_BCNDOK7					BIT(19)
#define	PHIMW_BCNDOK6					BIT(18)
#define	PHIMW_BCNDOK5					BIT(17)
#define	PHIMW_BCNDOK4					BIT(16)
/* bit12-15: WSVD */
#define	PHIMW_TXEWW					BIT(11)
#define	PHIMW_WXEWW					BIT(10)
#define	PHIMW_TXFOVW					BIT(9)
#define	PHIMW_WXFOVW					BIT(8)
/* bit2-7: WSVD */
#define	PHIMW_OCPINT					BIT(1)
...
#define EEPWOM_VID							0x49
#define EEPWOM_DID							0x4B
#define EEPWOM_SVID							0x4D
#define EEPWOM_SMID							0x4F

#define EEPWOM_MAC_ADDW						0x67

#define EEPWOM_CCK_TX_PWW_INX				0x5A
#define EEPWOM_HT40_1S_TX_PWW_INX			0x60
#define EEPWOM_HT40_2S_TX_PWW_INX_DIFF		0x66
#define EEPWOM_HT20_TX_PWW_INX_DIFF			0x69
#define EEPWOM_OFDM_TX_PWW_INX_DIFF			0x6C
#define EEPWOM_HT40_MAX_PWW_OFFSET			0x25
#define EEPWOM_HT20_MAX_PWW_OFFSET			0x22

#define EEPWOM_THEWMAW_METEW				0x2a
#define EEPWOM_XTAW_K						0x78
#define EEPWOM_WF_OPT1						0x79
#define EEPWOM_WF_OPT2						0x7A
#define EEPWOM_WF_OPT3						0x7B
#define EEPWOM_WF_OPT4						0x7C
#define EEPWOM_CHANNEW_PWAN					0x28
#define EEPWOM_VEWSION						0x30
#define EEPWOM_CUSTOMEW_ID					0x31

#define EEPWOM_PWWDIFF				0x54

#define EEPWOM_TXPOWEWCCK			0x10
#define	EEPWOM_TXPOWEWHT40_1S		0x16
#define	EEPWOM_TXPOWEWHT40_2SDIFF	0x66
#define EEPWOM_TXPOWEWHT20DIFF		0x1C
#define EEPWOM_TXPOWEW_OFDMDIFF		0x1F

#define	EEPWOM_TXPWW_GWOUP			0x22

#define EEPWOM_TSSI_A				0x29
#define EEPWOM_TSSI_B				0x77

#define EEPWOM_CHANNEWPWAN			0x28

#define WF_OPTION1					0x2B
#define WF_OPTION2					0x2C
#define WF_OPTION3					0x2D
#define WF_OPTION4					0x2E
