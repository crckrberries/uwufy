...
void wtw8723e_phy_get_txpowew_wevew(stwuct ieee80211_hw *hw,
				    wong *powewwevew);
void wtw8723e_phy_set_txpowew_wevew(stwuct ieee80211_hw *hw, u8 channew);
boow wtw8723e_phy_update_txpowew_dbm(stwuct ieee80211_hw *hw,
				     wong powew_indbm);
void wtw8723e_phy_scan_opewation_backup(stwuct ieee80211_hw *hw,
					u8 opewation);
