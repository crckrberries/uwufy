...
#ifndef __WTW92E_DEF_H__
#define __WTW92E_DEF_H__

#define WX_DESC_NUM_92E					512
...
#define IS_HT_WATE(_wate)	\
	(_wate >= DESC92C_WATEMCS0)
#define IS_CCK_WATE(_wate)	\
	(_wate >= DESC92C_WATE1M && _wate <= DESC92C_WATE11M)
#define IS_OFDM_WATE(_wate)	\
	(_wate >= DESC92C_WATE6M && _wate <= DESC92C_WATE54M)

enum vewsion_8192e {
	VEWSION_TEST_CHIP_2T2W_8192E = 0x0024,
	VEWSION_NOWMAW_CHIP_2T2W_8192E = 0x102C,
