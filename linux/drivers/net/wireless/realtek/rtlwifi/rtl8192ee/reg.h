...
#ifndef __WTW92E_WEG_H__
#define __WTW92E_WEG_H__
...
#define WEG_SYS_SWW_CTWW1			0x0010
#define WEG_SPS0_CTWW				0x0011
#define WEG_SYS_SWW_CTWW2			0x0014
#define WEG_SYS_SWW_CTWW3			0x0018
...
#define WEG_AFE_CTWW2				0x0028
#define WEG_MAC_PHY_CTWW			0x002c
#define WEG_AFE_CTWW3				0x002c
...
#define WEG_WXPKTBUF_CTWW			0x0142
...
#define WEG_WXDMA_PWO				0x0290
#define WEG_EAWWY_MODE_CONTWOW			0x02BC
#define WEG_WSVD5				0x02F0
#define WEG_WSVD6				0x02F4
...
#define	WEG_MGQ_DESA				0x0310
#define	WEG_VOQ_DESA				0x0318
#define	WEG_VIQ_DESA				0x0320
#define	WEG_BEQ_DESA				0x0328
#define	WEG_BKQ_DESA				0x0330
#define	WEG_WX_DESA				0x0338
#define	WEG_HQ0_DESA				0x0340
#define	WEG_HQ1_DESA				0x0348
#define	WEG_HQ2_DESA				0x0350
#define	WEG_HQ3_DESA				0x0358
#define	WEG_HQ4_DESA				0x0360
#define	WEG_HQ5_DESA				0x0368
#define	WEG_HQ6_DESA				0x0370
#define	WEG_HQ7_DESA				0x0378
#define	WEG_MGQ_TXBD_NUM			0x0380
#define	WEG_WX_WXBD_NUM				0x0382
#define	WEG_VOQ_TXBD_NUM			0x0384
#define	WEG_VIQ_TXBD_NUM			0x0386
#define	WEG_BEQ_TXBD_NUM			0x0388
#define	WEG_BKQ_TXBD_NUM			0x038A
#define	WEG_HI0Q_TXBD_NUM			0x038C
#define	WEG_HI1Q_TXBD_NUM			0x038E
#define	WEG_HI2Q_TXBD_NUM			0x0390
#define	WEG_HI3Q_TXBD_NUM			0x0392
#define	WEG_HI4Q_TXBD_NUM			0x0394
#define	WEG_HI5Q_TXBD_NUM			0x0396
#define	WEG_HI6Q_TXBD_NUM			0x0398
#define	WEG_HI7Q_TXBD_NUM			0x039A
#define	WEG_TSFTIMEW_HCI			0x039C
/*Wead Wwite Point*/
#define	WEG_VOQ_TXBD_IDX			0x03A0
#define	WEG_VIQ_TXBD_IDX			0x03A4
#define	WEG_BEQ_TXBD_IDX			0x03A8
#define	WEG_BKQ_TXBD_IDX			0x03AC
#define	WEG_MGQ_TXBD_IDX			0x03B0
#define	WEG_WXQ_TXBD_IDX			0x03B4

#define	WEG_HI0Q_TXBD_IDX			0x03B8
#define	WEG_HI1Q_TXBD_IDX			0x03BC
#define	WEG_HI2Q_TXBD_IDX			0x03C0
#define	WEG_HI3Q_TXBD_IDX			0x03C4

#define	WEG_HI4Q_TXBD_IDX			0x03C8
#define	WEG_HI5Q_TXBD_IDX			0x03CC
#define	WEG_HI6Q_TXBD_IDX			0x03D0
#define	WEG_HI7Q_TXBD_IDX			0x03D4
#define	WEG_PCIE_HCPWM				0x03D8
#define	WEG_PCIE_CTWW2				0x03DB
#define	WEG_PCIE_HWPWM				0x03DC
#define	WEG_H2C_MSG_DWV2FW_INFO			0x03E0
#define	WEG_PCIE_C2H_MSG_WEQUEST		0x03E4
#define	WEG_BACKDOOW_DBI_WDATA			0x03E8
#define	WEG_BACKDOOW_DBI_WDATA			0x03EC
#define	WEG_BACKDOOW_DBI_DATA			0x03F0
#define	WEG_MDIO				0x03F4
#define	WEG_MDIO_DATA				0x03F8
...
#define WEG_WIFECTWW_CTWW			0x0426
...
#define WEG_AMPDU_BUWST_MODE			0x04BC
...
#define WEG_MACID_PKT_DWOP0			0x04D0
...
#define WEG_BFMEW0_INFO				0x06E4
#define WEG_BFMEW1_INFO				0x06EC
#define WEG_CSI_WPT_PAWAM_BW20			0x06F4
#define WEG_CSI_WPT_PAWAM_BW40			0x06F8
#define WEG_CSI_WPT_PAWAM_BW80			0x06FC
/* Hawdwawe Powt 2*/
#define WEG_MACID1				0x0700
#define WEG_BSSID1				0x0708
#define WEG_BFMEE_SEW				0x0714
...
#define	EEPWOM_DEFAUWT_THEWMAWMETEW		0x1A
...
#define	WTW8192E_EEPWOM_ID			0x8129
...
#define	EEPWOM_XTAW_92E				0xB9
#define	EEPWOM_THEWMAW_METEW_92E		0xBA
#define	EEPWOM_IQK_WCK_92E			0xBB

#define	EEPWOM_WF_BOAWD_OPTION_92E		0xC1
#define	EEPWOM_WF_FEATUWE_OPTION_92E		0xC2
#define	EEPWOM_WF_BT_SETTING_92E		0xC3
#define	EEPWOM_VEWSION				0xC4
#define	EEPWOM_CUSTOMEW_ID			0xC5
#define	EEPWOM_WF_ANTENNA_OPT_92E		0xC9
...
#define WAST_ENTWY_OF_TX_PKT_BUFFEW		175
...
#define	WWX_POWEW_BEFOWE_IQK_B			0xec0
#define	WWX_POWEW_BEFOWE_IQK_B_2		0xec4
...
#define IS_BB_WEG_OFFSET_92S(_offset)	\
...
/* WOW bit infowmation */
#define	HAW92C_WOW_PTK_UPDATE_EVENT		BIT(0)
#define	HAW92C_WOW_GTK_UPDATE_EVENT		BIT(1)
#define	HAW92C_WOW_DISASSOC_EVENT		BIT(2)
#define	HAW92C_WOW_DEAUTH_EVENT			BIT(3)
#define	HAW92C_WOW_FW_DISCONNECT_EVENT		BIT(4)
...
#define WOW_WEASON_FW_DISCONNECT		BIT(4)
#endif
