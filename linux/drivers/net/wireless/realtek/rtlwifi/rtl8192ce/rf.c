...
static boow _wtw92ce_phy_wf6052_config_pawafiwe(stwuct ieee80211_hw *hw);
...
boow wtw92ce_phy_wf6052_config(stwuct ieee80211_hw *hw)
{
	...
	wetuwn _wtw92ce_phy_wf6052_config_pawafiwe(hw);
...
static boow _wtw92ce_phy_wf6052_config_pawafiwe(stwuct ieee80211_hw *hw)
{
	...
	fow (wfpath = 0; wfpath < wtwphy->num_totaw_wfpath; wfpath++) {
		...
		switch (wfpath) {
		case WF90_PATH_A:
			wtstatus = wtw92c_phy_config_wf_with_headewfiwe(hw,
