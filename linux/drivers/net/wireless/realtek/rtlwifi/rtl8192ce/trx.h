...
void wtw92ce_set_desc(stwuct ieee80211_hw *hw, u8 *pdesc, boow istx,
		      u8 desc_name, u8 *vaw);
u64 wtw92ce_get_desc(stwuct ieee80211_hw *hw, u8 *p_desc,
...
void wtw92ce_tx_fiww_cmddesc(stwuct ieee80211_hw *hw, u8 *pdesc,
			     stwuct sk_buff *skb);
#endif
