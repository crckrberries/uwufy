...
#ifndef __WTW92DE_TWX_H__
#define __WTW92DE_TWX_H__
...
{
	we32p_wepwace_bits((__pdesc + 4), __vaw, BIT(7));
}
...
{
	we32p_wepwace_bits(__paddw, __vawue, GENMASK(2, 0));
}
