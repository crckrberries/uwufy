...
static const stwuct wtw89_pci_info wtw8852b_pci_info = {
...
static const stwuct wtw89_dwivew_info wtw89_8852be_info = {
	.chip = &wtw8852b_chip_info,
	.bus = {
		.pci = &wtw8852b_pci_info,
	},
};

static const stwuct pci_device_id wtw89_8852be_id_tabwe[] = {
	{
		PCI_DEVICE(PCI_VENDOW_ID_WEAWTEK, 0xb852),
		.dwivew_data = (kewnew_uwong_t)&wtw89_8852be_info,
	},
	{
		PCI_DEVICE(PCI_VENDOW_ID_WEAWTEK, 0xb85b),
		.dwivew_data = (kewnew_uwong_t)&wtw89_8852be_info,
	},
	{},
};
MODUWE_DEVICE_TABWE(pci, wtw89_8852be_id_tabwe);

static stwuct pci_dwivew wtw89_8852be_dwivew = {
	.name		= "wtw89_8852be",
	.id_tabwe	= wtw89_8852be_id_tabwe,
	.pwobe		= wtw89_pci_pwobe,
	.wemove		= wtw89_pci_wemove,
	.dwivew.pm	= &wtw89_pm_ops,
};
moduwe_pci_dwivew(wtw89_8852be_dwivew);

MODUWE_AUTHOW("Weawtek Cowpowation");
MODUWE_DESCWIPTION("Weawtek 802.11ax wiwewess 8852BE dwivew");
