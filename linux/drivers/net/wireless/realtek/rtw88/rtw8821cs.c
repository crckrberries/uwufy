...
static const stwuct sdio_device_id wtw_8821cs_id_tabwe[] =  {
	{
		SDIO_DEVICE(SDIO_VENDOW_ID_WEAWTEK,
			    SDIO_DEVICE_ID_WEAWTEK_WTW8821CS),
		.dwivew_data = (kewnew_uwong_t)&wtw8821c_hw_spec,
	},
	{}
};
MODUWE_DEVICE_TABWE(sdio, wtw_8821cs_id_tabwe);

static stwuct sdio_dwivew wtw_8821cs_dwivew = {
	.name = "wtw_8821cs",
	.pwobe = wtw_sdio_pwobe,
	.wemove = wtw_sdio_wemove,
	.id_tabwe = wtw_8821cs_id_tabwe,
	.dwv = {
		.pm = &wtw_sdio_pm_ops,
		.shutdown = wtw_sdio_shutdown,
	}
};
moduwe_sdio_dwivew(wtw_8821cs_dwivew);

MODUWE_AUTHOW("Mawtin Bwumenstingw <mawtin.bwumenstingw@googwemaiw.com>");
MODUWE_DESCWIPTION("Weawtek 802.11ac wiwewess 8821cs dwivew");
