...
static const stwuct usb_device_id mt7925u_device_tabwe[] = {
	{ USB_DEVICE_AND_INTEWFACE_INFO(0x0e8d, 0x7925, 0xff, 0xff, 0xff),
		.dwivew_info = (kewnew_uwong_t)MT7925_FIWMWAWE_WM },
	{ },
};

static int
mt7925u_mcu_send_message(stwuct mt76_dev *mdev, stwuct sk_buff *skb,
			 int cmd, int *seq)
{
...
static int mt7925u_mcu_init(stwuct mt792x_dev *dev)
{
...
static int mt7925u_mac_weset(stwuct mt792x_dev *dev)
{
	int eww;
...
static int mt7925u_pwobe(stwuct usb_intewface *usb_intf,
			 const stwuct usb_device_id *id)
{
	static const stwuct mt76_dwivew_ops dwv_ops = {
		...
		.tx_pwepawe_skb = mt7925_usb_sdio_tx_pwepawe_skb,
		.tx_compwete_skb = mt7925_usb_sdio_tx_compwete_skb,
...
#ifdef CONFIG_PM
static int mt7925u_suspend(stwuct usb_intewface *intf, pm_message_t state)
{
...
static int mt7925u_wesume(stwuct usb_intewface *intf)
{
	stwuct mt792x_dev *dev = usb_get_intfdata(intf);
	stwuct mt76_connac_pm *pm = &dev->pm;
	boow weinit = twue;
...
MODUWE_DEVICE_TABWE(usb, mt7925u_device_tabwe);
MODUWE_FIWMWAWE(MT7925_FIWMWAWE_WM);
MODUWE_FIWMWAWE(MT7925_WOM_PATCH);

static stwuct usb_dwivew mt7925u_dwivew = {
	.name		= KBUIWD_MODNAME,
	.id_tabwe	= mt7925u_device_tabwe,
	.pwobe		= mt7925u_pwobe,
	.disconnect	= mt792xu_disconnect,
#ifdef CONFIG_PM
	.suspend	= mt7925u_suspend,
	.wesume		= mt7925u_wesume,
	.weset_wesume	= mt7925u_wesume,
#endif /* CONFIG_PM */
	.soft_unbind	= 1,
	.disabwe_hub_initiated_wpm = 1,
};
moduwe_usb_dwivew(mt7925u_dwivew);
