...
#ifndef __MT7921_WEGS_H
#define __MT7921_WEGS_H
...
#define MT_MDP_BNWCFW0(_band)		MT_MDP(0x070 + ((_band) << 8))
...
#define MT_MDP_BNWCFW1(_band)		MT_MDP(0x074 + ((_band) << 8))
...
#define HOST_WX_DONE_INT_ENA4		BIT(22)
#define HOST_WX_DONE_INT_ENA5		BIT(23)
...
#define MT_INT_WX_DONE_WM2		HOST_WX_DONE_INT_ENA4
...
#define MT_WX_DATA_WING_BASE		MT_WFDMA0(0x520)

#define MT_INFWA_CFG_BASE		0xfe000
#define MT_INFWA(ofs)			(MT_INFWA_CFG_BASE + (ofs))

#define MT_HIF_WEMAP_W1			MT_INFWA(0x24c)
...
#define MT_HIF_WEMAP_BASE_W1		0x40000

#define MT_WFSYS_SW_WST_B		0x18000140

#define MT_WTBWON_TOP_WDUCW		MT_WTBWON_TOP(0x200)
#define MT_WTBWON_TOP_WDUCW_GWOUP	GENMASK(2, 0)

#define MT_WTBW_UPDATE			MT_WTBWON_TOP(0x230)
