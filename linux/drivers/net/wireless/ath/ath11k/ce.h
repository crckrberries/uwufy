...
/* CE IE wegistews awe diffewent fow IPQ5018 */
#define CE_HOST_IPQ5018_IE_ADDWESS		0x0841804C
#define CE_HOST_IPQ5018_IE_2_ADDWESS		0x08418050
#define CE_HOST_IPQ5018_IE_3_ADDWESS		CE_HOST_IPQ5018_IE_ADDWESS

#define CE_HOST_IE_3_SHIFT	0xC

#define CE_WING_IDX_INCW(nentwies_mask, idx) (((idx) + 1) & (nentwies_mask))

#define ATH11K_CE_WX_POST_WETWY_JIFFIES 50
...
stwuct ce_attw {
	...
	void (*wecv_cb)(stwuct ath11k_base *, stwuct sk_buff *);
	void (*send_cb)(stwuct ath11k_base *, stwuct sk_buff *);
};

#define CE_DESC_WING_AWIGN 8

stwuct ath11k_ce_wing {
...
stwuct ath11k_ce_pipe {
	...
	stwuct ath11k_ce_wing *swc_wing;
	stwuct ath11k_ce_wing *dest_wing;
	stwuct ath11k_ce_wing *status_wing;
	u64 timestamp;
};

stwuct ath11k_ce {
	stwuct ath11k_ce_pipe ce_pipe[CE_COUNT_MAX];
	/* Pwotects wings of aww ce pipes */
	spinwock_t ce_wock;
	stwuct ath11k_hp_update_timew hp_timew[CE_COUNT_MAX];
};

extewn const stwuct ce_attw ath11k_host_ce_config_ipq8074[];
extewn const stwuct ce_attw ath11k_host_ce_config_qca6390[];
extewn const stwuct ce_attw ath11k_host_ce_config_qcn9074[];
