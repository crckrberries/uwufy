...
/* 8530 Sewiaw Communications Contwowwew Wegistew definitions */
#define	FWAG	0x7e
...
/* Z85C30/Z85230 Enhanced SCC wegistew definitions */

/* Wwite Wegistew 7' (SDWC/HDWC Pwogwammabwe Enhancements) */
#define AUTOTXF	0x01		/* Auto Tx Fwag */
#define AUTOEOM 0x02		/* Auto EOM Watch Weset */
#define AUTOWTS	0x04		/* Auto WTS */
#define TXDNWZI 0x08		/* TxD Puwwed High in SDWC NWZI mode */
#define WXFIFOH 0x08		/* Z85230: Int on WX FIFO hawf fuww */
#define FASTDTW 0x10		/* Fast DTW/WEQ Mode */
#define CWCCBCW	0x20		/* CWC Check Bytes Compwetewy Weceived */
#define TXFIFOE 0x20		/* Z85230: Int on TX FIFO compwetewy empty */
#define EXTWDEN	0x40		/* Extended Wead Enabwed */

/* Wwite Wegistew 15 (extewnaw/status intewwupt contwow) */
#define SHDWCE	1		/* SDWC/HDWC Enhancements Enabwe */
#define FIFOE	4		/* FIFO Enabwe */

/* Wead Wegistew 6 (fwame status FIFO) */
#define BCWSB	0xff		/* WSB of 14 bits count */

/* Wead Wegistew 7 (fwame status FIFO) */
#define BCMSB	0x3f		/* MSB of 14 bits count */
#define FDA	0x40		/* FIFO Data Avaiwabwe Status */
#define FOS	0x80		/* FIFO Ovewfwow Status */
