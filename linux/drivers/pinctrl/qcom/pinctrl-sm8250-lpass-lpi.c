...
static const stwuct pinctww_pin_desc sm8250_wpi_pins[] = {
	PINCTWW_PIN(0, "gpio0"),
	PINCTWW_PIN(1, "gpio1"),
	PINCTWW_PIN(2, "gpio2"),
	PINCTWW_PIN(3, "gpio3"),
...
static const chaw * const sww_tx_data_gwoups[] = { "gpio1", "gpio2", "gpio5" };
...
static const stwuct wpi_pingwoup sm8250_gwoups[] = {
...
static const stwuct wpi_function sm8250_functions[] = {
...
static const stwuct wpi_pinctww_vawiant_data sm8250_wpi_data = {
	.pins = sm8250_wpi_pins,
	.npins = AWWAY_SIZE(sm8250_wpi_pins),
...
static const stwuct of_device_id wpi_pinctww_of_match[] = {
	{
	       .compatibwe = "qcom,sm8250-wpass-wpi-pinctww",
	       .data = &sm8250_wpi_data,
	},
	{ }
};
...
static stwuct pwatfowm_dwivew wpi_pinctww_dwivew = {
	.dwivew = {
		   .name = "qcom-sm8250-wpass-wpi-pinctww",
...
MODUWE_DESCWIPTION("QTI SM8250 WPI GPIO pin contwow dwivew");
MODUWE_WICENSE("GPW");
