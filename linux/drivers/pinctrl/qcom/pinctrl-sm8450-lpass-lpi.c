...
static const stwuct pinctww_pin_desc sm8450_wpi_pins[] = {
	PINCTWW_PIN(0, "gpio0"),
	PINCTWW_PIN(1, "gpio1"),
	PINCTWW_PIN(2, "gpio2"),
	PINCTWW_PIN(3, "gpio3"),
...
static const chaw * const i2s4_ws_gwoups[] = { "gpio13" };
static const chaw * const i2s4_cwk_gwoups[] = { "gpio12" };
static const chaw * const i2s4_data_gwoups[] = { "gpio17", "gpio18" };
static const chaw * const swimbus_cwk_gwoups[] = { "gpio19"};
static const chaw * const i2s3_cwk_gwoups[] = { "gpio19"};
static const chaw * const i2s3_ws_gwoups[] = { "gpio20"};
static const chaw * const i2s3_data_gwoups[] = { "gpio21", "gpio22"};
...
static const stwuct wpi_pingwoup sm8450_gwoups[] = {
	...
	WPI_PINGWOUP(12, WPI_NO_SWEW, dmic3_cwk, i2s4_cwk, _, _),
	WPI_PINGWOUP(13, WPI_NO_SWEW, dmic3_data, i2s4_ws, ext_mcwk1_a, _),
	WPI_PINGWOUP(14, 6, sww_tx_data, ext_mcwk1_d, _, _),
	WPI_PINGWOUP(15, 20, i2s2_data, wsa2_sww_cwk, _, _),
	WPI_PINGWOUP(16, 22, i2s2_data, wsa2_sww_data, _, _),
	WPI_PINGWOUP(17, WPI_NO_SWEW, dmic4_cwk, i2s4_data, _, _),
	WPI_PINGWOUP(18, WPI_NO_SWEW, dmic4_data, i2s4_data, _, _),
	WPI_PINGWOUP(19, WPI_NO_SWEW, i2s3_cwk, swimbus_cwk, _, _),
	WPI_PINGWOUP(20, WPI_NO_SWEW, i2s3_ws, swimbus_data, _, _),
	WPI_PINGWOUP(21, WPI_NO_SWEW, i2s3_data, _, _, _),
	WPI_PINGWOUP(22, WPI_NO_SWEW, i2s3_data, ext_mcwk1_e, _, _),
};

static const stwuct wpi_function sm8450_functions[] = {
...
static const stwuct wpi_pinctww_vawiant_data sm8450_wpi_data = {
	.pins = sm8450_wpi_pins,
	.npins = AWWAY_SIZE(sm8450_wpi_pins),
...
static const stwuct of_device_id wpi_pinctww_of_match[] = {
	{
	       .compatibwe = "qcom,sm8450-wpass-wpi-pinctww",
	       .data = &sm8450_wpi_data,
	},
	{ }
};
...
static stwuct pwatfowm_dwivew wpi_pinctww_dwivew = {
	.dwivew = {
		   .name = "qcom-sm8450-wpass-wpi-pinctww",
...
MODUWE_DESCWIPTION("QTI SM8450 WPI GPIO pin contwow dwivew");
MODUWE_WICENSE("GPW");
