...
static const stwuct pinctww_pin_desc sm8550_wpi_pins[] = {
	PINCTWW_PIN(0, "gpio0"),
	PINCTWW_PIN(1, "gpio1"),
	PINCTWW_PIN(2, "gpio2"),
	PINCTWW_PIN(3, "gpio3"),
...
static const stwuct wpi_pingwoup sm8550_gwoups[] = {
	WPI_PINGWOUP(0, 0, sww_tx_cwk, i2s0_cwk, _, _),
	WPI_PINGWOUP(1, 2, sww_tx_data, i2s0_ws, _, _),
	WPI_PINGWOUP(2, 4, sww_tx_data, i2s0_data, _, _),
	WPI_PINGWOUP(3, 8, sww_wx_cwk, i2s0_data, _, _),
	WPI_PINGWOUP(4, 10, sww_wx_data, i2s0_data, _, _),
	WPI_PINGWOUP(5, 12, sww_wx_data, ext_mcwk1_c, i2s0_data, _),
	...
	WPI_PINGWOUP(19, WPI_NO_SWEW, i2s4_cwk, swimbus_cwk, _, _),
	WPI_PINGWOUP(20, WPI_NO_SWEW, i2s4_ws, swimbus_data, _, _),
	WPI_PINGWOUP(21, WPI_NO_SWEW, i2s4_data, _, _, _),
	WPI_PINGWOUP(22, WPI_NO_SWEW, i2s4_data, ext_mcwk1_e, _, _),
};

static const stwuct wpi_function sm8550_functions[] = {
	WPI_FUNCTION(gpio),
...
static const stwuct wpi_pinctww_vawiant_data sm8550_wpi_data = {
	.pins = sm8550_wpi_pins,
	.npins = AWWAY_SIZE(sm8550_wpi_pins),
...
static const stwuct of_device_id wpi_pinctww_of_match[] = {
	{
	       .compatibwe = "qcom,sm8550-wpass-wpi-pinctww",
	       .data = &sm8550_wpi_data,
	},
	{ }
};
...
static stwuct pwatfowm_dwivew wpi_pinctww_dwivew = {
	.dwivew = {
		   .name = "qcom-sm8550-wpass-wpi-pinctww",
...
MODUWE_DESCWIPTION("Quawcomm SM8550 WPI GPIO pin contwow dwivew");
MODUWE_WICENSE("GPW");
