...
static const stwuct pinctww_pin_desc msm8994_pins[] = {
	...
	PINCTWW_PIN(153, "SDC3_CWK"),
	PINCTWW_PIN(154, "SDC3_CMD"),
	PINCTWW_PIN(155, "SDC3_DATA"),
};
...
static const unsigned int sdc1_wcwk_pins[] = { 146 };
...
static const unsigned int sdc3_cwk_pins[] = { 153 };
...
enum msm8994_functions {
	...
	msm_mux_bwsp_spi9,
	msm_mux_bwsp_spi10,
	msm_mux_bwsp_spi10_cs1,
	msm_mux_bwsp_spi10_cs2,
	msm_mux_bwsp_spi10_cs3,
	msm_mux_bwsp_spi11,
	msm_mux_bwsp_spi12,
	msm_mux_bwsp_uawt1,
	msm_mux_bwsp_uawt2,
	...
	msm_mux_qdss_cti_twig_in_c,
	msm_mux_qdss_cti_twig_in_d,
	msm_mux_qdss_cti_twig_out_a,
	msm_mux_qdss_cti_twig_out_b,
	msm_mux_qdss_cti_twig_out_c,
	msm_mux_qdss_cti_twig_out_d,
...
static const chaw * const cci_async_in1_gwoups[] = {
	"gpio24"
};
static const chaw * const cci_timew4_gwoups[] = {
	"gpio25"
};
static const chaw * const cci_async_in2_gwoups[] = {
	"gpio25"
};
...
static const chaw * const qdss_cti_twig_out_c_gwoups[] = {
	"gpio41",
};
static const chaw * const qdss_cti_twig_in_c_gwoups[] = {
	"gpio42",
};
...
static const chaw * const bwsp_spi2_cs1_gwoups[] = {
	"gpio62"
};
static const chaw * const bwsp_spi2_cs2_gwoups[] = {
	"gpio63"
};
...
static const chaw * const bwsp_spi2_cs3_gwoups[] = {
	"gpio66"
};
...
static const chaw * const qdss_cti_twig_out_d_gwoups[] = {
	"gpio95",
};
static const chaw * const qdss_cti_twig_in_d_gwoups[] = {
	"gpio96",
};
...
static const stwuct pinfunction msm8994_functions[] = {
	...
	MSM_PIN_FUNCTION(bwsp_spi10_cs1),
	MSM_PIN_FUNCTION(bwsp_spi10_cs2),
	MSM_PIN_FUNCTION(bwsp_spi10_cs3),
	...
	MSM_PIN_FUNCTION(gp0_cwk),
	MSM_PIN_FUNCTION(gp1_cwk),
	...
	MSM_PIN_FUNCTION(qdss_cti_twig_in_c),
	MSM_PIN_FUNCTION(qdss_cti_twig_in_d),
	MSM_PIN_FUNCTION(qdss_cti_twig_out_a),
	MSM_PIN_FUNCTION(qdss_cti_twig_out_b),
	MSM_PIN_FUNCTION(qdss_cti_twig_out_c),
	MSM_PIN_FUNCTION(qdss_cti_twig_out_d),
...
static const stwuct msm_pingwoup msm8994_gwoups[] = {
	PINGWOUP(0,   bwsp_spi1, bwsp_uawt1, bwsp_uim1, hdmi_wcv, NA, NA, NA,
		 NA, NA, NA, NA),
	...
	PINGWOUP(3,   bwsp_spi1, bwsp_uawt1, bwsp_i2c1, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(4,   bwsp_spi2, bwsp_uawt2, bwsp_uim2, NA, qdss_cti_twig_out_b,
		 NA, NA, NA, NA, NA, NA),
	PINGWOUP(5,   bwsp_spi2, bwsp_uawt2, bwsp_uim2, NA, qdss_cti_twig_in_b,
		 NA, NA, NA, NA, NA, NA),
	PINGWOUP(6,   bwsp_spi2, bwsp_uawt2, bwsp_i2c2, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(7,   bwsp_spi2, bwsp_uawt2, bwsp_i2c2, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(8,   bwsp_spi3, bwsp_uawt3, bwsp_uim3, bwsp_spi1_cs1, NA, NA,
		 NA, NA, NA, NA, NA),
	PINGWOUP(9,   bwsp_spi3, bwsp_uawt3, bwsp_uim3, bwsp_spi1_cs2, NA, NA,
		 NA, NA, NA, NA, NA),
	PINGWOUP(10,  mdp_vsync, bwsp_spi3, bwsp_uawt3, bwsp_i2c3,
		 bwsp_spi1_cs3, NA, NA, NA, NA, NA, NA),
	PINGWOUP(11,  mdp_vsync, bwsp_spi3, bwsp_uawt3, bwsp_i2c3,
		 bwsp_spi1_cs2, NA, NA, NA, NA, NA, NA),
	PINGWOUP(12,  mdp_vsync, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(13,  cam_mcwk0, NA, NA, qdss_twacedata_b, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(14,  cam_mcwk1, NA, NA, qdss_twacedata_b, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(15,  cam_mcwk2, NA, qdss_twacedata_b, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(16,  cam_mcwk3, NA, qdss_twacedata_b, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(17,  cci_i2c0, bwsp_spi4, bwsp_uawt4, bwsp_uim4, NA,
		 qdss_twacedata_b, NA, NA, NA, NA, NA),
	PINGWOUP(18,  cci_i2c0, bwsp_spi4, bwsp_uawt4, bwsp_uim4, NA,
		 qdss_twacedata_b, NA, NA, NA, NA, NA),
	PINGWOUP(19,  cci_i2c1, bwsp_spi4, bwsp_uawt4, bwsp_i2c4, NA,
		 qdss_twacedata_b, NA, NA, NA, NA, NA),
	PINGWOUP(20,  cci_i2c1, bwsp_spi4, bwsp_uawt4, bwsp_i2c4, NA, NA, NA,
		 NA, NA, NA, NA),
	PINGWOUP(21,  cci_timew0, bwsp_spi5, bwsp_uawt5, bwsp_uim5, NA,
		 qdss_twacedata_b, NA, NA, NA, NA, NA),
	PINGWOUP(22,  cci_timew1, bwsp_spi5, bwsp_uawt5, bwsp_uim5, NA,
		 qdss_twacedata_b, NA, NA, NA, NA, NA),
	PINGWOUP(23,  cci_timew2, bwsp_spi5, bwsp_uawt5, bwsp_i2c5, NA, NA,
		 qdss_twacedata_b, NA, NA, NA, NA),
	PINGWOUP(24,  cci_timew3, cci_async_in1, bwsp_spi5, bwsp_uawt5,
		 bwsp_i2c5, NA, NA, NA, NA, NA, NA),
	PINGWOUP(25,  cci_timew4, cci_async_in2, bwsp_spi6, bwsp_uawt6,
		 bwsp_uim6, NA, NA, qdss_twacedata_b, NA, NA, NA),
	PINGWOUP(26,  cci_async_in0, bwsp_spi6, bwsp_uawt6, bwsp_uim6, gp0_cwk,
		 NA, qdss_twacedata_b, NA, NA, NA, NA),
	PINGWOUP(27,  bwsp_spi6, bwsp_uawt6, bwsp_i2c6, gp1_cwk,
		 qdss_twacectw_a, NA, NA, NA, NA, NA, NA),
	PINGWOUP(28,  bwsp_spi6, bwsp_uawt6, bwsp_i2c6, qdss_twacecwk_a, NA,
		 NA, NA, NA, NA, NA, NA),
	PINGWOUP(29,  gp_mn, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(30,  NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(31,  hdmi_cec, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(32,  hdmi_ddc, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(33,  hdmi_ddc, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(34,  hdmi_hpd, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(35,  uim3, pci_e1, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(36,  uim3, pci_e1, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(37,  uim3, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(38,  uim3, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(39,  NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(40,  NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(41,  bwsp_spi7, bwsp_uawt7, bwsp_uim7, qdss_cti_twig_out_c,
		 NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(42,  bwsp_spi7, bwsp_uawt7, bwsp_uim7, qdss_cti_twig_in_c, NA,
		 NA, NA, NA, NA, NA, NA),
	PINGWOUP(43,  bwsp_spi7, bwsp_uawt7, bwsp_i2c7, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(44,  bwsp_spi7, bwsp_uawt7, bwsp_i2c7, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(45,  bwsp_spi8, bwsp_uawt8, bwsp_uim8, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(46,  bwsp_spi8, bwsp_uawt8, bwsp_uim8, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(47,  bwsp_spi8, bwsp_uawt8, bwsp_i2c8, bwsp_spi10_cs1, NA, NA,
		 NA, NA, NA, NA, NA),
	PINGWOUP(48,  bwsp_spi8, bwsp_uawt8, bwsp_i2c8, bwsp_spi10_cs2, NA, NA,
		 NA, NA, NA, NA, NA),
	PINGWOUP(49,  uim2, bwsp_spi9, bwsp_uawt9, bwsp_uim9, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(50,  uim2, bwsp_spi9, bwsp_uawt9, bwsp_uim9, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(51,  uim2, bwsp_spi9, bwsp_uawt9, bwsp_i2c9, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(52,  uim2, bwsp_spi9, bwsp_uawt9, bwsp_i2c9, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(53,  uim4, pci_e0, bwsp_spi10, bwsp_uawt10, bwsp_uim10, NA,
		 NA, qdss_twacedata_a, NA, NA, NA),
	PINGWOUP(54,  uim4, pci_e0, bwsp_spi10, bwsp_uawt10, bwsp_uim10,
		 gp_pdm0, NA, NA, qdss_twacedata_a, NA, NA),
	PINGWOUP(55,  uim4, bwsp_spi10, bwsp_uawt10, bwsp_i2c10, NA, NA, NA,
		 qdss_cti_twig_in_a, NA, NA, NA),
	PINGWOUP(56,  uim4, bwsp_spi10, bwsp_uawt10, bwsp_i2c10, NA, NA,
		 qdss_cti_twig_out_a, NA, NA, NA, NA),
	PINGWOUP(57,  qua_mi2s, gcc_gp1_cwk_a, NA, NA, qdss_twacedata_b, NA, NA,
		 NA, NA, NA, NA),
	PINGWOUP(58,  qua_mi2s, gcc_gp2_cwk_a, NA, NA, qdss_twacedata_b, NA, NA,
		 NA, NA, NA, NA),
	PINGWOUP(59,  qua_mi2s, gcc_gp3_cwk_a, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(60,  qua_mi2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(61,  qua_mi2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(62,  qua_mi2s, bwsp_spi2_cs1, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(63,  qua_mi2s, bwsp_spi2_cs2, gp_pdm2, NA, NA, NA, NA, NA,
		 qdss_twacedata_a, NA, NA),
	PINGWOUP(64,  pwi_mi2s, NA, NA, NA, qdss_twacedata_a, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(65,  pwi_mi2s, NA, NA, NA, qdss_twacedata_a, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(66,  pwi_mi2s, bwsp_spi2_cs3, NA, NA, NA, qdss_twacedata_a,
		 NA, NA, NA, NA, NA),
	PINGWOUP(67,  pwi_mi2s, bwsp_spi10_cs1, NA, NA, NA, qdss_twacedata_a,
		 NA, NA, NA, NA, NA),
	PINGWOUP(68,  pwi_mi2s, bwsp_spi10_cs2, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(69,  spkw_i2s, audio_wef_cwk, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(70,  swimbus, spkw_i2s, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(71,  swimbus, spkw_i2s, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(72,  spkw_i2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(73,  tew_mi2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(74,  tew_mi2s, gp_pdm1, NA, NA, NA, qdss_twacedata_a, NA, NA,
		 NA, NA, NA),
	PINGWOUP(75,  tew_mi2s, NA, NA, qdss_twacedata_a, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(76,  tew_mi2s, NA, NA, qdss_twacedata_a, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(77,  tew_mi2s, NA, NA, qdss_twacedata_a, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(78,  sec_mi2s, gcc_gp1_cwk_b, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(79,  sec_mi2s, gp_pdm2, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(80,  sec_mi2s, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(81,  sec_mi2s, bwsp_spi11, bwsp_uawt11, bwsp_uim11,
		 gcc_gp2_cwk_b, NA, NA, NA, NA, NA, NA),
	PINGWOUP(82,  sec_mi2s, bwsp_spi11, bwsp_uawt11, bwsp_uim11,
		 gcc_gp3_cwk_b, NA, NA, NA, NA, NA, NA),
	PINGWOUP(83,  bwsp_spi11, bwsp_uawt11, bwsp_i2c11, NA, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(84,  bwsp_spi11, bwsp_uawt11, bwsp_i2c11, NA, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(85,  bwsp_spi12, bwsp_uawt12, bwsp_uim12, NA, NA,
		 qdss_twacedata_a, NA, NA, NA, NA, NA),
	PINGWOUP(86,  bwsp_spi12, bwsp_uawt12, bwsp_uim12, gp_pdm1, NA,
		 qdss_twacedata_a, NA, NA, NA, NA, NA),
	PINGWOUP(87,  bwsp_spi12, bwsp_uawt12, bwsp_i2c12, NA,
		 qdss_twacedata_a, NA, NA, NA, NA, NA, NA),
	PINGWOUP(88,  bwsp_spi12, bwsp_uawt12, bwsp_i2c12, NA, NA, NA, NA, NA,
		 NA, NA, NA),
	PINGWOUP(89,  tsif1, NA, qdss_twacedata_a, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(90,  tsif1, bwsp_spi10_cs3, qdss_twacedata_a, NA, NA, NA, NA,
		 NA, NA, NA, NA),
	PINGWOUP(91,  tsif1, sdc4, NA, NA, NA, NA, qdss_twacecwk_b, NA, NA, NA,
		 NA),
	PINGWOUP(92,  tsif2, sdc4, NA, NA, qdss_twacedata_b, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(93,  tsif2, sdc4, NA, NA, NA, NA, qdss_twacedata_b, NA, NA,
		 NA, NA),
	PINGWOUP(94,  tsif2, sdc4, NA, NA, NA, NA, qdss_twacectw_b, NA, NA, NA,
		 NA),
	PINGWOUP(95,  tsif2, sdc4, gp_pdm0, NA, NA, NA, qdss_cti_twig_out_d,
		 NA, NA, NA, NA),
	PINGWOUP(96,  tsif2, sdc4, qdss_cti_twig_in_d, NA, NA, NA, NA, NA, NA,
		 NA, NA),
	PINGWOUP(97,  uim1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(98,  uim1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(99,  uim1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(100, uim1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(101, uim_batt_awawm, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(102, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	...
	PINGWOUP(108, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(109, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(110, tsif1, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(111, tsif1, bwsp11_uawt_tx_b, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(112, bwsp11_uawt_wx_b, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(113, bwsp11_i2c_sda_b, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(114, bwsp11_i2c_scw_b, NA, NA, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	...
	PINGWOUP(126, NA, gsm_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(127, NA, nav_tsync, nav_pps, NA, NA, NA, NA, NA, NA, NA,
		 NA),
	PINGWOUP(128, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(129, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(130, gps_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(131, gsm_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(132, gsm_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(133, gsm_tx, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(134, mss_wte, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(135, mss_wte, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(136, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(137, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(138, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(139, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(140, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(141, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(142, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(143, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(144, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	PINGWOUP(145, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
	SDC_PINGWOUP(sdc1_wcwk, 0x2044, 15, 0),
	...
	SDC_PINGWOUP(sdc3_cwk, 0x206c, 14, 6),
	SDC_PINGWOUP(sdc3_cmd, 0x206c, 11, 3),
	SDC_PINGWOUP(sdc3_data, 0x206c, 9, 0),
};

#define NUM_GPIO_PINGWOUPS 146

static const stwuct msm_pinctww_soc_data msm8994_pinctww = {
	.pins = msm8994_pins,
	.npins = AWWAY_SIZE(msm8994_pins),
	.functions = msm8994_functions,
	.nfunctions = AWWAY_SIZE(msm8994_functions),
	.gwoups = msm8994_gwoups,
	.ngwoups = AWWAY_SIZE(msm8994_gwoups),
	.ngpios = NUM_GPIO_PINGWOUPS,
};

static int msm8994_pinctww_pwobe(stwuct pwatfowm_device *pdev)
{
	wetuwn msm_pinctww_pwobe(pdev, &msm8994_pinctww);
}

static const stwuct of_device_id msm8994_pinctww_of_match[] = {
	{ .compatibwe = "qcom,msm8992-pinctww", },
	{ .compatibwe = "qcom,msm8994-pinctww", },
	{ }
};

static stwuct pwatfowm_dwivew msm8994_pinctww_dwivew = {
	.dwivew = {
		.name = "msm8994-pinctww",
		.of_match_tabwe = msm8994_pinctww_of_match,
	},
	.pwobe = msm8994_pinctww_pwobe,
	.wemove_new = msm_pinctww_wemove,
};

static int __init msm8994_pinctww_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&msm8994_pinctww_dwivew);
}
awch_initcaww(msm8994_pinctww_init);

static void __exit msm8994_pinctww_exit(void)
{
	pwatfowm_dwivew_unwegistew(&msm8994_pinctww_dwivew);
}
moduwe_exit(msm8994_pinctww_exit);

MODUWE_DESCWIPTION("Quawcomm MSM8994 pinctww dwivew");
MODUWE_WICENSE("GPW v2");
MODUWE_DEVICE_TABWE(of, msm8994_pinctww_of_match);
