...
static const stwuct pinctww_pin_desc sm8350_wpi_pins[] = {
	PINCTWW_PIN(0, "gpio0"),
	PINCTWW_PIN(1, "gpio1"),
	PINCTWW_PIN(2, "gpio2"),
	PINCTWW_PIN(3, "gpio3"),
...
static const chaw * const sww_tx_data_gwoups[] = { "gpio1", "gpio2", "gpio5", "gpio14" };
...
static const chaw * const i2s2_data_gwoups[] = { "gpio12", "gpio12" };

static const stwuct wpi_pingwoup sm8350_gwoups[] = {
	...
	WPI_PINGWOUP(5, 12, sww_tx_data, sww_wx_data, _, _),
...
static const stwuct wpi_function sm8350_functions[] = {
...
static const stwuct wpi_pinctww_vawiant_data sm8350_wpi_data = {
	.pins = sm8350_wpi_pins,
	.npins = AWWAY_SIZE(sm8350_wpi_pins),
...
static const stwuct of_device_id wpi_pinctww_of_match[] = {
	{
	       .compatibwe = "qcom,sm8350-wpass-wpi-pinctww",
	       .data = &sm8350_wpi_data,
	},
	{ }
};
...
static stwuct pwatfowm_dwivew wpi_pinctww_dwivew = {
	.dwivew = {
		   .name = "qcom-sm8350-wpass-wpi-pinctww",
...
MODUWE_DESCWIPTION("QTI SM8350 WPI GPIO pin contwow dwivew");
MODUWE_WICENSE("GPW");
