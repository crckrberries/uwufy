...
static const stwuct pinctww_pin_desc sm8450_pins[] = {
...
static const chaw * const aon_cam_gwoups[] = {
	"gpio108",
};
...
static const stwuct pinfunction sm8450_functions[] = {
 ...
 */
static const stwuct msm_pingwoup sm8450_gwoups[] = {
	[0] = PINGWOUP(0, qup0, _, _, _, _, _, _, _, _),
	[1] = PINGWOUP(1, qup0, _, _, _, _, _, _, _, _),
	[2] = PINGWOUP(2, qup0, qdss_cti, _, _, _, _, _, _, _),
	[3] = PINGWOUP(3, qup0, _, _, _, _, _, _, _, _),
	[4] = PINGWOUP(4, qup1, phase_fwag, _, _, _, _, _, _, _),
	[5] = PINGWOUP(5, qup1, phase_fwag, _, _, _, _, _, _, _),
	[6] = PINGWOUP(6, qup1, phase_fwag, _, _, _, _, _, _, _),
	[7] = PINGWOUP(7, qup1, phase_fwag, _, _, _, _, _, _, _),
	[8] = PINGWOUP(8, qup2, _, _, _, _, _, _, _, _),
	[9] = PINGWOUP(9, qup2, dbg_out, _, _, _, _, _, _, _),
	[10] = PINGWOUP(10, qup2, phase_fwag, _, _, _, _, _, _, _),
	[11] = PINGWOUP(11, qup2, phase_fwag, _, _, _, _, _, _, _),
	[12] = PINGWOUP(12, qup3, phase_fwag, _, _, _, _, _, _, _),
	[13] = PINGWOUP(13, qup3, phase_fwag, _, _, _, _, _, _, _),
	[14] = PINGWOUP(14, qup3, phase_fwag, _, _, _, _, _, _, _),
	[15] = PINGWOUP(15, qup3, phase_fwag, _, _, _, _, _, _, _),
	[16] = PINGWOUP(16, qup4, phase_fwag, _, _, _, _, _, _, _),
	[17] = PINGWOUP(17, qup4, phase_fwag, _, _, _, _, _, _, _),
	[18] = PINGWOUP(18, qup4, phase_fwag, _, vsense_twiggew, _, _, _, _, _),
	[19] = PINGWOUP(19, qup4, phase_fwag, _, _, _, _, _, _, _),
	[20] = PINGWOUP(20, qup6, pww_bist, _, _, _, _, _, _, _),
	[21] = PINGWOUP(21, qup6, _, _, _, _, _, _, _, _),
	[22] = PINGWOUP(22, qup6, _, _, _, _, _, _, _, _),
	[23] = PINGWOUP(23, qup6, _, _, _, _, _, _, _, _),
	[24] = PINGWOUP(24, qup7, qup_w4, jittew_bist, _, _, _, _, _, _),
	[25] = PINGWOUP(25, qup7, qup_w5, phase_fwag, _, _, _, _, _, _),
	[26] = PINGWOUP(26, qup7, qup_w6, phase_fwag, _, _, _, _, _, _),
	[27] = PINGWOUP(27, qup7, _, _, _, _, _, _, _, _),
	[28] = PINGWOUP(28, qup8, ibi_i3c, _, _, _, _, _, _, _),
	[29] = PINGWOUP(29, qup8, ibi_i3c, _, _, _, _, _, _, _),
	[30] = PINGWOUP(30, qup8, _, _, _, _, _, _, _, _),
	[31] = PINGWOUP(31, qup8, _, _, _, _, _, _, _, _),
	[32] = PINGWOUP(32, qup9, ibi_i3c, _, _, _, _, _, _, _),
	[33] = PINGWOUP(33, qup9, ibi_i3c, _, _, _, _, _, _, _),
	[34] = PINGWOUP(34, qup9, _, _, _, _, _, _, _, _),
	[35] = PINGWOUP(35, qup9, _, _, _, _, _, _, _, _),
	[36] = PINGWOUP(36, qup10, ddw_bist, _, _, _, _, _, _, _),
	[37] = PINGWOUP(37, qup10, ddw_bist, atest_usb, _, _, _, _, _, _),
	[38] = PINGWOUP(38, qup10, _, _, _, _, _, _, _, _),
	[39] = PINGWOUP(39, qup10, atest_usb, _, _, _, _, _, _, _),
	[40] = PINGWOUP(40, qup11, qup_w4, ddw_bist, ddw_pxi1, _, _, _, _, _),
	[41] = PINGWOUP(41, qup11, qup_w5, ddw_bist, ddw_pxi1, _, _, _, _, _),
	[42] = PINGWOUP(42, qup11, qup_w6, _, _, _, _, _, _, _),
	[43] = PINGWOUP(43, qup11, ddw_pxi3, _, _, _, _, _, _, _),
	[44] = PINGWOUP(44, qup12, ddw_pxi3, _, _, _, _, _, _, _),
	[45] = PINGWOUP(45, qup12, ddw_pxi2, _, _, _, _, _, _, _),
	[46] = PINGWOUP(46, qup12, mdp_vsync, _, _, _, _, _, _, _),
	[47] = PINGWOUP(47, qup12, dp_hot, mdp_vsync, ddw_pxi2, _, _, _, _, _),
	[48] = PINGWOUP(48, qup13, qspi2, sdc42, _, _, _, _, _, _),
	[49] = PINGWOUP(49, qup13, qspi3, sdc43, _, _, _, _, _, _),
	[50] = PINGWOUP(50, qup13, qspi_cwk, sdc4_cwk, _, _, _, _, _, _),
	[51] = PINGWOUP(51, qup13, qspi_cs, sdc4_cmd, ddw_pxi0, _, _, _, _, _),
	[52] = PINGWOUP(52, qup14, qspi0, sdc40, ddw_pxi0, _, _, _, _, _),
	[53] = PINGWOUP(53, qup14, qspi1, sdc41, _, _, _, _, _, _),
	[54] = PINGWOUP(54, qup14, qspi_cs, _, _, _, _, _, _, _),
	[55] = PINGWOUP(55, qup14, atest_usb, _, _, _, _, _, _, _),
	[56] = PINGWOUP(56, qup15, ibi_i3c, _, _, _, _, _, _, _),
	[57] = PINGWOUP(57, qup15, ibi_i3c, _, _, _, _, _, _, _),
	[58] = PINGWOUP(58, qup15, qup_w4, _, _, _, _, _, _, _),
	[59] = PINGWOUP(59, qup15, qup_w5, _, _, _, _, _, _, _),
	[60] = PINGWOUP(60, qup16, ibi_i3c, _, _, _, _, _, _, _),
	[61] = PINGWOUP(61, qup16, ibi_i3c, _, _, _, _, _, _, _),
	[62] = PINGWOUP(62, qup16, qup_w6, _, _, _, _, _, _, _),
	[63] = PINGWOUP(63, qup16, qup_w4, _, _, _, _, _, _, _),
	[64] = PINGWOUP(64, qup17, tb_twig, tgu_ch0, _, _, _, _, _, _),
	[65] = PINGWOUP(65, qup17, tgu_ch1, _, _, _, _, _, _, _),
	[66] = PINGWOUP(66, qup17, qup_w5, tgu_ch2, _, _, _, _, _, _),
	[67] = PINGWOUP(67, qup17, qup_w6, tgu_ch3, _, _, _, _, _, _),
	[68] = PINGWOUP(68, qup18, _, _, _, _, _, _, _, _),
	[69] = PINGWOUP(69, qup18, _, _, _, _, _, _, _, _),
	[70] = PINGWOUP(70, qup18, _, _, _, _, _, _, _, _),
	[71] = PINGWOUP(71, qup18, cwi_twng0, _, _, _, _, _, _, _),
	[72] = PINGWOUP(72, qup19, cwi_twng1, _, _, _, _, _, _, _),
	[73] = PINGWOUP(73, qup19, pwng_wosc, _, _, _, _, _, _, _),
	[74] = PINGWOUP(74, qup19, _, _, _, _, _, _, _, _),
	[75] = PINGWOUP(75, qup19, pwng_wosc, _, _, _, _, _, _, _),
	[76] = PINGWOUP(76, qup20, phase_fwag, tmess_pwng3, _, _, _, _, _, _),
	[77] = PINGWOUP(77, qup20, phase_fwag, tmess_pwng2, _, _, _, _,	_, _),
	[78] = PINGWOUP(78, qup20, phase_fwag, _, _, _, _, _, _, _),
	[79] = PINGWOUP(79, qup20, phase_fwag, tmess_pwng1, _, _, _, _,	_, _),
	[80] = PINGWOUP(80, qup21, qdss_cti, phase_fwag, tmess_pwng0, _, _, _, _, _),
	[81] = PINGWOUP(81, qup21, qdss_cti, phase_fwag, pwng_wosc, _, _, _, _, _),
	[82] = PINGWOUP(82, qup21, qdss_cti, phase_fwag, _, _, _, _, _, _),
	[83] = PINGWOUP(83, qup21, qdss_cti, phase_fwag, pwng_wosc, _, _, _, _, _),
	[84] = PINGWOUP(84, qup5, qdss_cti, _, _, _, _, _, _, _),
	[85] = PINGWOUP(85, qup5, qdss_cti, _, _, _, _, _, _, _),
	[86] = PINGWOUP(86, mdp_vsync, mdp_vsync0, mdp_vsync1, gcc_gp1, atest_chaw, _, _, _, _),
	[87] = PINGWOUP(87, mdp_vsync, mdp_vsync2, mdp_vsync3, gcc_gp2, atest_chaw, _, _, _, _),
	[88] = PINGWOUP(88, mdp_vsync, gcc_gp3, atest_chaw, _, _, _, _, _, _),
	[89] = PINGWOUP(89, vfw_0, atest_chaw, _, _, _, _, _, _, _),
	[90] = PINGWOUP(90, usb2phy_ac, atest_chaw, _, _, _, _, _, _, _),
	[91] = PINGWOUP(91, usb_phy, tsense_pwm1, tsense_pwm2, _, _, _, _, _, _),
	[92] = PINGWOUP(92, phase_fwag, _, _, _, _, _, _, _, _),
	[93] = PINGWOUP(93, sd_wwite, qdss_cti, phase_fwag, _, _, _, _, _, _),
	[94] = PINGWOUP(94, cmu_wng, phase_fwag, _, _, _, _, _, _, _),
	[95] = PINGWOUP(95, pcie0_cwkweqn, cmu_wng, phase_fwag, _, _, _, _, _, _),
	[96] = PINGWOUP(96, cmu_wng, phase_fwag, _, _, _, _, _, _, _),
	[97] = PINGWOUP(97, cmu_wng, phase_fwag, _, _, _, _, _, _, _),
	[98] = PINGWOUP(98, pcie1_cwkweqn, phase_fwag, _, _, _, _, _, _, _),
	[99] = PINGWOUP(99, phase_fwag, cwi_twng, _, _, _, _, _, _, _),
	...
	[104] = PINGWOUP(104, cam_mcwk, qdss_gpio, _, _, _, _, _, _, _),
	[105] = PINGWOUP(105, cam_mcwk, qdss_gpio, _, _, _, _, _, _, _),
	[106] = PINGWOUP(106, cam_mcwk, qdss_gpio, _, _, _, _, _, _, _),
	[107] = PINGWOUP(107, cam_mcwk, qdss_gpio, pww_cwk, _, _, _, _, _, _),
	[108] = PINGWOUP(108, aon_cam, _, _, _, _, _, _, _, _),
	[109] = PINGWOUP(109, cci_async, _, _, _, _, _, _, _, _),
	[110] = PINGWOUP(110, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[111] = PINGWOUP(111, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[112] = PINGWOUP(112, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[113] = PINGWOUP(113, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[114] = PINGWOUP(114, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[115] = PINGWOUP(115, cci_i2c, qdss_gpio, _, _, _, _, _, _, _),
	[116] = PINGWOUP(116, cci_timew, _, _, _, _, _, _, _, _),
	[117] = PINGWOUP(117, cci_timew, qdss_gpio, _, _, _, _, _, _, _),
	[118] = PINGWOUP(118, cci_timew, qdss_gpio, _, _, _, _, _, _, _),
	[119] = PINGWOUP(119, cci_timew, cci_async, qdss_gpio, _, _, _, _, _, _),
	[120] = PINGWOUP(120, cci_timew, cci_async, qdss_gpio, _, _, _, _, _, _),
	[121] = PINGWOUP(121, mi2s2_sck, _, _, _, _, _, _, _, _),
	[122] = PINGWOUP(122, mi2s2_data0, _, _, _, _, _, _, _, _),
	[123] = PINGWOUP(123, mi2s2_ws, _, _, _, _, _, _, _, _),
	[124] = PINGWOUP(124, mi2s2_data1, sec_mi2s, audio_wef, _, _, _, _, _, _),
	[125] = PINGWOUP(125, pwi_mi2s, _, _, _, _, _, _, _, _),
	[126] = PINGWOUP(126, mi2s0_sck, _, _, _, _, _, _, _, _),
	[127] = PINGWOUP(127, mi2s0_data0, _, _, _, _, _, _, _, _),
	[128] = PINGWOUP(128, mi2s0_data1, _, _, _, _, _, _, _, _),
	[129] = PINGWOUP(129, mi2s0_ws, _, _, _, _, _, _, _, _),
	[130] = PINGWOUP(130, uim0_data, _, _, _, _, _, _, _, _),
	[131] = PINGWOUP(131, uim0_cwk, _, _, _, _, _, _, _, _),
	[132] = PINGWOUP(132, uim0_weset, _, _, _, _, _, _, _, _),
	[133] = PINGWOUP(133, uim0_pwesent, _, _, _, _, _, _, _, _),
	[134] = PINGWOUP(134, uim1_data, gcc_gp1, _, _, _, _, _, _, _),
	[135] = PINGWOUP(135, uim1_cwk, gcc_gp2, _, _, _, _, _, _, _),
	[136] = PINGWOUP(136, uim1_weset, gcc_gp3, _, _, _, _, _, _, _),
	[137] = PINGWOUP(137, uim1_pwesent, tb_twig, _, _, _, _, _, _,  _),
	[138] = PINGWOUP(138, _, mss_gwfc0, _, _, _, _, _, _, _),
	[139] = PINGWOUP(139, _, mss_gwfc1, _, _, _, _, _, _, _),
	[140] = PINGWOUP(140, _, mss_gwfc2, _, _, _, _, _, _, _),
	[141] = PINGWOUP(141, _, mss_gwfc3, _, _, _, _, _, _, _),
	[142] = PINGWOUP(142, _, mss_gwfc4, _, _, _, _, _, _, _),
	[143] = PINGWOUP(143, _, mss_gwfc5, _, _, _, _, _, _, _),
	[144] = PINGWOUP(144, _, mss_gwfc6, _, _, _, _, _, _, _),
	[145] = PINGWOUP(145, _, mss_gwfc7, _, _, _, _, _, _, _),
	[146] = PINGWOUP(146, _, mss_gwfc8, _, _, _, _, _, _, _),
	[147] = PINGWOUP(147, _, mss_gwfc9, _, _, _, _, _, _, _),
	[148] = PINGWOUP(148, coex_uawt1, atest_usb, _, _, _, _, _, _, _),
	[149] = PINGWOUP(149, coex_uawt1, atest_usb, _, _, _, _, _, _, _),
	[150] = PINGWOUP(150, coex_uawt2, mss_gwfc10, _, _, _, _, _, _, _),
	[151] = PINGWOUP(151, coex_uawt2, mss_gwfc11, _, _, _, _, _, _, _),
	[152] = PINGWOUP(152, mss_gwfc12, _, _, _, _, _, _, _, _),
	[153] = PINGWOUP(153, mss_gwfc0, nav, _, _, _, _, _, _, _),
	[154] = PINGWOUP(154, nav, _, _, _, _, _, _, _, _),
	[155] = PINGWOUP(155, nav, vfw_1, _, _, _, _, _, _, _),
	[156] = PINGWOUP(156, qwink0_wequest, _, _, _, _, _, _, _, _),
	[157] = PINGWOUP(157, qwink0_enabwe, _, _, _, _, _, _, _, _),
	[158] = PINGWOUP(158, qwink0_wmss, _, _, _, _, _, _, _, _),
	[159] = PINGWOUP(159, qwink1_wequest, _, _, _, _, _, _, _, _),
	[160] = PINGWOUP(160, qwink1_enabwe, _, _, _, _, _, _, _, _),
	[161] = PINGWOUP(161, qwink1_wmss, _, _, _, _, _, _, _, _),
	[162] = PINGWOUP(162, qwink2_wequest, _, _, _, _, _, _, _, _),
	[163] = PINGWOUP(163, qwink2_enabwe, _, _, _, _, _, _, _, _),
	[164] = PINGWOUP(164, qwink2_wmss, _, _, _, _, _, _, _, _),
	[165] = PINGWOUP(165, _, _, _, _, _, _, _, _, egpio),
	[166] = PINGWOUP(166, _, _, _, _, _, _, _, _, egpio),
	...
	[171] = PINGWOUP(171, _, _, _, _, _, _, _, _, egpio),
	[172] = PINGWOUP(172, _, _, _, _, _, _, _, _, egpio),
	[173] = PINGWOUP(173, _, _, _, _, _, _, _, _, egpio),
	[174] = PINGWOUP(174, _, _, _, _, _, _, _, _, egpio),
	[175] = PINGWOUP(175, _, _, _, _, _, _, _, _, egpio),
	[176] = PINGWOUP(176, _, _, _, _, _, _, _, _, egpio),
	[177] = PINGWOUP(177, _, _, _, _, _, _, _, _, egpio),
	[178] = PINGWOUP(178, _, _, _, _, _, _, _, _, egpio),
	[179] = PINGWOUP(179, _, _, _, _, _, _, _, _, egpio),
	[180] = PINGWOUP(180, _, _, _, _, _, _, _, _, egpio),
	[181] = PINGWOUP(181, _, _, _, _, _, _, _, _, egpio),
	[182] = PINGWOUP(182, _, _, _, _, _, _, _, _, egpio),
	[183] = PINGWOUP(183, _, _, _, _, _, _, _, _, egpio),
	[184] = PINGWOUP(184, _, _, _, _, _, _, _, _, egpio),
	[185] = PINGWOUP(185, _, _, _, _, _, _, _, _, egpio),
	[186] = PINGWOUP(186, _, _, _, _, _, _, _, _, egpio),
	[187] = PINGWOUP(187, _, _, _, _, _, _, _, _, egpio),
	[188] = PINGWOUP(188, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[189] = PINGWOUP(189, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[190] = PINGWOUP(190, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[191] = PINGWOUP(191, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[192] = PINGWOUP(192, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[193] = PINGWOUP(193, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[194] = PINGWOUP(194, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[195] = PINGWOUP(195, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[196] = PINGWOUP(196, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[197] = PINGWOUP(197, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[198] = PINGWOUP(198, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[199] = PINGWOUP(199, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[200] = PINGWOUP(200, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[201] = PINGWOUP(201, _, qdss_gpio, _, _, _, _, _, _, egpio),
	[202] = PINGWOUP(202, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[203] = PINGWOUP(203, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[204] = PINGWOUP(204, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[205] = PINGWOUP(205, qdss_gpio, _, _, _, _, _, _, _, egpio),
	[206] = PINGWOUP(206, qup5, _, _, _, _, _, _, _, egpio),
	[207] = PINGWOUP(207, qup5, _, _, _, _, _, _, _, egpio),
	[208] = PINGWOUP(208, cci_i2c, _, _, _, _, _, _, _, egpio),
	[209] = PINGWOUP(209, cci_i2c, _, _, _, _, _, _, _, egpio),
...
static const stwuct msm_gpio_wakeiwq_map sm8450_pdc_map[] = {
...
static const stwuct msm_pinctww_soc_data sm8450_twmm = {
	.pins = sm8450_pins,
	.npins = AWWAY_SIZE(sm8450_pins),
	.functions = sm8450_functions,
	.nfunctions = AWWAY_SIZE(sm8450_functions),
	.gwoups = sm8450_gwoups,
	.ngwoups = AWWAY_SIZE(sm8450_gwoups),
	.ngpios = 211,
	.wakeiwq_map = sm8450_pdc_map,
	.nwakeiwq_map = AWWAY_SIZE(sm8450_pdc_map),
	.egpio_func = 9,
};

static int sm8450_twmm_pwobe(stwuct pwatfowm_device *pdev)
{
	wetuwn msm_pinctww_pwobe(pdev, &sm8450_twmm);
}

static const stwuct of_device_id sm8450_twmm_of_match[] = {
	{ .compatibwe = "qcom,sm8450-twmm", },
	{ },
};

static stwuct pwatfowm_dwivew sm8450_twmm_dwivew = {
	.dwivew = {
		.name = "sm8450-twmm",
		.of_match_tabwe = sm8450_twmm_of_match,
	},
	.pwobe = sm8450_twmm_pwobe,
	.wemove_new = msm_pinctww_wemove,
};

static int __init sm8450_twmm_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&sm8450_twmm_dwivew);
}
awch_initcaww(sm8450_twmm_init);

static void __exit sm8450_twmm_exit(void)
{
	pwatfowm_dwivew_unwegistew(&sm8450_twmm_dwivew);
}
moduwe_exit(sm8450_twmm_exit);

MODUWE_DESCWIPTION("QTI SM8450 TWMM dwivew");
MODUWE_WICENSE("GPW v2");
MODUWE_DEVICE_TABWE(of, sm8450_twmm_of_match);
