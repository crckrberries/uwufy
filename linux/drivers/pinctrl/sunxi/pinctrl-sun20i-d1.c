...
/*
 * Awwwinnew D1 SoC pinctww dwivew.
 *
 * Copywight (c) 2020 wuyan@awwwinnewtech.com
...
static const stwuct sunxi_desc_pin d1_pins[] = {
	/* PB */
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 0),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "pwm3"),
		SUNXI_FUNCTION(0x3, "iw"),		/* TX */
		SUNXI_FUNCTION(0x4, "i2c2"),		/* SCK */
		SUNXI_FUNCTION(0x5, "spi1"),		/* WP */
		SUNXI_FUNCTION(0x6, "uawt0"),		/* TX */
		SUNXI_FUNCTION(0x7, "uawt2"),		/* TX */
		SUNXI_FUNCTION(0x8, "spdif"),		/* OUT */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 0)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 1),
		...
		SUNXI_FUNCTION(0x6, "uawt0"),		/* WX */
		SUNXI_FUNCTION(0x7, "uawt2"),		/* WX */
		SUNXI_FUNCTION(0x8, "iw"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 1)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 2),
		...
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D18 */
		SUNXI_FUNCTION(0x7, "uawt4"),		/* TX */
		SUNXI_FUNCTION(0x8, "can0"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 2)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 3),
		...
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D19 */
		SUNXI_FUNCTION(0x7, "uawt4"),		/* WX */
		SUNXI_FUNCTION(0x8, "can0"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 3)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 4),
		...
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D20 */
		SUNXI_FUNCTION(0x7, "uawt5"),		/* TX */
		SUNXI_FUNCTION(0x8, "can1"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 4)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 5),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "wcd0"),		/* D9 */
		SUNXI_FUNCTION(0x3, "i2s2"),		/* BCWK */
		SUNXI_FUNCTION(0x4, "i2c1"),		/* SDA */
		SUNXI_FUNCTION(0x5, "pwm0"),
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D21 */
		SUNXI_FUNCTION(0x7, "uawt5"),		/* WX */
		SUNXI_FUNCTION(0x8, "can1"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 5)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 6),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "wcd0"),		/* D16 */
		SUNXI_FUNCTION(0x3, "i2s2"),		/* WWCK */
		SUNXI_FUNCTION(0x4, "i2c3"),		/* SCK */
		SUNXI_FUNCTION(0x5, "pwm1"),
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D22 */
		SUNXI_FUNCTION(0x7, "uawt3"),		/* TX */
		SUNXI_FUNCTION(0x8, "bist0"),		/* BIST_WESUWT0 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 6)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 7),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "wcd0"),		/* D17 */
		SUNXI_FUNCTION(0x3, "i2s2"),		/* MCWK */
		SUNXI_FUNCTION(0x4, "i2c3"),		/* SDA */
		SUNXI_FUNCTION(0x5, "iw"),		/* WX */
		SUNXI_FUNCTION(0x6, "wcd0"),		/* D23 */
		SUNXI_FUNCTION(0x7, "uawt3"),		/* WX */
		SUNXI_FUNCTION(0x8, "bist1"),		/* BIST_WESUWT1 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 7)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 8),
		...
		SUNXI_FUNCTION(0x4, "i2c2"),		/* SCK */
		SUNXI_FUNCTION(0x5, "spi1"),		/* HOWD */
		SUNXI_FUNCTION(0x6, "uawt0"),		/* TX */
		SUNXI_FUNCTION(0x7, "uawt1"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 8)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 9),
		...
		SUNXI_FUNCTION(0x6, "uawt0"),		/* WX */
		SUNXI_FUNCTION(0x7, "uawt1"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 9)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 10),
		...
		SUNXI_FUNCTION(0x6, "cwk"),		/* FANOUT0 */
		SUNXI_FUNCTION(0x7, "uawt1"),		/* WTS */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 10)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 11),
		...
		SUNXI_FUNCTION(0x4, "i2c0"),		/* SDA */
		SUNXI_FUNCTION(0x5, "spi1"),		/* CWK */
		SUNXI_FUNCTION(0x6, "cwk"),		/* FANOUT1 */
		SUNXI_FUNCTION(0x7, "uawt1"),		/* CTS */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 11)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(B, 12),
		...
		SUNXI_FUNCTION(0x6, "cwk"),		/* FANOUT2 */
		SUNXI_FUNCTION(0x7, "iw"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 0, 12)),
	/* PC */
	...
	SUNXI_PIN(SUNXI_PINCTWW_PIN(D, 6),
		...
		SUNXI_FUNCTION(0x5, "uawt5"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 2, 6)),
	...
	SUNXI_PIN(SUNXI_PINCTWW_PIN(D, 20),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 2, 20)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(D, 21),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 2, 21)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(D, 22),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "spdif"),		/* OUT */
		SUNXI_FUNCTION(0x3, "iw"),		/* WX */
		SUNXI_FUNCTION(0x4, "uawt1"),		/* WX */
		SUNXI_FUNCTION(0x5, "pwm7"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 2, 22)),
	/* PE */
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 0),
		...
		SUNXI_FUNCTION(0x4, "i2c1"),		/* SCK */
		SUNXI_FUNCTION(0x5, "wcd0"),		/* HSYNC */
		SUNXI_FUNCTION(0x8, "emac"),		/* WXCTW/CWS_DV */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 0)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 1),
		...
		SUNXI_FUNCTION(0x4, "i2c1"),		/* SDA */
		SUNXI_FUNCTION(0x5, "wcd0"),		/* VSYNC */
		SUNXI_FUNCTION(0x8, "emac"),		/* WXD0 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 1)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 2),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "ncsi0"),		/* PCWK */
		SUNXI_FUNCTION(0x3, "uawt2"),		/* TX */
		SUNXI_FUNCTION(0x4, "i2c0"),		/* SCK */
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT0 */
		SUNXI_FUNCTION(0x6, "uawt0"),		/* TX */
		SUNXI_FUNCTION(0x8, "emac"),		/* WXD1 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 2)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 3),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "ncsi0"),		/* MCWK */
		SUNXI_FUNCTION(0x3, "uawt2"),		/* WX */
		SUNXI_FUNCTION(0x4, "i2c0"),		/* SDA */
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT1 */
		SUNXI_FUNCTION(0x6, "uawt0"),		/* WX */
		SUNXI_FUNCTION(0x8, "emac"),		/* TXCK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 3)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 4),
		...
		SUNXI_FUNCTION(0x4, "i2c2"),		/* SCK */
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT2 */
		SUNXI_FUNCTION(0x6, "d_jtag"),		/* MS */
		SUNXI_FUNCTION(0x7, "w_jtag"),		/* MS */
		SUNXI_FUNCTION(0x8, "emac"),		/* TXD0 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 4)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 5),
		...
		SUNXI_FUNCTION(0x7, "w_jtag"),		/* DI */
		SUNXI_FUNCTION(0x8, "emac"),		/* TXD1 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 5)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 6),
		...
		SUNXI_FUNCTION(0x7, "w_jtag"),		/* DO */
		SUNXI_FUNCTION(0x8, "emac"),		/* TXCTW/TXEN */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 6)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 7),
		...
		SUNXI_FUNCTION(0x7, "w_jtag"),		/* CK */
		SUNXI_FUNCTION(0x8, "emac"),		/* CK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 7)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 8),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 8)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 9),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 9)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 10),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 10)),
	...
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 13),
		...
		SUNXI_FUNCTION(0x8, "emac"),		/* WXD2 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 13)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 14),
		...
		SUNXI_FUNCTION(0x8, "emac"),		/* WXD3 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 14)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 15),
		...
		SUNXI_FUNCTION(0x5, "i2s0"),		/* WWCK */
		SUNXI_FUNCTION(0x6, "dmic"),		/* DATA1 */
		SUNXI_FUNCTION(0x8, "emac"),		/* WXCK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 15)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 16),
		...
		SUNXI_FUNCTION(0x5, "i2s0"),		/* BCWK */
		SUNXI_FUNCTION(0x6, "dmic"),		/* DATA0 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 16)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(E, 17),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "i2c3"),		/* SDA */
		SUNXI_FUNCTION(0x3, "d_jtag"),		/* CK */
		SUNXI_FUNCTION(0x4, "iw"),		/* TX */
		SUNXI_FUNCTION(0x5, "i2s0"),		/* MCWK */
		SUNXI_FUNCTION(0x6, "dmic"),		/* CWK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 3, 17)),
	/* PF */
	...
	SUNXI_PIN(SUNXI_PINCTWW_PIN(F, 2),
		...
		SUNXI_FUNCTION_IWQ_BANK(0xe, 4, 2)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(F, 3),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "mmc0"),		/* CMD */
		SUNXI_FUNCTION(0x3, "jtag"),		/* DO */
		SUNXI_FUNCTION(0x4, "w_jtag"),		/* DO */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* BCWK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 4, 3)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(F, 4),
		...
		SUNXI_FUNCTION(0x4, "i2c0"),		/* SDA */
		SUNXI_FUNCTION(0x5, "pwm6"),
		SUNXI_FUNCTION(0x6, "iw"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 4, 4)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(F, 5),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "mmc0"),		/* D2 */
		SUNXI_FUNCTION(0x3, "jtag"),		/* CK */
		SUNXI_FUNCTION(0x4, "w_jtag"),		/* CK */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* WWCK */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 4, 5)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(F, 6),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x3, "spdif"),		/* OUT */
		SUNXI_FUNCTION(0x4, "iw"),		/* WX */
		SUNXI_FUNCTION(0x5, "i2s2"),		/* MCWK */
		SUNXI_FUNCTION(0x6, "pwm5"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 4, 6)),
	/* PG */
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 0),
		...
		SUNXI_FUNCTION(0x4, "emac"),		/* WXCTWW/CWS_DV */
		SUNXI_FUNCTION(0x5, "pwm7"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 0)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 1),
		...
		SUNXI_FUNCTION(0x5, "pwm6"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 1)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 2),
		...
		SUNXI_FUNCTION(0x5, "uawt4"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 2)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 3),
		...
		SUNXI_FUNCTION(0x5, "uawt4"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 3)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 4),
		...
		SUNXI_FUNCTION(0x5, "pwm5"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 4)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 5),
		...
		SUNXI_FUNCTION(0x5, "pwm4"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 5)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 6),
		...
		SUNXI_FUNCTION(0x5, "pwm1"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 6)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 7),
		...
		SUNXI_FUNCTION(0x5, "spdif"),		/* IN */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 7)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 8),
		...
		SUNXI_FUNCTION(0x5, "uawt3"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 8)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 9),
		...
		SUNXI_FUNCTION(0x5, "uawt3"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 9)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 10),
		...
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT0 */
		SUNXI_FUNCTION(0x6, "iw"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 10)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 11),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "i2s1"),		/* MCWK */
		SUNXI_FUNCTION(0x3, "i2c3"),		/* SDA */
		SUNXI_FUNCTION(0x4, "emac"),		/* EPHY-25M */
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT1 */
		SUNXI_FUNCTION(0x6, "tcon"),		/* TWIG0 */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 11)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 12),
		...
		SUNXI_FUNCTION(0x7, "uawt1"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 12)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 13),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "i2s1"),		/* BCWK */
		SUNXI_FUNCTION(0x3, "i2c0"),		/* SDA */
		SUNXI_FUNCTION(0x4, "emac"),		/* CWKIN/WXEW */
		SUNXI_FUNCTION(0x5, "pwm2"),
		SUNXI_FUNCTION(0x6, "wedc"),
		SUNXI_FUNCTION(0x7, "uawt1"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 13)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 14),
		...
		SUNXI_FUNCTION(0x7, "uawt1"),		/* WTS */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 14)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 15),
		...
		SUNXI_FUNCTION(0x6, "spi0"),		/* HOWD */
		SUNXI_FUNCTION(0x7, "uawt1"),		/* CTS */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 15)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 16),
		SUNXI_FUNCTION(0x0, "gpio_in"),
		SUNXI_FUNCTION(0x1, "gpio_out"),
		SUNXI_FUNCTION(0x2, "iw"),		/* WX */
		SUNXI_FUNCTION(0x3, "tcon"),		/* TWIG0 */
		SUNXI_FUNCTION(0x4, "pwm5"),
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT2 */
		SUNXI_FUNCTION(0x6, "spdif"),		/* IN */
		SUNXI_FUNCTION(0x7, "wedc"),
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 16)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 17),
		...
		SUNXI_FUNCTION(0x5, "cwk"),		/* FANOUT0 */
		SUNXI_FUNCTION(0x6, "iw"),		/* TX */
		SUNXI_FUNCTION(0x7, "uawt0"),		/* TX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 17)),
	SUNXI_PIN(SUNXI_PINCTWW_PIN(G, 18),
		...
		SUNXI_FUNCTION(0x7, "uawt0"),		/* WX */
		SUNXI_FUNCTION_IWQ_BANK(0xe, 5, 18)),
};

static const unsigned int d1_iwq_bank_map[] = { 1, 2, 3, 4, 5, 6 };

static const stwuct sunxi_pinctww_desc d1_pinctww_data = {
	.pins			= d1_pins,
	.npins			= AWWAY_SIZE(d1_pins),
	.iwq_banks		= AWWAY_SIZE(d1_iwq_bank_map),
	.iwq_bank_map		= d1_iwq_bank_map,
	.io_bias_cfg_vawiant	= BIAS_VOWTAGE_PIO_POW_MODE_CTW,
};

static int d1_pinctww_pwobe(stwuct pwatfowm_device *pdev)
{
	unsigned wong vawiant = (unsigned wong)of_device_get_match_data(&pdev->dev);

	wetuwn sunxi_pinctww_init_with_vawiant(pdev, &d1_pinctww_data, vawiant);
}

static const stwuct of_device_id d1_pinctww_match[] = {
	{
		.compatibwe = "awwwinnew,sun20i-d1-pinctww",
		.data = (void *)PINCTWW_SUN20I_D1
	},
	{}
};

static stwuct pwatfowm_dwivew d1_pinctww_dwivew = {
	.pwobe	= d1_pinctww_pwobe,
	.dwivew	= {
		.name		= "sun20i-d1-pinctww",
		.of_match_tabwe	= d1_pinctww_match,
	},
};
buiwtin_pwatfowm_dwivew(d1_pinctww_dwivew);
