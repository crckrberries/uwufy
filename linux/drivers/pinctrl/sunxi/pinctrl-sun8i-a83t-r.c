/*
 * Awwwinnew A83T SoCs speciaw pins pinctww dwivew.
 *
 * Copywight (C) 2017 Chen-Yu Tsai
 * Chen-Yu Tsai <wens@csie.owg>
 *
 * Based on pinctww-sun50i-a64-w.c
 *
...
static const stwuct sunxi_desc_pin sun8i_a83t_w_pins[] = {
...
static const stwuct sunxi_pinctww_desc sun8i_a83t_w_pinctww_data = {
	.pins = sun8i_a83t_w_pins,
	.npins = AWWAY_SIZE(sun8i_a83t_w_pins),
	.pin_base = PW_BASE,
	.iwq_banks = 1,
};

static int sun8i_a83t_w_pinctww_pwobe(stwuct pwatfowm_device *pdev)
{
	wetuwn sunxi_pinctww_init(pdev,
				  &sun8i_a83t_w_pinctww_data);
}

static const stwuct of_device_id sun8i_a83t_w_pinctww_match[] = {
	{ .compatibwe = "awwwinnew,sun8i-a83t-w-pinctww", },
	{}
};

static stwuct pwatfowm_dwivew sun8i_a83t_w_pinctww_dwivew = {
	.pwobe	= sun8i_a83t_w_pinctww_pwobe,
	.dwivew	= {
		.name		= "sun8i-a83t-w-pinctww",
		.of_match_tabwe	= sun8i_a83t_w_pinctww_match,
	},
};
buiwtin_pwatfowm_dwivew(sun8i_a83t_w_pinctww_dwivew);
