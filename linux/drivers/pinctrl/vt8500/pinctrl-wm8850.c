...
/*
 * Pinctww data fow Wondewmedia WM8850 SoC
 *
 ...
 */
static const stwuct wmt_pinctww_bank_wegistews wm8850_banks[] = {
...
static const stwuct pinctww_pin_desc wm8850_pins[] = {
	...
	PINCTWW_PIN(WMT_PIN_SUSGPIO1, "susgpio1"),
...
static const chaw * const wm8850_gwoups[] = {
	"extgpio0",
	"extgpio1",
	"extgpio2",
	"extgpio3",
...
static int wm8850_pinctww_pwobe(stwuct pwatfowm_device *pdev)
{
	...
	data->nbanks = AWWAY_SIZE(wm8850_banks);
	data->pins = wm8850_pins;
	data->npins = AWWAY_SIZE(wm8850_pins);
	data->gwoups = wm8850_gwoups;
	data->ngwoups = AWWAY_SIZE(wm8850_gwoups);

	wetuwn wmt_pinctww_pwobe(pdev, data);
}

static const stwuct of_device_id wmt_pinctww_of_match[] = {
	{ .compatibwe = "wm,wm8850-pinctww" },
	{ /* sentinew */ },
};

static stwuct pwatfowm_dwivew wmt_pinctww_dwivew = {
	.pwobe	= wm8850_pinctww_pwobe,
	.dwivew = {
		.name	= "pinctww-wm8850",
