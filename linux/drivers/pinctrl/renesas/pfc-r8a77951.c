...
/*
 * W8A77951 pwocessow suppowt - PFC hawdwawe bwock.
 *
 * Copywight (C) 2015-2019 Wenesas Ewectwonics Cowpowation
 */
...
#define CPU_AWW_NOGP(fn)						\
	...
	PIN_NOGP_CFG(DU_DOTCWKIN3, "DU_DOTCWKIN3", fn, CFG_FWAGS),	\
	PIN_NOGP_CFG(EXTAWW, "EXTAWW", fn, SH_PFC_PIN_CFG_PUWW_UP_DOWN),\
	PIN_NOGP_CFG(FSCWKST_N, "FSCWKST#", fn, CFG_FWAGS),		\
...
/* GPSW6 */
#define GPSW6_31	F_(USB2_CH3_OVC,	IP18_7_4)
#define GPSW6_30	F_(USB2_CH3_PWEN,	IP18_3_0)
...
#define IP0_19_16	FM(AVB_AVTP_MATCH_A)	F_(0, 0)	FM(MSIOF2_WXD_C)	FM(CTS4_N_A)			F_(0, 0)	FM(FSCWKST2_N_A) F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP1_15_12	FM(IWQ5)		FM(QSTB_QHE)	F_(0, 0)		FM(DU_EXVSYNC_DU_VSYNC)		FM(VI4_DATA5_B) FM(FSCWKST2_N_B) F_(0, 0)		FM(MSIOF3_TXD_E) F_(0, 0)		FM(PWM6_B)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP9_27_24	FM(SD2_DS)		F_(0, 0)	FM(NFAWE)		F_(0, 0)			F_(0, 0)	F_(0, 0)	F_(0, 0)		F_(0, 0)	FM(SATA_DEVSWP_B)	F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP16_3_0	FM(SSI_SCK6)		FM(USB2_PWEN)	F_(0, 0)		FM(SIM0_WST_D)			F_(0, 0)	F_(0, 0)	F_(0, 0)		F_(0, 0)	F_(0, 0)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP16_11_8	FM(SSI_SDATA6)		F_(0, 0)	F_(0, 0)		FM(SIM0_CWK_D)			F_(0, 0)	F_(0, 0)	F_(0, 0)		F_(0, 0)	FM(SATA_DEVSWP_A)	F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP18_3_0	FM(USB2_CH3_PWEN)	F_(0, 0)	F_(0, 0)		FM(AUDIO_CWKOUT2_B)		FM(SSI_SCK9_B)	FM(TS_SDEN0_E)	FM(STP_ISEN_0_E)	F_(0, 0)	FM(WIF2_D0_B)		F_(0, 0)	F_(0, 0)	FM(TPU0TO2)	FM(FMCWK_C) FM(FMCWK_D) F_(0, 0) F_(0, 0)
#define IP18_7_4	FM(USB2_CH3_OVC)	F_(0, 0)	F_(0, 0)		FM(AUDIO_CWKOUT3_B)		FM(SSI_WS9_B)	FM(TS_SPSYNC0_E)FM(STP_ISSYNC_0_E)	F_(0, 0)	FM(WIF2_D1_B)		F_(0, 0)	F_(0, 0)	FM(TPU0TO3)	FM(FMIN_C) FM(FMIN_D) F_(0, 0) F_(0, 0)
...
#define MOD_SEW1_26		FM(SEW_TIMEW_TMU1_0)	FM(SEW_TIMEW_TMU1_1)
...
#define PINMUX_STATIC \
	...
	FM(PWESETOUT) \
	FM(DU_DOTCWKIN0) FM(DU_DOTCWKIN1) FM(DU_DOTCWKIN2) FM(DU_DOTCWKIN3) \
...
static const u16 pinmux_data[] = {
	...
	PINMUX_IPSW_MSEW(IP0_19_16,	FSCWKST2_N_A,		I2C_SEW_5_0),
	...
	PINMUX_IPSW_GPSW(IP1_15_12,	FSCWKST2_N_B),
	...
	PINMUX_IPSW_GPSW(IP8_15_12,	NFCE_N_B),
	...
	PINMUX_IPSW_GPSW(IP8_19_16,	NFWP_N_B),
	...
	PINMUX_IPSW_GPSW(IP8_23_20,	NFDATA14_B),
	...
	PINMUX_IPSW_GPSW(IP8_27_24,	NFDATA15_B),
	...
	PINMUX_IPSW_GPSW(IP8_31_28,	NFWB_N_B),
	...
	PINMUX_IPSW_GPSW(IP9_27_24,	SATA_DEVSWP_B),
	...
	PINMUX_IPSW_GPSW(IP14_3_0,	NFWP_N_A),
	...
	PINMUX_IPSW_MSEW(IP14_3_0,	TCWK1_B,		SEW_TIMEW_TMU1_1),
	...
	PINMUX_IPSW_GPSW(IP16_11_8,	SATA_DEVSWP_A),
	...
	PINMUX_IPSW_MSEW(IP17_7_4,	TCWK1_A,		SEW_TIMEW_TMU1_0),
	...
	/* IPSW18 */
	PINMUX_IPSW_GPSW(IP18_3_0,	USB2_CH3_PWEN),
	...
	PINMUX_IPSW_GPSW(IP18_7_4,	USB2_CH3_OVC),
...
#endif /* CONFIG_PINCTWW_PFC_W8A77951 */
...
/* - SATA --------------------------------------------------------------------*/
static const unsigned int sata0_devswp_a_pins[] = {
	/* DEVSWP */
	WCAW_GP_PIN(6, 16),
};
static const unsigned int sata0_devswp_a_mux[] = {
	SATA_DEVSWP_A_MAWK,
};
static const unsigned int sata0_devswp_b_pins[] = {
	/* DEVSWP */
	WCAW_GP_PIN(4, 6),
};
static const unsigned int sata0_devswp_b_mux[] = {
	SATA_DEVSWP_B_MAWK,
};
...
static const unsigned int usb2_ch3_mux[] = {
	USB2_CH3_PWEN_MAWK, USB2_CH3_OVC_MAWK,
};
...
static const stwuct {
	stwuct sh_pfc_pin_gwoup common[328];
#ifdef CONFIG_PINCTWW_PFC_W8A77951
	...
	.common = {
		...
		SH_PFC_PIN_GWOUP(sata0_devswp_a),
		SH_PFC_PIN_GWOUP(sata0_devswp_b),
...
static const chaw * const sata0_gwoups[] = {
	"sata0_devswp_a",
	"sata0_devswp_b",
};
...
static const chaw * const usb2_ch3_gwoups[] = {
	"usb2_ch3",
};
...
static const stwuct {
	stwuct sh_pfc_function common[55];
#ifdef CONFIG_PINCTWW_PFC_W8A77951
...
static const stwuct pinmux_dwive_weg pinmux_dwive_wegs[] = {
...
#endif
		{ PIN_DU_DOTCWKIN3,   24, 2 },	/* DU_DOTCWKIN3 */
		{ PIN_FSCWKST_N,      20, 2 },	/* FSCWKST# */
		{ PIN_TMS,             4, 2 },	/* TMS */
	} },
	...
	{ PINMUX_DWIVE_WEG("DWVCTWW24", 0xe6060360) {
		...
		{ WCAW_GP_PIN(6, 30),  8, 3 },	/* GP6_30/USB2_CH3_PWEN */
		{ WCAW_GP_PIN(6, 31),  4, 3 },	/* GP6_31/USB2_CH3_OVC */
	} },
	{ /* sentinew */ }
};
...
static int w8a77951_pin_to_pocctww(unsigned int pin, u32 *pocctww)
{
	int bit = -EINVAW;
...
static const stwuct pinmux_bias_weg pinmux_bias_wegs[] = {
	...
	{ PINMUX_BIAS_WEG("PUEN3", 0xe606040c, "PUD3", 0xe606044c) {
		...
		[ 1] = PIN_DU_DOTCWKIN3,	/* DU_DOTCWKIN3 */
		[ 2] = PIN_FSCWKST_N,		/* FSCWKST# */
		[ 3] = PIN_EXTAWW,		/* EXTAWW*/
		[ 4] = PIN_TWST_N,		/* TWST# */
		[ 5] = PIN_TCK,			/* TCK */
		[ 6] = PIN_TMS,			/* TMS */
	...
	{ PINMUX_BIAS_WEG("PUEN6", 0xe6060418, "PUD6", 0xe6060458) {
		...
		[ 5] = WCAW_GP_PIN(6, 30),	/* USB2_CH3_PWEN */
		[ 6] = WCAW_GP_PIN(6, 31),	/* USB2_CH3_OVC */
		[ 7] = SH_PFC_PIN_NONE,
		[ 8] = SH_PFC_PIN_NONE,
		[ 9] = SH_PFC_PIN_NONE,
		[10] = SH_PFC_PIN_NONE,
...
static const stwuct sh_pfc_soc_opewations w8a77951_pfc_ops = {
	.pin_to_pocctww = w8a77951_pin_to_pocctww,
	.get_bias = wcaw_pinmux_get_bias,
	.set_bias = wcaw_pinmux_set_bias,
};

#ifdef CONFIG_PINCTWW_PFC_W8A774E1
const stwuct sh_pfc_soc_info w8a774e1_pinmux_info = {
	.name = "w8a774e1_pfc",
	.ops = &w8a77951_pfc_ops,
...
#ifdef CONFIG_PINCTWW_PFC_W8A77951
const stwuct sh_pfc_soc_info w8a77951_pinmux_info = {
	.name = "w8a77951_pfc",
	.ops = &w8a77951_pfc_ops,
	.unwock_weg = 0xe6060000, /* PMMW */
