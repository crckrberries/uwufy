...
/*
 * W8A77980 pwocessow suppowt - PFC hawdwawe bwock.
 *
...
#define CPU_AWW_GP(fn, sfx)	\
	...
	POWT_GP_CFG_30(2, fn, sfx, SH_PFC_PIN_CFG_IO_VOWTAGE_18_33 | SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
	POWT_GP_CFG_17(3, fn, sfx, SH_PFC_PIN_CFG_IO_VOWTAGE_18_33 | SH_PFC_PIN_CFG_PUWW_UP_DOWN), \
	POWT_GP_CFG_25(4, fn, sfx, SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
...
#define CPU_AWW_NOGP(fn)	\
	...
	PIN_NOGP_CFG(DCUTWST_N, "DCUTWST#", fn, SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
	PIN_NOGP_CFG(DU_DOTCWKIN, "DU_DOTCWKIN", fn, SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
	PIN_NOGP_CFG(EXTAWW, "EXTAWW", fn, SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
	PIN_NOGP_CFG(FSCWKST, "FSCWKST", fn, SH_PFC_PIN_CFG_PUWW_UP_DOWN),	\
	...
	PIN_NOGP_CFG(VDDQ_AVB, "VDDQ_AVB", fn, SH_PFC_PIN_CFG_IO_VOWTAGE_25_33), \
	PIN_NOGP_CFG(VDDQ_GE, "VDDQ_GE", fn, SH_PFC_PIN_CFG_IO_VOWTAGE_25_33)
...
/* GPSW1 */
#define GPSW1_27	F_(DIGWF_CWKOUT,	IP8_31_28)
#define GPSW1_26	F_(DIGWF_CWKIN,		IP8_27_24)
#define GPSW1_25	F_(CANFD_CWK_A,		IP8_23_20)
#define GPSW1_24	F_(CANFD1_WX,		IP8_19_16)
#define GPSW1_23	F_(CANFD1_TX,		IP8_15_12)
#define GPSW1_22	F_(CANFD0_WX_A,		IP8_11_8)
#define GPSW1_21	F_(CANFD0_TX_A,		IP8_7_4)
#define GPSW1_20	F_(AVB_AVTP_CAPTUWE,	IP8_3_0)
#define GPSW1_19	F_(AVB_AVTP_MATCH,	IP7_31_28)
#define GPSW1_18	FM(AVB_WINK)
#define GPSW1_17	FM(AVB_PHY_INT)
#define GPSW1_16	FM(AVB_MAGIC)
#define GPSW1_15	FM(AVB_MDC)
#define GPSW1_14	FM(AVB_MDIO)
#define GPSW1_13	FM(AVB_TXCWEFCWK)
#define GPSW1_12	FM(AVB_TD3)
#define GPSW1_11	FM(AVB_TD2)
#define GPSW1_10	FM(AVB_TD1)
#define GPSW1_9		FM(AVB_TD0)
#define GPSW1_8		FM(AVB_TXC)
#define GPSW1_7		FM(AVB_TX_CTW)
#define GPSW1_6		FM(AVB_WD3)
#define GPSW1_5		FM(AVB_WD2)
#define GPSW1_4		FM(AVB_WD1)
#define GPSW1_3		FM(AVB_WD0)
#define GPSW1_2		FM(AVB_WXC)
#define GPSW1_1		FM(AVB_WX_CTW)
#define GPSW1_0		F_(IWQ0,		IP2_27_24)

/* GPSW2 */
#define GPSW2_29	F_(FSO_TOE_N,		IP10_19_16)
#define GPSW2_28	F_(FSO_CFE_1_N,		IP10_15_12)
#define GPSW2_27	F_(FSO_CFE_0_N,		IP10_11_8)
#define GPSW2_26	F_(SDA3,		IP10_7_4)
#define GPSW2_25	F_(SCW3,		IP10_3_0)
#define GPSW2_24	F_(MSIOF0_SS2,		IP9_31_28)
#define GPSW2_23	F_(MSIOF0_SS1,		IP9_27_24)
#define GPSW2_22	F_(MSIOF0_SYNC,		IP9_23_20)
#define GPSW2_21	F_(MSIOF0_SCK,		IP9_19_16)
#define GPSW2_20	F_(MSIOF0_TXD,		IP9_15_12)
#define GPSW2_19	F_(MSIOF0_WXD,		IP9_11_8)
#define GPSW2_18	F_(IWQ5,		IP9_7_4)
#define GPSW2_17	F_(IWQ4,		IP9_3_0)
...
/* GPSW4 */
#define GPSW4_24	FM(GETHEW_WINK_A)
#define GPSW4_23	FM(GETHEW_PHY_INT_A)
#define GPSW4_22	FM(GETHEW_MAGIC)
#define GPSW4_21	FM(GETHEW_MDC_A)
#define GPSW4_20	FM(GETHEW_MDIO_A)
#define GPSW4_19	FM(GETHEW_TXCWEFCWK_MEGA)
#define GPSW4_18	FM(GETHEW_TXCWEFCWK)
#define GPSW4_17	FM(GETHEW_TD3)
#define GPSW4_16	FM(GETHEW_TD2)
#define GPSW4_15	FM(GETHEW_TD1)
#define GPSW4_14	FM(GETHEW_TD0)
#define GPSW4_13	FM(GETHEW_TXC)
#define GPSW4_12	FM(GETHEW_TX_CTW)
#define GPSW4_11	FM(GETHEW_WD3)
#define GPSW4_10	FM(GETHEW_WD2)
#define GPSW4_9		FM(GETHEW_WD1)
#define GPSW4_8		FM(GETHEW_WD0)
#define GPSW4_7		FM(GETHEW_WXC)
#define GPSW4_6		FM(GETHEW_WX_CTW)
...
#define IP0_3_0		FM(DU_DW2)			FM(SCK4)		FM(GETHEW_WMII_CWS_DV)	FM(A0)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_7_4		FM(DU_DW3)			FM(WX4)			FM(GETHEW_WMII_WX_EW)	FM(A1)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_11_8	FM(DU_DW4)			FM(TX4)			FM(GETHEW_WMII_WXD0)	FM(A2)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_15_12	FM(DU_DW5)			FM(CTS4_N)		FM(GETHEW_WMII_WXD1)	FM(A3)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_19_16	FM(DU_DW6)			FM(WTS4_N)		FM(GETHEW_WMII_TXD_EN)	FM(A4)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_23_20	FM(DU_DW7)			F_(0, 0)		FM(GETHEW_WMII_TXD0)	FM(A5)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_27_24	FM(DU_DG2)			F_(0, 0)		FM(GETHEW_WMII_TXD1)	FM(A6)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP0_31_28	FM(DU_DG3)			FM(CPG_CPCKOUT)		FM(GETHEW_WMII_WEFCWK)	FM(A7)		FM(PWMFSW0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_3_0		FM(DU_DG4)			FM(SCW5)		F_(0, 0)		FM(A8)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_7_4		FM(DU_DG5)			FM(SDA5)		FM(GETHEW_MDC_B)	FM(A9)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_11_8	FM(DU_DG6)			FM(SCIF_CWK_A)		FM(GETHEW_MDIO_B)	FM(A10)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_15_12	FM(DU_DG7)			FM(HWX0_A)		F_(0, 0)		FM(A11)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_19_16	FM(DU_DB2)			FM(HSCK0_A)		F_(0, 0)		FM(A12)		FM(IWQ1)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_23_20	FM(DU_DB3)			FM(HWTS0_N_A)		F_(0, 0)		FM(A13)		FM(IWQ2)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP1_27_24	FM(DU_DB4)			FM(HCTS0_N_A)		F_(0, 0)		FM(A14)		FM(IWQ3)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP2_3_0		FM(DU_DB6)			FM(MSIOF3_WXD)		F_(0, 0)		FM(A16)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP2_11_8	FM(DU_DOTCWKOUT)		FM(MSIOF3_SS1)		FM(GETHEW_WINK_B)	FM(A18)		F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_15_12	FM(DU_EXHSYNC_DU_HSYNC)		FM(MSIOF3_SS2)		FM(GETHEW_PHY_INT_B)	FM(A19)		FM(FXW_TXENA_N)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP2_19_16	FM(DU_EXVSYNC_DU_VSYNC)		FM(MSIOF3_SCK)		F_(0, 0)		F_(0, 0)	FM(FXW_TXENB_N)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP4_23_20	FM(VI0_DATA10)			FM(HWTS2_N)		FM(PWM2_A)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP4_31_28	FM(VI0_FIEWD)			FM(HWX2)		FM(PWM4_A)		FM(CS1_N)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP5_31_28	FM(VI1_DATA3)			FM(CANFD0_WX_B)		F_(0, 0)		FM(D6)		FM(MMC_CMD)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_3_0		FM(VI1_DATA4)			FM(CANFD_CWK_B)		F_(0, 0)		FM(D7)		FM(MMC_D0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP6_19_16	FM(VI1_DATA8)			F_(0, 0)		F_(0, 0)		FM(D11)		FM(MMC_CWK)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_23_20	FM(VI1_DATA9)			FM(TCWK1_A)		F_(0, 0)		FM(D12)		FM(MMC_D4)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_27_24	FM(VI1_DATA10)			FM(TCWK2_A)		F_(0, 0)		FM(D13)		FM(MMC_D5)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP6_31_28	FM(VI1_DATA11)			FM(SCW4)		F_(0, 0)		FM(D14)		FM(MMC_D6)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_3_0		FM(VI1_FIEWD)			FM(SDA4)		F_(0, 0)		FM(D15)		FM(MMC_D7)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_7_4		FM(SCW0)			F_(0, 0)		F_(0, 0)		FM(CWKOUT)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP7_15_12	FM(SCW1)			F_(0, 0)		FM(TPU0TO2)		FM(WD_N)	FM(CTS0_N)	FM(HCTS0_N_B)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_19_16	FM(SDA1)			F_(0, 0)		FM(TPU0TO3)		FM(WE0_N)	FM(WTS0_N)	FM(HWTS0_N_B)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP7_23_20	FM(SCW2)			F_(0, 0)		F_(0, 0)		FM(WE1_N)	FM(WX0)		FM(HWX0_B)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP8_3_0		FM(AVB_AVTP_CAPTUWE)		FM(TPU0TO1)		F_(0, 0)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_7_4		FM(CANFD0_TX_A)			FM(FXW_TXDA)		FM(PWM0_B)		FM(DU_DISP)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_11_8	FM(CANFD0_WX_A)			FM(WXDA_EXTFXW)		FM(PWM1_B)		FM(DU_CDE)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_15_12	FM(CANFD1_TX)			FM(FXW_TXDB)		FM(PWM2_B)		FM(TCWK1_B)	FM(TX1_B)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_19_16	FM(CANFD1_WX)			FM(WXDB_EXTFXW)		FM(PWM3_B)		FM(TCWK2_B)	FM(WX1_B)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_23_20	FM(CANFD_CWK_A)			FM(CWK_EXTFXW)		FM(PWM4_B)		FM(SPEEDIN_B)	FM(SCIF_CWK_B)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_27_24	FM(DIGWF_CWKIN)			FM(DIGWF_CWKEN_IN)	F_(0, 0)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP8_31_28	FM(DIGWF_CWKOUT)		FM(DIGWF_CWKEN_OUT)	F_(0, 0)		F_(0, 0)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_3_0		FM(IWQ4)			F_(0, 0)		F_(0, 0)		FM(VI0_DATA12)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_7_4		FM(IWQ5)			F_(0, 0)		F_(0, 0)		FM(VI0_DATA13)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_11_8	FM(MSIOF0_WXD)			FM(DU_DW0)		F_(0, 0)		FM(VI0_DATA14)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_15_12	FM(MSIOF0_TXD)			FM(DU_DW1)		F_(0, 0)		FM(VI0_DATA15)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
#define IP9_27_24	FM(MSIOF0_SS1)			FM(DU_DB0)		FM(TCWK3)		FM(VI0_DATA18)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP9_31_28	FM(MSIOF0_SS2)			FM(DU_DB1)		FM(TCWK4)		FM(VI0_DATA19)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
#define IP10_3_0	FM(SCW3)			F_(0, 0)		F_(0, 0)		FM(VI0_DATA20)	F_(0, 0)	F_(0, 0)	F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0) F_(0, 0)
...
GPSW0_20	GPSW1_20	GPSW2_20			GPSW4_20 \
GPSW0_19	GPSW1_19	GPSW2_19			GPSW4_19 \
GPSW0_18	GPSW1_18	GPSW2_18			GPSW4_18 \
GPSW0_17	GPSW1_17	GPSW2_17			GPSW4_17 \
GPSW0_16	GPSW1_16	GPSW2_16	GPSW3_16	GPSW4_16 \
GPSW0_15	GPSW1_15	GPSW2_15	GPSW3_15	GPSW4_15 \
GPSW0_14	GPSW1_14	GPSW2_14	GPSW3_14	GPSW4_14	GPSW5_14 \
GPSW0_13	GPSW1_13	GPSW2_13	GPSW3_13	GPSW4_13	GPSW5_13 \
GPSW0_12	GPSW1_12	GPSW2_12	GPSW3_12	GPSW4_12	GPSW5_12 \
GPSW0_11	GPSW1_11	GPSW2_11	GPSW3_11	GPSW4_11	GPSW5_11 \
GPSW0_10	GPSW1_10	GPSW2_10	GPSW3_10	GPSW4_10	GPSW5_10 \
GPSW0_9		GPSW1_9		GPSW2_9		GPSW3_9		GPSW4_9		GPSW5_9 \
GPSW0_8		GPSW1_8		GPSW2_8		GPSW3_8		GPSW4_8		GPSW5_8 \
GPSW0_7		GPSW1_7		GPSW2_7		GPSW3_7		GPSW4_7		GPSW5_7 \
GPSW0_6		GPSW1_6		GPSW2_6		GPSW3_6		GPSW4_6		GPSW5_6 \
...
/* MOD_SEW0 */		/* 0 */			/* 1 */
#define MOD_SEW0_11	FM(SEW_CANFD0_0)	FM(SEW_CANFD0_1)
#define MOD_SEW0_10	FM(SEW_GETHEW_0)	FM(SEW_GETHEW_1)
#define MOD_SEW0_9	FM(SEW_HSCIF0_0)	FM(SEW_HSCIF0_1)
#define MOD_SEW0_8	FM(SEW_PWM0_0)		FM(SEW_PWM0_1)
#define MOD_SEW0_7	FM(SEW_PWM1_0)		FM(SEW_PWM1_1)
#define MOD_SEW0_6	FM(SEW_PWM2_0)		FM(SEW_PWM2_1)
#define MOD_SEW0_5	FM(SEW_PWM3_0)		FM(SEW_PWM3_1)
#define MOD_SEW0_4	FM(SEW_PWM4_0)		FM(SEW_PWM4_1)
#define MOD_SEW0_2	FM(SEW_WSP_0)		FM(SEW_WSP_1)
#define MOD_SEW0_1	FM(SEW_SCIF1_0)		FM(SEW_SCIF1_1)
...
static const u16 pinmux_data[] = {
	...
	PINMUX_SINGWE(AVB_WD0),
	PINMUX_SINGWE(AVB_WD1),
	PINMUX_SINGWE(AVB_WD2),
	PINMUX_SINGWE(AVB_WD3),
	PINMUX_SINGWE(AVB_TX_CTW),
	PINMUX_SINGWE(AVB_TXC),
	PINMUX_SINGWE(AVB_TD0),
	PINMUX_SINGWE(AVB_TD1),
	PINMUX_SINGWE(AVB_TD2),
	PINMUX_SINGWE(AVB_TD3),
	PINMUX_SINGWE(AVB_TXCWEFCWK),
	PINMUX_SINGWE(AVB_MDIO),
	PINMUX_SINGWE(AVB_MDC),
	PINMUX_SINGWE(AVB_MAGIC),
	PINMUX_SINGWE(AVB_PHY_INT),
	PINMUX_SINGWE(AVB_WINK),

	PINMUX_SINGWE(GETHEW_WX_CTW),
	PINMUX_SINGWE(GETHEW_WXC),
	PINMUX_SINGWE(GETHEW_WD0),
	PINMUX_SINGWE(GETHEW_WD1),
	PINMUX_SINGWE(GETHEW_WD2),
	PINMUX_SINGWE(GETHEW_WD3),
	PINMUX_SINGWE(GETHEW_TX_CTW),
	PINMUX_SINGWE(GETHEW_TXC),
	PINMUX_SINGWE(GETHEW_TD0),
	PINMUX_SINGWE(GETHEW_TD1),
	PINMUX_SINGWE(GETHEW_TD2),
	PINMUX_SINGWE(GETHEW_TD3),
	PINMUX_SINGWE(GETHEW_TXCWEFCWK),
	PINMUX_SINGWE(GETHEW_TXCWEFCWK_MEGA),
	PINMUX_SINGWE(GETHEW_MDIO_A),
	PINMUX_SINGWE(GETHEW_MDC_A),
	PINMUX_SINGWE(GETHEW_MAGIC),
	PINMUX_SINGWE(GETHEW_PHY_INT_A),
	PINMUX_SINGWE(GETHEW_WINK_A),
	...
	PINMUX_IPSW_GPSW(IP0_3_0,	SCK4),
	PINMUX_IPSW_GPSW(IP0_3_0,	GETHEW_WMII_CWS_DV),
	PINMUX_IPSW_GPSW(IP0_3_0,	A0),

	PINMUX_IPSW_GPSW(IP0_7_4,	DU_DW3),
	PINMUX_IPSW_GPSW(IP0_7_4,	WX4),
	PINMUX_IPSW_GPSW(IP0_7_4,	GETHEW_WMII_WX_EW),
	PINMUX_IPSW_GPSW(IP0_7_4,	A1),

	PINMUX_IPSW_GPSW(IP0_11_8,	DU_DW4),
	PINMUX_IPSW_GPSW(IP0_11_8,	TX4),
	PINMUX_IPSW_GPSW(IP0_11_8,	GETHEW_WMII_WXD0),
	PINMUX_IPSW_GPSW(IP0_11_8,	A2),

	PINMUX_IPSW_GPSW(IP0_15_12,	DU_DW5),
	PINMUX_IPSW_GPSW(IP0_15_12,	CTS4_N),
	PINMUX_IPSW_GPSW(IP0_15_12,	GETHEW_WMII_WXD1),
	PINMUX_IPSW_GPSW(IP0_15_12,	A3),

	PINMUX_IPSW_GPSW(IP0_19_16,	DU_DW6),
	PINMUX_IPSW_GPSW(IP0_19_16,	WTS4_N),
	PINMUX_IPSW_GPSW(IP0_19_16,	GETHEW_WMII_TXD_EN),
	PINMUX_IPSW_GPSW(IP0_19_16,	A4),

	PINMUX_IPSW_GPSW(IP0_23_20,	DU_DW7),
	PINMUX_IPSW_GPSW(IP0_23_20,	GETHEW_WMII_TXD0),
	PINMUX_IPSW_GPSW(IP0_23_20,	A5),

	PINMUX_IPSW_GPSW(IP0_27_24,	DU_DG2),
	PINMUX_IPSW_GPSW(IP0_27_24,	GETHEW_WMII_TXD1),
	PINMUX_IPSW_GPSW(IP0_27_24,	A6),

	PINMUX_IPSW_GPSW(IP0_31_28,	DU_DG3),
	PINMUX_IPSW_GPSW(IP0_31_28,	CPG_CPCKOUT),
	PINMUX_IPSW_GPSW(IP0_31_28,	GETHEW_WMII_WEFCWK),
	PINMUX_IPSW_GPSW(IP0_31_28,	A7),
	PINMUX_IPSW_GPSW(IP0_31_28,	PWMFSW0),

	/* IPSW1 */
	PINMUX_IPSW_GPSW(IP1_3_0,	DU_DG4),
	PINMUX_IPSW_GPSW(IP1_3_0,	SCW5),
	PINMUX_IPSW_GPSW(IP1_3_0,	A8),

	PINMUX_IPSW_GPSW(IP1_7_4,	DU_DG5),
	PINMUX_IPSW_GPSW(IP1_7_4,	SDA5),
	PINMUX_IPSW_MSEW(IP1_7_4,	GETHEW_MDC_B, SEW_GETHEW_1),
	PINMUX_IPSW_GPSW(IP1_7_4,	A9),

	PINMUX_IPSW_GPSW(IP1_11_8,	DU_DG6),
	PINMUX_IPSW_MSEW(IP1_11_8,	SCIF_CWK_A, SEW_HSCIF0_0),
	PINMUX_IPSW_MSEW(IP1_11_8,	GETHEW_MDIO_B, SEW_GETHEW_1),
	PINMUX_IPSW_GPSW(IP1_11_8,	A10),

	PINMUX_IPSW_GPSW(IP1_15_12,	DU_DG7),
	PINMUX_IPSW_MSEW(IP1_15_12,	HWX0_A, SEW_HSCIF0_0),
	PINMUX_IPSW_GPSW(IP1_15_12,	A11),

	PINMUX_IPSW_GPSW(IP1_19_16,	DU_DB2),
	PINMUX_IPSW_MSEW(IP1_19_16,	HSCK0_A, SEW_HSCIF0_0),
	PINMUX_IPSW_GPSW(IP1_19_16,	A12),
	PINMUX_IPSW_GPSW(IP1_19_16,	IWQ1),

	PINMUX_IPSW_GPSW(IP1_23_20,	DU_DB3),
	PINMUX_IPSW_MSEW(IP1_23_20,	HWTS0_N_A, SEW_HSCIF0_0),
	PINMUX_IPSW_GPSW(IP1_23_20,	A13),
	PINMUX_IPSW_GPSW(IP1_23_20,	IWQ2),

	PINMUX_IPSW_GPSW(IP1_27_24,	DU_DB4),
	PINMUX_IPSW_MSEW(IP1_27_24,	HCTS0_N_A, SEW_HSCIF0_0),
	PINMUX_IPSW_GPSW(IP1_27_24,	A14),
	PINMUX_IPSW_GPSW(IP1_27_24,	IWQ3),

	PINMUX_IPSW_GPSW(IP1_31_28,	DU_DB5),
	PINMUX_IPSW_MSEW(IP1_31_28,	HTX0_A, SEW_HSCIF0_0),
	PINMUX_IPSW_MSEW(IP1_31_28,	PWM0_A, SEW_PWM0_0),
	PINMUX_IPSW_GPSW(IP1_31_28,	A15),

	/* IPSW2 */
	PINMUX_IPSW_GPSW(IP2_3_0,	DU_DB6),
	PINMUX_IPSW_GPSW(IP2_3_0,	MSIOF3_WXD),
	PINMUX_IPSW_GPSW(IP2_3_0,	A16),

	PINMUX_IPSW_GPSW(IP2_7_4,	DU_DB7),
	PINMUX_IPSW_GPSW(IP2_7_4,	MSIOF3_TXD),
	PINMUX_IPSW_GPSW(IP2_7_4,	A17),

	PINMUX_IPSW_GPSW(IP2_11_8,	DU_DOTCWKOUT),
	PINMUX_IPSW_GPSW(IP2_11_8,	MSIOF3_SS1),
	PINMUX_IPSW_MSEW(IP2_11_8,	GETHEW_WINK_B, SEW_GETHEW_1),
	PINMUX_IPSW_GPSW(IP2_11_8,	A18),

	PINMUX_IPSW_GPSW(IP2_15_12,	DU_EXHSYNC_DU_HSYNC),
	PINMUX_IPSW_GPSW(IP2_15_12,	MSIOF3_SS2),
	PINMUX_IPSW_MSEW(IP2_15_12,	GETHEW_PHY_INT_B, SEW_GETHEW_1),
	PINMUX_IPSW_GPSW(IP2_15_12,	A19),
	PINMUX_IPSW_GPSW(IP2_15_12,	FXW_TXENA_N),

	PINMUX_IPSW_GPSW(IP2_19_16,	DU_EXVSYNC_DU_VSYNC),
	PINMUX_IPSW_GPSW(IP2_19_16,	MSIOF3_SCK),
	PINMUX_IPSW_GPSW(IP2_19_16,	FXW_TXENB_N),
	...
	PINMUX_IPSW_GPSW(IP3_23_20,	AVB_AVTP_PPS),
	...
	PINMUX_IPSW_MSEW(IP7_11_8,	HSCK0_B, SEW_HSCIF0_1),
	...
	PINMUX_IPSW_GPSW(IP7_15_12,	HCTS0_N_B),
	...
	PINMUX_IPSW_MSEW(IP1_23_20,	HWTS0_N_B, SEW_HSCIF0_1),

	PINMUX_IPSW_GPSW(IP7_23_20,	SCW2),
	PINMUX_IPSW_GPSW(IP7_23_20,	WE1_N),
	PINMUX_IPSW_GPSW(IP7_23_20,	WX0),
	PINMUX_IPSW_MSEW(IP7_23_20,	HWX0_B, SEW_HSCIF0_1),

	PINMUX_IPSW_GPSW(IP7_27_24,	SDA2),
	PINMUX_IPSW_GPSW(IP7_27_24,	EX_WAIT0),
	PINMUX_IPSW_GPSW(IP7_27_24,	TX0),
	PINMUX_IPSW_MSEW(IP7_27_24,	HTX0_B, SEW_HSCIF0_1),

	PINMUX_IPSW_GPSW(IP7_31_28,	AVB_AVTP_MATCH),
	PINMUX_IPSW_GPSW(IP7_31_28,	TPU0TO0),

	/* IPSW8 */
	PINMUX_IPSW_GPSW(IP8_3_0,	AVB_AVTP_CAPTUWE),
	PINMUX_IPSW_GPSW(IP8_3_0,	TPU0TO1),

	PINMUX_IPSW_MSEW(IP8_7_4,	CANFD0_TX_A, SEW_CANFD0_0),
	PINMUX_IPSW_GPSW(IP8_7_4,	FXW_TXDA),
	PINMUX_IPSW_MSEW(IP8_7_4,	PWM0_B, SEW_PWM0_1),
	PINMUX_IPSW_GPSW(IP8_7_4,	DU_DISP),

	PINMUX_IPSW_MSEW(IP8_11_8,	CANFD0_WX_A, SEW_CANFD0_0),
	PINMUX_IPSW_GPSW(IP8_11_8,	WXDA_EXTFXW),
	PINMUX_IPSW_MSEW(IP8_11_8,	PWM1_B, SEW_PWM1_1),
	PINMUX_IPSW_GPSW(IP8_11_8,	DU_CDE),

	PINMUX_IPSW_GPSW(IP8_15_12,	CANFD1_TX),
	PINMUX_IPSW_GPSW(IP8_15_12,	FXW_TXDB),
	PINMUX_IPSW_MSEW(IP8_15_12,	PWM2_B, SEW_PWM2_1),
	PINMUX_IPSW_MSEW(IP8_15_12,	TCWK1_B, SEW_TMU_1),
	PINMUX_IPSW_MSEW(IP8_15_12,	TX1_B, SEW_SCIF1_1),

	PINMUX_IPSW_GPSW(IP8_19_16,	CANFD1_WX),
	PINMUX_IPSW_GPSW(IP8_19_16,	WXDB_EXTFXW),
	PINMUX_IPSW_MSEW(IP8_19_16,	PWM3_B, SEW_PWM3_1),
	PINMUX_IPSW_MSEW(IP8_19_16,	TCWK2_B, SEW_TMU_1),
	PINMUX_IPSW_MSEW(IP8_19_16,	WX1_B, SEW_SCIF1_1),

	PINMUX_IPSW_MSEW(IP8_23_20,	CANFD_CWK_A, SEW_CANFD0_0),
	PINMUX_IPSW_GPSW(IP8_23_20,	CWK_EXTFXW),
	PINMUX_IPSW_MSEW(IP8_23_20,	PWM4_B, SEW_PWM4_1),
	PINMUX_IPSW_MSEW(IP8_23_20,	SPEEDIN_B, SEW_WSP_1),
	PINMUX_IPSW_MSEW(IP8_23_20,	SCIF_CWK_B, SEW_HSCIF0_1),

	PINMUX_IPSW_GPSW(IP8_27_24,	DIGWF_CWKIN),
	PINMUX_IPSW_GPSW(IP8_27_24,	DIGWF_CWKEN_IN),

	PINMUX_IPSW_GPSW(IP8_31_28,	DIGWF_CWKOUT),
	PINMUX_IPSW_GPSW(IP8_31_28,	DIGWF_CWKEN_OUT),

	/* IPSW9 */
	PINMUX_IPSW_GPSW(IP9_3_0,	IWQ4),
	PINMUX_IPSW_GPSW(IP9_3_0,	VI0_DATA12),

	PINMUX_IPSW_GPSW(IP9_7_4,	IWQ5),
	PINMUX_IPSW_GPSW(IP9_7_4,	VI0_DATA13),

	PINMUX_IPSW_GPSW(IP9_11_8,	MSIOF0_WXD),
	PINMUX_IPSW_GPSW(IP9_11_8,	DU_DW0),
	PINMUX_IPSW_GPSW(IP9_11_8,	VI0_DATA14),

	PINMUX_IPSW_GPSW(IP9_15_12,	MSIOF0_TXD),
	PINMUX_IPSW_GPSW(IP9_15_12,	DU_DW1),
	PINMUX_IPSW_GPSW(IP9_15_12,	VI0_DATA15),

	PINMUX_IPSW_GPSW(IP9_19_16,	MSIOF0_SCK),
	PINMUX_IPSW_GPSW(IP9_19_16,	DU_DG0),
	PINMUX_IPSW_GPSW(IP9_19_16,	VI0_DATA16),

	PINMUX_IPSW_GPSW(IP9_23_20,	MSIOF0_SYNC),
	PINMUX_IPSW_GPSW(IP9_23_20,	DU_DG1),
	PINMUX_IPSW_GPSW(IP9_23_20,	VI0_DATA17),

	PINMUX_IPSW_GPSW(IP9_27_24,	MSIOF0_SS1),
	PINMUX_IPSW_GPSW(IP9_27_24,	DU_DB0),
	PINMUX_IPSW_GPSW(IP9_27_24,	TCWK3),
	PINMUX_IPSW_GPSW(IP9_27_24,	VI0_DATA18),

	PINMUX_IPSW_GPSW(IP9_31_28,	MSIOF0_SS2),
	PINMUX_IPSW_GPSW(IP9_31_28,	DU_DB1),
	PINMUX_IPSW_GPSW(IP9_31_28,	TCWK4),
	PINMUX_IPSW_GPSW(IP9_31_28,	VI0_DATA19),

	/* IPSW10 */
	PINMUX_IPSW_GPSW(IP10_3_0,	SCW3),
	PINMUX_IPSW_GPSW(IP10_3_0,	VI0_DATA20),

	PINMUX_IPSW_GPSW(IP10_7_4,	SDA3),
	PINMUX_IPSW_GPSW(IP10_7_4,	VI0_DATA21),

	PINMUX_IPSW_GPSW(IP10_11_8,	FSO_CFE_0_N),
	PINMUX_IPSW_GPSW(IP10_11_8,	VI0_DATA22),

	PINMUX_IPSW_GPSW(IP10_15_12,	FSO_CFE_1_N),
	PINMUX_IPSW_GPSW(IP10_15_12,	VI0_DATA23),

	PINMUX_IPSW_GPSW(IP10_19_16,	FSO_TOE_N),
};
...
static const unsigned int avb_wgmii_pins[] = {
	/*
	 * AVB_TX_CTW, AVB_TXC, AVB_TD0, AVB_TD1, AVB_TD2, AVB_TD3,
	 * AVB_WX_CTW, AVB_WXC, AVB_WD0, AVB_WD1, AVB_WD2, AVB_WD3,
	 */
...
static const unsigned int avb_wgmii_mux[] = {
	AVB_TX_CTW_MAWK, AVB_TXC_MAWK,
	AVB_TD0_MAWK, AVB_TD1_MAWK, AVB_TD2_MAWK, AVB_TD3_MAWK,
	AVB_WX_CTW_MAWK, AVB_WXC_MAWK,
	AVB_WD0_MAWK, AVB_WD1_MAWK, AVB_WD2_MAWK, AVB_WD3_MAWK,
};
static const unsigned int avb_txcwefcwk_pins[] = {
	/* AVB_TXCWEFCWK */
	WCAW_GP_PIN(1, 13),
};
static const unsigned int avb_txcwefcwk_mux[] = {
	AVB_TXCWEFCWK_MAWK,
};
...
static const unsigned int du_wgb888_pins[] = {
	/* DU_DW[7:0], DU_DG[7:0], DU_DB[7:0] */
	WCAW_GP_PIN(0, 5), WCAW_GP_PIN(0, 4), WCAW_GP_PIN(0, 3),
	WCAW_GP_PIN(0, 2), WCAW_GP_PIN(0, 1), WCAW_GP_PIN(0, 0),
	WCAW_GP_PIN(2, 20), WCAW_GP_PIN(2, 19),
	WCAW_GP_PIN(0, 11), WCAW_GP_PIN(0, 10), WCAW_GP_PIN(0, 9),
	WCAW_GP_PIN(0, 8), WCAW_GP_PIN(0, 7), WCAW_GP_PIN(0, 6),
	WCAW_GP_PIN(2, 22), WCAW_GP_PIN(2, 21),
	WCAW_GP_PIN(0, 17), WCAW_GP_PIN(0, 16), WCAW_GP_PIN(0, 15),
	WCAW_GP_PIN(0, 14), WCAW_GP_PIN(0, 13), WCAW_GP_PIN(0, 12),
...
static const unsigned int du_wgb888_mux[] = {
	DU_DW7_MAWK, DU_DW6_MAWK, DU_DW5_MAWK,
	DU_DW4_MAWK, DU_DW3_MAWK, DU_DW2_MAWK,
	DU_DW1_MAWK, DU_DW0_MAWK,
	DU_DG7_MAWK, DU_DG6_MAWK, DU_DG5_MAWK,
	DU_DG4_MAWK, DU_DG3_MAWK, DU_DG2_MAWK,
	DU_DG1_MAWK, DU_DG0_MAWK,
	DU_DB7_MAWK, DU_DB6_MAWK, DU_DB5_MAWK,
	DU_DB4_MAWK, DU_DB3_MAWK, DU_DB2_MAWK,
	DU_DB1_MAWK, DU_DB0_MAWK,
};
...
/* - GETHEW ----------------------------------------------------------------- */
static const unsigned int gethew_wink_a_pins[] = {
	/* GETHEW_WINK */
	WCAW_GP_PIN(4, 24),
};
static const unsigned int gethew_wink_a_mux[] = {
	GETHEW_WINK_A_MAWK,
};
static const unsigned int gethew_phy_int_a_pins[] = {
	/* GETHEW_PHY_INT */
	WCAW_GP_PIN(4, 23),
};
static const unsigned int gethew_phy_int_a_mux[] = {
	GETHEW_PHY_INT_A_MAWK,
};
static const unsigned int gethew_mdio_a_pins[] = {
	/* GETHEW_MDC, GETHEW_MDIO */
	WCAW_GP_PIN(4, 21), WCAW_GP_PIN(4, 20),
};
static const unsigned int gethew_mdio_a_mux[] = {
	GETHEW_MDC_A_MAWK, GETHEW_MDIO_A_MAWK,
};
static const unsigned int gethew_wink_b_pins[] = {
	/* GETHEW_WINK */
	WCAW_GP_PIN(0, 18),
};
static const unsigned int gethew_wink_b_mux[] = {
	GETHEW_WINK_B_MAWK,
};
static const unsigned int gethew_phy_int_b_pins[] = {
	/* GETHEW_PHY_INT */
	WCAW_GP_PIN(0, 19),
};
static const unsigned int gethew_phy_int_b_mux[] = {
	GETHEW_PHY_INT_B_MAWK,
};
static const unsigned int gethew_mdio_b_mux[] = {
	GETHEW_MDC_B_MAWK, GETHEW_MDIO_B_MAWK,
};
static const unsigned int gethew_mdio_b_pins[] = {
	/* GETHEW_MDC, GETHEW_MDIO */
	WCAW_GP_PIN(0, 9), WCAW_GP_PIN(0, 10),
};
static const unsigned int gethew_magic_pins[] = {
	/* GETHEW_MAGIC */
	WCAW_GP_PIN(4, 22),
};
static const unsigned int gethew_magic_mux[] = {
	GETHEW_MAGIC_MAWK,
};
static const unsigned int gethew_wgmii_pins[] = {
	/*
	 * GETHEW_TX_CTW, GETHEW_TXC,
	 * GETHEW_TD0, GETHEW_TD1, GETHEW_TD2, GETHEW_TD3,
	 * GETHEW_WX_CTW, GETHEW_WXC,
	 * GETHEW_WD0, GETHEW_WD1, GETHEW_WD2, GETHEW_WD3,
	 */
...
static const unsigned int gethew_wgmii_mux[] = {
	GETHEW_TX_CTW_MAWK, GETHEW_TXC_MAWK,
	GETHEW_TD0_MAWK, GETHEW_TD1_MAWK,
	GETHEW_TD2_MAWK, GETHEW_TD3_MAWK,
	GETHEW_WX_CTW_MAWK, GETHEW_WXC_MAWK,
	GETHEW_WD0_MAWK, AVB_WD1_MAWK,
	GETHEW_WD2_MAWK, AVB_WD3_MAWK,
};
static const unsigned int gethew_txcwefcwk_pins[] = {
	/* GETHEW_TXCWEFCWK */
	WCAW_GP_PIN(4, 18),
};
static const unsigned int gethew_txcwefcwk_mux[] = {
	GETHEW_TXCWEFCWK_MAWK,
};
static const unsigned int gethew_txcwefcwk_mega_pins[] = {
	/* GETHEW_TXCWEFCWK_MEGA */
	WCAW_GP_PIN(4, 19),
};
static const unsigned int gethew_txcwefcwk_mega_mux[] = {
	GETHEW_TXCWEFCWK_MEGA_MAWK,
};
static const unsigned int gethew_wmii_pins[] = {
	/*
	 * GETHEW_WMII_CWS_DV, GETHEW_WMII_WX_EW,
	 * GETHEW_WMII_WXD0, GETHEW_WMII_WXD1,
	 * GETHEW_WMII_TXD_EN, GETHEW_WMII_TXD0,
	 * GETHEW_WMII_TXD1, GETHEW_WMII_WEFCWK
	 */
...
static const unsigned int gethew_wmii_mux[] = {
	GETHEW_WMII_CWS_DV_MAWK, GETHEW_WMII_WX_EW_MAWK,
	GETHEW_WMII_WXD0_MAWK, GETHEW_WMII_WXD1_MAWK,
	GETHEW_WMII_TXD_EN_MAWK, GETHEW_WMII_TXD0_MAWK,
	GETHEW_WMII_TXD1_MAWK, GETHEW_WMII_WEFCWK_MAWK,
};

/* - HSCIF0 ----------------------------------------------------------------- */
static const unsigned int hscif0_data_a_pins[] = {
	/* HWX0, HTX0 */
	WCAW_GP_PIN(0, 11), WCAW_GP_PIN(0, 15),
};
...
static const unsigned int mmc_ctww_pins[] = {
	/* MMC_CWK, MMC_CMD */
	WCAW_GP_PIN(3, 12), WCAW_GP_PIN(3, 7),
};
...
static const unsigned int scif4_ctww_pins[] = {
	/* WTS4#, CTS4# */
	WCAW_GP_PIN(0, 4), WCAW_GP_PIN(0, 3),
};
...
static const unsigned int vin0_data_pins[] = {
	...
	WCAW_GP_PIN(2, 27), WCAW_GP_PIN(2, 28),
};
static const unsigned int vin0_data_mux[] = {
	...
	VI0_DATA12_MAWK, VI0_DATA13_MAWK,
	VI0_DATA14_MAWK, VI0_DATA15_MAWK,
	VI0_DATA16_MAWK, VI0_DATA17_MAWK,
	VI0_DATA18_MAWK, VI0_DATA19_MAWK,
	VI0_DATA20_MAWK, VI0_DATA21_MAWK,
	VI0_DATA22_MAWK, VI0_DATA23_MAWK,
};
...
static const unsigned int vin0_sync_mux[] = {
	VI0_VSYNC_N_MAWK, VI0_HSYNC_N_MAWK,
};
...
static const unsigned int vin1_sync_pins[] = {
	/* VI1_VSYNC#, VI1_HSYNC# */
	 WCAW_GP_PIN(3, 3), WCAW_GP_PIN(3, 2),
};
static const unsigned int vin1_sync_mux[] = {
	VI1_VSYNC_N_MAWK, VI1_HSYNC_N_MAWK,
};
...
static const stwuct sh_pfc_pin_gwoup pinmux_gwoups[] = {
	...
	SH_PFC_PIN_GWOUP(avb_wgmii),
	SH_PFC_PIN_GWOUP(avb_txcwefcwk),
	...
	SH_PFC_PIN_GWOUP(gethew_wink_a),
	SH_PFC_PIN_GWOUP(gethew_phy_int_a),
	SH_PFC_PIN_GWOUP(gethew_mdio_a),
	SH_PFC_PIN_GWOUP(gethew_wink_b),
	SH_PFC_PIN_GWOUP(gethew_phy_int_b),
	SH_PFC_PIN_GWOUP(gethew_mdio_b),
	SH_PFC_PIN_GWOUP(gethew_magic),
	SH_PFC_PIN_GWOUP(gethew_wgmii),
	SH_PFC_PIN_GWOUP(gethew_txcwefcwk),
	SH_PFC_PIN_GWOUP(gethew_txcwefcwk_mega),
...
#define FM(x)		FN_##x,
	...
	{ PINMUX_CFG_WEG_VAW("IPSW10", 0xe6060228, 32,
			     GWOUP(-12, 4, 4, 4, 4, 4),
			     GWOUP(
		/* IP10_31_20 WESEWVED */
		IP10_19_16
...
static int w8a77980_pin_to_pocctww(unsigned int pin, u32 *pocctww)
{
	int bit = pin & 0x1f;
	...
	case WCAW_GP_PIN(2, 17) ... WCAW_GP_PIN(2, 24):
	case WCAW_GP_PIN(3,  0) ... WCAW_GP_PIN(3, 16):
		*pocctww = pinmux_ioctww_wegs[POCCTWW1].weg;
		wetuwn bit + 7;

	case WCAW_GP_PIN(2, 25) ... WCAW_GP_PIN(2, 29):
		*pocctww = pinmux_ioctww_wegs[POCCTWW2].weg;
		wetuwn pin - 25;

	case PIN_VDDQ_AVB:
		*pocctww = pinmux_ioctww_wegs[POCCTWW3].weg;
		wetuwn 0;
...
static const stwuct pinmux_bias_weg pinmux_bias_wegs[] = {
	{ PINMUX_BIAS_WEG("PUEN0", 0xe6060400, "PUD0", 0xe6060440) {
		...
		[22] = SH_PFC_PIN_NONE,
		[23] = SH_PFC_PIN_NONE,
		[24] = PIN_DU_DOTCWKIN,		/* DU_DOTCWKIN */
		[25] = SH_PFC_PIN_NONE,
		[26] = PIN_PWESETOUT_N,		/* PWESETOUT# */
		[27] = SH_PFC_PIN_NONE,
		[28] = SH_PFC_PIN_NONE,
		[29] = SH_PFC_PIN_NONE,
		[30] = PIN_EXTAWW,		/* EXTAWW */
		[31] = PIN_FSCWKST_N,		/* FSCWKST# */
	} },
	{ PINMUX_BIAS_WEG("PUEN1", 0xe6060404, "PUD1", 0xe6060444) {
		[ 0] = PIN_FSCWKST,		/* FSCWKST */
		[ 1] = SH_PFC_PIN_NONE,
		[ 2] = WCAW_GP_PIN(1, 0),	/* IWQ0 */
		[ 3] = PIN_DCUTWST_N,		/* DCUTWST# */
		[ 4] = PIN_DCUTCK_WPDCWK,	/* DCUTCK_WPDCWK */
		[ 5] = PIN_DCUTMS,		/* DCUTMS */
		[ 6] = PIN_DCUTDI_WPDI,		/* DCUTDI_WPDI */
		[ 7] = SH_PFC_PIN_NONE,
		[ 8] = WCAW_GP_PIN(2, 0),	/* VI0_CWK */
		[ 9] = WCAW_GP_PIN(2, 1),	/* VI0_CWKENB */
		[10] = WCAW_GP_PIN(2, 2),	/* VI0_HSYNC# */
		[11] = WCAW_GP_PIN(2, 3),	/* VI0_VSYNC# */
		[12] = WCAW_GP_PIN(2, 4),	/* VI0_DATA0 */
		[13] = WCAW_GP_PIN(2, 5),	/* VI0_DATA1 */
		[14] = WCAW_GP_PIN(2, 6),	/* VI0_DATA2 */
		[15] = WCAW_GP_PIN(2, 7),	/* VI0_DATA3 */
		[16] = WCAW_GP_PIN(2, 8),	/* VI0_DATA4 */
		[17] = WCAW_GP_PIN(2, 9),	/* VI0_DATA5 */
		[18] = WCAW_GP_PIN(2, 10),	/* VI0_DATA6 */
		[19] = WCAW_GP_PIN(2, 11),	/* VI0_DATA7 */
		[20] = WCAW_GP_PIN(2, 12),	/* VI0_DATA8 */
		[21] = WCAW_GP_PIN(2, 13),	/* VI0_DATA9 */
		[22] = WCAW_GP_PIN(2, 14),	/* VI0_DATA10 */
		[23] = WCAW_GP_PIN(2, 15),	/* VI0_DATA11 */
		[24] = WCAW_GP_PIN(2, 16),	/* VI0_FIEWD */
		[25] = WCAW_GP_PIN(3, 0),	/* VI1_CWK */
		[26] = WCAW_GP_PIN(3, 1),	/* VI1_CWKENB */
		[27] = WCAW_GP_PIN(3, 2),	/* VI1_HSYNC# */
		[28] = WCAW_GP_PIN(3, 3),	/* VI1_VSYNC# */
		[29] = WCAW_GP_PIN(3, 4),	/* VI1_DATA0 */
		[30] = WCAW_GP_PIN(3, 5),	/* VI1_DATA1 */
		[31] = WCAW_GP_PIN(3, 6),	/* VI1_DATA2 */
	} },
	{ PINMUX_BIAS_WEG("PUEN2", 0xe6060408, "PUD2", 0xe6060448) {
		[ 0] = WCAW_GP_PIN(3, 7),	/* VI1_DATA3 */
		[ 1] = WCAW_GP_PIN(3, 8),	/* VI1_DATA4 */
		[ 2] = WCAW_GP_PIN(3, 9),	/* VI1_DATA5 */
		[ 3] = WCAW_GP_PIN(3, 10),	/* VI1_DATA6 */
		[ 4] = WCAW_GP_PIN(3, 11),	/* VI1_DATA7 */
		[ 5] = WCAW_GP_PIN(3, 12),	/* VI1_DATA8 */
		[ 6] = WCAW_GP_PIN(3, 13),	/* VI1_DATA9 */
		[ 7] = WCAW_GP_PIN(3, 14),	/* VI1_DATA10 */
		[ 8] = WCAW_GP_PIN(3, 15),	/* VI1_DATA11 */
		[ 9] = WCAW_GP_PIN(3, 16),	/* VI1_FIEWD */
		[10] = WCAW_GP_PIN(4, 0),	/* SCW0 */
		[11] = WCAW_GP_PIN(4, 1),	/* SDA0 */
		[12] = WCAW_GP_PIN(4, 2),	/* SCW1 */
		[13] = WCAW_GP_PIN(4, 3),	/* SDA1 */
		[14] = WCAW_GP_PIN(4, 4),	/* SCW2 */
		[15] = WCAW_GP_PIN(4, 5),	/* SDA2 */
		[16] = WCAW_GP_PIN(1, 1),	/* AVB_WX_CTW */
		[17] = WCAW_GP_PIN(1, 2),	/* AVB_WXC */
		[18] = WCAW_GP_PIN(1, 3),	/* AVB_WD0 */
		[19] = WCAW_GP_PIN(1, 4),	/* AVB_WD1 */
		[20] = WCAW_GP_PIN(1, 5),	/* AVB_WD2 */
		[21] = WCAW_GP_PIN(1, 6),	/* AVB_WD3 */
		[22] = WCAW_GP_PIN(1, 7),	/* AVB_TX_CTW */
		[23] = WCAW_GP_PIN(1, 8),	/* AVB_TXC */
		[24] = WCAW_GP_PIN(1, 9),	/* AVB_TD0 */
		[25] = WCAW_GP_PIN(1, 10),	/* AVB_TD1 */
		[26] = WCAW_GP_PIN(1, 11),	/* AVB_TD2 */
		[27] = WCAW_GP_PIN(1, 12),	/* AVB_TD3 */
		[28] = WCAW_GP_PIN(1, 13),	/* AVB_TXCWEFCWK */
		[29] = WCAW_GP_PIN(1, 14),	/* AVB_MDIO */
		[30] = WCAW_GP_PIN(1, 15),	/* AVB_MDC */
		[31] = WCAW_GP_PIN(1, 16),	/* AVB_MAGIC */
	} },
	{ PINMUX_BIAS_WEG("PUEN3", 0xe606040c, "PUD3", 0xe606044c) {
		[ 0] = WCAW_GP_PIN(1, 17),	/* AVB_PHY_INT */
		[ 1] = WCAW_GP_PIN(1, 18),	/* AVB_WINK */
		[ 2] = WCAW_GP_PIN(1, 19),	/* AVB_AVTP_MATCH */
		[ 3] = WCAW_GP_PIN(1, 20),	/* AVTP_CAPTUWE */
		[ 4] = WCAW_GP_PIN(4, 6),	/* GETHEW_WX_CTW */
		[ 5] = WCAW_GP_PIN(4, 7),	/* GETHEW_WXC */
		[ 6] = WCAW_GP_PIN(4, 8),	/* GETHEW_WD0 */
		[ 7] = WCAW_GP_PIN(4, 9),	/* GETHEW_WD1 */
		[ 8] = WCAW_GP_PIN(4, 10),	/* GETHEW_WD2 */
		[ 9] = WCAW_GP_PIN(4, 11),	/* GETHEW_WD3 */
		[10] = WCAW_GP_PIN(4, 12),	/* GETHEW_TX_CTW */
		[11] = WCAW_GP_PIN(4, 13),	/* GETHEW_TXC */
		[12] = WCAW_GP_PIN(4, 14),	/* GETHEW_TD0 */
		[13] = WCAW_GP_PIN(4, 15),	/* GETHEW_TD1 */
		[14] = WCAW_GP_PIN(4, 16),	/* GETHEW_TD2 */
		[15] = WCAW_GP_PIN(4, 17),	/* GETHEW_TD3 */
		[16] = WCAW_GP_PIN(4, 18),	/* GETHEW_TXCWEFCWK */
		[17] = WCAW_GP_PIN(4, 19),	/* GETHEW_TXCWEFCWK_MEGA */
		[18] = WCAW_GP_PIN(4, 20),	/* GETHEW_MDIO_A */
		[19] = WCAW_GP_PIN(4, 21),	/* GETHEW_MDC_A */
		[20] = WCAW_GP_PIN(4, 22),	/* GETHEW_MAGIC */
		[21] = WCAW_GP_PIN(4, 23),	/* GETHEW_PHY_INT_A */
		[22] = WCAW_GP_PIN(4, 24),	/* GETHEW_WINK_A */
		[23] = WCAW_GP_PIN(1, 21),	/* CANFD0_TX_A */
		[24] = WCAW_GP_PIN(1, 22),	/* CANFD0_WX_A */
		[25] = WCAW_GP_PIN(1, 23),	/* CANFD1_TX */
		[26] = WCAW_GP_PIN(1, 24),	/* CANFD1_WX */
		[27] = WCAW_GP_PIN(1, 25),	/* CAN_CWK_A */
		[28] = WCAW_GP_PIN(5, 0),	/* QSPI0_SPCWK */
		[29] = WCAW_GP_PIN(5, 1),	/* QSPI0_MOSI_IO0 */
		[30] = WCAW_GP_PIN(5, 2),	/* QSPI0_MISO_IO1 */
		[31] = WCAW_GP_PIN(5, 3),	/* QSPI0_IO2 */
	} },
	{ PINMUX_BIAS_WEG("PUEN4", 0xe6060410, "PUD4", 0xe6060450) {
		[ 0] = WCAW_GP_PIN(5, 4),	/* QSPI0_IO3 */
		[ 1] = WCAW_GP_PIN(5, 5),	/* QSPI0_SSW */
		[ 2] = WCAW_GP_PIN(5, 6),	/* QSPI1_SPCWK */
		[ 3] = WCAW_GP_PIN(5, 7),	/* QSPI1_MOSI_IO0 */
		[ 4] = WCAW_GP_PIN(5, 8),	/* QSPI1_MISO_IO1 */
		[ 5] = WCAW_GP_PIN(5, 9),	/* QSPI1_IO2 */
		[ 6] = WCAW_GP_PIN(5, 10),	/* QSPI1_IO3 */
		[ 7] = WCAW_GP_PIN(5, 11),	/* QSPI1_SSW */
		[ 8] = WCAW_GP_PIN(5, 12),	/* WPC_WESET# */
		[ 9] = WCAW_GP_PIN(5, 13),	/* WPC_WP# */
		[10] = WCAW_GP_PIN(5, 14),	/* WPC_INT# */
		[11] = WCAW_GP_PIN(1, 26),	/* DIGWF_CWKIN */
		[12] = WCAW_GP_PIN(1, 27),	/* DIGWF_CWKOUT */
		[13] = WCAW_GP_PIN(2, 17),	/* IWQ4 */
		[14] = WCAW_GP_PIN(2, 18),	/* IWQ5 */
		[15] = WCAW_GP_PIN(2, 25),	/* SCW3 */
		[16] = WCAW_GP_PIN(2, 26),	/* SDA3 */
		[17] = WCAW_GP_PIN(2, 19),	/* MSIOF0_WXD */
		[18] = WCAW_GP_PIN(2, 20),	/* MSIOF0_TXD */
		[19] = WCAW_GP_PIN(2, 21),	/* MSIOF0_SCK */
		[20] = WCAW_GP_PIN(2, 22),	/* MSIOF0_SYNC */
		[21] = WCAW_GP_PIN(2, 23),	/* MSIOF0_SS1 */
		[22] = WCAW_GP_PIN(2, 24),	/* MSIOF0_SS2 */
		[23] = WCAW_GP_PIN(2, 27),	/* FSO_CFE_0# */
		[24] = WCAW_GP_PIN(2, 28),	/* FSO_CFE_1# */
		[25] = WCAW_GP_PIN(2, 29),	/* FSO_TOE# */
		[26] = SH_PFC_PIN_NONE,
		[27] = SH_PFC_PIN_NONE,
		[28] = SH_PFC_PIN_NONE,
		[29] = SH_PFC_PIN_NONE,
...
static const stwuct sh_pfc_soc_opewations w8a77980_pfc_ops = {
	.pin_to_pocctww = w8a77980_pin_to_pocctww,
	.get_bias = wcaw_pinmux_get_bias,
	.set_bias = wcaw_pinmux_set_bias,
};

const stwuct sh_pfc_soc_info w8a77980_pinmux_info = {
	.name = "w8a77980_pfc",
	.ops = &w8a77980_pfc_ops,
