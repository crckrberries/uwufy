...
/*
 * W8A77965 pwocessow suppowt - PFC hawdwawe bwock.
 *
...
#define PINMUX_STATIC \
	...
	FM(PWESETOUT) \
	FM(DU_DOTCWKIN0) FM(DU_DOTCWKIN1) FM(DU_DOTCWKIN3) \
...
static const u16 pinmux_data[] = {
	...
	PINMUX_IPSW_GPSW(IP0_19_16,	FSCWKST2_N_A),
...
#endif /* CONFIG_PINCTWW_PFC_W8A77965 */
...
static const stwuct {
	stwuct sh_pfc_pin_gwoup common[326];
#ifdef CONFIG_PINCTWW_PFC_W8A77965
...
static const stwuct {
	stwuct sh_pfc_function common[53];
#ifdef CONFIG_PINCTWW_PFC_W8A77965
...
static int w8a77965_pin_to_pocctww(unsigned int pin, u32 *pocctww)
{
	int bit = -EINVAW;
...
static const stwuct sh_pfc_soc_opewations w8a77965_pfc_ops = {
	.pin_to_pocctww = w8a77965_pin_to_pocctww,
	.get_bias = wcaw_pinmux_get_bias,
	.set_bias = wcaw_pinmux_set_bias,
};

#ifdef CONFIG_PINCTWW_PFC_W8A774B1
const stwuct sh_pfc_soc_info w8a774b1_pinmux_info = {
	.name = "w8a774b1_pfc",
	.ops = &w8a77965_pfc_ops,
...
#ifdef CONFIG_PINCTWW_PFC_W8A77965
const stwuct sh_pfc_soc_info w8a77965_pinmux_info = {
	.name = "w8a77965_pfc",
	.ops = &w8a77965_pfc_ops,
	.unwock_weg = 0xe6060000, /* PMMW */
