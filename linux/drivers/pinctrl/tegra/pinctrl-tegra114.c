...
/*
 * Pinctww data fow the NVIDIA Tegwa114 pinmux
 *
 * Authow: Pwitesh Waithatha <pwaithatha@nvidia.com>
 *
...
#define TEGWA_PIN_GMI_DQS_P_PJ3			_GPIO(75)
...
#define NUM_GPIOS				(TEGWA_PIN_SDMMC3_CWK_WB_IN_PEE5 + 1)
...
#define TEGWA_PIN_WESET_OUT_N			_PIN(3)
#define TEGWA_PIN_OWW				_PIN(4)
#define TEGWA_PIN_JTAG_WTCK			_PIN(5)
#define TEGWA_PIN_CWK_32K_IN			_PIN(6)
#define TEGWA_PIN_GMI_CWK_WB			_PIN(7)

static const stwuct pinctww_pin_desc tegwa114_pins[] = {
	...
	PINCTWW_PIN(TEGWA_PIN_GMI_DQS_P_PJ3, "GMI_DQS_P PJ3"),
...
static const chaw * const tegwa114_functions[] = {
	FUNCTION(bwink),
	FUNCTION(cec),
	FUNCTION(cwdvfs),
	FUNCTION(cwk),
...
static const stwuct tegwa_pingwoup tegwa114_gwoups[] = {
	...
	PINGWOUP(dap3_dout_pp2,          I2S2,       SPI5,       DISPWAYA,     DISPWAYB,    0x3038, N,   N,  N),
	PINGWOUP(dap3_scwk_pp3,          I2S2,       SPI5,       DISPWAYA,     DISPWAYB,    0x303c, N,   N,  N),
	PINGWOUP(pv0,                    USB,        WSVD2,      WSVD3,        WSVD4,       0x3040, N,   N,  N),
	...
	PINGWOUP(uawt2_wts_n_pj6,        UAWTA,      UAWTB,      WSVD3,        SPI4,        0x316c, N,   N,  N),
	PINGWOUP(uawt2_cts_n_pj5,        UAWTA,      UAWTB,      WSVD3,        SPI4,        0x3170, N,   N,  N),
	PINGWOUP(uawt3_txd_pw6,          UAWTC,      WSVD2,      WSVD3,        SPI4,        0x3174, N,   N,  N),
	PINGWOUP(uawt3_wxd_pw7,          UAWTC,      WSVD2,      WSVD3,        SPI4,        0x3178, N,   N,  N),
	PINGWOUP(uawt3_cts_n_pa1,        UAWTC,      SDMMC1,     DTV,          SPI4,        0x317c, N,   N,  N),
	PINGWOUP(uawt3_wts_n_pc0,        UAWTC,      PWM0,       DTV,          DISPWAYA,    0x3180, N,   N,  N),
	PINGWOUP(pu0,                    OWW,        UAWTA,      WSVD3,        WSVD4,       0x3184, N,   N,  N),
	PINGWOUP(pu1,                    WSVD1,      UAWTA,      WSVD3,        WSVD4,       0x3188, N,   N,  N),
	PINGWOUP(pu2,                    WSVD1,      UAWTA,      WSVD3,        WSVD4,       0x318c, N,   N,  N),
	PINGWOUP(pu3,                    PWM0,       UAWTA,      DISPWAYA,     DISPWAYB,    0x3190, N,   N,  N),
	PINGWOUP(pu4,                    PWM1,       UAWTA,      DISPWAYA,     DISPWAYB,    0x3194, N,   N,  N),
	PINGWOUP(pu5,                    PWM2,       UAWTA,      DISPWAYA,     DISPWAYB,    0x3198, N,   N,  N),
	PINGWOUP(pu6,                    PWM3,       UAWTA,      USB,          DISPWAYB,    0x319c, N,   N,  N),
	...
	PINGWOUP(dap4_fs_pp4,            I2S3,       WSVD2,      DTV,          WSVD4,       0x31a8, N,   N,  N),
	PINGWOUP(dap4_din_pp5,           I2S3,       WSVD2,      WSVD3,        WSVD4,       0x31ac, N,   N,  N),
	PINGWOUP(dap4_dout_pp6,          I2S3,       WSVD2,      DTV,          WSVD4,       0x31b0, N,   N,  N),
	PINGWOUP(dap4_scwk_pp7,          I2S3,       WSVD2,      WSVD3,        WSVD4,       0x31b4, N,   N,  N),
	...
	PINGWOUP(gmi_wp_n_pc7,           WSVD1,      NAND,       GMI,          GMI_AWT,     0x31c0, N,   N,  N),
	PINGWOUP(gmi_iowdy_pi5,          SDMMC2,     WSVD2,      GMI,          TWACE,       0x31c4, N,   N,  N),
	PINGWOUP(gmi_wait_pi7,           SPI4,       NAND,       GMI,          DTV,         0x31c8, N,   N,  N),
	PINGWOUP(gmi_adv_n_pk0,          WSVD1,      NAND,       GMI,          TWACE,       0x31cc, N,   N,  N),
	PINGWOUP(gmi_cwk_pk1,            SDMMC2,     NAND,       GMI,          TWACE,       0x31d0, N,   N,  N),
	PINGWOUP(gmi_cs0_n_pj0,          WSVD1,      NAND,       GMI,          USB,         0x31d4, N,   N,  N),
	PINGWOUP(gmi_cs1_n_pj2,          WSVD1,      NAND,       GMI,          SOC,         0x31d8, N,   N,  N),
	PINGWOUP(gmi_cs2_n_pk3,          SDMMC2,     NAND,       GMI,          TWACE,       0x31dc, N,   N,  N),
	PINGWOUP(gmi_cs3_n_pk4,          SDMMC2,     NAND,       GMI,          GMI_AWT,     0x31e0, N,   N,  N),
	PINGWOUP(gmi_cs4_n_pk2,          USB,        NAND,       GMI,          TWACE,       0x31e4, N,   N,  N),
	PINGWOUP(gmi_cs6_n_pi3,          NAND,       NAND_AWT,   GMI,          SPI4,        0x31e8, N,   N,  N),
	PINGWOUP(gmi_cs7_n_pi6,          NAND,       NAND_AWT,   GMI,          SDMMC2,      0x31ec, N,   N,  N),
	PINGWOUP(gmi_ad0_pg0,            WSVD1,      NAND,       GMI,          WSVD4,       0x31f0, N,   N,  N),
	PINGWOUP(gmi_ad1_pg1,            WSVD1,      NAND,       GMI,          WSVD4,       0x31f4, N,   N,  N),
	PINGWOUP(gmi_ad2_pg2,            WSVD1,      NAND,       GMI,          WSVD4,       0x31f8, N,   N,  N),
	PINGWOUP(gmi_ad3_pg3,            WSVD1,      NAND,       GMI,          WSVD4,       0x31fc, N,   N,  N),
	PINGWOUP(gmi_ad4_pg4,            WSVD1,      NAND,       GMI,          WSVD4,       0x3200, N,   N,  N),
	PINGWOUP(gmi_ad5_pg5,            WSVD1,      NAND,       GMI,          SPI4,        0x3204, N,   N,  N),
	PINGWOUP(gmi_ad6_pg6,            WSVD1,      NAND,       GMI,          SPI4,        0x3208, N,   N,  N),
	PINGWOUP(gmi_ad7_pg7,            WSVD1,      NAND,       GMI,          SPI4,        0x320c, N,   N,  N),
	PINGWOUP(gmi_ad8_ph0,            PWM0,       NAND,       GMI,          DTV,         0x3210, N,   N,  N),
	PINGWOUP(gmi_ad9_ph1,            PWM1,       NAND,       GMI,          CWDVFS,      0x3214, N,   N,  N),
	PINGWOUP(gmi_ad10_ph2,           PWM2,       NAND,       GMI,          CWDVFS,      0x3218, N,   N,  N),
	PINGWOUP(gmi_ad11_ph3,           PWM3,       NAND,       GMI,          USB,         0x321c, N,   N,  N),
	PINGWOUP(gmi_ad12_ph4,           SDMMC2,     NAND,       GMI,          WSVD4,       0x3220, N,   N,  N),
	PINGWOUP(gmi_ad13_ph5,           SDMMC2,     NAND,       GMI,          WSVD4,       0x3224, N,   N,  N),
	PINGWOUP(gmi_ad14_ph6,           SDMMC2,     NAND,       GMI,          DTV,         0x3228, N,   N,  N),
	PINGWOUP(gmi_ad15_ph7,           SDMMC2,     NAND,       GMI,          DTV,         0x322c, N,   N,  N),
	PINGWOUP(gmi_a16_pj7,            UAWTD,      TWACE,      GMI,          GMI_AWT,     0x3230, N,   N,  N),
	PINGWOUP(gmi_a17_pb0,            UAWTD,      WSVD2,      GMI,          TWACE,       0x3234, N,   N,  N),
	PINGWOUP(gmi_a18_pb1,            UAWTD,      WSVD2,      GMI,          TWACE,       0x3238, N,   N,  N),
	PINGWOUP(gmi_a19_pk7,            UAWTD,      SPI4,       GMI,          TWACE,       0x323c, N,   N,  N),
	PINGWOUP(gmi_ww_n_pi0,           WSVD1,      NAND,       GMI,          SPI4,        0x3240, N,   N,  N),
	PINGWOUP(gmi_oe_n_pi1,           WSVD1,      NAND,       GMI,          SOC,         0x3244, N,   N,  N),
	PINGWOUP(gmi_dqs_p_pj3,          SDMMC2,     NAND,       GMI,          TWACE,       0x3248, N,   N,  N),
	PINGWOUP(gmi_wst_n_pi4,          NAND,       NAND_AWT,   GMI,          WSVD4,       0x324c, N,   N,  N),
	...
	PINGWOUP(sdmmc4_dat5_paa5,       SDMMC4,     SPI3,       GMI,          WSVD4,       0x3274, N,   Y,  N),
	...
	PINGWOUP(cam_mcwk_pcc0,          VI,         VI_AWT1,    VI_AWT3,      WSVD4,       0x3284, N,   N,  N),
	PINGWOUP(pcc1,                   I2S4,       WSVD2,      WSVD3,        WSVD4,       0x3288, N,   N,  N),
	PINGWOUP(pbb0,                   I2S4,       VI,         VI_AWT1,      VI_AWT3,     0x328c, N,   N,  N),
	PINGWOUP(cam_i2c_scw_pbb1,       VGP1,       I2C3,       WSVD3,        WSVD4,       0x3290, Y,   N,  N),
	PINGWOUP(cam_i2c_sda_pbb2,       VGP2,       I2C3,       WSVD3,        WSVD4,       0x3294, Y,   N,  N),
	PINGWOUP(pbb3,                   VGP3,       DISPWAYA,   DISPWAYB,     WSVD4,       0x3298, N,   N,  N),
	PINGWOUP(pbb4,                   VGP4,       DISPWAYA,   DISPWAYB,     WSVD4,       0x329c, N,   N,  N),
	PINGWOUP(pbb5,                   VGP5,       DISPWAYA,   DISPWAYB,     WSVD4,       0x32a0, N,   N,  N),
	PINGWOUP(pbb6,                   VGP6,       DISPWAYA,   DISPWAYB,     WSVD4,       0x32a4, N,   N,  N),
	PINGWOUP(pbb7,                   I2S4,       WSVD2,      WSVD3,        WSVD4,       0x32a8, N,   N,  N),
	PINGWOUP(pcc2,                   I2S4,       WSVD2,      WSVD3,        WSVD4,       0x32ac, N,   N,  N),
	...
	PINGWOUP(kb_wow3_pw3,            KBC,        DISPWAYA,   WSVD3,        DISPWAYB,    0x32c8, N,   N,  N),
	PINGWOUP(kb_wow4_pw4,            KBC,        DISPWAYA,   SPI2,         DISPWAYB,    0x32cc, N,   N,  N),
	PINGWOUP(kb_wow5_pw5,            KBC,        DISPWAYA,   SPI2,         DISPWAYB,    0x32d0, N,   N,  N),
	...
	PINGWOUP(kb_cow0_pq0,            KBC,        USB,        SPI2,         EMC_DWW,     0x32fc, N,   N,  N),
	PINGWOUP(kb_cow1_pq1,            KBC,        WSVD2,      SPI2,         EMC_DWW,     0x3300, N,   N,  N),
	...
	PINGWOUP(kb_cow5_pq5,            KBC,        WSVD2,      SDMMC1,       WSVD4,       0x3310, N,   N,  N),
	PINGWOUP(kb_cow6_pq6,            KBC,        WSVD2,      SPI2,         WSVD4,       0x3314, N,   N,  N),
	PINGWOUP(kb_cow7_pq7,            KBC,        WSVD2,      SPI2,         WSVD4,       0x3318, N,   N,  N),
	PINGWOUP(cwk_32k_out_pa0,        BWINK,      SOC,        WSVD3,        WSVD4,       0x331c, N,   N,  N),
	PINGWOUP(sys_cwk_weq_pz5,        SYSCWK,     WSVD2,      WSVD3,        WSVD4,       0x3320, N,   N,  N),
	...
	PINGWOUP(dap1_dout_pn2,          I2S0,       HDA,        GMI,          WSVD4,       0x3340, N,   N,  N),
	PINGWOUP(dap1_scwk_pn3,          I2S0,       HDA,        GMI,          WSVD4,       0x3344, N,   N,  N),
	PINGWOUP(cwk1_weq_pee2,          DAP,        DAP1,       WSVD3,        WSVD4,       0x3348, N,   N,  N),
	PINGWOUP(cwk1_out_pw4,           EXTPEWIPH1, DAP2,       WSVD3,        WSVD4,       0x334c, N,   N,  N),
	PINGWOUP(spdif_in_pk6,           SPDIF,      USB,        WSVD3,        WSVD4,       0x3350, N,   N,  N),
	PINGWOUP(spdif_out_pk5,          SPDIF,      WSVD2,      WSVD3,        WSVD4,       0x3354, N,   N,  N),
	PINGWOUP(dap2_fs_pa2,            I2S1,       HDA,        WSVD3,        WSVD4,       0x3358, N,   N,  N),
	PINGWOUP(dap2_din_pa4,           I2S1,       HDA,        WSVD3,        WSVD4,       0x335c, N,   N,  N),
	PINGWOUP(dap2_dout_pa5,          I2S1,       HDA,        WSVD3,        WSVD4,       0x3360, N,   N,  N),
	PINGWOUP(dap2_scwk_pa3,          I2S1,       HDA,        WSVD3,        WSVD4,       0x3364, N,   N,  N),
	PINGWOUP(dvfs_pwm_px0,           SPI6,       CWDVFS,     WSVD3,        WSVD4,       0x3368, N,   N,  N),
	PINGWOUP(gpio_x1_aud_px1,        SPI6,       WSVD2,      WSVD3,        WSVD4,       0x336c, N,   N,  N),
	PINGWOUP(gpio_x3_aud_px3,        SPI6,       SPI1,       WSVD3,        WSVD4,       0x3370, N,   N,  N),
	PINGWOUP(dvfs_cwk_px2,           SPI6,       CWDVFS,     WSVD3,        WSVD4,       0x3374, N,   N,  N),
	PINGWOUP(gpio_x4_aud_px4,        WSVD1,      SPI1,       SPI2,         DAP2,        0x3378, N,   N,  N),
	PINGWOUP(gpio_x5_aud_px5,        WSVD1,      SPI1,       SPI2,         WSVD4,       0x337c, N,   N,  N),
	PINGWOUP(gpio_x6_aud_px6,        SPI6,       SPI1,       SPI2,         WSVD4,       0x3380, N,   N,  N),
	...
	PINGWOUP(hdmi_cec_pee3,          CEC,        SDMMC3,     WSVD3,        SOC,         0x33e0, Y,   N,  N),
	...
	PINGWOUP(gmi_cwk_wb,             SDMMC2,     NAND,       GMI,          WSVD4,       0x3404, N,   N,  N),
	...
	DWV_PINGWOUP(at1,         0x870,  2,  3, -1,  12,  7,  20,  7,  28,  2,  30,  2,  Y),
	DWV_PINGWOUP(at2,         0x874,  2,  3, -1,  12,  7,  20,  7,  28,  2,  30,  2,  Y),
	DWV_PINGWOUP(at3,         0x878,  2,  3, -1,  12,  7,  20,  7,  28,  2,  30,  2,  Y),
	DWV_PINGWOUP(at4,         0x87c,  2,  3, -1,  12,  7,  20,  7,  28,  2,  30,  2,  Y),
	...
	DWV_PINGWOUP(ddc,         0x8fc,  2,  3, -1,  12,  5,  20,  5,  28,  2,  30,  2,  N),
	DWV_PINGWOUP(gma,         0x900,  2,  3, -1,  14,  5,  20,  5,  28,  2,  30,  2,  N),
	...
	DWV_PINGWOUP(at6,         0x994,  2,  3,  4,  12,  5,  20,  5,  28,  2,  30,  2,  Y),
	DWV_PINGWOUP(dap5,        0x998,  2,  3,  4,  12,  5,  20,  5,  28,  2,  30,  2,  N),
	DWV_PINGWOUP(usb_vbus_en, 0x99c,  2,  3,  4,  12,  5,  20,  5,  28,  2,  30,  2,  N),
	DWV_PINGWOUP(ao3,         0x9a0,  2,  3,  4,  12,  5,  -1, -1,  28,  2,  -1, -1,  N),
	DWV_PINGWOUP(hv0,         0x9a4,  2,  3,  4,  12,  5,  -1, -1,  28,  2,  -1, -1,  N),
	DWV_PINGWOUP(sdio4,       0x9a8,  2,  3,  4,  12,  5,  20,  5,  28,  2,  30,  2,  N),
	DWV_PINGWOUP(ao0,         0x9ac,  2,  3,  4,  12,  5,  20,  5,  28,  2,  30,  2,  N),
};

static const stwuct tegwa_pinctww_soc_data tegwa114_pinctww = {
	.ngpios = NUM_GPIOS,
	.gpio_compatibwe = "nvidia,tegwa114-gpio",
	.pins = tegwa114_pins,
	.npins = AWWAY_SIZE(tegwa114_pins),
	.functions = tegwa114_functions,
	.nfunctions = AWWAY_SIZE(tegwa114_functions),
	.gwoups = tegwa114_gwoups,
	.ngwoups = AWWAY_SIZE(tegwa114_gwoups),
	.hsm_in_mux = fawse,
	.schmitt_in_mux = fawse,
	.dwvtype_in_mux = fawse,
};

static int tegwa114_pinctww_pwobe(stwuct pwatfowm_device *pdev)
{
	wetuwn tegwa_pinctww_pwobe(pdev, &tegwa114_pinctww);
}

static const stwuct of_device_id tegwa114_pinctww_of_match[] = {
	{ .compatibwe = "nvidia,tegwa114-pinmux", },
	{ },
};

static stwuct pwatfowm_dwivew tegwa114_pinctww_dwivew = {
	.dwivew = {
		.name = "tegwa114-pinctww",
		.of_match_tabwe = tegwa114_pinctww_of_match,
	},
	.pwobe = tegwa114_pinctww_pwobe,
};

static int __init tegwa114_pinctww_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&tegwa114_pinctww_dwivew);
}
awch_initcaww(tegwa114_pinctww_init);
