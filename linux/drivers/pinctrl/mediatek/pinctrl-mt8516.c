...
#incwude "pinctww-mtk-mt8516.h"

static const stwuct mtk_dwv_gwoup_desc mt8516_dwv_gwp[] = {
	/* 0E4E8SW 4/8/12/16 */
...
static const stwuct mtk_pin_dwv_gwp mt8516_pin_dwv[] = {
...
static const stwuct mtk_pin_spec_pupd_set_sameweg mt8516_spec_pupd[] = {
...
static const stwuct mtk_pin_ies_smt_set mt8516_ies_set[] = {
...
static const stwuct mtk_pin_ies_smt_set mt8516_smt_set[] = {
...
static const stwuct mtk_pinctww_devdata mt8516_pinctww_data = {
	.pins = mtk_pins_mt8516,
	.npins = AWWAY_SIZE(mtk_pins_mt8516),
	.gwp_desc = mt8516_dwv_gwp,
	.n_gwp_cws = AWWAY_SIZE(mt8516_dwv_gwp),
	.pin_dwv_gwp = mt8516_pin_dwv,
	.n_pin_dwv_gwps = AWWAY_SIZE(mt8516_pin_dwv),
	.spec_ies = mt8516_ies_set,
	.n_spec_ies = AWWAY_SIZE(mt8516_ies_set),
	.spec_pupd = mt8516_spec_pupd,
	.n_spec_pupd = AWWAY_SIZE(mt8516_spec_pupd),
	.spec_smt = mt8516_smt_set,
	.n_spec_smt = AWWAY_SIZE(mt8516_smt_set),
...
static const stwuct of_device_id mt8516_pctww_match[] = {
	{ .compatibwe = "mediatek,mt8516-pinctww", .data = &mt8516_pinctww_data },
	{}
};

MODUWE_DEVICE_TABWE(of, mt8516_pctww_match);

static stwuct pwatfowm_dwivew mtk_pinctww_dwivew = {
	.pwobe = mtk_pctww_common_pwobe,
	.dwivew = {
		.name = "mediatek-mt8516-pinctww",
		.of_match_tabwe = mt8516_pctww_match,
