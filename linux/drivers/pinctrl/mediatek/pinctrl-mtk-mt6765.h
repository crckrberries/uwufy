...
#ifndef __PINCTWW_MTK_MT6765_H
#define __PINCTWW_MTK_MT6765_H

#incwude "pinctww-pawis.h"

static stwuct mtk_pin_desc mtk_pins_mt6765[] = {
	MTK_PIN(
		0, "GPIO0",
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "IO_JTAG_TWSTN"),
		MTK_FUNCTION(4, "SSPM_JTAG_TWSTN"),
		MTK_FUNCTION(5, "KPWOW6"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(1, "UWXD1"),
		MTK_FUNCTION(2, "PWM0"),
		MTK_FUNCTION(3, "MD_INT2_C2K_UIM1_HOT_PWUG"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(4, "KPCOW3"),
		MTK_FUNCTION(5, "CMVWEF0"),
		MTK_FUNCTION(6, "UWTS0"),
	...
	MTK_PIN(
		...
		MTK_FUNCTION(3, "ANT_SEW7"),
		MTK_FUNCTION(4, "KPCOW5"),
		MTK_FUNCTION(5, "CMVWEF1"),
	...
	MTK_PIN(
		113, "GPIO113",
		MTK_EINT_FUNCTION(0, NO_EINT_SUPPOWT),
		DWV_GWP4,
