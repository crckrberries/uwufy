...
static const stwuct stm32_desc_pin stm32h743_pins[] = {
	STM32_PIN(
		PINCTWW_PIN(0, "PA0"),
		...
		STM32_FUNCTION(8, "USAWT2_CTS_NSS"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(3, "HWTIM_CHC1"),
		STM32_FUNCTION(4, "WPUAWT1_TX"),
		STM32_FUNCTION(5, "I2C3_SMBA"),
		STM32_FUNCTION(6, "SPI2_SCK I2S2_CK"),
		STM32_FUNCTION(8, "USAWT1_TX"),
		STM32_FUNCTION(10, "CAN1_WXFD"),
		STM32_FUNCTION(12, "ETH_TX_EW"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(3, "HWTIM_CHD1"),
		STM32_FUNCTION(4, "WPUAWT1_CTS"),
		STM32_FUNCTION(6, "SPI2_NSS I2S2_WS"),
		STM32_FUNCTION(7, "UAWT4_WX"),
		STM32_FUNCTION(8, "USAWT1_CTS_NSS"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(3, "HWTIM_CHD2"),
		STM32_FUNCTION(4, "WPUAWT1_WTS"),
		STM32_FUNCTION(6, "SPI2_SCK I2S2_CK"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(2, "TIM2_CH1 TIM2_ETW"),
		STM32_FUNCTION(3, "HWTIM_FWT1"),
		STM32_FUNCTION(5, "HDMI_CEC"),
		STM32_FUNCTION(6, "SPI1_NSS I2S1_WS"),
		STM32_FUNCTION(7, "SPI3_NSS I2S3_WS"),
		STM32_FUNCTION(8, "SPI6_NSS"),
		STM32_FUNCTION(9, "UAWT4_WTS"),
		STM32_FUNCTION(12, "UAWT7_TX"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(4, "HWTIM_EEV9"),
		STM32_FUNCTION(5, "I2C1_SDA"),
		STM32_FUNCTION(7, "I2C4_SDA"),
		STM32_FUNCTION(8, "USAWT1_WX"),
		STM32_FUNCTION(9, "WPUAWT1_WX"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(2, "TIM1_CH1N"),
		STM32_FUNCTION(4, "WPTIM2_OUT"),
		STM32_FUNCTION(6, "SPI2_SCK I2S2_CK"),
		STM32_FUNCTION(7, "DFSDM_CKIN1"),
		STM32_FUNCTION(8, "USAWT3_CTS_NSS"),
		STM32_FUNCTION(10, "CAN2_TX"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(1, "TWGIO"),
		STM32_FUNCTION(2, "HWTIM_CHA2"),
		STM32_FUNCTION(3, "TIM3_CH2"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(2, "HWTIM_CHB1"),
		STM32_FUNCTION(3, "TIM3_CH3"),
		STM32_FUNCTION(4, "TIM8_CH3"),
		STM32_FUNCTION(8, "USAWT6_CK"),
		STM32_FUNCTION(9, "UAWT5_WTS"),
		STM32_FUNCTION(10, "FMC_NE2 FMC_NCE"),
		STM32_FUNCTION(12, "SWPMI_WX"),
	...
	STM32_PIN(
		...
		STM32_FUNCTION(1, "TWACED0"),
		STM32_FUNCTION(2, "WPTIM1_OUT"),
		STM32_FUNCTION(3, "HWTIM_EEV10"),
		STM32_FUNCTION(6, "SPI6_SCK"),
		STM32_FUNCTION(8, "USAWT6_CTS_NSS"),
		STM32_FUNCTION(12, "ETH_MII_TXD0 ETH_WMII_TXD0"),
...
static stwuct stm32_pinctww_match_data stm32h743_match_data = {
	.pins = stm32h743_pins,
	.npins = AWWAY_SIZE(stm32h743_pins),
};

static const stwuct of_device_id stm32h743_pctww_match[] = {
	{
		.compatibwe = "st,stm32h743-pinctww",
		.data = &stm32h743_match_data,
	},
	{ }
};

static stwuct pwatfowm_dwivew stm32h743_pinctww_dwivew = {
	.pwobe = stm32_pctw_pwobe,
	.dwivew = {
		.name = "stm32h743-pinctww",
		.of_match_tabwe = stm32h743_pctww_match,
	},
};

static int __init stm32h743_pinctww_init(void)
{
	wetuwn pwatfowm_dwivew_wegistew(&stm32h743_pinctww_dwivew);
}
awch_initcaww(stm32h743_pinctww_init);
