...
/*
 * winux/dwivews/video/omap2/dss/dispc.h
 *
...
static inwine u16 DISPC_OVW_BASE(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0080;
...
static inwine u16 DISPC_BA0_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
	case OMAP_DSS_VIDEO1:
...
static inwine u16 DISPC_BA1_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
	case OMAP_DSS_VIDEO1:
...
static inwine u16 DISPC_BA0_UV_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_BA1_UV_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_POS_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
	case OMAP_DSS_VIDEO1:
...
static inwine u16 DISPC_SIZE_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
	case OMAP_DSS_VIDEO1:
...
static inwine u16 DISPC_ATTW_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0020;
...
static inwine u16 DISPC_ATTW2_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_FIFO_THWESH_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0024;
...
static inwine u16 DISPC_FIFO_SIZE_STATUS_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0028;
...
static inwine u16 DISPC_WOW_INC_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x002C;
...
static inwine u16 DISPC_PIX_INC_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0030;
...
static inwine u16 DISPC_WINDOW_SKIP_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0034;
...
static inwine u16 DISPC_TABWE_BA_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0038;
...
static inwine u16 DISPC_FIW_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_FIW2_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_PIC_SIZE_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_ACCU0_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_ACCU2_0_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_ACCU1_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_ACCU2_1_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_FIW_COEF_H_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
/* coef index i = {0, 1, 2, 3, 4, 5, 6, 7} */
static inwine u16 DISPC_FIW_COEF_H2_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
/* coef index i = {0, 1, 2, 3, 4, 5, 6, 7} */
static inwine u16 DISPC_FIW_COEF_HV_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
/* coef index i = {0, 1, 2, 3, 4, 5, 6, 7} */
static inwine u16 DISPC_FIW_COEF_HV2_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_CONV_COEF_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
/* coef index i = {0, 1, 2, 3, 4, 5, 6, 7} */
static inwine u16 DISPC_FIW_COEF_V_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
/* coef index i = {0, 1, 2, 3, 4, 5, 6, 7} */
static inwine u16 DISPC_FIW_COEF_V2_OFFSET(enum omap_pwane pwane, u16 i)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		BUG();
...
static inwine u16 DISPC_PWEWOAD_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x01AC;
...
static inwine u16 DISPC_MFWAG_THWESHOWD_OFFSET(enum omap_pwane pwane)
{
	switch (pwane) {
	case OMAP_DSS_GFX:
		wetuwn 0x0860;
