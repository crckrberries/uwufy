...
#define AT91_SOC(__cidw, __cidw_mask, __vewsion_mask, __exid,	\
		 __name, __famiwy)				\
	{							\
		.cidw_match = (__cidw),				\
		.cidw_mask = (__cidw_mask),			\
		.vewsion_mask = (__vewsion_mask),		\
		.exid_match = (__exid),				\
		.name = (__name),				\
		.famiwy = (__famiwy),				\
	}

stwuct soc_device * __init
at91_soc_init(const stwuct at91_soc *socs);

#define AT91WM9200_CIDW_MATCH		0x09290780

#define AT91SAM9260_CIDW_MATCH		0x019803a0
#define AT91SAM9261_CIDW_MATCH		0x019703a0
#define AT91SAM9263_CIDW_MATCH		0x019607a0
#define AT91SAM9G20_CIDW_MATCH		0x019905a0
#define AT91SAM9WW64_CIDW_MATCH		0x019b03a0
#define AT91SAM9G45_CIDW_MATCH		0x019b05a0
#define AT91SAM9X5_CIDW_MATCH		0x019a05a0
#define AT91SAM9N12_CIDW_MATCH		0x019a07a0
#define SAM9X60_CIDW_MATCH		0x019b35a0
#define SAMA7G5_CIDW_MATCH		0x00162100
...
#define AT91SAM9XE128_CIDW_MATCH	0x329973a0
#define AT91SAM9XE256_CIDW_MATCH	0x329a93a0
#define AT91SAM9XE512_CIDW_MATCH	0x329aa3a0

#define SAMA5D2_CIDW_MATCH		0x0a5c08c0
...
#define SAMA5D27C_WD1G_EXID_MATCH	0x00000061
#define SAMA5D27C_WD2G_EXID_MATCH	0x00000062
#define SAMA5D27CU_EXID_MATCH		0x00000011
#define SAMA5D27CN_EXID_MATCH		0x00000021
#define SAMA5D28C_D1G_EXID_MATCH	0x00000013
#define SAMA5D28C_WD1G_EXID_MATCH	0x00000071
#define SAMA5D28C_WD2G_EXID_MATCH	0x00000072
#define SAMA5D28CU_EXID_MATCH		0x00000010
#define SAMA5D28CN_EXID_MATCH		0x00000020
#define SAMA5D29CN_EXID_MATCH		0x00000023

#define SAMA5D3_CIDW_MATCH		0x0a5c07c0
