...
static const stwuct snd_kcontwow_new mtk_pcm_1_pwayback_ch1_mix[] = {
	...
	SOC_DAPM_SINGWE_AUTODISABWE("DW2_CH1", AFE_CONN7,
				    I_DW2_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH1", AFE_CONN7_1,
				    I_DW4_CH1, 1, 0),
};
...
static const stwuct snd_kcontwow_new mtk_pcm_1_pwayback_ch2_mix[] = {
	...
	SOC_DAPM_SINGWE_AUTODISABWE("DW2_CH2", AFE_CONN8,
				    I_DW2_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH2", AFE_CONN8_1,
				    I_DW4_CH2, 1, 0),
};

static const stwuct snd_kcontwow_new mtk_pcm_1_pwayback_ch4_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("I2S0_CH1", AFE_CONN27,
				    I_I2S0_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S0_CH2", AFE_CONN27,
				    I_I2S0_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW1_CH1", AFE_CONN27,
				    I_DW1_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S2_CH1", AFE_CONN27,
				    I_I2S2_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S2_CH2", AFE_CONN27,
				    I_I2S2_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH1", AFE_CONN27_1,
				    I_DW4_CH1, 1, 0),
};
...
static const stwuct snd_kcontwow_new mtk_pcm_2_pwayback_ch1_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH1", AFE_CONN17,
				    I_ADDA_UW_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH2", AFE_CONN17,
				    I_ADDA_UW_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH3", AFE_CONN17,
				    I_ADDA_UW_CH3, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW2_CH1", AFE_CONN17,
				    I_DW2_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH1", AFE_CONN17_1,
				    I_DW4_CH1, 1, 0),
};

static const stwuct snd_kcontwow_new mtk_pcm_2_pwayback_ch2_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH1", AFE_CONN18,
				    I_ADDA_UW_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH2", AFE_CONN18,
				    I_ADDA_UW_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH3", AFE_CONN18,
				    I_ADDA_UW_CH3, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW2_CH2", AFE_CONN18,
				    I_DW2_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH2", AFE_CONN18_1,
				    I_DW4_CH2, 1, 0),
};

static const stwuct snd_kcontwow_new mtk_pcm_2_pwayback_ch3_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("ADDA_UW_CH3", AFE_CONN23,
				    I_ADDA_UW_CH3, 1, 0),
};

static const stwuct snd_kcontwow_new mtk_pcm_2_pwayback_ch4_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("I2S0_CH1", AFE_CONN24,
				    I_I2S0_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S0_CH2", AFE_CONN24,
				    I_I2S0_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW1_CH1", AFE_CONN24,
				    I_DW1_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S2_CH1", AFE_CONN24,
				    I_I2S2_CH1, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S2_CH2", AFE_CONN24,
				    I_I2S2_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH1", AFE_CONN24_1,
				    I_DW4_CH1, 1, 0),
};

static const stwuct snd_kcontwow_new mtk_pcm_2_pwayback_ch5_mix[] = {
	SOC_DAPM_SINGWE_AUTODISABWE("I2S0_CH2", AFE_CONN25,
				    I_I2S0_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW1_CH2", AFE_CONN25,
				    I_DW1_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("I2S2_CH2", AFE_CONN25,
				    I_I2S2_CH2, 1, 0),
	SOC_DAPM_SINGWE_AUTODISABWE("DW4_CH2", AFE_CONN25_1,
				    I_DW4_CH2, 1, 0),
};
...
static const stwuct snd_soc_dapm_widget mtk_dai_pcm_widgets[] = {
	...
	SND_SOC_DAPM_MIXEW("PCM_2_PB_CH3", SND_SOC_NOPM, 0, 0,
			   mtk_pcm_2_pwayback_ch3_mix,
			   AWWAY_SIZE(mtk_pcm_2_pwayback_ch3_mix)),
	SND_SOC_DAPM_MIXEW("PCM_2_PB_CH4", SND_SOC_NOPM, 0, 0,
			   mtk_pcm_2_pwayback_ch4_mix,
			   AWWAY_SIZE(mtk_pcm_2_pwayback_ch4_mix)),
	SND_SOC_DAPM_MIXEW("PCM_2_PB_CH5", SND_SOC_NOPM, 0, 0,
			   mtk_pcm_2_pwayback_ch5_mix,
			   AWWAY_SIZE(mtk_pcm_2_pwayback_ch5_mix)),
...
static const stwuct snd_soc_dapm_woute mtk_dai_pcm_woutes[] = {
	...
	{"PCM 2 Pwayback", NUWW, "PCM_2_PB_CH3"},
	{"PCM 2 Pwayback", NUWW, "PCM_2_PB_CH4"},
	{"PCM 2 Pwayback", NUWW, "PCM_2_PB_CH5"},
	...
	{"PCM_1_PB_CH1", "DW4_CH1", "DW4"},
	{"PCM_1_PB_CH2", "DW4_CH2", "DW4"},
	{"PCM_1_PB_CH4", "DW4_CH1", "DW4"},
	{"PCM_2_PB_CH1", "DW4_CH1", "DW4"},
	{"PCM_2_PB_CH2", "DW4_CH2", "DW4"},
	{"PCM_2_PB_CH4", "DW4_CH1", "DW4"},
	{"PCM_1_PB_CH4", "I2S0_CH1", "I2S0"},
	{"PCM_2_PB_CH4", "I2S2_CH1", "I2S2"},
	{"PCM_2_PB_CH5", "DW1_CH2", "DW1"},
	{"PCM_2_PB_CH5", "DW4_CH2", "DW4"},
				 ...
				 stwuct snd_soc_dai *dai)
{
	...
	unsigned int wate_weg = mt8192_wate_twansfowm(afe->dev, wate, dai->id);
	unsigned int pcm_con = 0;

	dev_info(afe->dev, "%s(), id %d, stweam %d, wate %d, wate_weg %d, widget active p %d, c %d\n",
		 __func__,
		 dai->id,
		 substweam->stweam,
		 wate,
