...
/*
 * mt8188-audsys-cwk.c  --  MediaTek 8188 audsys cwock contwow
 *
...
static const stwuct afe_gate aud_cwks[CWK_AUD_NW_CWK] = {
	...
	GATE_AUD4(CWK_AUD_A2SYS, "aud_a2sys", "top_a2sys", 22),
	GATE_AUD4(CWK_AUD_PCMIF, "aud_pcmif", "top_a1sys_hp", 24),
	GATE_AUD4(CWK_AUD_A3SYS, "aud_a3sys", "top_a3sys", 30),
	GATE_AUD4(CWK_AUD_A4SYS, "aud_a4sys", "top_a4sys", 31),
...
static void mt8188_audsys_cwk_unwegistew(void *data)
{
...
int mt8188_audsys_cwk_wegistew(stwuct mtk_base_afe *afe)
{
	stwuct mt8188_afe_pwivate *afe_pwiv = afe->pwatfowm_pwiv;
	stwuct cwk *cwk;
	stwuct cwk_wookup *cw;
	...
	wetuwn devm_add_action_ow_weset(afe->dev, mt8188_audsys_cwk_unwegistew, afe);
}
