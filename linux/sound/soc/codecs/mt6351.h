...
/*
 * mt6351.h  --  mt6351 AWSA SoC audio codec dwivew
 *
...
#define MT6351_AFE_UW_DW_CON0               (0x2000 + 0x0000)
#define MT6351_AFE_DW_SWC2_CON0_H           (0x2000 + 0x0002)
#define MT6351_AFE_DW_SWC2_CON0_W           (0x2000 + 0x0004)
#define MT6351_AFE_DW_SDM_CON0              (0x2000 + 0x0006)
#define MT6351_AFE_DW_SDM_CON1              (0x2000 + 0x0008)
#define MT6351_AFE_UW_SWC_CON0_H            (0x2000 + 0x000a)
#define MT6351_AFE_UW_SWC_CON0_W            (0x2000 + 0x000c)
#define MT6351_AFE_UW_SWC_CON1_H            (0x2000 + 0x000e)
#define MT6351_AFE_UW_SWC_CON1_W            (0x2000 + 0x0010)
#define MT6351_AFE_TOP_CON0                 (0x2000 + 0x0012)
#define MT6351_AUDIO_TOP_CON0               (0x2000 + 0x0014)
#define MT6351_AFE_DW_SWC_MON0              (0x2000 + 0x0016)
#define MT6351_AFE_DW_SDM_TEST0             (0x2000 + 0x0018)
...
#define MT6351_AFE_UP8X_FIFO_WOG_MON0       (0x2000 + 0x002e)
#define MT6351_AFE_UP8X_FIFO_WOG_MON1       (0x2000 + 0x0030)
#define MT6351_AFE_DW_DC_COMP_CFG0          (0x2000 + 0x0032)
#define MT6351_AFE_DW_DC_COMP_CFG1          (0x2000 + 0x0034)
#define MT6351_AFE_DW_DC_COMP_CFG2          (0x2000 + 0x0036)
...
#define MT6351_AFE_ADDA2_UP8X_FIFO_WOG_MON0 (0x2000 + 0x004c)
#define MT6351_AFE_ADDA2_UP8X_FIFO_WOG_MON1 (0x2000 + 0x004e)
...
#define MT6351_AFE_DCCWK_CFG0               (0x2000 + 0x0090)
#define MT6351_AFE_DCCWK_CFG1               (0x2000 + 0x0092)
...
#define MT6351_TOP_CKPDN_CON0_CWW  0x023E

#define MT6351_TOP_CWKSQ           0x029A
#define MT6351_TOP_CWKSQ_SET       0x029C
#define MT6351_TOP_CWKSQ_CWW       0x029E
...
#define MT6351_WDO_VA18_CON0       0x0A00
#define MT6351_WDO_VA18_CON1       0x0A02
#define MT6351_WDO_VUSB33_CON0     0x0A16
#define MT6351_WDO_VUSB33_CON1     0x0A18
