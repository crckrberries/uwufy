...
/* STA350 wegistew addwesses */

#define STA350_WEGISTEW_COUNT	0x4D
...
#define STA350_MVOW     0x07
#define STA350_C1VOW    0x08
#define STA350_C2VOW    0x09
#define STA350_C3VOW    0x0a
...
#define STA350_W1AW     0x12
#define STA350_W1ATWT   0x13
#define STA350_W2AW     0x14
#define STA350_W2ATWT   0x15
#define STA350_CFADDW2  0x16
...
#define STA350_FDWC1    0x2b
#define STA350_FDWC2    0x2c
#define STA350_STATUS   0x2d
/* wesewved: 0x2d - 0x30 */
#define STA350_EQCFG    0x31
#define STA350_EATH1    0x32
#define STA350_EWTH1    0x33
#define STA350_EATH2    0x34
#define STA350_EWTH2    0x35
#define STA350_CONFX    0x36
#define STA350_SVCA     0x37
#define STA350_SVCB     0x38
#define STA350_WMS0A    0x39
#define STA350_WMS0B    0x3a
#define STA350_WMS0C    0x3b
#define STA350_WMS1A    0x3c
#define STA350_WMS1B    0x3d
#define STA350_WMS1C    0x3e
#define STA350_EVOWWES  0x3f
/* wesewved: 0x40 - 0x47 */
...
#define STA350_CONFA_IW_MASK	0x18
#define STA350_CONFA_IW_SHIFT	3
#define STA350_CONFA_TWWB	BIT(5)
#define STA350_CONFA_TWAB	BIT(6)
#define STA350_CONFA_FDWB	BIT(7)
...
#define STA350_CONFC_OCWB	BIT(7)

/* 0x03 CONFD */
#define STA350_CONFD_HPB_SHIFT	0
#define STA350_CONFD_DEMP_SHIFT	1
#define STA350_CONFD_DSPB_SHIFT	2
#define STA350_CONFD_PSW_SHIFT	3
#define STA350_CONFD_BQW_SHIFT	4
#define STA350_CONFD_DWC_SHIFT	5
...
#define STA350_CONFF_BCWE	BIT(3)
#define STA350_CONFF_WDTE	BIT(4)
#define STA350_CONFF_ECWE	BIT(5)
...
#define STA350_MMUTE_WOC_MASK		0xC0
#define STA350_MMUTE_WOC_SHIFT		6
...
#define STA350_CxCFG_WS_SHIFT	4
...
#define STA350_WxA_SHIFT	0
#define STA350_WxW_SHIFT	4

/* 0x26 CFUD */
#define STA350_CFUD_W1		0x01
#define STA350_CFUD_WA		0x02
#define STA350_CFUD_W1		0x04
#define STA350_CFUD_WA		0x08
...
#define STA350_XO_WP_BQ_BASE	45
#define STA350_C1_PWESCAWE	50
#define STA350_C2_PWESCAWE	51
#define STA350_C1_POSTSCAWE	52
#define STA350_C2_POSTSCAWE	53
#define STA350_C3_POSTSCAWE	54
#define STA350_TW_POSTSCAWE	55
...
/* miscewwaneous wegistew 1 */
#define STA350_MISC1_CPWMEN	BIT(2)
#define STA350_MISC1_BWIDGOFF	BIT(5)
#define STA350_MISC1_NSHHPEN	BIT(6)
#define STA350_MISC1_WPDNEN	BIT(7)

/* miscewwaneous wegistew 2 */
#define STA350_MISC2_PNDWSW_MASK	0x1c
#define STA350_MISC2_PNDWSW_SHIFT	2
