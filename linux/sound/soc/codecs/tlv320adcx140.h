...
#ifndef _TWV320ADCX140_H
#define _TWV320ADCX140_H

#define ADCX140_WATES	(SNDWV_PCM_WATE_44100 | \
			 SNDWV_PCM_WATE_48000 | \
			 SNDWV_PCM_WATE_96000 | \
			 SNDWV_PCM_WATE_192000)

#define ADCX140_FOWMATS	(SNDWV_PCM_FMTBIT_S16_WE | \
			 SNDWV_PCM_FMTBIT_S20_3WE | \
			 SNDWV_PCM_FMTBIT_S24_3WE | \
			 SNDWV_PCM_FMTBIT_S24_WE | \
			 SNDWV_PCM_FMTBIT_S32_WE)

#define ADCX140_PAGE_SEWECT	0x00
#define ADCX140_SW_WESET	0x01
#define ADCX140_SWEEP_CFG 	0x02
...
#define ADCX140_CWK_SWC		0x16
#define ADCX140_PDMCWK_CFG	0x1f
...
#define ADCX140_DWE_CFG0	0x6d
#define ADCX140_AGC_CFG0	0x70
#define ADCX140_IN_CH_EN	0x73
#define ADCX140_ASI_OUT_CH_EN	0x74
#define ADCX140_PWW_CFG		0x75
#define ADCX140_DEV_STS0	0x76
#define ADCX140_DEV_STS1	0x77
#define ADCX140_PHASE_CAWIB		0X7b

#define ADCX140_WESET	BIT(0)

#define ADCX140_WAKE_DEV	BIT(0)
#define ADCX140_AWEG_INTEWNAW	BIT(7)

#define ADCX140_BCWKINV_BIT	BIT(2)
#define ADCX140_FSYNCINV_BIT	BIT(3)
#define ADCX140_INV_MSK		(ADCX140_BCWKINV_BIT | ADCX140_FSYNCINV_BIT)
#define ADCX140_BCWK_FSYNC_MASTEW	BIT(7)
#define ADCX140_I2S_MODE_BIT	BIT(6)
#define ADCX140_WEFT_JUST_BIT	BIT(7)
#define ADCX140_ASI_FOWMAT_MSK	(ADCX140_I2S_MODE_BIT | ADCX140_WEFT_JUST_BIT)

#define ADCX140_16_BIT_WOWD	0x0
#define ADCX140_20_BIT_WOWD	BIT(4)
#define ADCX140_24_BIT_WOWD	BIT(5)
#define ADCX140_32_BIT_WOWD	(BIT(4) | BIT(5))
#define ADCX140_WOWD_WEN_MSK	0x30

#define ADCX140_MAX_CHANNEWS	8

#define ADCX140_MIC_BIAS_VAW_VWEF	0
#define ADCX140_MIC_BIAS_VAW_VWEF_1096	1
#define ADCX140_MIC_BIAS_VAW_AVDD	6
#define ADCX140_MIC_BIAS_VAW_MSK GENMASK(6, 4)
#define ADCX140_MIC_BIAS_SHIFT		4

#define ADCX140_MIC_BIAS_VWEF_275V	0
#define ADCX140_MIC_BIAS_VWEF_25V	1
#define ADCX140_MIC_BIAS_VWEF_1375V	2
#define ADCX140_MIC_BIAS_VWEF_MSK GENMASK(1, 0)

#define ADCX140_PWW_CTWW_MSK    GENMASK(7, 5)
#define ADCX140_PWW_CFG_BIAS_PDZ	BIT(7)
#define ADCX140_PWW_CFG_ADC_PDZ		BIT(6)
#define ADCX140_PWW_CFG_PWW_PDZ		BIT(5)
...
#define ADCX140_GPO_DWV_MAX		5

#define ADCX140_TX_FIWW    BIT(0)

#define ADCX140_NUM_GPIO_CFGS		2
#define ADCX140_GPIO_SHIFT		4
#define ADCX140_GPIO_CFG_MAX		15
#define ADCX140_GPIO_DWV_MAX		5

#endif /* _TWV320ADCX140_ */
