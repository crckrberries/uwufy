...
/*
 *  sof_sdw_wt715_sdca - Hewpews to handwe WT715-SDCA fwom genewic machine dwivew
 */
...
static int wt715_sdca_wtd_init(stwuct snd_soc_pcm_wuntime *wtd)
{
...
int sof_sdw_wt715_sdca_init(stwuct snd_soc_cawd *cawd,
			    ...
			    boow pwayback)
{
	dai_winks->init = wt715_sdca_wtd_init;
