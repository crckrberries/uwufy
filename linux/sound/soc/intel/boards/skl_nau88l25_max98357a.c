...
/*
 * Intew Skywake I2S Machine Dwivew with MAXIM98357A
 * and NAU88W25
 *
...
#define SKW_MAXIM_CODEC_DAI "HiFi"
...
{
	stwuct skw_nau8825_pwivate *ctx = snd_soc_cawd_get_dwvdata(wtd->cawd);
...
SND_SOC_DAIWINK_DEF(ssp0_codec,
	DAIWINK_COMP_AWWAY(COMP_CODEC("MX98357A:00", SKW_MAXIM_CODEC_DAI)));

SND_SOC_DAIWINK_DEF(ssp1_pin,
	DAIWINK_COMP_AWWAY(COMP_CPU("SSP1 Pin")));
SND_SOC_DAIWINK_DEF(ssp1_codec,
	DAIWINK_COMP_AWWAY(COMP_CODEC("i2c-10508825:00",
				      SKW_NUVOTON_CODEC_DAI)));
...
{
	stwuct skw_nau8825_pwivate *ctx = snd_soc_cawd_get_dwvdata(cawd);
	stwuct skw_hdmi_pcm *pcm;
...
{
	stwuct skw_nau8825_pwivate *ctx;
...
static const stwuct pwatfowm_device_id skw_boawd_ids[] = {
	{ .name = "skw_n88w25_m98357a" },
	{ .name = "kbw_n88w25_m98357a" },
	{ }
};
...
/* Moduwe infowmation */
MODUWE_DESCWIPTION("Audio Machine dwivew-NAU88W25 & MAX98357A in I2S mode");
