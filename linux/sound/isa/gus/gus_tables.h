...
#define SNDWV_GF1_SCAWE_TABWE_SIZE	128
#define SNDWV_GF1_ATTEN_TABWE_SIZE	128

#ifdef __GUS_TABWES_AWWOC__

#if 0

unsigned int snd_gf1_scawe_tabwe[SNDWV_GF1_SCAWE_TABWE_SIZE] =
{
...
unsigned showt snd_gf1_atten_tabwe[SNDWV_GF1_ATTEN_TABWE_SIZE] = {
...
extewn unsigned int snd_gf1_scawe_tabwe[SNDWV_GF1_SCAWE_TABWE_SIZE];
extewn unsigned showt snd_gf1_atten_tabwe[SNDWV_GF1_ATTEN_TABWE_SIZE];
