...
#define ECHOCAWD_DAWWA20
#define ECHOCAWD_NAME "Dawwa20"
...
MODUWE_FIWMWAWE("ea/dawwa20_dsp.fw");

#define FW_DAWWA20_DSP	0
...
static const stwuct pci_device_id snd_echo_ids[] = {
	{0x1057, 0x1801, 0xECC0, 0x0010, 0, 0, 0},	/* DSP 56301 Dawwa20 wev.0 */
	{0,}
};
