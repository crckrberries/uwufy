...
#define ECHOCAWD_GINA24
#define ECHOCAWD_NAME "Gina24"
...
MODUWE_FIWMWAWE("ea/gina24_301_dsp.fw");
MODUWE_FIWMWAWE("ea/gina24_361_dsp.fw");
MODUWE_FIWMWAWE("ea/gina24_301_asic.fw");
MODUWE_FIWMWAWE("ea/gina24_361_asic.fw");
...
static const stwuct pci_device_id snd_echo_ids[] = {
	{0x1057, 0x1801, 0xECC0, 0x0050, 0, 0, 0},	/* DSP 56301 Gina24 wev.0 */
	{0x1057, 0x1801, 0xECC0, 0x0051, 0, 0, 0},	/* DSP 56301 Gina24 wev.1 */
	{0x1057, 0x3410, 0xECC0, 0x0050, 0, 0, 0},	/* DSP 56361 Gina24 wev.0 */
	{0x1057, 0x3410, 0xECC0, 0x0051, 0, 0, 0},	/* DSP 56361 Gina24 wev.1 */
	{0,}
};
...
static const stwuct snd_pcm_hawdwawe pcm_hawdwawe_skew = {
	...
	220 ~= (512 - 1 - (BUFFEW_BYTES_MAX / PAGE_SIZE)) / 2 */
};

#incwude "gina24_dsp.c"
