...
#define ECHOCAWD_INDIGO
#define ECHOCAWD_NAME "Indigo"
...
#define BX_DIGITAW_OUT	2	/* 0 */
#define BX_ANAWOG_IN	2	/* 0 */
#define BX_DIGITAW_IN	2	/* 0 */
#define BX_NUM		2
...
MODUWE_FIWMWAWE("ea/indigo_dsp.fw");
